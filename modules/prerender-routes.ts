...
export async function getDynamicPages() {
  ...
  const onlyPages = ['/home' /* will be replaced with '/' */, '/newsletter', '/staking', '/new-wallet', '/wallet', '/iframes/albatross-liveview']
...
// async function getDynamicPagesByType(documentType: 'blog_page' | 'page', { prismicUrl, ref, prismicAccessToken }: PrerenderPagesOptions) {
