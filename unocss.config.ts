  ...
  presets: [
    ...
    presetIcons({
      collections: {
        ...
        annoucement: {
          'lg-identicons-left': () => readFile('./public/assets/annoucement-identicons/lg-identicons-left.svg', 'utf-8'),
          'lg-identicons-right': () => readFile('./public/assets/annoucement-identicons/lg-identicons-right.svg', 'utf-8'),
          'md-identicons-left': () => readFile('./public/assets/annoucement-identicons/md-identicons-left.svg', 'utf-8'),
          'sm-identicons-right': () => readFile('./public/assets/annoucement-identicons/sm-identicons-right.svg', 'utf-8'),
        },
        roadmap: {
