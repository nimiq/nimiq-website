  ...
  presets: [
    ...
    presetIcons({
      collections: {
        ...
        'continents': FileSystemIconLoader('./app/assets/continents'),
        'oasis-regions': FileSystemIconLoader('./app/assets/oasis-regions'),
        'announcement': FileSystemIconLoader('./app/assets/announcement-identicons'),
        'custom': FileSystemIconLoader('./app/assets/custom-icons'),
        'roadmap': {
