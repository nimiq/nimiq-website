  ...
  presets: [
    ...
    presetIcons({
      collections: {
        ...
        'oasis-regions': {
          'europe': () => readFile('./public/assets/oasis-regions/europe.svg', 'utf-8'),
          'central-america': () => readFile('./public/assets/oasis-regions/central-america.svg', 'utf-8'),
          'rest-of-the-world': () => readFile('./public/assets/oasis-regions/rest-of-the-world.svg', 'utf-8'),
        },
        'announcement': {
        ...
        'custom': {
          ...
          'bg-hexagons': () => readFile('./public/assets/custom-icons/bg-hexagons.svg', 'utf-8'),
        },
        'roadmap': {
