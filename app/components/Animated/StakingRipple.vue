<template>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 140 140" text-0 style="--d: var(--duration, 1s)">
    ...
    <path d="M70 2.25h0A67.75 67.75 0 01137.75 70v0A67.75 67.75 0 0170 137.75h0A67.75 67.75 0 012.25 70v0A67.75 67.75 0 0170 2.25z" fill="none" stroke="url(#a)" style="--delay:600ms" stroke-width="3" stroke-opacity="0.4" class="ripple" animate-delay-600 op-0 />
    ...
    <path d="M70.71 69.1v21.56m18.71-26.11c0 12.4-6.31 18.89-18.71 18.89 0-17.56 5.28-18.89 18.71-18.89zM54.18 53.98c0 13.33 4.13 20.07 16.53 20.07 0-13.43-1.03-20.07-16.53-20.07z" fill="none" stroke-neutral-0 stroke-width="4.0316" stroke-linecap="round" stroke-linejoin="round" />
  </svg>
</template>
...
svg {
  ...
  .ripple {
    animation: fastwave var(--d) ease alternate infinite;
