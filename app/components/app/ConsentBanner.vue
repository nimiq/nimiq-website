...
<template>
  <AlertDialogRoot :open="open" :modal="false">
    <AlertDialogPortal>
      <AlertDialogContent
        class="nq-prose-compact outline outline-1.5 outline-neutral/10 mx-auto rounded-2 bg-neutral-0 max-w-none transition-all duration-300 ease-out inset-x-3 bottom-3 fixed z-101 f-p-lg flex flex-col" shadow style="box-shadow:
      ...
      >
        ...
        <div class="flex gap-4 mx-0 w-max -translate-x-[13px] f-mt-sm">
