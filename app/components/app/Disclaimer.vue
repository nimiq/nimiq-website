...
<template>
  <section :class="bgColor === 'darkblue' ? 'bg-darkerblue dark' : bgColor === 'white' ? 'bg-neutral-0' : 'bg-neutral-100'" group mx-0 children:max-w-none>
    <div nq-prose transition-colors children:text="f-sm neutral-800 group-hocus:neutral-900">
      <h2 px-0>
        Disclaimer
      </h2>
