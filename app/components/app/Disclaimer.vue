...
defineProps<{ bgColor?: 'grey' | 'white' | 'darkblue' }>()
</script>

<template>
  <aside class="group nq-prose mx-0 transition-colors" :class="bgColor === 'darkblue' ? 'bg-darkerblue dark' : bgColor === 'white' ? 'bg-neutral-0' : 'bg-neutral-100'" children:max-w-none children:text="f-sm neutral-800 group-hocus:neutral-900">
    <h2 class="px-0">
      Disclaimer
    </h2>
    <p class="lh-[1.75] px-0 mt-2 md:mt-3">
