...
const datum = computed(() => {
  ...
  return [
    { color: `var(--colors-green)`, value: ratio, label: `${formatter.value.format(ratio)} staked`, annotation: { bottom: '40px', right: '-72px' } },
    { color: `var(--colors-neutral-200)`, value: 1 - ratio, label: 'Circulating', annotation: { top: '40px', left: '-42px' } },
