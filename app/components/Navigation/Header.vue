...
<template>
  ...
  >
    ...
    <NuxtLink v-if="hotCtaLink" :to="hotCtaLink" mr-auto gap-x-9 bg="neutral/15 hocus:neutral/20" text-neutral nq-pill children:transition-colors :class="{ 'children:delay-200': direction === 'bottom' }">
      <div i-nimiq:flame />
