...
<template>
  <div flex="~ col md:items-center" group>
    ...
    <PrismicLink v-if="hasLink(cta)" internal-component="a" :field="cta" :class="primaryPill ? 'nq-pill-blue' : 'nq-pill-tertiary'" nq-mt-48 nq-shadow nq-arrow nq-pill-lg md:mx-auto inverted:shadow-none />
    <small :id text="green-1100 inverted:white/80 sm:center" nq-mt-32 data-note transition-colors duration-400 sm:max-w-32ch>
