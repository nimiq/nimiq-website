<template>
  <div relative pb-32>
    ...
    <div w="[calc(100%+48px)]" nq-mt-40 relative left--24 aspect-0.7 size-full rounded-14 bg-neutral-300 p-8 op-50 backdrop-blur-3.5 style="box-shadow: inset 0px 0px 40px #FFFFFF;">
