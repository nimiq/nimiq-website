...
<template>
  ...
  <HeroHome v-if="slice.variation === 'home2024'" :headline="slice.primary.headline!" :sub-headline-template="slice.primary.subheadline as any" :link="slice.primary.link!" :data-slice-type="slice.slice_type" />
