...
<template>
  ...
  <HeroHome v-if="slice.variation === 'home2024'" :headline="slice.primary.headline!" :subline="slice.primary.subheadline as any" :link="slice.primary.link!" :logos="(slice.primary as any).organizations" :data-slice-type="slice.slice_type" />
