...
interface NewYorkGridSlice {
  primary: {
    bgColor: string | undefined
    firstBlockFirstImage: ImageField
    firstBlockFirstLabel: string | undefined
    firstBlockFirstStat: string | undefined
    firstBlockSecondImage: ImageField
    firstBlockSecondLabel: string | undefined
    firstBlockSecondStat: string | undefined
    firstBlockThirdImage: ImageField
    secondBlockFirstImage: ImageField
    secondBlockFirstLabel: string | undefined
    secondBlockFirstStat: string | undefined
    secondBlockSecondImage: ImageField
    secondBlockSecondLabel: string | undefined
    secondBlockSecondStat: string | undefined
    secondBlockThirdImage: ImageField
  }
  variation?: string
}

const { slice } = defineProps<{ slice: NewYorkGridSlice, slices?: any[] }>()
const [DefineStats, ReuseStat] = createReusableTemplate<any>()
