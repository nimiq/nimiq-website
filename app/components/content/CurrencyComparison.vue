...
interface CurrencyComparisonSlice {
  primary: {
...
const props = defineProps<{ slice: CurrencyComparisonSlice, slices?: any[] }>()
const bgClass = getColorClass(props.slice.primary.bgColor as any)

const [DefineCrypto, ReuseCrypto] = createReusableTemplate<any>()
</script>
