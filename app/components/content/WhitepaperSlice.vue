...
interface WhitepaperSliceSlice {
  items: any[]
}

const props = defineProps<{ slice: WhitepaperSliceSlice, slices?: any[] }>()
...
const { define: DefineLitepaper, reuse: ReuseLitepaper } = createReusableTemplate<any>()
