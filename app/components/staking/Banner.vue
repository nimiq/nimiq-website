...
<template>
  <div class="w-full relative pt-40 md:pt-56 lg:pt-72 pb-0 px-3 md:px-4 translate-y-2">
    ...
    <div
      ...
      class="staking-banner-card relative grid grid-cols-1 lg:grid-cols-[1fr_max-content] lg:grid-flow-col gap-x-8 py-20 px-10 md:px-20 lg:p-24 rounded-2 bg-neutral-0 shadow mx-auto"
      style="max-width: calc(var(--nq-max-width, 73rem) - 32px)"
    >
      <div class="flex-1 flex flex-col gap-8">
        <h3 class="text-f-3xl text-neutral font-bold max-w-[24ch]">
          {{ item.headline }}
        </h3>
      ...
      <ul class="flex flex-col gap-3 md:gap-4 lg:gap-6 mt-10 lg:mt-0 lg:row-span-2 lg:self-center shrink-0">
