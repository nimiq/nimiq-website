...
<template>
  <div>
    ...
    <ul v-if="highlightsItems.length > 0" class="f-mt-xs flex flex-md:justify-center flex-items-center flex-wrap gap-x-4 gap-y-1" :aria-label="`Highlights of ${displayTitle}`" role="list">
    ...
    <div v-if="displayLink" class="flex flex-wrap gap-x-8 gap-y-4 flex-items-center flex-justify-center f-mt-lg" style="--nq-font-size-min:18;--nq-font-size-max:22">
