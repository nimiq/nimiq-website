...
watch(isVisible, visible => visible ? resume() : pause(), { immediate: true })
  ...
  >
    <div class="metawrapper">
      <div class="metacontainer">
        ...
        <svg
          class="metacloud three max-sm:hidden"
    ...
    <div class="pb-container">
      <div class="rect max-sm:hidden">
        <svg viewBox="0 0 1096 658" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g class="opacity-50 max-sm:hidden">
...
.metawrapper {
  ...
  left: calc(-1 * (var(--total-width) - 100%) / 2);
  overflow: hidden;
}
...
.metarect {
  ...
  border-radius: 10px;
  width: calc(100% - (var(--px) * 2) + 16px);
  height: auto;
  padding-block: 2px;
  position: absolute;
  top: calc(var(--f-pt) - 4px);
  left: 50%;
