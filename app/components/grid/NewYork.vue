...
<template>
  ...
  <section mx-0 bg-neutral-0>
    <div grid="~ flow-row gap-8 lg:rows-[auto,1fr,auto] lg:gap-24 cols-1 md:cols-2" w-full class="multiple-images" children:rounded-6 children:shadow>
