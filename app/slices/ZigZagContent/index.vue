    ...
    <ul>
      ...
      >
        ...
        >
          ...
          <PrismicRichText f-mt-24 :field="item.headline" />
          <div f-mt-12ext-12 nq-label>
            {{ item.label }}
          </div>
          <PrismicRichText f-mt-48lass="nq-prose-compact" :field="item.description" />
          <div flex="~ gap-24 md:col lg:row" f-mt-24ax-w-lg>
