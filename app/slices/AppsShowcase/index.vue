...
<template>
  <section ref="sectionRef">
    <ul v-if="slice.variation === 'nimiqsApps'" grid="~ cols-1 lg:cols-2 gap-20 md:gap-22">
      ...
      >
        <PrismicLink p="32 md:40 lg:48 b-0" :field="link" of-hidden nq-hoverable bg="gradient-subtle-neutral hocus:neutral-0" style="--ring-color: rgb(var(--nq-neutral-400));" grid="~ gap-x-48 lg:gap-x-80 md:rows-[auto_auto_1fr] md:cols-[221px_1fr]" :class="{ 'lg:rows-[repeat(4,auto)] lg:cols-1': !highlight }">
          ...
          <div :class="{ 'max-md:mr--128 md:ml-16': item === 'CPL', 'max-md:mr--128': item === 'Nimiq Wallet', 'md:max-w-245': item === 'Nimiq Pay', 'lg:mt-40 md:row-span-full md:col-start-2 lg:row-span-1 lg:col-start-1': !highlight, 'md:row-span-full md:col-start-2 lg:min-h-490': highlight }" h-282 md:mx-auto>
