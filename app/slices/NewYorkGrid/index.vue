...
<template>
  ...
  <section mx-0 :class="bgClass">
    ...
    >
      <LocalImage v-if="slice.variation === 'default'" :field="slice.primary.firstBlockFirstImage" size-full max-h-278 object-cover lg:row-span-2 md:col-span-2 style="grid-area: block1-image" />
      <ul v-else style="grid-area: block1-image" ring="1.5 neutral-200" h="128 lg:192 md:240" children:h="[calc(100%+32px)]" children:w="[calc((2*(100%-24px*2))/5)]" flex="~ gap-12 md:gap-24" bg-white overflow-hidden children:shrink-0 pl="12 md:24" pt="12 md:24">
        <li><LocalImage :field="slice.primary.firstBlockFirstImage" size-full object-cover /></li>
        <li><LocalImage :field="slice.primary.firstBlockSecondImage" size-full object-cover /></li>
        <li><LocalImage :field="slice.primary.firstBlockThirdImage" size-full object-cover /></li>
      </ul>
      ...
      <LocalImage v-if="slice.variation === 'default'" :field="slice.primary.secondBlockFirstImage" size-full max-h-278 object-cover lg:row-span-2 md:col-span-2 style="grid-area: block2-image" />
      ...
      <ul v-else style="grid-area: block2-image" ring="1.5 neutral-200" h="128 lg:192 md:240" children:h="[calc(100%+32px)]" children:w="[calc((2*(100%-24px*2))/5)]" flex="~ gap-12 md:gap-24" bg-white overflow-hidden children:shrink-0 pl="12 md:24" pt="12 md:24">
        <li><LocalImage :field="slice.primary.secondBlockFirstImage" size-full object-cover /></li>
        <li><LocalImage :field="slice.primary.secondBlockSecondImage" size-full object-cover /></li>
        <li><LocalImage :field="slice.primary.secondBlockThirdImage" size-full object-cover /></li>
      </ul>
