...
<template>
  <section ref="sectionRef">
    <div class="flex flex-col items-stretch gap-20 md:flex-row" w-full>
      <PrismicLink v-for="({ color, headline, iconName, linkHref, shape, subline }, i) in slice.items" :key="i" :style="`--c:${color}`" :field="linkHref" hocus:bg="$c" p="32 lg:40 2xl:48" group nq-no-color relative w-full flex-1 shrink-0 items-center nq-hoverable>
