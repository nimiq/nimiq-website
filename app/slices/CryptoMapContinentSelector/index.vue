...
<template>
  <section grid="~ cols-1 lg:cols-[min(calc(100vw-64px),411px)_1fr] gap-x-24" max-w="none lg:$nq-max-width" nq-wide w-screen bg-neutral-100 px-0 max-lg:mx-0 max-lg:children:max-w-none>
