...
<template>
  <section mx-0 of-x-clip bg-neutral-0 px-0 children:max-w-none>
    ...
    <ul flex="~ gap-6" nq-mt-48 mx-auto>
    ...
    <ul ref="scroller" flex="~ gap-16 md:gap-32 xl:gap-48" px="[calc((100%-min(87.2%,684px))/2)]" snap="x mandatory" nq-mt-96 of-x-auto of-y-hidden nq-scrollbar-hide @scroll.passive="calculateStep">
      <li
      ...
      >
        ...
        <PrismicRichText px="8 md:32 xl:48" :field="item.description" class="nq-prose-compact" nq-mt-12 text="neutral-800 xl" />
      </li>
    </ul>
  </section>
</template>
