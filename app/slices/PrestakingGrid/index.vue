...
<template>
  <section class="dark" data-gradient text-neutral pt-32 bg-darkblue relative>
    <NuxtImg provider="ipx" src="/assets/images/prestaking-glowing-background.webp" alt="" size-full max-w-none pointer-events-none rotate-180 inset-0 top-0 absolute z-1 object-cover object-bottom />
