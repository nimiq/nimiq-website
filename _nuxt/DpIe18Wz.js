import { i as L, a as T, b as x, d as z, c as K, u as $, _ as U } from "./Co9d64pR.js";
import { u as _, P as b, c as Y, a as j, e as V, b as F, f as W } from "./DRAR02aM.js";
import { d as m, b as v, o as f, w as d, R as g, c as k, m as y, u as t, j as X, a as h, h as N, U as q, C as P, S as E, T as S, a0 as A, G, as as H, e as C, n as D, i as J } from "./g1xKa6TI.js";
import { d as Q, _ as Z, a as ee, c as te, b as oe } from "./DUznQD6O.js";
const ae = { key: 0, d: "M0 0L6 6L12 0" }, se = { key: 1, d: "M0 0L4.58579 4.58579C5.36683 5.36683 6.63316 5.36684 7.41421 4.58579L12 0" }, ne = m({ __name: "Arrow", props: { width: { default: 10 }, height: { default: 5 }, rounded: { type: Boolean }, asChild: { type: Boolean }, as: { default: "svg" } }, setup(p) {
...
} }), [O, le] = Y("PopoverRoot"), de = m({ __name: "PopoverRoot", props: { defaultOpen: { type: Boolean, default: false }, open: { type: Boolean, default: void 0 }, modal: { type: Boolean, default: false } }, emits: ["update:open"], setup(p, { emit: a }) {
  const e = p, o = a, { modal: s } = q(e), n = j(e, "open", o, { defaultValue: e.defaultOpen, passive: e.open === void 0 }), r = P(), c = P(false);
  ...
  const a = p;
  return _(), (e, o) => (f(), v(t(re), E(S(a)), { default: d(() => [g(e.$slots, "default")]), _: 3 }, 16));
} }), ue = m({ __name: "PopoverPortal", props: { to: {}, disabled: { type: Boolean }, defer: { type: Boolean }, forceMount: { type: Boolean } }, setup(p) {
  const a = p;
  return (e, o) => (f(), v(t(Q), E(S(a)), { default: d(() => [g(e.$slots, "default")]), _: 3 }, 16));
...
} }), fe = m({ __name: "PopoverContentNonModal", props: { side: {}, sideOffset: {}, align: {}, alignOffset: {}, avoidCollisions: { type: Boolean }, collisionBoundary: {}, collisionPadding: {}, arrowPadding: {}, sticky: {}, hideWhenDetached: { type: Boolean }, positionStrategy: {}, updatePositionStrategy: {}, disableUpdateOnLayoutShift: { type: Boolean }, prioritizePosition: { type: Boolean }, reference: {}, asChild: { type: Boolean }, as: {}, disableOutsidePointerEvents: { type: Boolean } }, emits: ["escapeKeyDown", "pointerDownOutside", "focusOutside", "interactOutside", "openAutoFocus", "closeAutoFocus"], setup(p, { emit: a }) {
...
} }), ge = m({ __name: "PopoverContent", props: { forceMount: { type: Boolean }, side: {}, sideOffset: {}, align: {}, alignOffset: {}, avoidCollisions: { type: Boolean }, collisionBoundary: {}, collisionPadding: {}, arrowPadding: {}, sticky: {}, hideWhenDetached: { type: Boolean }, positionStrategy: {}, updatePositionStrategy: {}, disableUpdateOnLayoutShift: { type: Boolean }, prioritizePosition: { type: Boolean }, reference: {}, asChild: { type: Boolean }, as: {}, disableOutsidePointerEvents: { type: Boolean } }, emits: ["escapeKeyDown", "pointerDownOutside", "focusOutside", "interactOutside", "openAutoFocus", "closeAutoFocus"], setup(p, { emit: a }) {
  const e = p, o = a, s = O(), n = $(e, o), { forwardRef: r } = _();
  return s.contentId || (s.contentId = F(void 0, "reka-popover-content")), (c, i) => (f(), v(t(W), { present: c.forceMount || t(s).open.value }, { default: d(() => [t(s).modal.value ? (f(), v(ce, y({ key: 0 }, t(n), { ref: t(r) }), { default: d(() => [g(c.$slots, "default")]), _: 3 }, 16)) : (f(), v(fe, y({ key: 1 }, t(n), { ref: t(r) }), { default: d(() => [g(c.$slots, "default")]), _: 3 }, 16))]), _: 3 }, 8, ["present"]));
} }), ve = m({ __name: "PopoverTrigger", props: { asChild: { type: Boolean }, as: { default: "button" } }, setup(p) {
  const a = p, e = O(), { forwardRef: o, currentElement: s } = _();
  return e.triggerId || (e.triggerId = F(void 0, "reka-popover-trigger")), G(() => {
    e.triggerElement.value = s.value;
  }), (n, r) => (f(), v(H(t(e).hasCustomAnchor.value ? t(b) : t(U)), { "as-child": "" }, { default: d(() => [h(t(b), { id: t(e).triggerId, ref: t(o), type: n.as === "button" ? "button" : void 0, "aria-haspopup": "dialog", "aria-expanded": t(e).open.value, "aria-controls": t(e).contentId, "data-state": t(e).open.value ? "open" : "closed", as: n.as, "as-child": a.asChild, onClick: t(e).onOpenToggle }, { default: d(() => [g(n.$slots, "default")]), _: 3 }, 8, ["id", "type", "aria-expanded", "aria-controls", "data-state", "as", "as-child", "onClick"])]), _: 3 }));
} }), me = m({ __name: "Tooltip", props: { dark: { type: Boolean } }, setup(p) {
  return (a, e) => {
    const o = ve, s = pe, n = ge, r = ue, c = de;
    return f(), v(c, null, { default: d(() => [h(o, y(a.$attrs, { "bg-transparent": "", "h-max": "" }), { default: d(() => [g(a.$slots, "trigger", {}, () => [e[0] || (e[0] = C("div", { "text-12": "", "text-neutral-700": "", "i-nimiq:info": "" }, null, -1))], true)]), _: 3 }, 16), h(r, null, { default: d(() => [h(n, { "as-child": "", class: "tooltip-animation", "side-offset": 8, "collision-padding": 8, side: "bottom", flex: "~ col", "max-w-360": "" }, { default: d(() => [C("div", { class: D(a.dark ? "bg-white" : "bg-gradient-neutral shadow dark scheme-dark"), "p-16": "", "rounded-8": "", text: "neutral dark:white" }, [g(a.$slots, "default", {}, void 0, true)], 2), h(s, { "as-child": "" }, { default: d(() => [C("div", { "rotate-180": "", class: D({ dark: a.dark }) }, e[1] || (e[1] = [C("div", { "aria-hidden": "", "mt--1": "", "h-8": "", "w-16": "", "i-nimiq:tooltip-triangle": "", class: "tooltip-animation", text: "darkblue dark:white" }, null, -1)]), 2)]), _: 1 })]), _: 3 })]), _: 3 })]), _: 3 });
  };
} }), Pe = Object.assign(J(me, [["__scopeId", "data-v-86a9e226"]]), { __name: "Tooltip" });
export {
  Pe as _,
  re as a
};
