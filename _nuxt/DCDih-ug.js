import { bt as g, i as u, bu as p, B as i, bv as b, ae as h, aa as w, b5 as B, bw as c, bx as S, N as x } from "./C95QRNzc.js";
const k = g(() => {
  ...
  return h(o, (s, y) => {
    ...
    l > 0 && (document.body.style.paddingRight = typeof r.padding == "number" ? `${r.padding}px` : String(r.padding), document.body.style.marginRight = typeof r.margin == "number" ? `${r.margin}px` : String(r.margin), document.body.style.setProperty("--scrollbar-width", `${l}px`), document.body.style.overflow = "hidden"), c && (a = S(document, "touchmove", (v) => C(v), { passive: false })), x(() => {
      document.body.style.pointerEvents = "none", document.body.style.overflow = "hidden";
    });
  }, { immediate: true, flush: "sync" }), t;
});
function O(t) {
  const e = Math.random().toString(36).substring(2, 7), o = k();
