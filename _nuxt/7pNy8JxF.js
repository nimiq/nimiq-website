...
import { aA as F, j as E } from "./gdLxT4Lf.js";
import { u as p } from "./ZiJUCFG6.js";
function I(e, t) {
...
function A(e) {
  ...
  const c = o === "test-albatross" ? P : b, l = _.getTime() + 24 * 60 * 60 * 1e3, m = R(l, { network: o }) - c, r = Math.E ** (-3432600460362e-16 * i);
  let u = 0;
...
function k(e, t, i = {}) {
  ...
  return c ? Number.parseFloat(d) : T(d, t, m, r);
}
function T(e, t, i, a) {
...
function Y() {
  const e = "https://dev.validators-api-mainnet.pages.dev", { data: t, state: i } = F({ key: ["staking_distribution"], query: async () => {
    ...
    if (!t.value) return 0;
    const s = A({ stakedSupplyRatio: t.value });
    return $(s.gainRatio);
  });
