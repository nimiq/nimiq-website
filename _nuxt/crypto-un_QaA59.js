...
(function() {
  ...
  (async () => {
    const U = Symbol("Comlink.proxy"), q = Symbol("Comlink.endpoint"), V = Symbol("Comlink.releaseProxy"), k = Symbol("Comlink.finalizer"), x = Symbol("Comlink.thrown"), z = (e) => typeof e == "object" && e !== null || typeof e == "function", G = {
      canHandle: (e) => z(e) && e[U],
      serialize(e) {
    ...
    const A = /* @__PURE__ */ new WeakMap(), M = "FinalizationRegistry" in globalThis && new FinalizationRegistry((e) => {
      const t = (A.get(e) || 0) - 1;
      A.set(e, t), t === 0 && F(e);
    });
    function X(e, t) {
      const n = (A.get(t) || 0) + 1;
      A.set(t, n), M && M.register(e, t, e);
    }
    function Z(e) {
      M && M.unregister(e);
    }
    ...
    var re = "" + new URL("index_bg-1-I0ZU3Y.wasm", _documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === "SCRIPT" && _documentCurrentScript.src || new URL("_nuxt/crypto-un_QaA59.js", document.baseURI).href).href, oe = async (e = {}, t) => {
      let n;
    ...
    function ae(e, t, n, s) {
      const r = {
        ...
        try {
          ...
          --r.cnt === 0 ? (u.__wbindgen_export_3.get(r.dtor)(_, r.b), W.unregister(r)) : r.a = _;
        }
      };
    ...
    const g = await oe({
      "./index_bg.js": {
        ...
        __wbg_static_accessor_SELF_37c5d418e4bf5819: Me,
        ...
        __wbindgen_closure_wrapper60: Oe,
