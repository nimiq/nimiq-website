...
const X = { "px-0": "", "pb-0": "", "bg-neutral-100": "", "max-lg:mx-0": "", "data-slice-type": "crypto-map-continent-selector" }, Y = { "max-w": "none lg:$nq-max-width children:none", "w-screen": "", grid: "~ cols-1 lg:cols-[min(calc(100vw-64px),411px)_1fr] gap-x-24" }, G = { flex: "~ lg:col gap-16", "max-lg": "snap-x snap-mandatory scroll-pl-32 of-x-auto nq-scrollbar-hide py-20 lg:py-40" }, H = ["data-selected"], K = ["onClick"], Q = { text: "20/26 lg:22/28.6", "font-semibold": "", "text-left": "", "whitespace-nowrap": "" }, Z = { flex: "~ gap-12 items-center", mt: "8 md:12", "h-21": "" }, tt = { key: 0, flex: "~ gap-6 items-center" }, et = { text: "14 md:15 neutral-800", "font-semibold": "", "whitespace-nowrap": "" }, ot = { key: 1, "bg-neutral-500": "", "w-1": "", "self-stretch": "" }, nt = { text: "14 md:15 neutral-800", "whitespace-nowrap": "" }, st = { "font-semibold": "" }, it = { pointer: "", invisible: "", "pointer-events-none": "", "inset-y-0": "", "right-0": "", absolute: "", "of-hidden": "", "md:visible": "" }, at = { grid: "~ *:col-span-full *:row-span-full", "mx-auto": "", "w-full": "", "self-stretch": "", "justify-self-stretch": "", "max-lg:mt-24": "", "max-lg:px-32": "", "max-lg:w-full": "", "lg:self-stretch": "" }, lt = { key: 0, flex: "~ col gap-8 items-center justify-center", "rounded-8": "", "bg-darkblue": "", "bg-op-80": "", "z-1": "" }, rt = { text: "white min-18 max-24", "font-bold": "" }, ct = { flex: "~ col gap-16 md:items-center", w: "[calc(100%-64px)] lg:full", "px-24": "", "py-32": "", "rounded-b-12": "", "bg-neutral-400": "", "top--8": "", relative: "", "max-lg:mx-32": "", "lg:col-start-2": "", "lg:row-start-2": "" }, ht = B({ __name: "index", props: R(), setup(z) {
  ...
  return (o, e) => {
    const n = A, s = J;
    return a(), i("section", X, [t("div", Y, [t("ul", G, [(a(true), i(F, null, V(v(L), ({ label: r, hasCryptoCities: p, hasLocations: u, cryptoCitiesCount: f, locationsCount: $, svg: I, selected: M }, j) => (a(), i("li", { key: r, "max-lg": "snap-start shrink-0 first:pl-32 last:pr-32", "rounded-8": "", "data-selected": M ? "" : void 0 }, [t("button", { p: "x-24 y-20", "w-full": "", relative: "", "of-hidden": "", "nq-hoverable": "", "lg:max-w-410": "", "md:min-w-385": "", "max-md:selected:bg-white": "", onClick: (pt) => l.value = j }, [t("p", Q, d(r), 1), t("div", Z, [p ? (a(), i("div", tt, [e[1] || (e[1] = t("div", { "text-20": "", "i-nimiq:logos-cryptocity": "" }, null, -1)), t("span", et, d(f), 1)])) : h("", true), p && u ? (a(), i("div", ot)) : h("", true), t("p", nt, [t("span", st, d($), 1), e[2] || (e[2] = D(" locations "))])]), t("div", it, [t("div", { class: O(I), "text-neutral-500": "", "transition-colors": "", relative: "" }, null, 2)])], 8, K)], 8, H))), 128))]), t("div", at, [w(P, { "leave-active-class": "transition duration-500 [&_:is(button,p)]:duration-300 ease-nq [&_:is(button,p)]:ease-out [&_:is(button,p)]:transition", "leave-to-class": "op-0 [&_button]:translate-y-96 [&_p]:translate-y--96 [&_:is(button,p)]:op-0", "leave-from-class": "op-100 [&_p]:translate-y-0 [&_button]:translate-y-0 [&_:is(button,p)]:op-100" }, { default: T(() => {
      var _a2;
