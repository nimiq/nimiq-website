import { a as Fe, c as ye, u as Se, b as Ne, d as Ke, _ as We } from "./BFMIjy9Q.js";
import { _ as qe } from "./DxbAjo62.js";
import { _ as Ue, m as ze } from "./BPogp8AH.js";
import { i as je } from "./BNXriZyS.js";
import { aq as Ye, d as V, C as E, Y as Te, b as R, o as T, w as _, e as L, m as W, R as $, u as t, U as fe, j as O, f as te, c as N, F as me, r as Ee, G as j, a2 as X, a as C, h as Ge, V as Xe, a0 as Z, as as Ze, S as oe, T as ne, X as Qe, a3 as Je, g as ae, t as Pe, ay as et, am as tt, ak as _e, aB as be } from "./BguRs3jF.js";
import { c as ot, u as nt } from "./Cn5kCPLx.js";
import { g as at } from "./CpsPJSKh.js";
import { a as lt } from "./CwbeRH5k.js";
import { a as st, b as Be, c as it, d as rt, u as ut, _ as dt } from "./C8aoRHDt.js";
import { a as we, c as se, u as G, g as ct, P as K, h as pt, f as ft, b as Ie } from "./CMmzeBWC.js";
import { _ as mt, u as Q } from "./QoFfB0oT.js";
import { u as vt } from "./qA1gjzOk.js";
import { i as xe } from "./CHIgUVhi.js";
import { c as gt, b as ht, a as yt, _ as _t, h as bt, g as wt, d as xt } from "./BIPleKtX.js";
import { f as Ce } from "./CbA0xmEM.js";
import "./BcNiqOM3.js";
import "./T2yBj71G.js";
import "./DeSMYd_K.js";
...
const Et = V({ __name: "BubbleSelect", props: { autocomplete: {}, autofocus: { type: Boolean }, disabled: { type: Boolean }, form: {}, multiple: { type: Boolean }, name: {}, required: { type: Boolean }, size: {}, value: {} }, setup(n) {
  ...
  }), (f, o) => (T(), R(t(mt), { "as-child": "" }, { default: _(() => [L("select", W({ ref_key: "selectElement", ref: e }, s), [$(f.$slots, "default")], 16)]), _: 3 }));
  ...
  const e = n, f = s, { required: o, disabled: l, multiple: v, dir: r } = fe(e), d = we(e, "modelValue", f, { defaultValue: e.defaultValue ?? (v.value ? [] : void 0), passive: e.modelValue === void 0, deep: true }), c = we(e, "open", f, { defaultValue: e.defaultOpen, passive: e.open === void 0 }), m = E(), g = E(), b = E({ x: 0, y: 0 }), h = O(() => {
    var _a;
  ...
  const e = n, f = s, { getItems: o } = Q(), l = Y(), v = ie(), r = E(false), d = E(true), c = E(), { forwardRef: m, currentElement: g } = G(), { viewport: b, selectedItem: h, selectedItemText: u, focusSelectedItem: P } = v;
  function B() {
    if (l.triggerElement.value && l.valueElement.value && c.value && g.value && (b == null ? void 0 : b.value) && (h == null ? void 0 : h.value) && (u == null ? void 0 : u.value)) {
      ...
      const y = o().map((M) => M.ref), x = window.innerHeight - A * 2, I = b.value.scrollHeight, S = window.getComputedStyle(g.value), q = Number.parseInt(S.borderTopWidth, 10), H = Number.parseInt(S.paddingTop, 10), ve = Number.parseInt(S.borderBottomWidth, 10), Re = Number.parseInt(S.paddingBottom, 10), ge = q + H + I + Re + ve, De = Math.min(h.value.offsetHeight * 5, ge), he = window.getComputedStyle(b.value), Ae = Number.parseInt(he.paddingTop, 10), Oe = Number.parseInt(he.paddingBottom, 10), J = i.top + i.height / 2 - A, Me = x - J, re = h.value.offsetHeight / 2, Le = h.value.offsetTop + re, ee = q + H + Le, He = ge - ee;
      if (ee <= J) {
        const M = h.value === y[y.length - 1];
        c.value.style.bottom = "0px";
        const F = g.value.clientHeight - b.value.offsetTop - b.value.offsetHeight, U = Math.max(Me, re + (M ? Oe : 0) + F + ve), z = ee + U;
        c.value.style.height = `${z}px`;
      } else {
        const M = h.value === y[0];
        c.value.style.top = "0px";
        const U = Math.max(J, q + b.value.offsetTop + (M ? Ae : 0) + re) + He;
        c.value.style.height = `${U}px`, b.value.scrollTop = ee - J + b.value.offsetTop;
      }
  ...
  const D = E("");
  j(async () => {
    await X(), B(), g.value && (D.value = window.getComputedStyle(g.value).zIndex);
  });
  function k(i) {
  ...
  return ct(l.triggerElement, () => {
    B();
  }), kt({ contentWrapper: c, shouldExpandOnScrollRef: r, onScrollButtonChange: k }), (i, a) => (T(), N("div", { ref_key: "contentWrapperElement", ref: c, style: Ge({ display: "flex", flexDirection: "column", position: "fixed", zIndex: D.value }) }, [C(t(K), W({ ref: t(m), style: { boxSizing: "border-box", maxHeight: "100%" } }, { ...i.$attrs, ...e }), { default: _(() => [$(i.$slots, "default")]), _: 3 }, 16)], 4));
  ...
  ht(r);
  const { search: d, handleTypeaheadSearch: c } = Se(), m = E(), g = E(), b = E(), h = E(false), u = E(false), P = E(false);
  function B() {
  ...
  return $e({ content: r, viewport: m, onViewportChange: (p) => {
    ...
    I && (u.value = true);
  }, selectedItem: g, selectedItemText: b, onItemLeave: () => {
    var _a;
    (_a = r.value) == null ? void 0 : _a.focus();
  }, itemTextRefCallback: (p, y, x) => {
    const I = !u.value && !x;
    (le(o.modelValue.value, y, o.by) || I) && (b.value = p);
  }, focusSelectedItem: B, position: e.position, isPositioned: h, searchRef: d }), (p, y) => (T(), R(t(l), null, { default: _(() => [C(t(yt), { "as-child": "", onMountAutoFocus: y[6] || (y[6] = Z(() => {
  ...
  }) }, { default: _(() => [C(t(_t), { "as-child": "", "disable-outside-pointer-events": "", onFocusOutside: y[2] || (y[2] = Z(() => {
  }, ["prevent"])), onDismiss: y[3] || (y[3] = (x) => t(o).onOpenChange(false)), onEscapeKeyDown: y[4] || (y[4] = (x) => f("escapeKeyDown", x)), onPointerDownOutside: y[5] || (y[5] = (x) => f("pointerDownOutside", x)) }, { default: _(() => [(T(), R(Ze(p.position === "popper" ? Vt : $t), W({ ...p.$attrs, ...t(w) }, { id: t(o).contentId, ref: (x) => {
    r.value = t(pt)(x);
  ...
  return (c, m) => {
    var _a;
    return d.value ? (T(), R(t(ft), { key: 0, ref_key: "presenceRef", ref: r, present: true }, { default: _(() => [C(Dt, oe(ne({ ...t(o), ...c.$attrs })), { default: _(() => [$(c.$slots, "default")]), _: 3 }, 16)]), _: 3 }, 512)) : !((_a = r.value) == null ? void 0 : _a.present) && v.value ? (T(), N("div", Ot, [(T(), R(Qe, { to: v.value }, [C(At, { context: t(l) }, { default: _(() => [$(c.$slots, "default")]), _: 3 }, 8, ["context"])], 8, ["to"]))])) : te("", true);
  };
  ...
  const e = n, f = s, { disabled: o } = fe(e), l = Y(), v = ie(), { forwardRef: r, currentElement: d } = G(), { CollectionItem: c } = Q(), m = O(() => {
    var _a;
    return le((_a = l.modelValue) == null ? void 0 : _a.value, e.value, l.by);
  }), g = E(false), b = E(e.textValue ?? ""), h = Ie(void 0, "reka-select-item-text"), u = "select.select";
  async function P(a) {
  ...
  async function B(a) {
    await X(), f("select", a), !a.defaultPrevented && (o.value || (l.onValueChange(e.value), l.multiple.value || l.onOpenChange(false)));
  }
  async function D(a) {
    var _a, _b;
    await X(), !a.defaultPrevented && (o.value ? (_a = v.onItemLeave) == null ? void 0 : _a.call(v) : (_b = a.currentTarget) == null ? void 0 : _b.focus({ preventScroll: true }));
  }
  async function k(a) {
    var _a;
    await X(), !a.defaultPrevented && a.currentTarget === wt() && ((_a = v.onItemLeave) == null ? void 0 : _a.call(v));
  }
  async function i(a) {
    var _a;
    await X(), !(a.defaultPrevented || ((_a = v.searchRef) == null ? void 0 : _a.value) !== "" && a.key === " ") && (St.includes(a.key) && P(a), a.key === " " && a.preventDefault());
  }
  ...
  const s = n, e = Ve();
  return (f, o) => t(e).isSelected.value ? (T(), R(t(K), W({ key: 0, "aria-hidden": "true" }, s), { default: _(() => [$(f.$slots, "default")]), _: 3 }, 16)) : te("", true);
} }), Nt = V({ inheritAttrs: false, __name: "SelectItemText", props: { asChild: { type: Boolean }, as: { default: "span" } }, setup(n) {
  const s = n, e = Y(), f = ie(), o = Ve(), { forwardRef: l, currentElement: v } = G(), r = O(() => {
    var _a, _b;
  ...
  function g(b) {
    m(), e.triggerPointerDownPosRef.value = { x: Math.round(b.pageX), y: Math.round(b.pageY) };
  }
  return (b, h) => (T(), R(t(dt), { "as-child": "", reference: b.reference }, { default: _(() => {
    var _a, _b, _c, _d;
    return [C(t(K), { ref: t(f), role: "combobox", type: b.as === "button" ? "button" : void 0, "aria-controls": t(e).contentId, "aria-expanded": t(e).open.value || false, "aria-required": (_a = t(e).required) == null ? void 0 : _a.value, "aria-autocomplete": "none", disabled: l.value, dir: (_b = t(e)) == null ? void 0 : _b.dir.value, "data-state": ((_c = t(e)) == null ? void 0 : _c.open.value) ? "open" : "closed", "data-disabled": l.value ? "" : void 0, "data-placeholder": t(Tt)((_d = t(e).modelValue) == null ? void 0 : _d.value) ? "" : void 0, "as-child": b.asChild, as: b.as, onClick: h[0] || (h[0] = (u) => {
      var _a2;
    ...
    }) }, { default: _(() => [$(b.$slots, "default")]), _: 3 }, 8, ["type", "aria-controls", "aria-expanded", "aria-required", "disabled", "dir", "data-state", "data-disabled", "data-placeholder", "as-child", "as"])];
  }), _: 3 }, 8, ["reference"]));
} }), qt = V({ __name: "SelectValue", props: { placeholder: { default: "" }, asChild: { type: Boolean }, as: { default: "span" } }, setup(n) {
  const s = n, { forwardRef: e, currentElement: f } = G(), o = Y();
  j(() => {
    o.valueElement = f;
  });
  const l = O(() => {
  ...
  return (r, d) => (T(), R(t(K), { ref: t(e), as: r.as, "as-child": r.asChild, style: { pointerEvents: "none" }, "data-placeholder": l.value.length ? void 0 : s.placeholder }, { default: _(() => [$(r.$slots, "default", { selectedLabel: l.value, modelValue: t(o).modelValue.value }, () => [ae(Pe(v.value), 1)])]), _: 3 }, 8, ["as", "as-child", "data-placeholder"]));
} }), Ut = V({ __name: "SelectViewport", props: { nonce: {}, asChild: { type: Boolean }, as: {} }, setup(n) {
  const s = n, { nonce: e } = fe(s), f = Ne(e), o = ie(), l = o.position === "item-aligned" ? It() : void 0, { forwardRef: v, currentElement: r } = G();
  j(() => {
    o == null ? void 0 : o.onViewportChange(r.value);
  });
  const d = E(0);
  function c(m) {
    const g = m.currentTarget, { shouldExpandOnScrollRef: b, contentWrapper: h } = l ?? {};
    if ((b == null ? void 0 : b.value) && (h == null ? void 0 : h.value)) {
