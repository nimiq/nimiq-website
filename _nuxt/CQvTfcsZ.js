import { _ as f } from "./H0qEFha8.js";
import { d as m, c as s, o as t, e as i, f as r, b as d, t as l, F as g, r as h, a, u as q, Z as k, i as b } from "./g1xKa6TI.js";
import { a as y } from "./B2NqqgPK.js";
...
const w = { flex: "~ col md:items-center" }, F = { "w-max": "", "f-text-lg": "", "nq-label": "" }, I = { grid: "~ cols-1 md:cols-2 lg:cols-3 gap-24", "f-mt-md": "" }, v = { key: 0, text: "left md:center neutral-800 f-lg", "f-mt-xl": "" }, B = m({ __name: "Faq", props: { questions: {}, title: {}, moreInsightfulLabel: {}, cta: {} }, setup(c) {
  return (e, p) => {
    const n = f, u = k;
    return t(), s("div", w, [i("h2", F, l(e.title), 1), i("ul", I, [(t(true), s(g, null, h(e.questions, (o, _) => (t(), s("li", { key: _, "p-16": "", "rounded-6": "", "bg-neutral-300": "" }, [a(n, { wrapper: "div", field: o.question, "f-mt-2xs": "" }, null, 8, ["field"]), a(n, { wrapper: "div", field: o.answer, "nq-prose-compact": "", "f-mt-xs": "" }, null, 8, ["field"])]))), 128))]), e.moreInsightfulLabel ? (t(), s("p", v, l(e.moreInsightfulLabel), 1)) : r("", true), ("hasLink" in e ? e.hasLink : q(y))(e.cta) ? (t(), d(u, { key: 1, field: e.cta, "f-mt-sm": "", "nq-arrow": "", "nq-pill-lg": "", "nq-pill-secondary": "" }, null, 8, ["field"])) : r("", true)]);
  };
} }), S = Object.assign(b(B, [["__scopeId", "data-v-46a8f206"]]), { __name: "StakingFaq" }), x = { "bg-neutral-100": "", "data-slice-type": "staking-faq" }, D = m({ __name: "index", props: L(), setup(c) {
  return (e, p) => {
    const n = S;
