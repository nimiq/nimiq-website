...
import { aj as d, A as _, ai as m, aK as w, c as f } from "./Dzy_QPZd.js";
...
function F(r) {
  return !(!P(r) || !r.message && !r.args || r.stack);
}
let g = false;
const S = [];
class l {
  constructor(t = {}) {
    ...
    const o = t.types || L;
    this.options = C({ ...t, defaults: { ...t.defaults }, level: h(t.level, o), reporters: [...t.reporters || []] }, { types: L, throttle: 1e3, throttleMin: 5, formatOptions: { date: true, colors: false, compact: true } });
    for (const i in o) {
...
function k(r = {}) {
  return B({ reporters: r.reporters || [new T({})], prompt(o, i = {}) {
