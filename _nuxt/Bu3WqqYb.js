import { a as N, u as w, c as D, P as R, b as S, s as P, f as q } from "./DvG5VWlW.js";
import { ag as O, j as m, d as y, U as M, b as C, o as A, w as g, R as _, u as o, W as j, B as k, L as K, E as L, a as U, m as z, f as W, a1 as X } from "./ClGJWWej.js";
import { i as G } from "./CHIgUVhi.js";
import { u as J } from "./ZsnPzy3h.js";
function Q(t, n) {
...
const [E, ae] = D("AccordionRoot"), ve = y({ __name: "AccordionRoot", props: { collapsible: { type: Boolean, default: false }, disabled: { type: Boolean, default: false }, dir: {}, orientation: { default: "vertical" }, unmountOnHide: { type: Boolean, default: true }, asChild: { type: Boolean }, as: {}, type: {}, modelValue: {}, defaultValue: {} }, emits: ["update:modelValue"], setup(t, { emit: n }) {
  const a = t, e = n, { dir: l, disabled: i, unmountOnHide: r } = M(a), s = J(l), { modelValue: u, changeModelValue: p, isSingle: v } = te(a, e), { forwardRef: c, currentElement: f } = w();
