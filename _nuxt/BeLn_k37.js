import { i as g, c as d, o as r, e, d as y, B as h, as as q, V as M, F as j, r as A, u as _, n as $, t as T, h as C, a as f, j as B, aj as E, E as P, G as I, a4 as z, b as k } from "./7tyaNgEA.js";
import { r as O, b as Z, d as H } from "./-SGvg42Q.js";
import { _ as D } from "./BUqI_u8t.js";
import { g as R } from "./CpsPJSKh.js";
import { u as V } from "./CynVbIQT.js";
import "./8Lad1M9Y.js";
...
const G = Object.assign(g(N, [["render", L], ["__scopeId", "data-v-8793b676"]]), { __name: "AnimatedCloudyBg" }), Y = { flex: "~ gap-4", "self-end": "!", ring: "1 blue/80", relative: "", "z-10": "", "h-max": "", "rounded-full": "", "bg-white": "", "p-4": "", style: { "--un-shadow": "0 0 32px #0682CA" } }, J = ["data-state", "onClick"], K = { font: "semibold data-active:bold", text: "data-active:white", "transition-color": "" }, Q = y({ __name: "ActionSelector", emits: ["state"], setup(v, { emit: t }) {
  ...
  }, { flush: "post" }), (m, u) => (r(), d("ul", Y, [e("div", { ref_key: "pill", ref: l, absolute: "", "inset-y-3": "", "rounded-full": "", "bg-darkblue": "", "transition-all": "", "duration-400": "", "ease-in-out": "" }, null, 512), (r(), d(j, null, A(x, ({ icon: s, label: a, value: w, color: b }) => e("li", { key: w, style: C({ "--c": `rgb(var(--nq-${b}) / 1)` }) }, [e("button", { flex: "~ gap-2 items-center", "rounded-full": "", "bg-transparent": "", "p-2": "", "pr-12": "", "data-state": w === _(o) ? "active" : void 0, onClick: (i) => o.value = w }, [e("div", { class: $(s), text: "neutral-800 data-active:$c", "m-8": "", "transition-color": "" }, null, 2), e("span", K, T(a), 1)], 8, J)], 4)), 64)), e("li", { class: $(_(o) === "idle" ? "scale-0 w-0" : "scale-100 w-36"), "h-36": "", transition: "[width,transform]", "duration-300": "", "ease-out": "", "max-sm:hidden": "" }, [e("button", { "bg-transparent": "", onClick: u[0] || (u[0] = (s) => o.value = "idle") }, u[1] || (u[1] = [e("div", { text: "neutral-800", "m-8": "", "i-nimiq:redo": "" }, null, -1)]))], 2)]));
...
function le(v, t) {
  const c = W, o = F;
  return r(), d("div", oe, [t[0] || (t[0] = e("div", { class: "bg", left: "[calc(var(--px)*-1)]", w: "[calc(100%+var(--px)*2)]", absolute: "", "inset-0": "", "top--160": "", "z--1": "" }, null, -1)), f(c, { "mx-auto": "", "w-max": "" }), t[1] || (t[1] = e("div", { w: "[calc(100%+48px)]", relative: "", "left--24": "", "aspect-0.7": "", "size-full": "", "rounded-14": "", "bg-neutral-300": "", "p-8": "", "op-50": "", "backdrop-blur-3.5": "", "f-mt-xl": "", style: { "box-shadow": "inset 0px 0px 40px #FFFFFF" } }, [e("div", { "size-full": "", "rounded-8": "", "bg-white": "" })], -1)), f(o, { "mt-24": "" })]);
}
const se = Object.assign(g(ne, [["render", le], ["__scopeId", "data-v-1698fb0f"]]), { __name: "WalletPlaygroundMobile" }), ae = { class: "metawrapper" }, ie = { class: "metacontainer" }, re = y({ __name: "PlaygroundBackground", setup(v) {
  ...
  const l = x(o), m = h(null), { y: u } = O(), s = B(() => {
    var _a;
  ...
  }), (i, n) => (r(), d("div", { ref_key: "containerRef", ref: m, class: "playground-background", style: C({ "--scrollbar-width": `${c.value}px` }) }, [e("div", ae, [e("div", ie, [(r(), d("svg", { class: "one metacloud", style: C({ "--translate-x": _(a).one }), viewBox: "0 0 120 64", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, n[0] || (n[0] = [e("path", { d: "M120 43C120 54.598 110.598 64 99 64H21C9.40202 64 0 54.598 0 43C0 31.402 9.40202 22 21 22C22.4727 22 23.9101 22.1516 25.2972 22.4401C28.7758 15.6484 35.845 11 44 11C48.4407 11 52.5595 12.3783 55.9518 14.7306C58.6183 6.19486 66.5857 0 76 0C87.598 0 97 9.40202 97 21C97 21.3678 96.9905 21.7335 96.9719 22.0967C97.6393 22.0327 98.3158 22 99 22C110.598 22 120 31.402 120 43Z" }, null, -1)]), 4)), (r(), d("svg", { class: "metacloud two", style: C({ "--translate-x": _(a).two }), viewBox: "0 0 120 64", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, n[1] || (n[1] = [e("path", { d: "M120 43C120 54.598 110.598 64 99 64H21C9.40202 64 0 54.598 0 43C0 31.402 9.40202 22 21 22C22.4727 22 23.9101 22.1516 25.2972 22.4401C28.7758 15.6484 35.845 11 44 11C48.4407 11 52.5595 12.3783 55.9518 14.7306C58.6183 6.19486 66.5857 0 76 0C87.598 0 97 9.40202 97 21C97 21.3678 96.9905 21.7335 96.9719 22.0967C97.6393 22.0327 98.3158 22 99 22C110.598 22 120 31.402 120 43Z" }, null, -1)]), 4)), (r(), d("svg", { class: "metacloud three", "max-sm:hidden": "", style: C({ "--translate-x": _(a).three }), viewBox: "0 0 120 64", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, n[2] || (n[2] = [e("path", { d: "M120 43C120 54.598 110.598 64 99 64H21C9.40202 64 0 54.598 0 43C0 31.402 9.40202 22 21 22C22.4727 22 23.9101 22.1516 25.2972 22.4401C28.7758 15.6484 35.845 11 44 11C48.4407 11 52.5595 12.3783 55.9518 14.7306C58.6183 6.19486 66.5857 0 76 0C87.598 0 97 9.40202 97 21C97 21.3678 96.9905 21.7335 96.9719 22.0967C97.6393 22.0327 98.3158 22 99 22C110.598 22 120 31.402 120 43Z" }, null, -1)]), 4)), (r(), d("svg", { class: "metacloud four", style: C({ "--translate-x": _(a).four }), viewBox: "0 0 120 64", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, n[3] || (n[3] = [e("path", { d: "M120 43C120 54.598 110.598 64 99 64H21C9.40202 64 0 54.598 0 43C0 31.402 9.40202 22 21 22C22.4727 22 23.9101 22.1516 25.2972 22.4401C28.7758 15.6484 35.845 11 44 11C48.4407 11 52.5595 12.3783 55.9518 14.7306C58.6183 6.19486 66.5857 0 76 0C87.598 0 97 9.40202 97 21C97 21.3678 96.9905 21.7335 96.9719 22.0967C97.6393 22.0327 98.3158 22 99 22C110.598 22 120 31.402 120 43Z" }, null, -1)]), 4)), n[4] || (n[4] = e("svg", { class: "metarect max-sm:aspect-9/16", viewBox: "0 0 1096 658", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, [e("path", { d: "M0 7.99999C0 3.58171 3.58172 0 8 0H1088C1092.42 0 1096 3.58172 1096 8V650C1096 654.418 1092.42 658 1088 658H7.99997C3.58169 658 0 654.418 0 650V7.99999Z" })], -1))])]), n[5] || (n[5] = e("div", { class: "pb-container" }, [e("div", { class: "rect", "max-sm:hidden": "" }, [e("svg", { viewBox: "0 0 1096 658", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, [e("g", { opacity: "0.5", "max-sm:hidden": "" }, [e("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M21 26C23.7614 26 26 23.7614 26 21C26 18.2386 23.7614 16 21 16C18.2386 16 16 18.2386 16 21C16 23.7614 18.2386 26 21 26Z", fill: "#1F2348" }), e("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M37 26C39.7614 26 42 23.7614 42 21C42 18.2386 39.7614 16 37 16C34.2386 16 32 18.2386 32 21C32 23.7614 34.2386 26 37 26Z", fill: "#1F2348" }), e("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M53 26C55.7614 26 58 23.7614 58 21C58 18.2386 55.7614 16 53 16C50.2386 16 48 18.2386 48 21C48 23.7614 50.2386 26 53 26Z", fill: "#1F2348" })]), e("g", { opacity: "0.5" }, [e("rect", { x: "368", y: "12", width: "360", height: "14", rx: "7", fill: "#1F2348" })])])])], -1))], 4));
} }), de = Object.assign(g(re, [["__scopeId", "data-v-307908ca"]]), { __name: "WalletPlaygroundBackground" }), ce = z(D), ue = {}, pe = { relative: "" }, me = { "max-w": "$nq-max-width", "mx-auto": "", "size-full": "", stack: "" }, _e = { "self-start": "!", "justify-self-end": "!", relative: "", "z-10": "", "mr--18": "", "mt-11": "", "w-max": "" };
function fe(v, t) {
  const c = de, o = ce, x = W, l = F;
  return r(), d("div", pe, [e("div", me, [t[1] || (t[1] = e("div", { "self-start": "!", "justify-self-end": "!", "aria-hidden": "", "z-1": "", "mr--18": "", "mt-48": "", "w-44": "", "origin-bottom-right": "", "rotate--45": "", border: "22 x-transparent t-0 #EC991C" }, null, -1)), f(c), t[2] || (t[2] = e("div", { p: "t-48 x-10 b-10", "z-1": "", "size-full": "" }, [e("div", { "size-full": "", "rounded-4": "", "bg-slate-200": "" })], -1)), e("div", _e, [f(o, { translate: "-50%", absolute: "", left: "50%", top: "50%", "z-1": "" }), t[0] || (t[0] = e("div", { bg: "#E9B213", text: "f-lg white", rounded: "6 br-0", relative: "", "z-2": "", "ml-auto": "", "w-max": "", "px-20": "", "py-16": "", "font-semibold": "" }, " Try live preview ", -1))]), f(x, { "translate-y": "[calc(50%-10px)]" })]), f(l, { "f-mt-lg": "" })]);
}
const ve = Object.assign(g(ue, [["render", fe], ["__scopeId", "data-v-188027fa"]]), { __name: "WalletPlaygroundDesktop" }), xe = z(G), we = { relative: "", "of-x-clip": "", "md:f-pt-md": "", "children:max-w-none": "" }, Ce = y({ __name: "index", props: R(), setup(v) {
  const { isMobileOrTablet: t } = V(), { smaller: c } = Z(H), o = B(() => t || c("md").value);
  return (x, l) => {
    const m = xe, u = se, s = ve;
    return r(), d("section", we, [f(m, { h: "[calc(100%+400px)]", "pointer-events-none": "", "top--400": "", "max-w-screen": "" }), _(o) ? (r(), k(u, { key: 0 })) : (r(), k(s, { key: 1, "z-1": "", "w-full": "" }))]);
  };
} }), Be = g(Ce, [["__scopeId", "data-v-bd1270ed"]]);
export {
  Be as default
};
