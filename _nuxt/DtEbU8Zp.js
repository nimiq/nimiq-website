import { u as V } from "./eRMYwULF.js";
import { s as z, u as B } from "./mUzFeepZ.js";
import { B as p, X as N, E as S, a1 as I, a2 as P, j as k, d as X, c as x, o as b, e as u, u as d, m as q, F as $, r as M, Q as T, h as A } from "./gdLxT4Lf.js";
function E(c = {}) {
...
const O = { group: "", stack: "", "h-full": "", "max-w-none": "", relative: "" }, F = ["disabled"], L = ["disabled"], K = { flex: "~ gap-6 justify-center", "self-end": "", "bottom-64": "", absolute: "" }, Q = ["title", "onClick"], U = X({ __name: "Carousel", props: { items: {}, multiple: { type: Boolean, default: true } }, setup(c) {
  const i = c.multiple ? E() : B(), { scroller: C, slideTo: t, slideNext: n, slidePrev: l, canSlideNext: o, canSlidePrev: g } = i, h = c.multiple ? i.activeIndexes : i.activeIndex, f = k(() => {
    if (c.multiple) {
