import { i as k, c as y, o as f, e as t, ae as I, aR as T, d as M, j as z, C, G as P, f as D, u as _, Y as R, ay as O, V as q, F as L, r as j, n as $, t as H, h as b, a as h, ar as Z, H as N, ad as S, b as U } from "./BguRs3jF.js";
import { m as V, r as Y, v as G } from "./Cn5kCPLx.js";
import { _ as Q } from "./CMAmxNdM.js";
import { g as J } from "./CpsPJSKh.js";
import { e as K } from "./BNXriZyS.js";
import "./DeSMYd_K.js";
...
function W() {
  ...
  return { playgroundState: T(o), setIframeRef: g, onIframeReady: i, setSelectedAction: v, resetActionState: r, connectWallet: l, disconnectWallet: n, sendMessage: c, handlePlaygroundMessage: a, openModal: m, closeModal: w, activateDemoMode: s, isStandardizedAction: p };
}
const ne = { "size-full": "", "inline-block": "", relative: "", aspect: "16/9 desktop:9/16" }, ae = ["src", "sandbox", "width", "height"], le = M({ __name: "WalletPlaygroundIframe", props: { playgroundUrl: {}, allowedOrigins: { default: () => [] }, height: { default: "600px" }, width: { default: "100%" }, sandbox: { default: "allow-scripts allow-same-origin" } }, emits: ["message", "ready", "error"], setup(o, { expose: u, emit: p }) {
  ...
  return V(window, "message", w), P(() => {
    g({ sendMessage: m });
  }), u({ sendMessage: m }), (e, d) => (f(), y("div", ne, [_(l) ? (f(), y("iframe", { key: 0, ref_key: "iframeRef", ref: n, src: _(l), sandbox: e.sandbox, width: e.width, height: e.height, frameborder: "0", allowtransparency: "true", "outline-none": "", "rounded-8": "", "border-none": "", "size-full": "", "shadow-lg": "", "transition-opacity": "", "duration-300": "", ease: "", onLoad: s, onError: a }, null, 40, ae)) : D("", true)]));
} }), A = Object.assign(le, { __name: "WalletPlaygroundIframe" }), re = { flex: "~ gap-4", "self-end": "!", ring: "1 blue/80", "p-4": "", "rounded-full": "", "bg-white": "", "h-max": "", relative: "", "z-10": "", style: { "--un-shadow": "0 0 32px #0682CA" } }, se = ["data-state", "onClick"], ie = { font: "semibold data-active:bold", text: "data-active:white", "transition-color": "" }, de = M({ __name: "ActionSelector", emits: ["state"], setup(o, { emit: u }) {
  ...
  }, { flush: "post" }), (n, r) => (f(), y("ul", re, [t("div", { ref_key: "pill", ref: l, "rounded-full": "", "bg-darkblue": "", "transition-all": "", "duration-400": "", "ease-in-out": "", "inset-y-3": "", absolute: "" }, null, 512), (f(), y(L, null, j(v, ({ icon: m, label: w, value: s, color: a }) => t("li", { key: s, style: b({ "--c": `rgb(var(--nq-${a}) / 1)` }), class: "dark", "scheme-dark": "" }, [t("button", { flex: "~ gap-2 items-center", "p-2": "", "pr-12": "", "rounded-full": "", "bg-transparent": "", "data-state": s === _(i) ? "active" : void 0, onClick: (e) => i.value = s }, [t("div", { class: $(m), text: "neutral-800 data-active:$c", "m-8": "", "transition-color": "" }, null, 2), t("span", ie, H(w), 1)], 8, se)], 4)), 64)), t("li", { class: $(_(i) === "idle" ? "scale-0 w-0" : "scale-100 w-36"), "h-36": "", transition: "[width,transform]", "duration-300": "", "ease-out": "", "max-sm:hidden": "" }, [t("button", { "bg-transparent": "", onClick: r[0] || (r[0] = (m) => i.value = "idle") }, r[1] || (r[1] = [t("div", { text: "neutral-800", "m-8": "", "i-nimiq:redo": "" }, null, -1)]))], 2)]));
} }), F = Object.assign(de, { __name: "WalletActionSelector" }), ue = {}, ce = { flex: "~ col gap-20 justify-center items-center" };
function me(o, u) {
...
const B = Object.assign(k(ue, [["render", me]]), { __name: "WalletCurrencies" }), fe = { "pb-32": "", relative: "" }, pe = { w: "[calc(100%+48px)]", "p-8": "", "rounded-14": "", "size-full": "", "aspect-0.7": "", "left--24": "", relative: "", "f-mt-xl": "" }, ge = { "rounded-8": "", "size-full": "", relative: "", "z-1": "" }, ye = M({ __name: "PlaygroundMobile", props: { playgroundUrl: {} }, setup(o) {
...
} }), ve = Object.assign(k(ye, [["__scopeId", "data-v-2802423b"]]), { __name: "WalletPlaygroundMobile" }), we = { class: "metawrapper" }, _e = { class: "metacontainer" }, he = M({ __name: "PlaygroundBackground", setup(o) {
  function u() {
    var _a;
  ...
  const i = g(c), v = C(null), { y: l } = Y(), n = z(() => {
    var _a;
  ...
  return P(() => {
    ...
    const r = xe, m = A, w = be, s = F, a = B;
    return f(), y("div", Ce, [t("div", Me, [n[2] || (n[2] = t("div", { "self-start": "!", "justify-self-end": "!", "aria-hidden": "", "mr--18": "", "mt-48": "", "w-44": "", "origin-bottom-right": "", "rotate--45": "", "z-1": "", border: "22 x-transparent t-0 #EC991C" }, null, -1)), h(r), t("div", ke, [l.playgroundUrl ? (f(), y("div", Pe, [h(m, { ref_key: "iframeRef", ref: g, "playground-url": l.playgroundUrl, height: "600px", onMessage: _(u), onReady: i, onError: v }, null, 8, ["playground-url", "onMessage"])])) : (f(), y("div", We, n[0] || (n[0] = [t("p", { text: "center neutral-600" }, " No playground URL configured ", -1)])))]), t("div", Ie, [h(w, { translate: "-50%", absolute: "", left: "50%", top: "50%", "z-1": "" }), n[1] || (n[1] = t("div", { bg: "#E9B213", text: "f-lg white", rounded: "6 br-0", "font-semibold": "", "ml-auto": "", "px-20": "", "py-16": "", "w-max": "", relative: "", "z-2": "" }, " Try live preview ", -1))]), h(s, { "translate-y": "[calc(50%-10px)]" })]), h(a, { "f-mt-lg": "" })]);
  };
} }), $e = Object.assign(k(Re, [["__scopeId", "data-v-5609789d"]]), { __name: "WalletPlaygroundDesktop" }), Ue = S(oe), ze = { "data-slice-type": "wallet-playground", "bg-darkerblue": "", "scheme-dark": "", relative: "", "of-x-clip": "", "md:f-pt-3xl": "", "children:max-w-none": "" }, Oe = M({ __name: "index", props: J(), setup(o) {
  const u = G("(max-width: 768px)", { ssrWidth: 768 }), p = K(o.slice.primary.playgroundUrl);
  ...
  return (c, g) => {
    const i = Ue, v = ve, l = $e;
    return f(), y("section", ze, [h(i, { h: "[calc(100%+400px)]", "max-w-screen": "", "pointer-events-none": "", "top--400": "" }), _(u) ? (f(), U(v, { key: "mobile", "playground-url": _(p) }, null, 8, ["playground-url"])) : (f(), U(l, { key: "desktop", "w-full": "", "z-1": "", "playground-url": _(p) }, null, 8, ["playground-url"]))]);
  };
} });
export {
  Oe as default
