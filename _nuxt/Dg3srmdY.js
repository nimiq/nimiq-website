import { i as L, _ as z, u as K, a as U, b as V } from "./BIy3fMUT.js";
import { d as m, S as w, e as g, o as f, f as p, Q as v, j as b, s as y, h as e, R as k, a as W, g as _, q as X, X as Y, W as j, v as O, $ as x, T as E, U as R, aF as N, b2 as q, a5 as H, a3 as G, b3 as Q, a4 as $, b4 as J, ae as A, a0 as S, a6 as Z, B as ee, b5 as oe, O as F, l as te, k as C, n as D } from "./BSLliBk6.js";
import { u as ae } from "./DODWcfLE.js";
...
const ne = { key: 0, d: "M0 0L6 6L12 0" }, ie = { key: 1, d: "M0 0L4.58579 4.58579C5.36683 5.36683 6.63316 5.36684 7.41421 4.58579L12 0" }, re = m({ __name: "Arrow", props: { width: { default: 10 }, height: { default: 5 }, rounded: { type: Boolean }, asChild: { type: Boolean }, as: { default: "svg" } }, setup(u) {
  const i = u;
  return w(), (o, a) => (f(), g(e(k), y(i, { width: o.width, height: o.height, viewBox: o.asChild ? void 0 : "0 0 12 6", preserveAspectRatio: o.asChild ? void 0 : "none" }), { default: p(() => [v(o.$slots, "default", {}, () => [o.rounded ? (f(), b("path", ie)) : (f(), b("path", ne))])]), _: 3 }, 16, ["width", "height", "viewBox", "preserveAspectRatio"]));
  ...
  return (t, r) => {
    ...
    return f(), g(h, { open: e(o), "onUpdate:open": s }, { default: p(() => [_(c, y(t.$attrs, { "bg-transparent": "", "h-max": "", onMouseenter: a, onFocus: a }), { default: p(() => [v(t.$slots, "trigger", {}, () => [r[0] || (r[0] = C("div", { "text-12": "", "text-neutral-700": "", "i-nimiq:info": "" }, null, -1))], true)]), _: 3 }, 16), e(i) ? (f(), g(d, { key: 0 }, { default: p(() => [_(l, { "as-child": "", class: "tooltip-animation", "side-offset": t.sideOffset, "collision-padding": t.collisionPadding, side: t.side, flex: "~ col", "max-w-360": "" }, { default: p(() => [C("div", { class: D(t.dark ? "bg-white" : "bg-gradient-neutral shadow dark scheme-dark"), "p-16": "", "rounded-8": "", text: "neutral dark:white" }, [v(t.$slots, "default", {}, void 0, true)], 2), _(n, { "as-child": "" }, { default: p(() => [C("div", { "rotate-180": "", class: D({ dark: t.dark }) }, r[1] || (r[1] = [C("div", { "aria-hidden": "", "mt--1": "", "h-8": "", "w-16": "", "i-nimiq:tooltip-triangle": "", class: "tooltip-animation", text: "darkblue dark:white" }, null, -1)]), 2)]), _: 1 })]), _: 3 }, 8, ["side-offset", "collision-padding", "side"])]), _: 3 })) : te("", true)]), _: 3 }, 8, ["open"]);
  };
