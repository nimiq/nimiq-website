import { c as wt } from "./CVtsTRWS.js";
import { d as nt, U as Bt, ah as Gt, B as kt, c as j, V as It, L as pt, G as St, o as B, R as jt, am as dt, an as gt, ao as Pt, j as lt, E as Vt, a1 as Ut, Z as Yt, a as V, w as Ct, b as Xt, f as ht, u as M, b7 as qt, H as Zt, i as Qt, e as tt, t as st, h as Jt } from "./ClGJWWej.js";
import { C as Kt, d as te, $ as ft, A as ct, a0 as _t, a1 as U, a2 as W, q as C, a3 as yt, r as ee, s as L, a4 as rt, a5 as et, a6 as mt, a7 as xt, a8 as k, a9 as At, aa as ne, ab as ae, l as oe, w as Dt, i as ie, f as at, t as se, m as re, S as le, v as Rt, u as ce, h as ue, ac as de, Q as Lt, R as Ot, X as ge, Y as fe, Z as me, _ as pe } from "./J3mR9qeT.js";
import { _ as Tt } from "./D3wyXQF5.js";
import { u as he } from "./CKmrXjwn.js";
import { u as Et } from "./xLWJwwMd.js";
import { u as ve } from "./DqQgyLEs.js";
...
class ye extends te {
  ...
  render(e = this.config.duration) {
    ...
    if (a.sizing === ft.Extend || a.sizing === ft.FitWidth) {
      const l = a.sizing === ft.FitWidth, u = o, s = u.getWidth() + a.margin.left + a.margin.right, t = u.getHeight() + a.margin.top + a.margin.bottom, i = l ? this.getFitWidthScale() : 1, n = this.svg.attr("width"), h = this.svg.attr("height"), g = s * i, d = t * i, v = n || h;
...
function Se(c, e, a, o, l, u, s, t) {
  var i = a - c, n = o - e, h = s - l, g = t - u, d = g * i - h * n;
  if (!(d * d < L)) return d = (h * (e - u) - g * (c - l)) / d, [c + d * i, e + d * n];
}
function it(c, e, a, o, l, u, s) {
  var t = c - a, i = e - o, n = (s ? u : -u) / et(t * t + i * i), h = n * i, g = -n * t, d = c + h, v = e + g, b = a + h, R = o + g, r = (d + b) / 2, D = (v + R) / 2, y = b - d, x = R - v, _ = y * y + x * x, w = l - u, A = d * R - b * v, F = (x < 0 ? -1 : 1) * et(ne(0, w * w * _ - A * A)), N = (A * x - y * F) / _, S = (-A * y - x * F) / _, O = (A * x + y * F) / _, T = (-A * y + x * F) / _, f = N - r, p = S - D, $ = O - r, z = T - D;
  return f * f + p * p > $ * $ + z * z && (N = O, S = T), { cx: N, cy: S, x01: -h, y01: -g, x11: N * (l / w - 1), y11: S * (l / w - 1) };
}
function Ce() {
  var c = xe, e = Ae, a = C(0), o = null, l = Re, u = we, s = ke, t = null;
  function i() {
    var n, h, g = +c.apply(this, arguments), d = +e.apply(this, arguments), v = l.apply(this, arguments) - yt, b = u.apply(this, arguments) - yt, R = xt(b - v), r = b > v;
    if (t || (t = n = ee()), d < g && (h = d, d = g, g = h), !(d > L)) t.moveTo(0, 0);
    else if (R > rt - L) t.moveTo(d * U(v), d * W(v)), t.arc(0, 0, d, v, b, !r), g > L && (t.moveTo(g * U(b), g * W(b)), t.arc(0, 0, g, b, v, r));
    else {
      var D = v, y = b, x = v, _ = b, w = R, A = R, F = s.apply(this, arguments) / 2, N = F > L && (o ? +o.apply(this, arguments) : et(g * g + d * d)), S = mt(xt(d - g) / 2, +a.apply(this, arguments)), O = S, T = S, f, p;
      if (N > L) {
        var $ = At(N / g * W(F)), z = At(N / d * W(F));
        (w -= $ * 2) > L ? ($ *= r ? 1 : -1, x += $, _ -= $) : (w = 0, x = _ = (v + b) / 2), (A -= z * 2) > L ? (z *= r ? 1 : -1, D += z, y -= z) : (A = 0, D = y = (v + b) / 2);
      }
      var G = d * U(D), I = d * W(D), ot = g * U(_), Y = g * W(_);
      if (S > L) {
        var P = d * U(y), X = d * W(y), q = g * U(x), Z = g * W(x), H;
        if (R < _t && (H = Se(G, I, q, Z, P, X, ot, Y))) {
          var Q = G - H[0], J = I - H[1], m = P - H[0], E = X - H[1], K = 1 / W(ae((Q * m + J * E) / (et(Q * Q + J * J) * et(m * m + E * E))) / 2), bt = et(H[0] * H[0] + H[1] * H[1]);
          O = mt(S, (g - bt) / (K - 1)), T = mt(S, (d - bt) / (K + 1));
        }
      }
      A > L ? T > L ? (f = it(q, Z, G, I, d, T, r), p = it(P, X, ot, Y, d, T, r), t.moveTo(f.cx + f.x01, f.cy + f.y01), T < S ? t.arc(f.cx, f.cy, T, k(f.y01, f.x01), k(p.y01, p.x01), !r) : (t.arc(f.cx, f.cy, T, k(f.y01, f.x01), k(f.y11, f.x11), !r), t.arc(0, 0, d, k(f.cy + f.y11, f.cx + f.x11), k(p.cy + p.y11, p.cx + p.x11), !r), t.arc(p.cx, p.cy, T, k(p.y11, p.x11), k(p.y01, p.x01), !r))) : (t.moveTo(G, I), t.arc(0, 0, d, D, y, !r)) : t.moveTo(G, I), !(g > L) || !(w > L) ? t.lineTo(ot, Y) : O > L ? (f = it(ot, Y, P, X, g, -O, r), p = it(G, I, q, Z, g, -O, r), t.lineTo(f.cx + f.x01, f.cy + f.y01), O < S ? t.arc(f.cx, f.cy, O, k(f.y01, f.x01), k(p.y01, p.x01), !r) : (t.arc(f.cx, f.cy, O, k(f.y01, f.x01), k(f.y11, f.x11), !r), t.arc(0, 0, g, k(f.cy + f.y11, f.cx + f.x11), k(p.cy + p.y11, p.cx + p.x11), r), t.arc(p.cx, p.cy, O, k(p.y11, p.x11), k(p.y01, p.x01), !r))) : t.arc(0, 0, g, _, x, r);
    }
...
function Oe() {
  ...
  function s(t) {
    var i, n = t.length, h, g, d = 0, v = new Array(n), b = new Array(n), R = +o.apply(this, arguments), r = Math.min(rt, Math.max(-rt, l.apply(this, arguments) - R)), D, y = Math.min(Math.abs(r) / n, u.apply(this, arguments)), x = y * (r < 0 ? -1 : 1), _;
    for (i = 0; i < n; ++i) (_ = b[v[i] = i] = +c(t[i], i, t)) > 0 && (d += _);
    for (e != null ? v.sort(function(w, A) {
      return e(b[w], b[A]);
    }) : a != null && v.sort(function(w, A) {
      return a(t[w], t[A]);
    }), i = 0, g = d ? (r - n * x) / d : 0; i < n; ++i, R = D) h = v[i], _ = b[h], D = R + (_ > 0 ? _ * g : 0) + x, b[h] = { data: t[h], index: i, value: _, startAngle: R, endAngle: D, padAngle: y };
    return b;
  }
...
function Fe(c, e, a, o) {
  ...
  o ? ct(c, o).style("opacity", l).attrTween("d", (s, t, i) => {
    const n = i[t], h = { startAngle: s.startAngle, endAngle: s.endAngle, innerRadius: s.innerRadius, outerRadius: s.outerRadius, padAngle: s.padAngle }, g = ie(n._animState, h);
    return (d) => (n._animState = g(d), a(n._animState));
...
class ut extends re {
  ...
  _render(e) {
    var a, o, l, u, s, t, i, n, h, g, d, v, b, R;
    const { config: r, datamodel: D, bleed: y } = this, x = D.data.map((m, E) => ({ index: E, datum: m })).filter((m) => r.showEmptySegments || Rt(m.datum, r.value, m.index)), _ = ce(e) ? e : r.duration, [w, A, F, N] = Ft.map((m) => r.angleRange && r.angleRange[0] === m[0] && r.angleRange[1] === m[1]), S = w || F, O = A || N, T = this._width * (O ? 2 : 1), f = this._height * (S ? 2 : 1), p = r.radius || Math.min(T - y.left - y.right, f - y.top - y.bottom) / 2, $ = r.arcWidth === 0 ? 0 : ue(p - r.arcWidth, 0, p - 1), z = this._height / 2 + (w ? p / 2 : F ? -p / 2 : 0), G = this._width / 2 + (N ? p / 2 : A ? -p / 2 : 0), I = `translate(${G},${z})`;
    ...
    const Y = Oe().startAngle((o = (a = r.angleRange) === null || a === void 0 ? void 0 : a[0]) !== null && o !== void 0 ? o : 0).endAngle((u = (l = r.angleRange) === null || l === void 0 ? void 0 : l[1]) !== null && u !== void 0 ? u : 2 * Math.PI).padAngle(r.padAngle).value((m) => Rt(m.datum, r.value, m.index) || 0).sort((m, E) => {
      var K;
    ...
    const Z = A ? "start" : N ? "end" : "middle";
    this.centralLabel.attr("dy", r.centralSubLabel ? "-0.55em" : null).style("text-anchor", Z).text((s = r.centralLabel) !== null && s !== void 0 ? s : null), this.centralSubLabel.attr("dy", r.centralLabel ? "0.55em" : null).style("text-anchor", Z).text((t = r.centralSubLabel) !== null && t !== void 0 ? t : null), r.centralSubLabelWrap && de(this.centralSubLabel, $ * 1.9);
    const H = (r.centralLabelOffsetX || 0) + G;
    let Q = (r.centralLabelOffsetY || 0) + z;
    S && r.centralLabelOffsetX === void 0 && r.centralLabelOffsetY === void 0 && (Q = (w ? -this.centralSubLabel.node().getBoundingClientRect().height : F ? this.centralLabel.node().getBoundingClientRect().height : 0) + z);
    const J = `translate(${H},${Q})`;
    this.centralLabel.attr("transform", J), this.centralSubLabel.attr("transform", J), this.arcBackground.attr("class", $t).attr("visibility", r.showBackground ? null : "hidden").attr("transform", I), ct(this.arcBackground, _).attr("d", this.arcGen({ startAngle: (g = (n = (i = r.backgroundAngleRange) === null || i === void 0 ? void 0 : i[0]) !== null && n !== void 0 ? n : (h = r.angleRange) === null || h === void 0 ? void 0 : h[0]) !== null && g !== void 0 ? g : 0, endAngle: (R = (v = (d = r.backgroundAngleRange) === null || d === void 0 ? void 0 : d[1]) !== null && v !== void 0 ? v : (b = r.angleRange) === null || b === void 0 ? void 0 : b[1]) !== null && R !== void 0 ? R : 2 * Math.PI, innerRadius: $, outerRadius: p }));
  }
}
ut.selectors = ze;
const He = nt({ __name: "index", props: { component: {}, tooltip: {}, annotations: {}, duration: {}, margin: {}, padding: {}, sizing: {}, width: {}, height: {}, svgDefs: {}, ariaLabel: {}, data: {} }, setup(c, { expose: e }) {
  ...
  let u;
  const s = Gt({ component: void 0, tooltip: void 0, annotations: void 0 }), t = kt(), i = () => {
  ...
  }), St(() => u == null ? void 0 : u.destroy()), gt(Ot, { data: o, update: (n) => s.component = n, destroy: () => s.component = void 0 }), gt(ge, { data: o, update: (n) => s.tooltip = n, destroy: () => {
    s.tooltip = void 0;
...
const We = nt({ __name: "index", props: { id: { type: Function }, value: {}, angleRange: {}, padAngle: {}, sortFunction: { type: Function }, cornerRadius: {}, color: {}, radius: {}, arcWidth: {}, centralLabel: {}, centralSubLabel: {}, centralSubLabelWrap: { type: Boolean }, showEmptySegments: { type: Boolean }, emptySegmentAngle: {}, showBackground: { type: Boolean }, backgroundAngleRange: {}, centralLabelOffsetX: {}, centralLabelOffsetY: {}, duration: {}, events: {}, attributes: {}, data: {} }, setup(c, { expose: e }) {
  const a = Pt(Ot), o = c, l = lt(() => a.data.value ?? o.data), u = Lt(o), s = kt();
  return Vt(() => {
    Ut(() => {
      var t;
  ...
  function t(i) {
    ...
    return qt(Zt(e.default, i.data), n), n.innerHTML;
  }
  return (i, n) => (B(), j("div", Be, [V(M(He), { data: i.data, height: 280, width: 280, relative: "", "size-280": "", "max-w-280": "" }, { default: Ct(() => [V(M(We), { color: s, value: u, "angle-range": l, "corner-radius": 8, "arc-width": 64, "pad-angle": 0.045, "show-background": false }), e.default ? (B(), Xt(M(pe), { key: 0, triggers: { [M(ut).selectors.segment]: t } }, null, 8, ["triggers"])) : ht("", true)]), _: 1 }, 8, ["data"])]));
} }), Wt = Object.assign(Qt(Ge, [["__scopeId", "data-v-917916cc"]]), { __name: "ChartDonut" }), Ie = wt(Wt), je = { relative: "", flex: "~ col items-center" }, Pe = { ring: "1.5 green", absolute: "", "right-8": "", "top-196": "", "rounded-full": "", "bg-neutral-0": "", "px-12": "", "py-6": "", "text-neutral": "", "font-semibold": "" }, Ve = nt({ __name: "Distribution", props: { info: {} }, setup(c) {
  ...
  return (s, t) => {
    const i = Ie, n = Tt;
    return B(), j("div", je, [V(i, { data: M(l), "start-angle": M(u) }, null, 8, ["data", "start-angle"]), tt("div", Pe, st(M(o).format(M(e) ?? 0)) + " staked ", 1), V(n, { wrapper: "div", field: s.info, "max-w-42ch": "", "text-center": "", "f-m-lg": "" }, null, 8, ["field"])]);
  };
} }), Ue = Object.assign(Ve, { __name: "StakingDistribution" }), Ye = wt(Wt), Xe = { flex: "~ col items-center" }, qe = ["src"], Ze = { flex: "~ gap-2 col", "font-semibold": "", "lh-none": "" }, Qe = { "f-text-lg": "" }, Je = { flex: "~ justify-between items-baseline gap-12", "mt-4": "" }, Ke = { text: "f-sm neutral-800", "lh-none": "" }, tn = { key: 0, text: "green f-xs", "font-bold": "", "lh-none": "" }, en = nt({ __name: "Distribution", props: { info: {} }, setup(c) {
  const e = Et(), a = new Intl.NumberFormat(e.value, { style: "percent", minimumFractionDigits: 2, maximumFractionDigits: 2 }), o = new Intl.NumberFormat(e.value, { style: "decimal", minimumFractionDigits: 0, maximumFractionDigits: 0 }), { validators: l } = ve(), u = lt(() => {
    ...
    for (const { score: i, dominanceRatio: n, accentColor: h, ...g } of l.value) {
      if (!i) continue;
      const d = n || (i == null ? void 0 : i.total);
      i.total < 0.02 ? (t.value += d, t.balance += g.balance) : s.push({ color: h, value: d, score: i, dominanceRatio: n, accentColor: h, ...g });
    }
    return t.value > 0 ? [...s, t] : s;
  });
  return (s, t) => {
    const i = Ye, n = Tt;
    return B(), j("div", Xe, [V(i, { data: M(u) }, { default: Ct(({ color: h, value: g, name: d, logo: v, balance: b }) => [(B(), j("div", { key: d, style: Jt({ "--c": h }), ring: "1.5 $c", flex: "~ items-center gap-16", "data-tooltip-container": "", "w-max": "", "rounded-8": "", "bg-neutral-0": "", "p-16": "", "text-neutral": "", "font-semibold": "", shadow: "" }, [v ? (B(), j("img", { key: 0, src: v, "size-40": "", loading: "lazy" }, null, 8, qe)) : ht("", true), tt("div", Ze, [tt("h3", Qe, st(d), 1), tt("div", Je, [tt("span", Ke, st(M(a).format(g)), 1), b > 0 ? (B(), j("p", tn, st(M(o).format(b / 1e5)) + " NIM ", 1)) : ht("", true)])])], 4))]), _: 1 }, 8, ["data"]), V(n, { wrapper: "div", field: s.info, "max-w-42ch": "", "text-center": "", "f-m-lg": "" }, null, 8, ["field"])]);
  };
} }), nn = Object.assign(en, { __name: "ValidatorDistribution" }), an = { "bg-neutral-0": "" }, on = { flex: "~ wrap md:gap-100 gap-y-72 lg:gap-x-160 f-gap-x-12 justify-center" }, An = nt({ __name: "index", props: be(), setup(c) {
  return (e, a) => {
    const o = Ue, l = nn;
