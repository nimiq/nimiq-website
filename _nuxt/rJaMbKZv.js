import { u as V } from "./BhpWC2zv.js";
import { d, B as c, i as f, E as v, ae as g, c as h, o as p, t as b, u as w, az as x, aA as I, aI as _, b3 as $, m as A, aK as D } from "./C95QRNzc.js";
class m {
...
const N = m, B = { "data-allow-mismatch": "", "tabular-nums": "" }, M = d({ __name: "TweenedNumber", props: { value: { default: 0 }, decimals: { default: 0 }, duration: { default: 1e3 } }, setup(a) {
  ...
  return (r, t) => (p(), h("span", B, b(w(u)), 1));
} }), F = Object.assign(M, { __name: "AnimatedTweenedNumber" }), C = d({ __name: "AmountInput", props: x({ decimals: { default: 0 }, min: { default: 0 } }, { modelValue: {}, modelModifiers: {} }), emits: ["update:modelValue"], setup(a) {
  const e = I(a, "modelValue"), n = c(e.value ? `${e.value}` : ""), i = c(0), u = f({ get() {
    return n.value;
  }, set(t) {
    if (n.value = t, !t) {
  ...
  return v(() => {
    e.value || r();
  }), (t, o) => _((p(), h("input", A({ "onUpdate:modelValue": o[0] || (o[0] = (s) => D(u) ? u.value = s : null), type: "text", style: { "field-sizing": "content" }, "focus-visible:outline": "1 solid blue", "font-semibold": "", "lh-none": "", "px-12": "", "rounded-2": "", "bg-transparent": "", "nq-input-box": "", inputmode: "decimal" }, t.$attrs, { onBlur: r }), null, 16)), [[$, w(u)]]);
} }), O = Object.assign(C, { __name: "AmountInput" });
export {
  F as _,
  O as a
};
