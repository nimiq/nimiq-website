import { g as $, _ as R, a as k, u as b, b as M, c as h, d as K } from "./ViQ2U2w0.js";
import { g as T } from "./B8QP58w5.js";
import { a as S, c as V, u as O, b as _, f as w, P as F } from "./BI3535uL.js";
import { d as v, B, T as N, Q as g, u as e, E as P, b as f, o as m, w as c, a as A, m as y, f as L, R as j, S as z } from "./gdLxT4Lf.js";
const [C, H] = V("DialogRoot"), Y = v({ inheritAttrs: false, __name: "DialogRoot", props: { open: { type: Boolean, default: void 0 }, defaultOpen: { type: Boolean, default: false }, modal: { type: Boolean, default: true } }, emits: ["update:open"], setup(u, { emit: l }) {
  const t = u, o = S(t, "open", l, { defaultValue: t.defaultOpen, passive: t.open === void 0 }), d = B(), p = B(), { modal: r } = N(t);
  return H({ open: o, modal: r, openModal: () => {
    o.value = true;
  }, onOpenChange: (a) => {
    o.value = a;
  }, onOpenToggle: () => {
...
} }), Q = v({ __name: "DialogContentModal", props: { forceMount: { type: Boolean }, trapFocus: { type: Boolean }, disableOutsidePointerEvents: { type: Boolean }, asChild: { type: Boolean }, as: {} }, emits: ["escapeKeyDown", "pointerDownOutside", "focusOutside", "interactOutside", "openAutoFocus", "closeAutoFocus"], setup(u, { emit: l }) {
...
} }), U = v({ __name: "DialogContentNonModal", props: { forceMount: { type: Boolean }, trapFocus: { type: Boolean }, disableOutsidePointerEvents: { type: Boolean }, asChild: { type: Boolean }, as: {} }, emits: ["escapeKeyDown", "pointerDownOutside", "focusOutside", "interactOutside", "openAutoFocus", "closeAutoFocus"], setup(u, { emit: l }) {
  const t = u, o = b(l);
  O();
  ...
  return (r, a) => (m(), f(e(w), { present: r.forceMount || e(o).open.value }, { default: c(() => [e(o).modal.value ? (m(), f(Q, y({ key: 0, ref: e(p) }, { ...t, ...e(d), ...r.$attrs }), { default: c(() => [g(r.$slots, "default")]), _: 3 }, 16)) : (m(), f(U, y({ key: 1, ref: e(p) }, { ...t, ...e(d), ...r.$attrs }), { default: c(() => [g(r.$slots, "default")]), _: 3 }, 16))]), _: 3 }, 8, ["present"]));
  ...
  const l = u;
  return (t, n) => (m(), f(e(K), j(z(l)), { default: c(() => [g(t.$slots, "default")]), _: 3 }, 16));
} });
export {
  Y as _,
  ee as a,
