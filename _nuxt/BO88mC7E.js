import { d as V, l as b, p as j, q as A, s as O, v as l, i as d, x as R, j as g, b as z, o as E, w as G, a as J, y as K, u as i, k as Z, z as F } from "./C95QRNzc.js";
import { c as Q } from "./D3tACF25.js";
import { g as k, h as W } from "./CCkBGt8y.js";
import { u as X } from "./BIzRNNCz.js";
import { s as Y } from "./PoXG0q01.js";
const rt = V({ __name: "[...uid]", async setup(tt) {
  var _a, _b, _c, _d, _e, _f, _g, _h, _i;
  let m, f;
  const h = b().params, c = typeof h.uid == "string" ? [] : (h == null ? void 0 : h.uid.filter(Boolean)) || [], P = c.length >= 2, e = c.at(-1) || "home", p = e === "home", { showDrafts: y } = j().public, x = b(), { client: D } = A(), { data: t } = ([m, f] = O(() => F(`prismic-page-${c.join("-")}`, () => D.getByUID("page", e).catch((r) => {
  ...
  if (P) {
    const r = ((_b = t.value) == null ? void 0 : _b.data.parents.length) === c.length - 1, v = (_c = t.value) == null ? void 0 : _c.data.parents.every((u, L) => u.uid === c[L]);
  ...
  return g({ link: [{ rel: "canonical", href: _ }] }), g({ title: n, meta: [{ name: "description", content: s }, { name: "keywords", content: T }, { property: "og:title", content: n }, { property: "og:description", content: s }, { property: "og:url", content: _ }, { property: "og:type", content: "website" }, { property: "og:site_name", content: w.name }, { property: "og:locale", content: "en_US" }, { name: "twitter:card", content: "summary_large_image" }, { name: "twitter:title", content: n }, { name: "twitter:description", content: s }, { name: "twitter:site", content: "@nimiq" }, { name: "twitter:creator", content: "@nimiq" }, { name: "author", content: "Nimiq Team" }, { name: "publisher", content: "Nimiq" }] }), W(o) && (g({ meta: [{ property: "og:image", content: o.url }, { property: "og:image:alt", content: n }, { property: "og:image:width", content: (_h = o.dimensions) == null ? void 0 : _h.width }, { property: "og:image:height", content: (_i = o.dimensions) == null ? void 0 : _i.height }, { name: "twitter:image", content: o.url }, { name: "twitter:image:alt", content: n }] }), Y({ title: n, subline: s, image: o })), (r, v) => {
    const C = K, u = Z;
    return E(), z(u, { "footer-bg-color": i(S), "dark-header": i($), draft: i(I), "show-socials-hexagon-bg": i(M) }, { default: G(() => {
      var _a2;
      return [J(C, { wrapper: "main", slices: ((_a2 = i(t)) == null ? void 0 : _a2.data.slices) ?? [], components: i(Q) }, null, 8, ["slices", "components"])];
