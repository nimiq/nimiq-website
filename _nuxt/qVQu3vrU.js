...
import { b2 as z, j as M, au as l, aj as U, b3 as E, y as F, b4 as R } from "./7tyaNgEA.js";
const q = [1779033703, -1150833019, 1013904242, -1521486534, 1359893119, -1694144372, 528734635, 1541459225], x = [1116352408, 1899447441, -1245643825, -373957723, 961987163, 1508970993, -1841331548, -1424204075, -670586216, 310598401, 607225278, 1426881987, 1925078388, -2132889090, -1680079193, -1046744716, -459576895, -272742522, 264347078, 604807628, 770255983, 1249150122, 1555081692, 1996064986, -1740746414, -1473132947, -1341970488, -1084653625, -958395405, -710438585, 113926993, 338241895, 666307205, 773529912, 1294757372, 1396182291, 1695183700, 1986661051, -2117940946, -1838011259, -1564481375, -1474664885, -1035236496, -949202525, -778901479, -694614492, -200395387, 275423344, 430227734, 506948616, 659060556, 883997877, 958139571, 1322822218, 1537002063, 1747873779, 1955562222, 2024104815, -2067236844, -1933114872, -1866530822, -1538233109, -1090935817, -965641998], C = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_", d = [];
class S {
  constructor() {
    __publicField(this, "_data", new B());
    __publicField(this, "_hash", new B([...q]));
  ...
  _doProcessBlock(e, s) {
    ...
    for (let n = 0; n < 64; n++) {
      ...
      const D = c & y ^ ~c & g, j = o & a ^ o & i ^ a & i, A = (o << 30 | o >>> 2) ^ (o << 19 | o >>> 13) ^ (o << 10 | o >>> 22), O = (c << 26 | c >>> 6) ^ (c << 21 | c >>> 11) ^ (c << 7 | c >>> 25), m = _ + O + D + x[n] + d[n], b = A + j;
...
class B {
  ...
  toBase64() {
    ...
    for (let s = 0; s < this.sigBytes; s += 3) {
      ...
      for (let h = 0; h < 4 && s * 8 + h * 6 < this.sigBytes * 8; h++) e.push(C.charAt(i >>> 6 * (3 - h) & 63));
    }
    return e.join("");
  }
  concat(e) {
...
function I(r, e, s) {
  const [t = {}, o] = typeof e == "string" ? [{}, e] : [e, s], a = M(() => l(r)), i = M(() => l(t.key) || "$f" + w([o, typeof a.value == "string" ? a.value : "", ...L(t)]));
  if (!t.baseURL && typeof a.value == "string" && a.value[0] === "/" && a.value[1] === "/") throw new Error('[nuxt] [useFetch] the request URL must not start with "//".');
  const { server: h, lazy: c, default: y, transform: g, pick: _, watch: n, immediate: D, getCachedData: j, deep: A, dedupe: O, ...m } = t, b = U({ ...E, ...m, cache: typeof t.cache == "boolean" ? void 0 : t.cache }), f = { server: h, lazy: c, default: y, transform: g, pick: _, immediate: D, getCachedData: j, deep: A, dedupe: O, watch: n === false ? [] : [...n || [], b] };
  let u;
  return F(n === false ? i.value : i, () => {
    var _a;
