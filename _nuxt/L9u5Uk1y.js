import { g as me } from "./BzRmGp1f.js";
import { d as se, B as le, o as ce, C as M, D as ue, h as fe } from "./B8biU-UE.js";
...
See: https://github.com/francoischalifour/medium-zoom`);
  ...
  var d = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, m = window.Promise || function(o) {
    ...
    return a = b({}, a, n), g.forEach(function(s) {
      s.dispatchEvent(C("medium-zoom:update", { detail: { zoom: l } }));
    }), l;
  }, _ = function() {
    ...
    return s.forEach(function(r) {
      r.classList.remove("medium-zoom-image"), r.dispatchEvent(C("medium-zoom:detach", { detail: { zoom: l } }));
    ...
    return new m(function(s) {
      ...
      var r = function I() {
        E = false, e.zoomed.removeEventListener("transitionend", I), e.original.dispatchEvent(C("medium-zoom:opened", { detail: { zoom: l } })), s(l);
      };
      if (e.zoomed) {
        s(l);
        return;
      ...
      if (e.original.dispatchEvent(C("medium-zoom:open", { detail: { zoom: l } })), Y = window.pageYOffset || document.documentElement.scrollTop || document.body.scrollTop || 0, E = true, e.zoomed = he(e.original), document.body.appendChild(x), a.template) {
    ...
    return new m(function(o) {
      ...
      E = true, document.body.classList.remove("medium-zoom--opened"), e.zoomed.style.transform = "", e.zoomedHd && (e.zoomedHd.style.transform = ""), e.template && (e.template.style.transition = "opacity 150ms", e.template.style.opacity = 0), e.original.dispatchEvent(C("medium-zoom:close", { detail: { zoom: l } })), e.zoomed.addEventListener("transitionend", n);
    });
  }, D = function() {
    ...
    return e.original;
  }, g = [], O = [], E = false, Y = 0, a = d, e = { original: null, zoomed: null, zoomedHd: null, template: null };
  ...
  var l = { open: P, close: z, toggle: D, update: h, clone: _, attach: H, detach: Z, on: F, off: X, getOptions: K, getImages: G, getZoomedImage: V };
  return l;
};
function ze(c2, t) {
  t === void 0 && (t = {});
