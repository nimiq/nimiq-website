import { a0 as Q, b2 as J, a_ as Z, B as w, U as C, a1 as P, d as _, j as g, as as U, b as I, o as M, w as H, Q as W, u as O, h as ee, X as $, G as te, aD as ne, f as se, W as oe } from "./gdLxT4Lf.js";
import { i as T, u as z, o as re, P as q, m as ae, h as ie, n as ue, t as le, p as ce, q as N, s as de, v as fe } from "./BI3535uL.js";
function Ae(e) {
  const n = Q(), t = n == null ? void 0 : n.type.emits, s = {};
...
function ye(e, n) {
  ...
  return C((i) => {
    ...
    const l = async (c) => {
      ...
      await P(), await P();
      const v = c.target;
      !n.value || !v || V(n.value, v) || c.target && !s.value && j(pe, e, { originalEvent: c });
    };
...
const B = "focusScope.autoFocusOnMount", k = "focusScope.autoFocusOnUnmount", x = { bubbles: false, cancelable: true };
function we(e, { select: n = false } = {}) {
  const t = S();
  for (const s of e) if (E(s, { select: n }), S() !== t) return true;
}
function ge(e) {
  const n = X(e), t = K(n, e), s = K(n.reverse(), e);
  return [t, s];
}
function X(e) {
...
const Ie = _({ __name: "FocusScope", props: { loop: { type: Boolean, default: false }, trapped: { type: Boolean, default: false }, asChild: { type: Boolean }, as: {} }, emits: ["mountAutoFocus", "unmountAutoFocus"], setup(e, { emit: n }) {
  ...
  C((a) => {
    ...
    const u = S();
    if (!o.contains(u)) {
      const r = new CustomEvent(B, x);
      o.addEventListener(B, (f) => s("mountAutoFocus", f)), o.dispatchEvent(r), r.defaultPrevented || (we(Ee(X(o)), { select: true }), S() === u && E(o));
    }
    a(() => {
      o.removeEventListener(B, (p) => s("mountAutoFocus", p));
      const r = new CustomEvent(k, x), f = (p) => {
...
var Se = function(e) {
...
}, D = /* @__PURE__ */ new WeakMap(), L = /* @__PURE__ */ new WeakMap(), F = {}, A = 0, Y = function(e) {
  ...
  return a(n), v.clear(), A++, function() {
    ...
    }), A--, A || (D = /* @__PURE__ */ new WeakMap(), D = /* @__PURE__ */ new WeakMap(), L = /* @__PURE__ */ new WeakMap(), F = {});
  };
}, Le = function(e, n, t) {
