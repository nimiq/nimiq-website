import { i as L, a as U, u as z, b as K, _ as V } from "./UtPS5osl.js";
import { d as m, V as _, b as g, o as f, w as p, T as v, c as b, m as y, u as e, U as k, i as W, a as w, h as X, $ as Y, Z as j, B as O, a2 as x, W as E, X as R, aG as N, aT as q, a8 as G, a6 as H, bj as Z, a7 as $, aS as J, ai as A, a3 as S, a9 as Q, E as ee, aU as oe, R as F, f as te, e as C, n as D } from "./C95QRNzc.js";
import { u as ae } from "./DCDih-ug.js";
...
const ne = { key: 0, d: "M0 0L6 6L12 0" }, ie = { key: 1, d: "M0 0L4.58579 4.58579C5.36683 5.36683 6.63316 5.36684 7.41421 4.58579L12 0" }, re = m({ __name: "Arrow", props: { width: { default: 10 }, height: { default: 5 }, rounded: { type: Boolean }, asChild: { type: Boolean }, as: { default: "svg" } }, setup(u) {
  const i = u;
  return _(), (o, a) => (f(), g(e(k), y(i, { width: o.width, height: o.height, viewBox: o.asChild ? void 0 : "0 0 12 6", preserveAspectRatio: o.asChild ? void 0 : "none" }), { default: p(() => [v(o.$slots, "default", {}, () => [o.rounded ? (f(), b("path", ie)) : (f(), b("path", ne))])]), _: 3 }, 16, ["width", "height", "viewBox", "preserveAspectRatio"]));
  ...
  return pe({ contentId: "", triggerId: "", modal: s, open: t, onOpenChange: (n) => {
    ...
    t.value = !t.value;
  }, triggerElement: r, hasCustomAnchor: c }), (n, l) => (f(), g(e(U), null, { default: p(() => [v(n.$slots, "default", { open: e(t) })]), _: 3 }));
  ...
  const i = u;
  return _(), (o, a) => (f(), g(e(de), E(R(i)), { default: p(() => [v(o.$slots, "default")]), _: 3 }, 16));
  ...
  const o = u, a = i, s = P(), t = $(o, a), { forwardRef: r } = _();
  return s.contentId || (s.contentId = S(void 0, "reka-popover-content")), (c, n) => (f(), g(e(Q), { present: c.forceMount || e(s).open.value }, { default: p(() => [e(s).modal.value ? (f(), g(ge, y({ key: 0 }, e(t), { ref: e(r) }), { default: p(() => [v(c.$slots, "default")]), _: 3 }, 16)) : (f(), g(ve, y({ key: 1 }, e(t), { ref: e(r) }), { default: p(() => [v(c.$slots, "default")]), _: 3 }, 16))]), _: 3 }, 8, ["present"]));
} }), he = m({ __name: "PopoverTrigger", props: { asChild: { type: Boolean }, as: { default: "button" } }, setup(u) {
  const i = u, o = P(), { forwardRef: a, currentElement: s } = _();
  return o.triggerId || (o.triggerId = S(void 0, "reka-popover-trigger")), ee(() => {
    o.triggerElement.value = s.value;
  }), (t, r) => (f(), g(oe(e(o).hasCustomAnchor.value ? e(k) : e(V)), { "as-child": "" }, { default: p(() => [w(e(k), { id: e(o).triggerId, ref: e(a), type: t.as === "button" ? "button" : void 0, "aria-haspopup": "dialog", "aria-expanded": e(o).open.value, "aria-controls": e(o).contentId, "data-state": e(o).open.value ? "open" : "closed", as: t.as, "as-child": i.asChild, onClick: e(o).onOpenToggle }, { default: p(() => [v(t.$slots, "default")]), _: 3 }, 8, ["id", "type", "aria-expanded", "aria-controls", "data-state", "as", "as-child", "onClick"])]), _: 3 }));
  ...
  return (t, r) => {
    ...
    return f(), g(h, { open: e(o), "onUpdate:open": s }, { default: p(() => [w(c, y(t.$attrs, { "bg-transparent": "", "h-max": "", onMouseenter: a, onFocus: a }), { default: p(() => [v(t.$slots, "trigger", {}, () => [r[0] || (r[0] = C("div", { "text-12": "", "text-neutral-700": "", "i-nimiq:info": "" }, null, -1))], true)]), _: 3 }, 16), e(i) ? (f(), g(d, { key: 0 }, { default: p(() => [w(l, { "as-child": "", class: "tooltip-animation", "side-offset": t.sideOffset, "collision-padding": t.collisionPadding, side: t.side, flex: "~ col", "max-w-360": "" }, { default: p(() => [C("div", { class: D(t.dark ? "bg-white" : "bg-gradient-neutral shadow dark scheme-dark"), "p-16": "", "rounded-8": "", text: "neutral dark:white" }, [v(t.$slots, "default", {}, void 0, true)], 2), w(n, { "as-child": "" }, { default: p(() => [C("div", { "rotate-180": "", class: D({ dark: t.dark }) }, r[1] || (r[1] = [C("div", { "aria-hidden": "", "mt--1": "", "h-8": "", "w-16": "", "i-nimiq:tooltip-triangle": "", class: "tooltip-animation", text: "darkblue dark:white" }, null, -1)]), 2)]), _: 1 })]), _: 3 }, 8, ["side-offset", "collision-padding", "side"])]), _: 3 })) : te("", true)]), _: 3 }, 8, ["open"]);
  };
} }), Be = Object.assign(se(ye, [["__scopeId", "data-v-1eda537a"]]), { __name: "Tooltip" });
export {
  Be as _,
  de as a
};
