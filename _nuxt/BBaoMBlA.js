import { d as w, B as g, c as b, o as y, $ as x, aa as P, e as d, b5 as $, u, ac as q, f as S, t as M, b6 as I } from "./7tyaNgEA.js";
var c;
function v(n) {
  return { lang: (n == null ? void 0 : n.lang) ?? (c == null ? void 0 : c.lang), message: n == null ? void 0 : n.message, abortEarly: (n == null ? void 0 : n.abortEarly) ?? (c == null ? void 0 : c.abortEarly), abortPipeEarly: (n == null ? void 0 : n.abortPipeEarly) ?? (c == null ? void 0 : c.abortPipeEarly) };
}
var j;
function z(n) {
...
function E(n) {
  return { kind: "validation", type: "email", reference: E, expects: null, async: false, requirement: R, message: n, "~run"(e, t) {
    return e.typed && !this.requirement.test(e.value) && p(this, "email", e, t), e;
  } };
}
function _(n) {
  return { kind: "validation", type: "non_empty", reference: _, async: false, expects: "!0", message: n, "~run"(e, t) {
    return e.typed && e.value.length === 0 && p(this, "length", e, t, { received: "0" }), e;
  } };
}
function k(n) {
  return { kind: "schema", type: "string", reference: k, expects: "string", async: false, message: n, get "~standard"() {
    ...
    return typeof e.value == "string" ? e.typed = true : p(this, "type", e, t), e;
  } };
}
function V(...n) {
