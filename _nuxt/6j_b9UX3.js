import { a0 as J, a$ as Q, aU as Z, B as w, V as C, a1 as L, d as _, j as g, aj as U, b as I, o as M, w as H, R as N, u as O, h as ee, L as $, G as te, aw as ne, f as se, X as oe } from "./7tyaNgEA.js";
import { i as T, u as z, o as re, P as j, m as ae, h as ie, n as ue, t as le, p as ce, q as W, s as de, v as fe } from "./BqwFAzj-.js";
function Ae(e) {
...
function ye(e, n) {
  ...
  return C((i) => {
    ...
    const l = async (c) => {
      ...
      await L(), await L();
      const v = c.target;
      !n.value || !v || V(n.value, v) || c.target && !s.value && q(pe, e, { originalEvent: c });
    };
...
const h = U({ layersRoot: /* @__PURE__ */ new Set(), layersWithOutsidePointerEventsDisabled: /* @__PURE__ */ new Set(), branches: /* @__PURE__ */ new Set() }), _e = _({ __name: "DismissableLayer", props: { disableOutsidePointerEvents: { type: Boolean, default: false }, asChild: { type: Boolean }, as: {} }, emits: ["escapeKeyDown", "pointerDownOutside", "focusOutside", "interactOutside", "dismiss"], setup(e, { emit: n }) {
  ...
  }), (r, f) => (M(), I(O(j), { ref: O(i), "as-child": r.asChild, as: r.as, "data-dismissable-layer": "", style: ee({ pointerEvents: y.value ? a.value ? "auto" : "none" : void 0 }), onFocusCapture: O(u).onFocusCapture, onBlurCapture: O(u).onBlurCapture, onPointerdownCapture: O(o).onPointerDownCapture }, { default: H(() => [N(r.$slots, "default")]), _: 3 }, 8, ["as-child", "as", "style", "onFocusCapture", "onBlurCapture", "onPointerdownCapture"]));
} });
function S() {
...
const Ie = _({ __name: "FocusScope", props: { loop: { type: Boolean, default: false }, trapped: { type: Boolean, default: false }, asChild: { type: Boolean }, as: {} }, emits: ["mountAutoFocus", "unmountAutoFocus"], setup(e, { emit: n }) {
  ...
  return (a, o) => (M(), I(O(j), { ref_key: "currentRef", ref: i, tabindex: "-1", "as-child": a.asChild, as: a.as, onKeydown: y }, { default: H(() => [N(a.$slots, "default")]), _: 3 }, 8, ["as-child", "as"]));
} });
var Se = function(e) {
  if (typeof document > "u") return null;
  var n = Array.isArray(e) ? e[0] : e;
  return n.ownerDocument.body;
}, D = /* @__PURE__ */ new WeakMap(), P = /* @__PURE__ */ new WeakMap(), F = {}, A = 0, Y = function(e) {
...
const We = _({ __name: "Teleport", props: { to: { default: "body" }, disabled: { type: Boolean }, defer: { type: Boolean }, forceMount: { type: Boolean } }, setup(e) {
  const n = fe();
  return (t, s) => O(n) || t.forceMount ? (M(), I(oe, { key: 0, to: t.to, disabled: t.disabled, defer: t.defer }, [N(t.$slots, "default")], 8, ["to", "disabled", "defer"])) : se("", true);
} });
export {
  _e as _,
  Ie as a,
