import { M as fr, N as hr, O as pr, P as ki, Q as mr, d as H, b as O, o as A, w as _, R as ct, m as Dt, u as h, S as us, T as vr, C as V, U as cs, j as I, V as ie, a as C, W as gr, X as ds, f as j, G as oe, c as R, F as at, Y as _t, I as Xe, e as k, t as F, Z as Pe, g as nt, v as $t, r as ht, n as Tt, $ as yr, h as Ye, a0 as br, a1 as fs, a2 as hs, a3 as ps, H as ms, s as wr, z as xr, _ as an, i as zn, p as Tr, E as Sr, a4 as Pr, a5 as _r, a6 as Ar, a7 as Mr, a8 as Cr, a9 as kr, aa as Er, ab as Dr, ac as Vr, ad as Lr } from "./BguRs3jF.js";
import { a as Rr, b as vs } from "./BNXriZyS.js";
import { u as Hn, S as B } from "./Dvca-oHQ.js";
import { P as Mt, u as At, a as Or, r as gs, c as Wn, b as ys, d as $r, e as Br, f as Kn, i as Ei, g as Ze, h as Fr } from "./CMmzeBWC.js";
import { _ as Ir, a as jr, b as Nr, c as Ur, d as zr } from "./Ba6ZbKEs.js";
import { u as bs, _ as Hr, a as Wr, b as Kr, c as Gr } from "./B32zcr7a.js";
import { _ as qr } from "./B-0a4KEb.js";
import { u as _e, _ as Xr } from "./QoFfB0oT.js";
import { u as Yr } from "./qA1gjzOk.js";
import { g as te, _ as Zr } from "./BIPleKtX.js";
import { u as Jr } from "./C8aoRHDt.js";
import { b as Qr, d as tl, e as el, f as nl } from "./Cn5kCPLx.js";
import { u as il } from "./BDcJzeBR.js";
import { _ as ol } from "./C2NnffCY.js";
import { g as ws } from "./T2yBj71G.js";
import { _ as sl } from "./ybb453Wh.js";
import "./CbA0xmEM.js";
import "./CHIgUVhi.js";
import "./DeSMYd_K.js";
import "./DSbx5aGI.js";
function al(t = {}) {
  var _a2;
  const e = ki(""), n = ki(t.politeness || "polite"), i = mr();
...
const [Gt, fl] = Wn(["NavigationMenuRoot", "NavigationMenuSub"], "NavigationMenuContext"), hl = H({ __name: "NavigationMenuRoot", props: { modelValue: { default: void 0 }, defaultValue: {}, dir: {}, orientation: { default: "horizontal" }, delayDuration: { default: 200 }, skipDelayDuration: { default: 300 }, disableClickTrigger: { type: Boolean, default: false }, disableHoverTrigger: { type: Boolean, default: false }, disablePointerLeaveClose: { type: Boolean }, unmountOnHide: { type: Boolean, default: true }, asChild: { type: Boolean }, as: { default: "nav" } }, emits: ["update:modelValue"], setup(t, { emit: e }) {
...
} }), [qn, pl] = Wn("NavigationMenuItem"), ml = H({ __name: "NavigationMenuItem", props: { value: {}, asChild: { type: Boolean }, as: { default: "li" } }, setup(t) {
  const e = t;
  At();
  const { getItems: n } = _e({ key: "NavigationMenu" }), i = Gt(), o = ys(e.value), a = V(), s = V(), r = Gn(i.baseId, o);
  let l = () => ({});
  const u = V(false);
  ...
  const n = t, i = e, { getItems: o } = _e({ key: "NavigationMenu" }), { forwardRef: a, currentElement: s } = At(), r = Gt(), l = qn(), u = xs(r.baseId, l.value), c = Gn(r.baseId, l.value), d = V(null), f = I(() => {
  ...
  function w(y) {
    ...
    const g = y.altKey || y.ctrlKey || y.metaKey, S = y.key === "Tab" && !g, b = _n(y.currentTarget);
    if (S) {
  ...
  const e = t, n = Gt(), i = qn(), { CollectionItem: o } = _e({ key: "NavigationMenu" }), { forwardRef: a, currentElement: s } = At(), r = V(""), l = V(""), u = gs(false, 300), c = V(false), d = I(() => i.value === n.modelValue.value);
  oe(() => {
    i.triggerRef = s, r.value = xs(n.baseId, i.value), l.value = Gn(n.baseId, i.value);
  });
  function f() {
  ...
  return Ze(d, () => {
    ...
    f();
  }), (p, m) => (A(), O(h(Kn), { present: p.forceMount || c.value, "force-mount": !h(o).unmountOnHide.value, onAfterLeave: m[2] || (m[2] = () => {
  ...
  let e, n;
  const { data: i } = ([e, n] = $t(() => Hn()), e = await e, n(), e), o = I(() => t.items.map((s) => i.value[s]).filter(Boolean)), a = (s) => s.charAt(0).toUpperCase() + s.slice(1);
  return (s, r) => {
    var _a2;
    const l = Pe;
...
} }), Xn = Object.assign(El, { __name: "SocialMediaLogosList" });
(function() {
  var t;
  try {
...
const [Yn, Rl] = Wn("DrawerRoot"), Ps = /* @__PURE__ */ new WeakMap();
...
const K = { DURATION: 0.5, EASE: [0.32, 0.72, 0, 1] }, _s = 0.4, Fl = 0.25, Il = 100, As = 8, je = 16, Ms = 26, Vi = "vaul-dragging";
...
function zl(t) {
  ...
  function ar(D) {
    var X, et, U, ot, rt, gt;
    if ($.value && b.value) {
      const Yt = v.value === "bottom" || v.value === "right" ? 1 : -1, $e = (Ft.value - (Z(v.value) ? D.clientY : D.clientX)) * Yt, Be = $e > 0, _i = W.value && !s.value && !Be;
      if (_i && le.value === 0) return;
      const un = Math.abs($e), Ai = document.querySelector("[data-vaul-drawer-wrapper]") || document.querySelector("[vaul-drawer-wrapper]");
      let It = un / vt.value;
      const Mi = qt(un, Be);
      if (Mi !== null && (It = Mi), _i && It >= 1 || !dt.value && !Rt(D.target, Be)) return;
      if ((X = $ == null ? void 0 : $.value) == null || X.$el.classList.add(Vi), dt.value = true, it((et = $.value) == null ? void 0 : et.$el, { transition: "none" }), it((U = P.value) == null ? void 0 : U.$el, { transition: "none" }), W.value && Oe({ draggedDistance: $e }), Be && !W.value) {
      ...
      const dr = 1 - It;
      if ((Lt.value || m.value && le.value === m.value - 1) && (e(It), it((rt = P.value) == null ? void 0 : rt.$el, { opacity: `${dr}`, transition: "none" }, true)), Ai && P.value && u.value) {
        const jt = Math.min(wt() + It * (1 - wt()), 1), Fe = 8 - It * 8, Ci = Math.max(0, 14 - It * 14);
        it(Ai, { borderRadius: `${Fe}px`, transform: Z(v.value) ? `scale(${jt}) translate3d(0, ${Ci}px, 0)` : `scale(${jt}) translate3d(${Ci}px, 0, 0)`, transition: "none" }, true);
      }
      if (!W.value) {
        const jt = un * Yt;
...
const Hl = H({ __name: "DrawerRoot", props: { activeSnapPoint: { default: void 0 }, closeThreshold: { default: Fl }, shouldScaleBackground: { type: Boolean, default: void 0 }, setBackgroundColorOnScale: { type: Boolean, default: true }, scrollLockTimeout: { default: Il }, fixed: { type: Boolean, default: void 0 }, dismissible: { type: Boolean, default: true }, modal: { type: Boolean, default: true }, open: { type: Boolean, default: void 0 }, defaultOpen: { type: Boolean, default: void 0 }, nested: { type: Boolean, default: false }, direction: { default: "bottom" }, noBodyStyles: { type: Boolean }, handleOnly: { type: Boolean, default: false }, preventScrollRestoration: { type: Boolean }, snapPoints: { default: void 0 }, fadeFromIndex: { default: void 0 } }, emits: ["drag", "release", "close", "update:open", "update:activeSnapPoint", "animationEnd"], setup(t, { expose: e, emit: n }) {
  const i = t, o = n;
  yr();
  const a = I(() => i.fadeFromIndex ?? (i.snapPoints && i.snapPoints.length - 1)), s = Di(i, "open", o, { defaultValue: i.defaultOpen, passive: i.open === void 0 }), r = Di(i, "activeSnapPoint", o, { passive: i.activeSnapPoint === void 0 }), l = { emitDrag: (m) => o("drag", m), emitRelease: (m) => o("release", m), emitClose: () => o("close"), emitOpenChange: (m) => {
  ...
  const { overlayRef: e, hasSnapPoints: n, isOpen: i, shouldFade: o } = Yn();
...
function Gl() {
  const { direction: t, isOpen: e, shouldScaleBackground: n, setBackgroundColorOnScale: i, noBodyStyles: o } = Yn(), a = V(null), s = V(document.body.style.backgroundColor);
  function r() {
    return (window.innerWidth - Ms) / window.innerWidth;
  }
  ie((l) => {
...
const ql = H({ __name: "DrawerContent", setup(t) {
  const { open: e, isOpen: n, snapPointsOffset: i, hasSnapPoints: o, drawerRef: a, onPress: s, onDrag: r, onRelease: l, modal: u, emitOpenChange: c, dismissible: d, keyboardIsOpen: f, closeDrawer: p, direction: m, handleOnly: v } = Yn();
  Gl();
...
const Zl = { class: "mb-16 flex gap-20" }, Jl = { "of-x-hidden": "", "of-y-auto": "" }, Ql = { class: "my-16" }, tu = { text: "f-sm neutral-700", "font-bold": "", "nq-arrow": "" }, eu = { "text-14": "", "f-mt-xs": "" }, nu = { "text-12": "", uppercase: "" }, iu = { text: "neutral-800 hocus:neutral-900", "transition-colors": "", "f-mt-md": "", flex: "~ gap-16 items-center" }, ou = { "text-neutral-600": "", "f-mt-md": "" }, su = H({ __name: "Mobile", async setup(t) {
  ...
  return (o, a) => {
    const s = Pe, r = ul, l = Kr, u = qr, c = Gr, d = Wr, f = Hr, p = Xn, m = an;
...
} }), Pu = Object.assign(Su, { __name: "NavigationDesktop" }), Cs = (t) => (e) => typeof e == "string" && e.startsWith(t), Zn = Cs("--"), _u = Cs("var(--"), Jn = (t) => _u(t) ? Au.test(t.split("/*")[0].trim()) : false, Au = /var\(--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)$/iu, we = {};
function ks(t) {
  for (const e in t) we[e] = t[e], Zn(e) && (we[e].isCSSVariable = true);
}
function Me(t, e) {
...
const Qn = /* @__PURE__ */ new WeakMap(), [Bu, Dm] = Me("AnimatePresenceContext");
function Fu(t) {
...
class Uu {
  ...
  updateOptions(e) {
    var n;
    this.options = e, (n = this.visualElement) == null || n.update({ ...this.options, whileTap: this.options.whilePress }, { isPresent: !Qn.has(this.element) });
  }
  beforeMount() {
...
const Bi = { syntax: "<angle>", initialValue: "0deg", toDefaultUnit: (t) => `${t}deg` }, zu = { translate: { syntax: "<length-percentage>", initialValue: "0px", toDefaultUnit: (t) => `${t}px` }, rotate: Bi, scale: { syntax: "<number>", initialValue: 1, toDefaultUnit: Vu }, skew: Bi }, Hu = ["translate", "scale", "rotate", "skew"], Wu = ["", "X", "Y", "Z"], ti = /* @__PURE__ */ new Map(), Je = ["transformPerspective", "x", "y", "z", "translateX", "translateY", "translateZ", "scale", "scaleX", "scaleY", "rotate", "rotateX", "rotateY", "rotateZ", "skew", "skewX", "skewY"];
Hu.forEach((t) => {
  Wu.forEach((e) => {
    Je.push(t + e), ti.set(t + e, zu[t]);
  });
});
const Ku = new Set(Je), Gu = (t) => Ku.has(t), Fi = { x: "translateX", y: "translateY", z: "translateZ" };
function qu([t], [e]) {
...
const Ii = { translate: [0, 0], rotate: 0, scale: 1, skew: 0, x: 0, y: 0, z: 0 }, Ce = (t) => ({ test: (e) => typeof e == "string" && e.endsWith(t) && e.split(" ").length === 1, parse: parseFloat, transform: (e) => `${e}${t}` }), Ot = Ce("deg"), St = Ce("%"), E = Ce("px"), Zu = Ce("vh"), Ju = Ce("vw"), ji = { ...St, parse: (t) => St.parse(t) / 100, transform: (t) => St.transform(t * 100) }, Q = (t) => !!(t && t.getVelocity), Qu = { get: (t, e) => {
...
function tc(t) {
  ...
  for (let o in t) {
    let a = t[o];
    a = Q(a) ? a.get() : a, Gu(o) && o in Fi && (o = Fi[o]);
...
for (const t in Ui) An[t] = { isEnabled: (e) => Ui[t].some((n) => !!e[n]) };
const zi = () => ({ translate: 0, scale: 1, origin: 0, originPoint: 0 }), Zt = () => ({ x: zi(), y: zi() }), Hi = () => ({ min: 0, max: 0 }), Y = () => ({ x: Hi(), y: Hi() }), lc = typeof window < "u", Qe = { current: null }, Ls = { current: false };
function uc() {
...
class ni {
  ...
  add(e) {
    return ei(this.subscriptions, e), () => ln(this.subscriptions, e);
  }
  notify(e, n, i) {
...
const Wi = 30, vc = (t) => !isNaN(parseFloat(t));
class gc {
  constructor(e, n = {}) {
...
const Ut = (t) => t * 180 / Math.PI, Mn = (t) => {
  const e = Ut(Math.atan2(t[1], t[0]));
  return Cn(e);
}, wc = { x: 4, y: 5, translateX: 4, translateY: 5, scaleX: 0, scaleY: 3, scale: (t) => (Math.abs(t[0]) + Math.abs(t[3])) / 2, rotate: Mn, rotateZ: Mn, skewX: (t) => Ut(Math.atan(t[1])), skewY: (t) => Ut(Math.atan(t[2])), skew: (t) => (Math.abs(t[1]) + Math.abs(t[2])) / 2 }, Cn = (t) => (t = t % 360, t < 0 && (t += 360), t), Gi = Mn, qi = (t) => Math.sqrt(t[0] * t[0] + t[1] * t[1]), Xi = (t) => Math.sqrt(t[4] * t[4] + t[5] * t[5]), xc = { x: 12, y: 13, z: 14, translateX: 12, translateY: 13, translateZ: 14, scaleX: qi, scaleY: Xi, scale: (t) => (qi(t) + Xi(t)) / 2, rotateX: (t) => Cn(Ut(Math.atan2(t[6], t[5]))), rotateY: (t) => Cn(Ut(Math.atan2(-t[2], t[0]))), rotateZ: Gi, rotate: Gi, skewX: (t) => Ut(Math.atan(t[4])), skewY: (t) => Ut(Math.atan(t[1])), skew: (t) => (Math.abs(t[1]) + Math.abs(t[4])) / 2 };
function kn(t) {
...
const Ht = { width: ({ x: t }, { paddingLeft: e = "0", paddingRight: n = "0" }) => t.max - t.min - parseFloat(e) - parseFloat(n), height: ({ y: t }, { paddingTop: e = "0", paddingBottom: n = "0" }) => t.max - t.min - parseFloat(e) - parseFloat(n), top: (t, { top: e }) => parseFloat(e), left: (t, { left: e }) => parseFloat(e), bottom: ({ y: t }, { top: e }) => parseFloat(e) + (t.max - t.min), right: ({ x: t }, { left: e }) => parseFloat(e) + (t.max - t.min), x: (t, { transform: e }) => En(e, "x"), y: (t, { transform: e }) => En(e, "y") };
Ht.translateX = Ht.x;
Ht.translateY = Ht.y;
const Wt = /* @__PURE__ */ new Set();
let Dn = false, Vn = false, Ln = false;
function Bs() {
  if (Vn) {
  ...
  Vn = false, Dn = false, Wt.forEach((t) => t.complete(Ln)), Wt.clear();
}
function Fs() {
  Wt.forEach((t) => {
    t.readKeyframes(), t.needsMeasurement && (Vn = true);
  });
}
function Mc() {
  Ln = true, Fs(), Bs(), Ln = false;
}
class ii {
  ...
  scheduleResolve() {
    this.state = "scheduled", this.isAsync ? (Wt.add(this), Dn || (Dn = true, N.read(Fs), N.resolveKeyframes(Bs))) : (this.readKeyframes(), this.complete());
  }
  readKeyframes() {
...
const Is = (t) => /^-?(?:\d+(?:\.\d+)?|\.\d+)$/u.test(t), js = (t) => /^0[^.\s]+$/u.test(t), me = (t) => Math.round(t * 1e5) / 1e5, oi = /-?(?:\d+(?:\.\d+)?|\.\d+)/gu;
function Cc(t) {
  return t == null;
}
const kc = /^(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))$/iu, si = (t, e) => (n) => !!(typeof n == "string" && kc.test(n) && n.startsWith(t) || e && !Cc(n) && Object.prototype.hasOwnProperty.call(n, e)), Ns = (t, e, n) => (i) => {
  if (typeof i != "string") return i;
  const [o, a, s, r] = i.match(oi);
  return { [t]: parseFloat(o), [e]: parseFloat(a), [n]: parseFloat(s), alpha: r !== void 0 ? parseFloat(r) : 1 };
}, Ec = (t) => Et(0, 255, t), hn = { ...re, transform: (t) => Math.round(Ec(t)) }, zt = { test: si("rgb", "red"), parse: Ns("red", "green", "blue"), transform: ({ red: t, green: e, blue: n, alpha: i = 1 }) => "rgba(" + hn.transform(t) + ", " + hn.transform(e) + ", " + hn.transform(n) + ", " + me(xe.transform(i)) + ")" };
function Dc(t) {
  let e = "", n = "", i = "", o = "";
...
const Rn = { test: si("#"), parse: Dc, transform: zt.transform }, Jt = { test: si("hsl", "hue"), parse: Ns("hue", "saturation", "lightness"), transform: ({ hue: t, saturation: e, lightness: n, alpha: i = 1 }) => "hsla(" + Math.round(t) + ", " + St.transform(me(e)) + ", " + St.transform(me(n)) + ", " + me(xe.transform(i)) + ")" }, J = { test: (t) => zt.test(t) || Rn.test(t) || Jt.test(t), parse: (t) => zt.test(t) ? zt.parse(t) : Jt.test(t) ? Jt.parse(t) : Rn.parse(t), transform: (t) => typeof t == "string" ? t : t.hasOwnProperty("red") ? zt.transform(t) : Jt.transform(t), getAnimatableNone: (t) => {
  const e = J.parse(t);
  return e.alpha = 0, J.transform(e);
} }, Vc = /(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))/giu;
function Lc(t) {
  var e, n;
  return isNaN(t) && typeof t == "string" && (((e = t.match(oi)) == null ? void 0 : e.length) || 0) + (((n = t.match(Vc)) == null ? void 0 : n.length) || 0) > 0;
}
const Us = "number", zs = "color", Rc = "var", Oc = "var(", Zi = "${}", $c = /var\s*\(\s*--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)|#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\)|-?(?:\d+(?:\.\d+)?|\.\d+)/giu;
function Te(t) {
  const e = t.toString(), n = [], i = { color: [], number: [], var: [] }, o = [];
  let a = 0;
  const r = e.replace($c, (l) => (J.test(l) ? (i.color.push(a), o.push(zs), n.push(J.parse(l))) : l.startsWith(Oc) ? (i.var.push(a), o.push(Rc), n.push(l)) : (i.number.push(a), o.push(Us), n.push(parseFloat(l))), ++a, Zi)).split(Zi);
...
const Bt = { test: Lc, parse: Hs, createTransformer: Ws, getAnimatableNone: Fc }, Ic = { test: (t) => t === "auto", parse: (t) => t }, Ks = (t) => (e) => e.test(t), Gs = [re, E, St, Ot, Ju, Zu, Ic], Ji = (t) => Gs.find(Ks(t)), jc = [...Gs, J, Bt], Nc = (t) => jc.find(Ks(t)), Uc = /* @__PURE__ */ new Set(["brightness", "contrast", "saturate", "opacity"]);
function zc(t) {
...
const Hc = /\b([a-z-]*)\(.*?\)/gu, On = { ...Bt, getAnimatableNone: (t) => {
  const e = t.match(Hc);
  return e ? e.map(zc).join(" ") : t;
} }, Qi = { ...re, transform: Math.round }, Wc = { rotate: Ot, rotateX: Ot, rotateY: Ot, rotateZ: Ot, scale: Ue, scaleX: Ue, scaleY: Ue, scaleZ: Ue, skew: Ot, skewX: Ot, skewY: Ot, distance: E, translateX: E, translateY: E, translateZ: E, x: E, y: E, z: E, perspective: E, transformPerspective: E, opacity: xe, originX: ji, originY: ji, originZ: E }, ai = { borderWidth: E, borderTopWidth: E, borderRightWidth: E, borderBottomWidth: E, borderLeftWidth: E, borderRadius: E, radius: E, borderTopLeftRadius: E, borderTopRightRadius: E, borderBottomRightRadius: E, borderBottomLeftRadius: E, width: E, maxWidth: E, height: E, maxHeight: E, top: E, right: E, bottom: E, left: E, padding: E, paddingTop: E, paddingRight: E, paddingBottom: E, paddingLeft: E, margin: E, marginTop: E, marginRight: E, marginBottom: E, marginLeft: E, backgroundPositionX: E, backgroundPositionY: E, ...Wc, zIndex: Qi, fillOpacity: xe, strokeOpacity: xe, numOctaves: Qi }, Kc = { ...ai, color: J, backgroundColor: J, outlineColor: J, fill: J, stroke: J, borderColor: J, borderTopColor: J, borderRightColor: J, borderBottomColor: J, borderLeftColor: J, filter: On, WebkitFilter: On }, qs = (t) => Kc[t];
function Xs(t, e) {
  let n = qs(t);
  return n !== On && (n = Bt), n.getAnimatableNone ? n.getAnimatableNone(e) : void 0;
}
...
class Ys {
  ...
  constructor({ parent: e, props: n, presenceContext: i, reducedMotionConfig: o, blockInitialAnimation: a, visualState: s }, r = {}) {
    this.current = null, this.children = /* @__PURE__ */ new Set(), this.isVariantNode = false, this.isControllingVariants = false, this.shouldReduceMotion = null, this.values = /* @__PURE__ */ new Map(), this.KeyframeResolver = ii, this.features = {}, this.valueSubscriptions = /* @__PURE__ */ new Map(), this.prevMotionValues = {}, this.events = {}, this.propEventSubscriptions = {}, this.notifyUpdate = () => this.notify("Update", this.latestValues), this.render = () => {
...
class Jc extends ii {
  ...
  readKeyframes() {
    ...
    for (let l = 0; l < e.length; l++) {
      let u = e[l];
      if (typeof u == "string" && (u = u.trim(), Jn(u))) {
...
class oa extends Qs {
  ...
  readValueFromInstance(e, n) {
    var i;
    if (ae.has(n)) return (i = this.projection) != null && i.isProjecting ? kn(n) : Tc(e, n);
    {
      const o = id(e), a = (Zn(n) ? o.getPropertyValue(n) : o[n]) || 0;
...
const li = (t) => t.replace(/([a-z])([A-Z])/gu, "$1-$2").toLowerCase(), od = { offset: "stroke-dashoffset", array: "stroke-dasharray" }, sd = { offset: "strokeDashoffset", array: "strokeDasharray" };
...
function ud(t, e, n, i) {
  na(t, e, void 0, i);
  for (const o in e.attrs) t.setAttribute(sa.has(o) ? o : li(o), e.attrs[o]);
}
function cd(t, e, n) {
  const i = ia(t, e, n);
...
class aa extends Qs {
  ...
  readValueFromInstance(e, n) {
    ...
    return n = sa.has(n) ? n : li(n), e.getAttribute(n);
  }
  scrapeMotionValuesFromProps(e, n, i) {
    return cd(e, n, i);
  }
...
function ra(t, e, n, i) {
  return typeof t == "string" && ui(e) ? ci(t, n, i) : t instanceof NodeList ? Array.from(t) : Array.isArray(t) ? t : [t];
}
function fd(t, e, n) {
  return t * (e + 1);
}
...
function fa(t, e = 100, n) {
  const i = n({ ...t, keyframes: [0, e] }), o = Math.min(di(i), tn);
...
function bd(t, { defaultTransition: e = {}, ...n } = {}, i, o) {
  ...
  for (let p = 0; p < t.length; p++) {
    ...
    if (typeof m == "string") {
      ...
      u.set(m.name, eo(d, m.at, c, u));
      continue;
    }
    let [v, w, x = {}] = m;
    x.at !== void 0 && (d = eo(d, x.at, c, u));
    let y = 0;
    const g = (S, b, T, P = 0, M = 0) => {
      ...
      const De = typeof G == "function" ? G(P, M) : G, Ve = L.length, le = fi(dt) ? dt : o == null ? void 0 : o[dt || "keyframes"];
      if (Ve <= 2 && le) {
        let Lt = 100;
        if (Ve === 2 && Sd(L)) {
          const wt = L[1] - L[0];
    ...
    if (Q(v)) {
      ...
      for (let T = 0; T < b; T++) {
        w = w, x = x;
        const P = S[T], M = no(P, r);
        for (const L in w) g(w[L], xd(x, L), io(L, M), T, b);
      }
    }
    c = d, d += y;
  }
...
const Dd = "framerAppearId", Vd = "data-" + li(Dd);
function ha(t) {
  return t.props[Vd];
}
const Ld = (t) => t !== null;
...
}, Ud = [Rn, zt, Jt], zd = (t) => Ud.find((e) => e.test(t));
function oo(t) {
  const e = zd(t);
  if (!e) return false;
  let n = e.parse(t);
...
}, $n = /* @__PURE__ */ new Set(["none", "hidden"]);
function Hd(t, e) {
...
function pi(t) {
  return typeof t == "number" ? Kd : typeof t == "string" ? Jn(t) ? en : J.test(t) ? so : Xd : Array.isArray(t) ? pa : typeof t == "object" ? J.test(t) ? so : Gd : en;
}
function pa(t, e) {
  const n = [...t], i = n.length, o = t.map((a, s) => pi(a)(a, e[s]));
  return (a) => {
...
function Gd(t, e) {
  const n = { ...t, ...e }, i = {};
  for (const o in n) t[o] !== void 0 && e[o] !== void 0 && (i[o] = pi(t[o])(t[o], e[o]));
  return (o) => {
...
const Xd = (t, e) => {
  ...
  return i.indexes.var.length === o.indexes.var.length && i.indexes.color.length === o.indexes.color.length && i.indexes.number.length >= o.indexes.number.length ? $n.has(t) && !o.values.length || $n.has(e) && !i.values.length ? Hd(t, e) : ke(pa(qd(i, o), o.values), n) : en(t, e);
};
function ma(t, e, n) {
  return typeof t == "number" && typeof e == "number" && typeof n == "number" ? z(t, e, n) : pi(t)(t, e);
}
const Yd = (t) => {
...
function Jd({ duration: t = q.duration, bounce: e = q.bounce, velocity: n = q.velocity, mass: i = q.mass }) {
  ...
  s = Et(q.minDamping, q.maxDamping, s), t = Et(q.minDuration, q.maxDuration, Pt(t)), s < 1 ? (o = (u) => {
    const c = u * s, d = c * t, f = c - n, p = Bn(u, s), m = Math.exp(-d);
    return vn - f / p * m;
  }, a = (u) => {
    const d = u * s * t, f = d * n + n, p = Math.pow(s, 2) * Math.pow(u, 2) * t, m = Math.exp(-d), v = Bn(Math.pow(u, 2), s);
    return (-o(u) + vn > 0 ? -1 : 1) * ((f - p) * m) / v;
  }) : (o = (u) => {
...
function Se(t = q.visualDuration, e = q.bounce) {
  ...
  const S = { calculatedDuration: p && d || null, next: (b) => {
    ...
    const b = Math.min(di(S), tn), T = va((P) => S.next(b * P).value, b, 30);
    return b + "ms " + T;
  }, toTransition: () => {
  } };
  return S;
...
function Fn({ keyframes: t, velocity: e = 0, power: n = 0.8, timeConstant: i = 325, bounceDamping: o = 10, bounceStiffness: a = 500, modifyTarget: s, min: r, max: l, restDelta: u = 0.5, restSpeed: c }) {
...
function af(t, e, { clamp: n = true, ease: i, mixer: o } = {}) {
  const a = t.length;
  if (ri(a === e.length), a === 1) return () => e[0];
...
const df = Ee(0.42, 0, 1, 1), ff = Ee(0, 0, 0.58, 1), ba = Ee(0.42, 0, 0.58, 1), wa = (t) => (e) => e <= 0.5 ? t(2 * e) / 2 : (2 - t(2 * (1 - e))) / 2, xa = (t) => (e) => 1 - t(1 - e), Ta = Ee(0.33, 1.53, 0.69, 0.99), mi = xa(Ta), Sa = wa(mi), Pa = (t) => (t *= 2) < 1 ? 0.5 * mi(t) : 0.5 * (2 - Math.pow(2, -10 * (t - 1))), vi = (t) => 1 - Math.sin(Math.acos(t)), _a = xa(vi), Aa = wa(vi), Ma = (t) => Array.isArray(t) && typeof t[0] == "number", hf = { linear: ut, easeIn: df, easeInOut: ba, easeOut: ff, circIn: vi, circInOut: Aa, circOut: _a, backIn: mi, backInOut: Sa, backOut: Ta, anticipate: Pa }, pf = (t) => typeof t == "string", ro = (t) => {
  if (Ma(t)) {
    ri(t.length === 4);
    const [e, n, i, o] = t;
    return Ee(e, n, i, o);
...
const vf = (t) => t !== null;
function gi(t, { repeat: e, repeatType: n = "loop" }, i, o = 1) {
  const a = t.filter(vf), r = o < 0 || e && n !== "loop" && e % 2 === 1 ? 0 : a.length - 1;
  return !r || i === void 0 ? a[r] : i;
}
const gf = { decay: Fn, inertia: Fn, tween: ve, keyframes: ve, spring: Se };
function Ca(t) {
...
class bi extends yi {
  ...
  initAnimation() {
    ...
    a === "mirror" && (this.mirroredGenerator = l({ ...e, keyframes: [...r].reverse(), velocity: -s })), u.calculatedDuration === null && (u.calculatedDuration = di(u));
  ...
  tick(e, n = false) {
    ...
    return P && m !== Fn && (b.value = gi(c, this.options, w, this.speed)), v && v(b.value), P && this.finish(), b;
  }
  then(e, n) {
    return this.finished.then(e, n);
  }
...
const xf = wi(() => window.ScrollTimeline !== void 0), Tf = {};
function Sf(t, e) {
  const n = wi(t);
  return () => Tf[e] ?? n();
}
...
function _f({ type: t, ...e }) {
  return fi(t) && ka() ? t.applyToOptions(e) : (e.duration ?? (e.duration = 300), e.ease ?? (e.ease = "easeOut"), e);
}
class Af extends yi {
  constructor(e) {
    ...
    this.isPseudoElement = !!a, this.allowFlatten = s, this.options = e, ri(typeof e.type != "string");
    const u = _f(e);
    this.animation = Pf(n, i, o, u, a), u.autoplay === false && this.animation.pause(), this.animation.onfinish = () => {
      if (this.finishedTime = this.time, !a) {
        const c = gi(o, this.options, r, this.speed);
...
class kf extends Af {
  ...
  updateMotionValue(e) {
    ...
    const r = new bi({ ...s, autoplay: false }), l = yt(this.finishedTime ?? this.time);
...
function Df(t, e, n, i) {
  ...
  return !s || !r ? false : Ef(t) || (n === "spring" || fi(n)) && i;
}
function Va(t) {
...
const Vf = /* @__PURE__ */ new Set(["opacity", "clipPath", "filter", "transform"]), Lf = wi(() => Object.hasOwnProperty.call(Element.prototype, "animate"));
function Rf(t) {
  var e;
...
class $f extends yi {
  constructor({ autoplay: e = true, delay: n = 0, type: i = "keyframes", repeat: o = 0, repeatDelay: a = 0, repeatType: s = "loop", keyframes: r, name: l, motionValue: u, element: c, ...d }) {
    ...
    const p = { autoplay: e, delay: n, type: i, repeat: o, repeatDelay: a, repeatType: s, name: l, motionValue: u, element: c, ...d }, m = (c == null ? void 0 : c.KeyframeResolver) || ii;
  ...
  onKeyframesResolved(e, n, i, o) {
    ...
    this.resolvedAt = lt.now(), Df(e, a, s, r) || ((Ct.instantAnimations || !l) && (c == null ? void 0 : c(gi(e, i, n))), e[0] = e[e.length - 1], i.duration = 0, i.repeat = 0);
    const f = { startTime: o ? this.resolvedAt ? this.resolvedAt - this.createdAt > Of ? this.resolvedAt : this.createdAt : this.createdAt : void 0, finalKeyframe: n, ...i, keyframes: e }, p = !u && Rf(f) ? new kf({ ...f, element: f.motionValue.owner.current }) : new bi(f);
...
const xi = (t, e, n, i = {}, o, a) => (s) => {
  const r = hi(i, t) || {}, l = r.delay || i.delay || 0;
  let { elapsed: u = 0 } = i;
  u = u - yt(l);
  ...
  return r.isSync ? new bi(c) : new $f(c);
};
...
function Ff(t, e, { delay: n = 0, transitionOverride: i, type: o } = {}) {
  ...
  for (const c in r) {
    ...
    const p = { delay: n, ...hi(a || {}, c) }, m = d.get();
    ...
    Ed(t, c), d.start(xi(c, d, f, t.shouldReduceMotion && Zs.has(c) ? { type: false } : p, t, v));
    const w = d.animation;
    w && l.push(w);
  }
...
function Nf(t) {
  const e = { presenceContext: null, props: {}, visualState: { renderState: { transform: {}, transformOrigin: {}, style: {}, vars: {}, attrs: {} }, latestValues: {} } }, n = Ti(t) && !Ra(t) ? new aa(e) : new oa(e);
...
function Oa(t, e, n) {
  const i = Q(t) ? t : ee(t);
  return i.start(xi("", i, e, n)), i.animation;
}
function zf(t, e) {
  return Q(t) || typeof t == "number" || typeof t == "string" && !ui(e);
}
function $a(t, e, n, i) {
  const o = [];
  if (zf(t, e)) o.push(Oa(t, ui(e) && e.default || e, n && (n.default || n)));
  else {
...
class Zf extends Vt {
  ...
  updateAnimationControlsSubscription() {
    ...
    Ri(e) && (this.unmountControls = e.subscribe(this.state));
  }
  executeAnimations({ factories: e, getChildAnimations: n, transition: i, controlActiveState: o, isExit: a = false }) {
    const s = () => Promise.all(e.map((d) => d()).filter(Boolean)), r = { ...this.state.target }, l = this.state.element, u = (d) => {
      ...
      l.dispatchEvent($i("motionstart", r)), (p = (f = this.state.options).onAnimationStart) == null || p.call(f, r), d.then(() => {
        var m, v;
        l.dispatchEvent($i("motioncomplete", r, a)), (v = (m = this.state.options).onAnimationComplete) == null || v.call(m, r);
      }).catch(ut);
    }, c = () => {
  ...
  resolveStateAnimation({ controlActiveState: e, directAnimate: n, directTransition: i }) {
    ...
    return this.state.activeStates = { ...this.state.activeStates, ...e }, Yf.forEach((d) => {
      if (!this.state.activeStates[d] || Ri(this.state.options[d])) return;
      const f = this.state.options[d];
      let p = Ni(f) ? pe(f, s, c) : void 0;
...
function Fa(t, e) {
  const n = ci(t), i = new AbortController(), o = { passive: true, ...e, signal: i.signal };
  return [n, o, () => i.abort()];
}
...
function uh(t, e, { root: n, margin: i, amount: o = "some" } = {}) {
  const a = ci(t), s = /* @__PURE__ */ new WeakMap(), r = (u) => {
    u.forEach((c) => {
...
class ph {
  ...
  add(e) {
    ei(this.children, e), this.isDirty = true;
  }
  remove(e) {
...
function In({ scale: t, scaleX: e, scaleY: n }) {
  return !bn(t) || !bn(e) || !bn(n);
}
function Nt(t) {
  return In(t) || Ua(t) || t.z || t.rotate || t.rotateX || t.rotateY || t.skewX || t.skewY;
}
function Ua(t) {
...
class Dh {
  ...
  add(e) {
    ei(this.members, e), e.scheduleRender();
  }
  remove(e) {
...
const qe = { hasAnimatedSinceResize: true, hasEverUpdated: false }, { schedule: Lh } = Ds(queueMicrotask, false), wn = ["", "X", "Y", "Z"], Rh = 1e3;
let Oh = 0;
function xn(t, e, n, i) {
...
function Xa({ attachResizeListener: t, defaultParent: e, measureScroll: n, checkIsScrollRoot: i, resetTransform: o }) {
  return class {
    ...
    mount(s) {
      ...
      this.isSVG = Ti(s) && !Ra(s), this.instance = s;
      ...
      r && this.root.registerSharedNode(r, this), this.options.animate !== false && u && (r || l) && this.addEventListener("didUpdate", ({ delta: c, hasLayoutChanged: d, hasRelativeLayoutChanged: f, layout: p }) => {
        ...
        if (this.options.layoutRoot || this.resumeFrom || y || d && (x || !this.currentAnimation)) {
          ...
          const g = { ...hi(m, "layout"), onPlay: v, onComplete: w };
    ...
    removeTransform(s) {
      ...
      for (let l = 0; l < this.path.length; l++) {
        ...
        In(u.latestValues) && u.updateSnapshot();
    ...
    getClosestProjectingParent() {
      if (!(!this.parent || In(this.parent.latestValues) || Ua(this.parent.latestValues))) return this.parent.isProjecting() ? this.parent : this.parent.getClosestProjectingParent();
    }
    isProjecting() {
    ...
    resetSkewAndRotation() {
      ...
      const u = {};
      l.z && xn("z", s, u, this.animationValues);
      for (let c = 0; c < wn.length; c++) xn(`rotate${wn[c]}`, s, u, this.animationValues), xn(`skew${wn[c]}`, s, u, this.animationValues);
      s.render();
    ...
    applyProjectionStyles(s, r) {
      ...
      this.options.layoutId && (s.pointerEvents = u === this ? yn(r == null ? void 0 : r.pointerEvents) || "" : "none");
    }
    clearSnapshot() {
...
const Jh = Xa({ attachResizeListener: (t, e) => Zh(t, "resize", e), measureScroll: () => ({ x: document.documentElement.scrollLeft || document.body.scrollLeft, y: document.documentElement.scrollTop || document.body.scrollTop }), checkIsScrollRoot: () => true }), Tn = { current: void 0 }, Qh = Xa({ measureScroll: (t) => ({ x: t.scrollLeft, y: t.scrollTop }), defaultParent: () => {
  if (!Tn.current) {
    const t = new Jh({});
  ...
  setOptions() {
    ...
    this.state.visualElement.projection.setOptions({ layout: e.layout, layoutId: e.layoutId, alwaysMeasureLayout: !!e.drag || e.dragConstraints && he(e.dragConstraints), visualElement: this.state.visualElement, animationType: typeof e.layout == "string" ? e.layout : "both", layoutRoot: e.layoutRoot, layoutScroll: e.layoutScroll, crossfade: e.crossfade, onExitComplete: () => {
      ...
      if (!((n = this.state.visualElement.projection) != null && n.isPresent)) {
        const i = Qn.get(this.state.element);
...
function Si(t, e = "page") {
  return { point: { x: t[`${e}X`], y: t[`${e}Y`] } };
}
function np(t) {
  return (e) => Qa(e) && t(e, Si(e));
}
function be(t, e, n, i) {
...
function ap(t = Un) {
  return t === false ? t = 0 : t === true && (t = Un), { x: Jo(t, "left", "right"), y: Jo(t, "top", "bottom") };
}
function Jo(t, e, n) {
...
class er {
  constructor(e, n, { transformPagePoint: i, contextWindow: o, dragSnapToOrigin: a = false } = {}) {
    if (this.startEvent = null, this.lastMoveEvent = null, this.lastMoveEventInfo = null, this.handlers = {}, this.contextWindow = window, this.updatePoint = () => {
      ...
      const d = Pn(this.lastMoveEventInfo, this.history), f = this.startEvent !== null, p = cp(d.offset, { x: 0, y: 0 }) >= 3;
      if (!f && !p) return;
    ...
    const s = Si(e), r = Sn(s, this.transformPagePoint), { point: l } = r, { timestamp: u } = st;
    this.history = [{ ...l, timestamp: u }];
    const { onSessionStart: c } = n;
    c && c(e, Pn(r, this.history)), this.removeListeners = ke(be(this.contextWindow, "pointermove", this.handlePointerMove), be(this.contextWindow, "pointerup", this.handlePointerUp), be(this.contextWindow, "pointercancel", this.handlePointerUp));
  }
  updateHandlers(e) {
    this.handlers = e;
  }
...
class wp {
  ...
  start(e, { snapToCursor: n = false } = {}) {
    ...
    const i = (u) => {
      ...
      c ? this.pauseAnimation() : this.stopAnimation(), n && this.snapToCursor(Si(u, "page").point);
    }, o = (u, c) => {
  ...
  startAxisValueAnimation(e, n) {
    ...
    return os(this.visualElement, e), i.start(xi(e, i, 0, n, this.visualElement, false));
  }
  stopAnimation() {
  ...
  getProps() {
    const e = this.visualElement.getProps(), { drag: n = false, dragDirectionLock: i = false, dragPropagation: o = false, dragConstraints: a = false, dragElastic: s = Un, dragMomentum: r = true } = e;
...
const Ip = Fp(_p), jp = Ip.create("div"), Np = { "text-neutral": "", truncate: "" }, Up = H({ __name: "Header", props: { darkHeader: { type: Boolean } }, async setup(t) {
  ...
  let e, n;
  const { data: i } = ([e, n] = $t(() => Hn()), e = await e, n(), e), o = ws(() => t.bgColor), a = I(() => 5), { width: s } = nl(), r = V(0), l = V(12), u = I(() => l.value * 8.75);
  function c(m, v) {
...
} }), rm = Object.assign(zn(am, [["__scopeId", "data-v-8ee25eaa"]]), { __name: "NavigationFooter" }), lm = Lr(Pl), um = { "bottom-20": "", "right-20": "", fixed: "", "z-102": "" }, Om = H({ __name: "default", props: { darkHeader: { type: Boolean, default: false }, footerBgColor: { default: "grey" }, draft: { type: Boolean }, showSocialsHexagonBg: { type: Boolean } }, async setup(t) {
  let e, n;
  const { data: i } = ([e, n] = $t(() => Ae()), e = await e, n(), e);
  return (o, a) => {
