import { d as x, j as b, c as a, o as n, e as h, u as t, h as S, t as p, a as F, g as K, n as A, i as W, C as N, G, f as $, b as I, ad as D, ae as H, q as R, Y as P, F as L, r as O, V as X, af as J, w as Y } from "./BguRs3jF.js";
import { S as T, P as U } from "./D0DW2WUk.js";
import { u as Z } from "./BghiwBAd.js";
import { g as Q, h as ee, i as te, j as oe } from "./Cn5kCPLx.js";
import { c as se, u as ne } from "./DeSMYd_K.js";
...
} }), Ee = Object.assign(je, { __name: "AlbatrossLiveviewMicroBlock" });
...
function Re() {
  const s = H("albatross-blocks", () => []), e = `${R().public.apiDomain}/api/albatross/liveview/blocks`, { status: l, data: i } = Q(e, { onError() {
...
const z = se(Re), Ve = { flex: "~ col wrap", h: "56 md:44" }, w = 60, qe = x({ __name: "Batch.client", props: { batchNumber: {}, blockNumber: {} }, setup(s) {
  const e = s, l = U, { microblocks: i } = z();
  function r(k) {
    const y = l + (e.batchNumber - 1) * w + k, g = i.value.find((j) => j.number === y);
...
} }), ze = Object.assign(qe, { __name: "AlbatrossLiveviewBatch" }), Ke = D(ze), Ge = { flex: "~ justify-end items-center", "px-24": "", "min-h-208": "", "of-hidden": "" }, He = { key: 0, flex: "~ justify-center items-center", "font-bold": "", "min-h-224": "", "inset-0": "", absolute: "" }, Xe = { key: 0, text: "f-lg white" }, Je = { key: 1, text: "18 white", "px-32": "", "py-24": "", "rounded-4": "", "bg-red": "", shadow: "", ring: "1.5 red/3" }, Ye = { key: 1, flex: "~ justify-center", "px-32": "", "w-full": "", "of-hidden": "", "f-mt-lg": "" }, Ue = { flex: "~ justify-center" }, E = 208, Ze = 0.55, Qe = x({ __name: "Blockchain", setup(s) {
  const { blocks: e, batchNumber: l, blockNumber: i, status: r } = z(), o = N(0), c = N(e.value.length * E), { pause: m, resume: u } = te(() => {
    o.value = -Math.floor((52 + c.value) ** Ze), c.value += o.value;
  }, { immediate: false }), v = N(), _ = oe(v), d = b(() => r.value === "OPEN" && e.value.length >= q && _.value);
  P(e, () => {
    d.value && (c.value += E);
  }, { deep: true }), X(() => d.value ? u() : m());
  const { clientNetwork: f } = R().public;
  return (k, y) => {
    const g = De, j = Ke;
    return n(), a("div", { ref_key: "target", ref: v, relative: "", "of-x-clip": "" }, [h("div", Ge, [F(J, { tag: "div", flex: "~ justify-end items-center", "enter-from-class": "op-0", "enter-active-class": "transition-opacity duration-400 ease-in", style: S({ transform: `translate3d(${t(c)}px, 0, 0)` }) }, { default: Y(() => [(n(true), a(L, null, O(t(e), (C) => (n(), I(g, { key: `block-${C.number}`, block: C, style: S({ width: E }) }, null, 8, ["block", "style"]))), 128))]), _: 1 }, 8, ["style"])]), t(r) !== "OPEN" || t(e).length === 0 ? (n(), a("div", He, [t(r) === "CONNECTING" || t(e).length === 0 ? (n(), a("div", Xe, " Loading... ")) : t(r) === "CLOSED" ? (n(), a("div", Je, " We couldn't connect to the " + p(t(f)), 1)) : $("", true)])) : (n(), a("div", Ye, [h("div", Ue, [(n(), a(L, null, O(7, (C) => F(j, { key: `batch-${t(l) - 2 + C - 1}`, "batch-number": t(l) - 3 + C - 1, "block-number": t(i), class: "animate-batch-unshift" }, null, 8, ["batch-number", "block-number"])), 64))])]))], 512);
  };
