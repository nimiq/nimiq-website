...
import { b7 as U, j as z, aB as l, as as M, b8 as E, z as F, b9 as R } from "./gdLxT4Lf.js";
...
function I(r, e, s) {
  ...
  const { server: h, lazy: c, default: y, transform: g, pick: _, watch: n, immediate: D, getCachedData: j, deep: A, dedupe: O, ...m } = t, b = M({ ...E, ...m, cache: typeof t.cache == "boolean" ? void 0 : t.cache }), f = { server: h, lazy: c, default: y, transform: g, pick: _, immediate: D, getCachedData: j, deep: A, dedupe: O, watch: n === false ? [] : [...n || [], b] };
  let u;
