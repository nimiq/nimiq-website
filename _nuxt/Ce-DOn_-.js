import { g as $, _ as R, a as k, u as b, b as M, c as h, d as K } from "./6j_b9UX3.js";
import { g as T } from "./BmXLCl62.js";
import { a as S, c as V, u as O, b as _, f as w, P as F } from "./BqwFAzj-.js";
import { d as v, B, U as N, R as g, u as e, E as P, b as f, o as m, w as c, a as A, m as y, f as L, S as U, T as j } from "./7tyaNgEA.js";
const [C, z] = V("DialogRoot"), Y = v({ inheritAttrs: false, __name: "DialogRoot", props: { open: { type: Boolean, default: void 0 }, defaultOpen: { type: Boolean, default: false }, modal: { type: Boolean, default: true } }, emits: ["update:open"], setup(u, { emit: l }) {
  ...
  return (r, a) => (m(), f(e(w), { present: r.forceMount || e(o).open.value }, { default: c(() => [e(o).modal.value ? (m(), f(H, y({ key: 0, ref: e(p) }, { ...t, ...e(d), ...r.$attrs }), { default: c(() => [g(r.$slots, "default")]), _: 3 }, 16)) : (m(), f(q, y({ key: 1, ref: e(p) }, { ...t, ...e(d), ...r.$attrs }), { default: c(() => [g(r.$slots, "default")]), _: 3 }, 16))]), _: 3 }, 8, ["present"]));
  ...
  return (n, o) => {
    var _a;
    return ((_a = e(l)) == null ? void 0 : _a.modal.value) ? (m(), f(e(w), { key: 0, present: n.forceMount || e(l).open.value }, { default: c(() => [A(x, y(n.$attrs, { ref: e(t), as: n.as, "as-child": n.asChild }), { default: c(() => [g(n.$slots, "default")]), _: 3 }, 16, ["as", "as-child"])]), _: 3 }, 8, ["present"])) : L("", true);
  };
