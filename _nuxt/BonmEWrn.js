...
import { ak as ii, i as si, bG as an, d as oi, an as ai, B as ci, c as ui, E as li, N as fi, G as hi, ae as di, o as pi } from "./C95QRNzc.js";
...
var Wa = Ir("start", "end", "cancel", "interrupt"), Ua = [], Dr = 0, Xn = 1, Pe = 2, Xt = 3, qn = 4, Ie = 5, qt = 6;
...
function ic(t3) {
  return t3 == null || (Bt || (Bt = document.createElementNS("http://www.w3.org/2000/svg", "g")), Bt.setAttribute("transform", t3), !(t3 = Bt.transform.baseVal.consolidate())) ? Le : (t3 = t3.matrix, Xr(t3.a, t3.b, t3.c, t3.d, t3.e, t3.f));
}
