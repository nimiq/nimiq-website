import { i as f, bE as w, ad as q, a0 as I, Y as T, bv as b, B as v, d as N, c as h, o as _, a as D, e as V, T as A, ak as C, O as M, al as B, t as E, m as k } from "./C95QRNzc.js";
import { _ as F } from "./4PIkP2wK.js";
function $(t) {
  return f(() => {
    var _a;
...
function W(t) {
  ...
  return { search: e, handleTypeaheadSearch: (u, m) => {
    e.value = e.value + u;
    {
      ...
      }), c = d.find((r) => r.ref === i), o = d.map((r) => r.textValue), g = O(o, e.value, c == null ? void 0 : c.textValue), p = d.find((r) => r.textValue === g);
...
const H = { flex: "~ justify-start", "px-32": "", "max-w-780px": "", "w-full": "", "f-mt-xs": "" }, P = N({ __name: "LeftAligned", props: { headline: {}, subline: {} }, setup(t) {
  return (e, a) => {
    const l = F;
    return _(), h("section", null, [D(l, { headline: e.headline, subline: e.subline, "left-align": "", "px-32": "", "max-w-780px": "", "w-full": "" }, null, 8, ["headline", "subline"]), V("div", H, [A(e.$slots, "bottom")])]);
  };
