import { i as L, a as T, b as z, d as x, c as K, u as $, _ as U } from "./De1jwUL-.js";
import { u as _, P as b, c as Y, a as j, e as V, b as E, f as W } from "./BI3535uL.js";
import { d as m, b as v, o as f, w as d, Q as g, c as k, m as y, u as t, j as X, a as h, h as N, T as q, B as P, R as F, S, $ as A, E as H, at as G, e as C, n as D, i as Q } from "./gdLxT4Lf.js";
import { d as J, _ as Z, a as ee, c as te, b as oe } from "./ViQ2U2w0.js";
const ae = { key: 0, d: "M0 0L6 6L12 0" }, se = { key: 1, d: "M0 0L4.58579 4.58579C5.36683 5.36683 6.63316 5.36684 7.41421 4.58579L12 0" }, ne = m({ __name: "Arrow", props: { width: { default: 10 }, height: { default: 5 }, rounded: { type: Boolean }, asChild: { type: Boolean }, as: { default: "svg" } }, setup(p) {
  ...
  const a = p;
  return (e, o) => (f(), v(t(J), F(S(a)), { default: d(() => [g(e.$slots, "default")]), _: 3 }, 16));
  ...
  return s.contentId || (s.contentId = E(void 0, "reka-popover-content")), (c, i) => (f(), v(t(W), { present: c.forceMount || t(s).open.value }, { default: d(() => [t(s).modal.value ? (f(), v(ce, y({ key: 0 }, t(n), { ref: t(r) }), { default: d(() => [g(c.$slots, "default")]), _: 3 }, 16)) : (f(), v(fe, y({ key: 1 }, t(n), { ref: t(r) }), { default: d(() => [g(c.$slots, "default")]), _: 3 }, 16))]), _: 3 }, 8, ["present"]));
