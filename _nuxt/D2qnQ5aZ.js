import { j as y, o as g, k as e, aw as A, b7 as O, d as k, v as P, a as B, x as U, B as E, l as L, h as w, au as j, Z, F as H, r as N, n as z, t as V, q as M, g as x, b6 as Q, C as Y, av as F, e as S } from "./Dzy_QPZd.js";
import { _ as W } from "./DlAUqK2U.js";
import { l as G, q as J, s as K } from "./CMqLQgad.js";
import { _ as X } from "./B75nZLF8.js";
import { g as ee } from "./CpsPJSKh.js";
import { e as te } from "./BiHuLGzs.js";
import "./CR0Fnf8w.js";
...
const re = { "size-full": "", "inline-block": "", relative: "", aspect: "16/9 desktop:9/16" }, se = ["src", "sandbox", "width", "height"], ie = k({ __name: "WalletPlaygroundIframe", props: { playgroundUrl: { default: "https://wallet.nimiq.com" }, allowedOrigins: { default: () => [] }, height: { default: "600px" }, width: { default: "100%" }, sandbox: { default: "allow-scripts allow-same-origin" } }, emits: ["message", "ready", "error"], setup(t, { expose: d, emit: f }) {
  const l = f, { playgroundState: r, setIframeRef: n, handlePlaygroundMessage: v, allowedMessageTypes: c, setPlaygroundUrl: u, ActionToMessageType: s, activateDemoMode: h, connectWallet: b } = T(), a = P(), o = B(() => {
    try {
  ...
  const f = d, { playgroundState: l, setSelectedAction: r } = T(), n = P("idle");
  U(n, (u) => {
    r(u);
...
const R = Object.assign(W(me, [["render", ge]]), { __name: "WalletCurrencies" }), ye = { "pb-32": "", relative: "" }, ve = { w: "[calc(100%+48px)]", "p-8": "", "rounded-14": "", "size-full": "", "aspect-0.7": "", "left--24": "", relative: "", "f-mt-xl": "" }, _e = { "rounded-8": "", "size-full": "", relative: "", "z-1": "" }, we = k({ __name: "PlaygroundMobile", props: { playgroundUrl: {} }, setup(t) {
  function d(l) {
  ...
  const n = r(l), v = P(null), { y: c } = J(), u = B(() => {
    var _a;
...
} }), Me = Object.assign(W(Ce, [["__scopeId", "data-v-44b98479"]]), { __name: "WalletPlaygroundBackground" }), ke = F(X), We = { relative: "" }, Pe = { stack: "", "mx-auto": "", "size-full": "" }, Ue = { p: "t-48 x-10 b-10", "size-full": "", "z-1": "" }, $e = { key: 0, "rounded-4": "", "size-full": "" }, Ie = { key: 1, "rounded-4": "", "size-full": "" }, Ae = { "self-start": "!", "justify-self-end": "!", "mr--18": "", "mt-11": "", "w-max": "", relative: "", "z-10": "" }, ze = k({ __name: "PlaygroundDesktop", props: { playgroundUrl: {} }, setup(t) {
  function d(l) {
    console.error("Playground iframe error:", l);
  }
  function f(l) {
...
} }), Se = Object.assign(W(ze, [["__scopeId", "data-v-4448de3b"]]), { __name: "WalletPlaygroundDesktop" }), Be = F(le), Ee = { "data-slice-type": "wallet-playground", "bg-darkerblue": "", "scheme-dark": "", relative: "", "of-x-clip": "", "md:f-pt-3xl": "", "children:max-w-none": "" }, je = k({ __name: "index", props: ee(), setup(t) {
  const d = K("(max-width: 768px)", { ssrWidth: 1024 }), f = te(t.slice.primary.playgroundUrl);
  ...
  return (l, r) => {
    const n = Be, v = he, c = Se;
    return g(), y("section", Ee, [x(n, { h: "[calc(100%+400px)]", "max-w-screen": "", "pointer-events-none": "", "top--400": "" }), w(d) ? (g(), S(v, { key: "mobile", "playground-url": w(f) }, null, 8, ["playground-url"])) : (g(), S(c, { key: "desktop", "w-full": "", "z-1": "", "playground-url": w(f) }, null, 8, ["playground-url"]))]);
  };
} });
export {
  je as default
