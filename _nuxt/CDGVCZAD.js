import { _ as v } from "./Fc1-Bd8L.js";
import { d as b, K as m, e as x, o as I } from "./B8biU-UE.js";
const S = "assets/images/prismic";
function w(e, t) {
  if (!(t == null ? void 0 : t.includes("prismic"))) return t;
  const s = P(t.split("/").pop() || "image");
...
const A = b({ __name: "ProxiedPrismicImage", props: { field: {}, imgixParams: {}, alt: {}, fallbackAlt: {}, widths: {}, pixelDensities: {}, width: {}, height: {} }, setup(e) {
  var _a, _b;
...
} }), D = Object.assign(A, { __name: "ProxiedPrismicImage" });
export {
  D as _
};
