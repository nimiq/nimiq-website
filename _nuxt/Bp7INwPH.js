import { b5 as $, b6 as j, b7 as M, b8 as b, b9 as O, ba as q, bb as R, O as W, p as L, i as p, B as U, ap as B, av as H, E as C, c as D, T as V, o as T, m as k, W as F } from "./C95QRNzc.js";
...
function I(e, t, r) {
  ...
  if (t = M(t) ? t : j(t), !n.supportsAlias) {
...
const ae = X({ keyMap: { format: "f", fit: "fit", width: "w", height: "h", resize: "s", quality: "q", background: "b" }, formatter: (e, t) => q(e) + "_" + q(t.toString()) }), ce = oe({ validateDomains: true, supportsAlias: true, getImage(e, { modifiers: t, baseURL: r }, i) {
  t.width && t.height && (t.resize = `${t.width}x${t.height}`, delete t.width, delete t.height);
  const s = ae(t) || "_";
  return r || (r = b(i.options.nuxt.baseURL, "/_ipx")), { url: b(r, s, R(e).replace(/\/{2,}/g, "/")) };
...
const ue = (e) => {
  ...
  const r = e, i = t, s = A(), { providerOptions: n, normalizedAttrs: a, imageModifiers: o } = ue(r), d = p(() => s.getSizes(r.src, { ...n.value, sizes: r.sizes, densities: r.densities, modifiers: o.value })), u = U(false), m = B(), g = p(() => ({ ...a.value, "data-nuxt-img": "", ...!r.placeholder || u.value ? { sizes: d.value.sizes, srcset: d.value.srcset } : {}, ...m })), w = p(() => {
    ...
    const [v = 10, E = v, N = 50, P = 3] = Array.isArray(c) ? c : typeof c == "number" ? [c] : [];
    return s(r.src, { ...o.value, width: v, height: E, quality: N, blur: P }, n.value);
  ...
  }), (c, v) => e.custom ? V(c.$slots, "default", F(k({ key: 1 }, { imgAttrs: g.value, isLoaded: u.value, src: l.value }))) : (T(), D("img", k({ key: 0, ref_key: "imgEl", ref: f, class: w.value ? e.placeholderClass : void 0 }, g.value, { src: l.value }), null, 16, fe));
} };
export {
  ge as _
};
