import { F as z, d as D, aX as q, m as J, aY as H, H as I, aZ as G, a2 as Y, N as Q, O as X, j as O, P as k, V as Z, aP as ee, a0 as C, ac as j, aj as W, u as K, L as b, au as y, aQ as te, U, a1 as L, B as w, E as ne, aq as re, ap as oe, a_ as V, G as ie } from "./7tyaNgEA.js";
function F(e) {
...
const se = D({ name: "PrimitiveSlot", inheritAttrs: false, setup(e, { attrs: t, slots: r }) {
  return () => {
    ...
    const n = F(r.default()), o = n.findIndex((u) => u.type !== q);
    if (o === -1) return n;
    const i = n[o];
    (_a = i.props) == null ? true : delete _a.ref;
    const s = i.props ? J(t, i.props) : t;
...
const qe = D({ name: "Presence", props: { present: { type: Boolean, required: true }, forceMount: { type: Boolean } }, slots: {}, setup(e, { slots: t, expose: r }) {
  var _a;
