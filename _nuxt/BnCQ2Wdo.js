import { u as E } from "./xLWJwwMd.js";
import { d, B as c, j as f, E as g, L as h, c as v, o as w, t as T, u as V, a6 as x, a7 as $, a9 as I, b3 as A, m as D, ab as N } from "./ClGJWWej.js";
class m {
...
const B = m, M = { "data-allow-mismatch": "", "tabular-nums": "" }, C = d({ __name: "TweenedNumber", props: { value: { default: 0 }, decimals: { default: 0 }, duration: { default: 1e3 } }, setup(a) {
  const e = E(), n = c(a.value), i = new Intl.NumberFormat(e.value, { style: "decimal", minimumFractionDigits: a.decimals, maximumFractionDigits: a.decimals }), u = f(() => i.format(n.value));
  ...
  function l(r, t) {
    ...
    function s() {
      const b = o.progress, p = o.currentValue;
      n.value = p, b < 1 && requestAnimationFrame(s);
    }
    s();
  }
  return (r, t) => (w(), v("span", M, T(V(u)), 1));
  ...
  return g(r), (t, o) => I((w(), v("input", D({ "onUpdate:modelValue": o[0] || (o[0] = (s) => N(u) ? u.value = s : null), type: "text", style: { "field-sizing": "content" }, "focus-visible:outline": "1 solid blue", "rounded-2": "", "bg-transparent": "", "px-6": "", "font-semibold": "", "lh-none": "", "nq-input-box": "", inputmode: "decimal" }, t.$attrs, { onBlur: r }), null, 16)), [[A, V(u)]]);
