import { d as w, B as g, c as b, o as y, ai as x, aI as P, e as d, b3 as q, u, aK as S, f as $, t as I, b4 as M } from "./C95QRNzc.js";
var p;
function v(n) {
...
const T = ["placeholder"], A = ["disabled"], F = { h: "0.5em md:0.75em", "font-semibold": "", "mt-0.25em": "", "pl-0.75em": "", text: "0.875em lg:0.9375em 2xl:1em red mt-0.5em" }, K = { key: 0 }, L = w({ __name: "EmailInput", props: { placeholder: {} }, setup(n) {
  ...
  function i() {
    ...
    M({ path: "/newsletter", query: { email: e.value } });
  }
  return (l, s) => (y(), b("form", { "max-w-32em": "", "w-full": "", relative: "", onSubmit: x(i, ["prevent"]) }, [P(d("input", { "onUpdate:modelValue": s[0] || (s[0] = (o) => S(e) ? e.value = o : null), type: "email", name: "email", required: "", "rounded-full": "", relative: "", "nq-input-box": "", placeholder: l.placeholder || "Enter email address..." }, null, 8, T), [[q, u(e)]]), d("button", { "aria-label": "Submit your email", type: "submit", disabled: !u(e), group: "", "rounded-full": "", "size-1.6875em": "", "aspect-1": "", "transition-colors": "", "right-0.1875em": "", "top-0.1875em": "", absolute: "", "not-disabled:cursor-pointer": "", bg: "not-disabled:gradient-blue hocus:not-disabled:gradient-blue-darkened disabled:!neutral-300", flex: "~ items-center justify-center" }, s[1] || (s[1] = [d("div", { "i-nimiq:arrow-right": "", text: "0.6875em white group-disabled:neutral-600" }, null, -1)]), 8, A), d("div", F, [u(r) && u(e) ? (y(), b("span", K, I(u(r)), 1)) : $("", true)])], 32));
} }), X = Object.assign(L, { __name: "NewsletterEmailInput" });
export {
  X as _
};
