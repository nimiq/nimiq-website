...
import { a as h, T as b, b as P, c as w, d as F, e as f } from "./D0DW2WUk.js";
import { aO as E, i as y, b1 as I } from "./C95QRNzc.js";
import { u as R } from "./BhpWC2zv.js";
function T(a, t) {
...
function $(a, { network: t = "main-albatross" } = {}) {
  ...
  return (b - (b - (t === "test-albatross" ? P : w) * 1e5) * T(F, i)) / 1e5;
}
function A(a) {
  ...
  const n = o === "test-albatross" ? P : w, u = h.getTime() + 1440 * 60 * 1e3, l = $(u, { network: o }) - n, c = Math.E ** (-3432600460362e-16 * i);
  let m = 0;
...
function L(a = {}) {
  const t = "https://validators-api-mainnet.pages.dev", { data: i, state: s } = E({ key: ["staking_distribution"], query: async () => {
    ...
    return n / e;
  }, staleTime: 3e5, placeholderData: (e) => e, enabled: y(() => I(a.enabled) ?? true) }), r = R(), o = y(() => {
    if (!i.value) return 0;
