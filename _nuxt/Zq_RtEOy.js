import { d as w, c as a, o as n, F as $, r as S, n as m, a as C, w as L, f as q, e as l, t as v, D as R, af as I, b, g as U, u as c, _ as V, s as z, i as O, aI as A, aJ as k, aK as N, ai as h, h as j, m as P, W as H } from "./C95QRNzc.js";
import { _ as T } from "./DbfG6DI8.js";
import { _ as W } from "./Bp7INwPH.js";
import { u as D } from "./DkaLAbT4.js";
import { a as F } from "./CoMN0Xhs.js";
...
const J = { grid: "~ cols-1 lg:cols-2 gap-20 md:gap-22" }, K = w({ __name: "Nimiq", props: { items: {} }, setup(f) {
  ...
  let o, i;
  const { data: r } = ([o, i] = z(() => D({ labelTeamNimiq: f.labelTeamNimiq })), o = await o, i(), o), { filteredApps: u, getSpotlightAppsPosition: g, madeBy: e } = p(r.value);
  ...
  return (x, t) => {
    const d = T, y = le;
    return n(), a($, null, [l("form", { "rounded-full": "", "bg-neutral-300": "", onSubmit: t[3] || (t[3] = h(() => {
      ...
      var _a;
      return n(), a("li", { key: _, style: j(c(g)(s)), class: m((_a = c(g)(s)) == null ? void 0 : _a.class), "w-full": "" }, [s.isHighlighted ? (n(), b(y, P({ key: 1, ref_for: true }, s, { "w-full": "" }), null, 16)) : (n(), b(d, P({ key: 0, ref_for: true }, s, { "w-full": "" }), null, 16))], 6);
    }), 128))])) : q("", true)], 64);
  };
} }), re = Object.assign(M(ie, [["__scopeId", "data-v-eeee24d0"]]), { __name: "AppsShowcaseAll" }), me = { "bg-neutral-0": "" }, be = w({ __name: "index", props: E(), setup(f) {
  return (o, i) => {
    const r = Q, u = re;
    return n(), a("section", me, [o.slice.variation === "nimiqsApps" ? (n(), b(r, { key: 0, items: o.slice.primary.apps }, null, 8, ["items"])) : o.slice.variation === "default" ? (n(), b(u, H(P({ key: 1 }, o.slice.primary)), null, 16)) : q("", true)]);
  };
} });
export {
  be as default
