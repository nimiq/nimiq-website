import { u as V } from "./Cn5kCPLx.js";
import { s as z, u as N } from "./Dqp79TGT.js";
import { C as p, Y as B, G as S, a2 as I, a3 as P, j as k, d as q, c as x, o as b, e as u, u as d, m as T, F as $, r as M, R as X, h as A } from "./BguRs3jF.js";
function O(c = {}) {
...
const E = { group: "", stack: "", "h-full": "", "max-w-none": "", relative: "" }, F = ["disabled"], L = ["disabled"], G = { flex: "~ gap-6 justify-center", "self-end": "", "bottom-64": "", absolute: "" }, K = ["title", "onClick"], R = q({ __name: "Carousel", props: { items: {}, multiple: { type: Boolean, default: true } }, setup(c) {
  const i = c.multiple ? O() : N(), { scroller: C, slideTo: t, slideNext: n, slidePrev: l, canSlideNext: o, canSlidePrev: g } = i, h = c.multiple ? i.activeIndexes : i.activeIndex, f = k(() => {
    if (c.multiple) {
