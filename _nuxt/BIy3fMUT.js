import { a as C, v as _, O as se, x as pt, M as le, N as ce, bb as tt, h as M, d as Ot, $ as Nt, Q as Ct, S as It, bd as jt, e as ae, o as Yt, f as qt, R as Xt, B as fe, aa as ue, be as de, bf as me, Z as Ut, j as he, g as pe, s as ge, q as we, a7 as ye } from "./BSLliBk6.js";
const xe = ["top", "right", "bottom", "left"], Z = Math.min, k = Math.max, at = Math.round, ct = Math.floor, V = (t) => ({ x: t, y: t }), ve = { left: "right", right: "left", bottom: "top", top: "bottom" }, be = { start: "end", end: "start" };
function yt(t, e, n) {
  return k(t, Z(e, n));
}
function q(t, e) {
...
function Bt(t, e, n) {
  ...
  const s = Y(e), r = St(e), l = Rt(r), c = X(e), a = s === "y", f = o.x + o.width / 2 - i.width / 2, u = o.y + o.height / 2 - i.height / 2, h = o[l] / 2 - i[l] / 2;
  let d;
  switch (c) {
    case "top":
...
const Ee = (t) => ({ name: "arrow", options: t, async fn(e) {
  ...
  const O = v / 2 - A / 2, S = b / 2 - p[m] / 2 - 1, E = Z(u[w], S), R = Z(u[x], S), D = E, z = b - p[m] - R, $ = b / 2 - p[m] / 2 + O, T = yt(D, $, z), j = !c.arrow && it(i) != null && $ !== T && s.reference[m] / 2 - ($ < D ? E : R) - p[m] / 2 < 0, L = j ? $ < D ? $ - D : $ - z : 0;
  ...
  return t === void 0 && (t = {}), { name: "flip", options: t, async fn(e) {
    ...
    const w = X(i), x = Y(l), y = X(l) === l, v = await (c.isRTL == null ? void 0 : c.isRTL(a.floating)), A = h || (y || !p ? [ft(l)] : Oe(l)), P = m !== "none";
    !h && P && A.push(...Pe(l, p, m, v));
    const b = [l, ...A], O = await rt(e, g), S = [];
    ...
    if (E = [...E, { placement: i, overflows: S }], !S.every((T) => T <= 0)) {
      ...
      if (j) {
        var z;
        const U = u === "alignment" ? x !== Y(j) : false, H = ((z = E[0]) == null ? void 0 : z.overflows[0]) > 0;
        if (!U || H) return { data: { index: T, overflows: E }, reset: { placement: j } };
      }
...
async function Te(t, e) {
  const { placement: n, platform: o, elements: i } = t, s = await (o.isRTL == null ? void 0 : o.isRTL(i.floating)), r = X(n), l = it(n), c = Y(n) === "y", a = ["left", "top"].includes(r) ? -1 : 1, f = s && c ? -1 : 1, u = q(e, t);
...
const ke = function(t) {
  ...
  return t === void 0 && (t = {}), { name: "shift", options: t, async fn(e) {
    const { x: n, y: o, placement: i } = e, { mainAxis: s = true, crossAxis: r = false, limiter: l = { fn: (g) => {
      let { x: w, y: x } = g;
      return { x: w, y: x };
    } }, ...c } = q(t, e), a = { x: n, y: o }, f = await rt(e, c), u = Y(X(i)), h = Pt(u);
    let d = a[h], m = a[u];
    if (s) {
  ...
  return t === void 0 && (t = {}), { options: t, fn(e) {
    ...
    if (a) {
      var w, x;
      const y = h === "y" ? "width" : "height", v = ["top", "left"].includes(X(i)), A = s.reference[u] - s.floating[y] + (v && ((w = r.offset) == null ? void 0 : w[u]) || 0) + (v ? 0 : g.crossAxis), P = s.reference[u] + s.reference[y] + (v ? 0 : ((x = r.offset) == null ? void 0 : x[u]) || 0) - (v ? g.crossAxis : 0);
      m < A ? m = A : m > P && (m = P);
    }
    return { [h]: d, [u]: m };
  } };
  ...
  return t === void 0 && (t = {}), { name: "size", options: t, async fn(e) {
    ...
    }, ...a } = q(t, e), f = await rt(e, a), u = X(i), h = it(i), d = Y(i) === "y", { width: m, height: p } = s.floating;
    let g, w;
    u === "top" || u === "bottom" ? (g = u, w = h === (await (r.isRTL == null ? void 0 : r.isRTL(l.floating)) ? "start" : "end") ? "left" : "right") : (w = u, g = h === "end" ? "top" : "bottom");
    const x = p - f.top - f.bottom, y = m - f.left - f.right, v = Z(p - f[g], x), A = Z(m - f[w], y), P = !e.middlewareData.shift;
    let b = v, O = A;
    if ((n = e.middlewareData.shift) != null && n.enabled.x && (O = y), (o = e.middlewareData.shift) != null && o.enabled.y && (b = x), P && !h) {
      const E = k(f.left, 0), R = k(f.right, 0), D = k(f.top, 0), z = k(f.bottom, 0);
      d ? O = m - 2 * (E !== 0 || R !== 0 ? E + R : k(f.left, f.right)) : b = p - 2 * (D !== 0 || z !== 0 ? D + z : k(f.top, f.bottom));
    }
    await c({ ...e, availableWidth: O, availableHeight: b });
...
function qe(t) {
  ...
  const r = [...n === "clippingAncestors" ? mt(e) ? [] : Ye(e, this._c) : [].concat(n), o], l = r[0], c = r.reduce((a, f) => {
    const u = Wt(e, f, i);
    return a.top = k(u.top, a.top), a.right = Z(u.right, a.right), a.bottom = Z(u.bottom, a.bottom), a.left = k(u.left, a.left), a;
  }, Wt(e, l, i));
...
function Ue(t, e, n) {
  const o = N(e), i = I(e), s = n === "fixed", r = Q(t, true, s, e);
...
const Ge = async function(t) {
  ...
  return { reference: Ue(t.reference, await e(t.floating), t.strategy), floating: { x: 0, y: 0, width: o.width, height: o.height } };
};
function Ze(t) {
  return W(t).direction === "rtl";
}
const Ke = { convertOffsetParentRelativeRectToViewportRelativeRect: _e, getDocumentElement: I, getClippingRect: qe, getOffsetParent: ee, getElementRects: Ge, getClientRects: Ve, getDimensions: Xe, getScale: nt, isElement: F, isRTL: Ze };
function ne(t, e) {
...
function Qe(t, e) {
  ...
  function r(l, c) {
    ...
    if (l || e(), !h || !d) return;
    const m = ct(u), p = ct(i.clientWidth - (f + h)), g = ct(i.clientHeight - (u + d)), w = ct(f), y = { rootMargin: -m + "px " + -p + "px " + -g + "px " + -w + "px", threshold: k(0, Z(1, c)) || 1 };
    let v = true;
    function A(P) {
...
const tn = ke, en = Be, Ht = De, nn = Me, on = Le, rn = Ee, sn = $e, ln = (t, e, n) => {
  const o = /* @__PURE__ */ new Map(), i = { platform: Ke, ...n }, s = { ...i.platform, _c: o };
...
function fn(t, e, n) {
  ...
  }), a = C(() => bt(t.value)), f = C(() => bt(e.value)), u = _(0), h = _(0), d = _(l.value), m = _(r.value), p = se({}), g = _(false), w = C(() => {
    const b = { position: d.value, left: "0", top: "0" };
    if (!f.value) return b;
    const O = _t(f.value, u.value), S = _t(f.value, h.value);
    return c.value ? { ...b, transform: "translate(" + O + "px, " + S + "px)", ...oe(f.value) >= 1.5 && { willChange: "transform" } } : { position: d.value, left: O + "px", top: S + "px" };
  });
  let x;
  function y() {
    if (a.value == null || f.value == null) return;
    const b = i.value;
    ln(a.value, f.value, { middleware: s.value, placement: r.value, strategy: l.value }).then((O) => {
      u.value = O.x, h.value = O.y, d.value = O.strategy, m.value = O.placement, p.value = O.middlewareData, g.value = b !== false;
    });
  }
  function v() {
...
const [ie, un] = Nt("PopperRoot"), yn = Ot({ inheritAttrs: false, __name: "PopperRoot", setup(t) {
  const e = _();
  return un({ anchor: e, onAnchorChange: (n) => e.value = n }), (n, o) => Ct(n.$slots, "default");
} }), xn = Ot({ __name: "PopperAnchor", props: { reference: {}, asChild: { type: Boolean }, as: {} }, setup(t) {
  const e = t, { forwardRef: n, currentElement: o } = It(), i = ie();
  return jt(() => {
    i.onAnchorChange(e.reference ?? o.value);
  }), (s, r) => (Yt(), ae(M(Xt), { ref: M(n), as: s.as, "as-child": s.asChild }, { default: qt(() => [Ct(s.$slots, "default")]), _: 3 }, 8, ["as", "as-child"]));
} });
function dn(t) {
  return t !== null;
}
...
const pn = { side: "bottom", sideOffset: 0, align: "center", alignOffset: 0, arrowPadding: 0, avoidCollisions: true, collisionBoundary: () => [], collisionPadding: 0, sticky: "partial", hideWhenDetached: false, positionStrategy: "fixed", updatePositionStrategy: "optimized", prioritizePosition: false }, [vn, gn] = Nt("PopperContent"), bn = Ot({ inheritAttrs: false, __name: "PopperContent", props: de({ side: {}, sideOffset: {}, align: {}, alignOffset: {}, avoidCollisions: { type: Boolean }, collisionBoundary: {}, collisionPadding: {}, arrowPadding: {}, sticky: {}, hideWhenDetached: { type: Boolean }, positionStrategy: {}, updatePositionStrategy: {}, disableUpdateOnLayoutShift: { type: Boolean }, prioritizePosition: { type: Boolean }, reference: {}, asChild: { type: Boolean }, as: {} }, { ...pn }), emits: ["placed"], setup(t, { emit: e }) {
  ...
  Ut(() => {
    r.value && (O.value = window.getComputedStyle(r.value).zIndex);
  });
  const S = C(() => {
    var _a;
  ...
  return gn({ placedSide: A, onArrowChange: (R) => c.value = R, arrowX: S, arrowY: E, shouldHideArrow: b }), (R, D) => {
    var _a, _b, _c;
    return Yt(), he("div", { ref_key: "floatingRef", ref: l, "data-reka-popper-content-wrapper": "", style: we({ ...M(w), transform: M(y) ? M(w).transform : "translate(0, -200%)", minWidth: "max-content", zIndex: O.value, "--reka-popper-transform-origin": [(_a = M(v).transformOrigin) == null ? void 0 : _a.x, (_b = M(v).transformOrigin) == null ? void 0 : _b.y].join(" "), ...((_c = M(v).hide) == null ? void 0 : _c.referenceHidden) && { visibility: "hidden", pointerEvents: "none" } }) }, [pe(M(Xt), ge({ ref: M(s) }, R.$attrs, { "as-child": n.asChild, as: R.as, "data-side": A.value, "data-align": P.value, style: { animation: M(y) ? void 0 : "none" } }), { default: qt(() => [Ct(R.$slots, "default")]), _: 3 }, 16, ["as-child", "as", "data-side", "data-align", "style"])], 4);
  };
} });
let wt = 0;
function An() {
