import { u as V } from "./E3CMvukU.js";
import { d, v as c, a as f, B as v, x as g, j as h, o as p, t as E, h as w, ay as b, az as _, aH as $, aU as I, s as A, aJ as D } from "./Dzy_QPZd.js";
class m {
...
const N = m, B = { "data-allow-mismatch": "", "tabular-nums": "" }, M = d({ __name: "TweenedNumber", props: { value: { default: 0 }, decimals: { default: 0 }, duration: { default: 1e3 } }, setup(a) {
  ...
  function l(r, t) {
    ...
    function s() {
      const x = o.progress, T = o.currentValue;
      n.value = T, x < 1 && requestAnimationFrame(s);
    }
    s();
  }
  return (r, t) => (p(), h("span", B, E(w(u)), 1));
} }), F = Object.assign(M, { __name: "AnimatedTweenedNumber" }), U = d({ __name: "AmountInput", props: b({ decimals: { default: 0 }, min: { default: 0 } }, { modelValue: {}, modelModifiers: {} }), emits: ["update:modelValue"], setup(a) {
