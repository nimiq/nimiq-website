import { _ as q } from "./4PIkP2wK.js";
import { d as T, B as h, i as n, c as l, o as a, a as v, e as s, F as g, r as b, u as y, b as L, f as N, t as P, D as V } from "./C95QRNzc.js";
import { g as A } from "./CpsPJSKh.js";
import { _ as D } from "./iXO873XU.js";
import { e as F } from "./DEpc-rVb.js";
import "./CCkBGt8y.js";
import "./BPgVFFXt.js";
const M = { "mx-0": "", "px-0": "", "bg-neutral-0": "", "of-x-clip": "", "children:max-w-none": "" }, $ = { flex: "~ gap-6", "mx-auto": "", "w-max": "", "f-mt-lg": "" }, j = ["data-state"], z = ["onClick"], E = ["data-state", "onClick"], H = { text: "neutral-800 f-xs", px: "8 md:32 xl:48", "mt-auto": "", "nq-label": "" }, U = T({ __name: "index", props: A(), setup(k) {
  const w = k, r = h(1), i = h(), S = n(() => {
    var _a;
    return Array.from(((_a = i.value) == null ? void 0 : _a.querySelectorAll("li")) || []);
  }), { width: m } = F(), c = n(() => Math.min(0.872 * m.value, 684)), p = n(() => m.value - c.value), f = n(() => w.slice.items.length);
  function C(e) {
