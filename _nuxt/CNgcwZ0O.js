...
import { ak as ii, a as si, bC as an, d as oi, aq as ai, r as ci, B as ui, n as li, q as fi, p as hi, Q as di, o as pi } from "./B8biU-UE.js";
...
function cr(t3, e) {
  for (var n = qe(t3), r = -1, i = e.length; ++r < i; ) n.add(e[r]);
}
function ur(t3, e) {
  for (var n = qe(t3), r = -1, i = e.length; ++r < i; ) n.remove(e[r]);
}
function hs(t3) {
  return function() {
    cr(this, t3);
...
function vs(t3, e) {
  var n = or(t3 + "");
  if (arguments.length < 2) {
    for (var r = qe(this.node()), i = -1, s = n.length; ++i < s; ) if (!r.contains(n[i])) return false;
    return true;
  }
...
M.prototype = kt.prototype = { constructor: M, select: _i, selectAll: bi, selectChild: Ti, selectChildren: Ri, filter: Ni, data: Fi, enter: Oi, exit: Bi, join: Di, merge: Hi, selection: Xs, order: Vi, sort: Wi, call: qi, nodes: Xi, node: Gi, size: Yi, empty: Zi, each: Ki, attr: rs, style: as, property: fs, classed: vs, text: ys, html: As, raise: Ss, lower: Es, append: $s, insert: Rs, remove: Os, clone: Ps, datum: Is, on: Hs, dispatch: Us, [Symbol.iterator]: qs };
function rt(t3) {
...
const Xe = (t3) => typeof t3 == "number", hr = (t3) => typeof t3 == "function", Ge = (t3) => Array.isArray(t3), to = (t3) => t3 instanceof Object, Qt = (t3) => t3.constructor.name !== "Function" && t3.constructor.name !== "Object", hn = (t3) => to(t3) && !Ge(t3) && !hr(t3) && !Qt(t3), Jt = (t3, e, n = [], r = /* @__PURE__ */ new Set()) => {
  if (Array.isArray(t3)) {
...
function Vu(t3, e, n, r) {
  const i = t3.map((a, c) => q(a, e, c) || 0), s = n.map((a, c) => {
    const u = Qs(t3, (l, f) => q(l, a, f) || 0);
...
function ro(t3, ...e) {
  return t3 ? fn(t3, (r, i) => fn(e, (s) => q(r, s, i))) : void 0;
}
function io(t3, ...e) {
  return t3 ? ln(t3, (r, i) => ln(e, (s) => q(r, s, i))) : void 0;
}
function Wu(t3, ...e) {
...
var j = function(t3) {
  ...
  !Dt && t3 > 0 && $e.start(), Dt += t3, !Dt && $e.stop();
}, Ao = function(t3) {
    ...
    default:
      ...
      switch (x += he(m), m * p) {
        ...
        case 44:
          ...
          break;
        case 64:
          D() === 45 && (x += Vt(z())), h = D(), l = f = L(_ = x += Uo(Ht())), m++;
          break;
        case 45:
          v === 45 && L(x) == 2 && (p = 0);
      }
...
function Xo(t3, e, n) {
  return pe(t3, e, n, wr, he(Bo()), Ct(t3, 2, -2), 0);
}
...
var Qo = function(e, n, r) {
  for (var i = 0, s = 0; i = s, s = D(), i === 38 && s === 12 && (n[r] = 1), !St(s); ) z();
  return Rt(e, O);
}, Jo = function(e, n) {
  var r = -1, i = 44;
  do
...
var Tt = 0.7, ie = 1 / Tt, ot = "\\s*([+-]?\\d+)\\s*", Et = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*", H = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*", _a = /^#([0-9a-f]{3,8})$/, ya = new RegExp(`^rgb\\(${ot},${ot},${ot}\\)$`), wa = new RegExp(`^rgb\\(${H},${H},${H}\\)$`), xa = new RegExp(`^rgba\\(${ot},${ot},${ot},${Et}\\)$`), ba = new RegExp(`^rgba\\(${H},${H},${H},${Et}\\)$`), Aa = new RegExp(`^hsl\\(${Et},${H},${H}\\)$`), Ca = new RegExp(`^hsla\\(${Et},${H},${H},${Et}\\)$`), zn = { aliceblue: 15792383, antiquewhite: 16444375, aqua: 65535, aquamarine: 8388564, azure: 15794175, beige: 16119260, bisque: 16770244, black: 0, blanchedalmond: 16772045, blue: 255, blueviolet: 9055202, brown: 10824234, burlywood: 14596231, cadetblue: 6266528, chartreuse: 8388352, chocolate: 13789470, coral: 16744272, cornflowerblue: 6591981, cornsilk: 16775388, crimson: 14423100, cyan: 65535, darkblue: 139, darkcyan: 35723, darkgoldenrod: 12092939, darkgray: 11119017, darkgreen: 25600, darkgrey: 11119017, darkkhaki: 12433259, darkmagenta: 9109643, darkolivegreen: 5597999, darkorange: 16747520, darkorchid: 10040012, darkred: 9109504, darksalmon: 15308410, darkseagreen: 9419919, darkslateblue: 4734347, darkslategray: 3100495, darkslategrey: 3100495, darkturquoise: 52945, darkviolet: 9699539, deeppink: 16716947, deepskyblue: 49151, dimgray: 6908265, dimgrey: 6908265, dodgerblue: 2003199, firebrick: 11674146, floralwhite: 16775920, forestgreen: 2263842, fuchsia: 16711935, gainsboro: 14474460, ghostwhite: 16316671, gold: 16766720, goldenrod: 14329120, gray: 8421504, green: 32768, greenyellow: 11403055, grey: 8421504, honeydew: 15794160, hotpink: 16738740, indianred: 13458524, indigo: 4915330, ivory: 16777200, khaki: 15787660, lavender: 15132410, lavenderblush: 16773365, lawngreen: 8190976, lemonchiffon: 16775885, lightblue: 11393254, lightcoral: 15761536, lightcyan: 14745599, lightgoldenrodyellow: 16448210, lightgray: 13882323, lightgreen: 9498256, lightgrey: 13882323, lightpink: 16758465, lightsalmon: 16752762, lightseagreen: 2142890, lightskyblue: 8900346, lightslategray: 7833753, lightslategrey: 7833753, lightsteelblue: 11584734, lightyellow: 16777184, lime: 65280, limegreen: 3329330, linen: 16445670, magenta: 16711935, maroon: 8388608, mediumaquamarine: 6737322, mediumblue: 205, mediumorchid: 12211667, mediumpurple: 9662683, mediumseagreen: 3978097, mediumslateblue: 8087790, mediumspringgreen: 64154, mediumturquoise: 4772300, mediumvioletred: 13047173, midnightblue: 1644912, mintcream: 16121850, mistyrose: 16770273, moccasin: 16770229, navajowhite: 16768685, navy: 128, oldlace: 16643558, olive: 8421376, olivedrab: 7048739, orange: 16753920, orangered: 16729344, orchid: 14315734, palegoldenrod: 15657130, palegreen: 10025880, paleturquoise: 11529966, palevioletred: 14381203, papayawhip: 16773077, peachpuff: 16767673, peru: 13468991, pink: 16761035, plum: 14524637, powderblue: 11591910, purple: 8388736, rebeccapurple: 6697881, red: 16711680, rosybrown: 12357519, royalblue: 4286945, saddlebrown: 9127187, salmon: 16416882, sandybrown: 16032864, seagreen: 3050327, seashell: 16774638, sienna: 10506797, silver: 12632256, skyblue: 8900331, slateblue: 6970061, slategray: 7372944, slategrey: 7372944, snow: 16775930, springgreen: 65407, steelblue: 4620980, tan: 13808780, teal: 32896, thistle: 14204888, tomato: 16737095, turquoise: 4251856, violet: 15631086, wheat: 16113331, white: 16777215, whitesmoke: 16119285, yellow: 16776960, yellowgreen: 10145074 };
Je(Ot, et, { copy(t3) {
...
function et(t3) {
  var e, n;
  return t3 = (t3 + "").trim().toLowerCase(), (e = _a.exec(t3)) ? (n = e[1].length, e = parseInt(e[1], 16), n === 6 ? In(e) : n === 3 ? new N(e >> 8 & 15 | e >> 4 & 240, e >> 4 & 15 | e & 240, (e & 15) << 4 | e & 15, 1) : n === 8 ? Ft(e >> 24 & 255, e >> 16 & 255, e >> 8 & 255, (e & 255) / 255) : n === 4 ? Ft(e >> 12 & 15 | e >> 8 & 240, e >> 8 & 15 | e >> 4 & 240, e >> 4 & 15 | e & 240, ((e & 15) << 4 | e & 15) / 255) : null) : (e = ya.exec(t3)) ? new N(e[1], e[2], e[3], 1) : (e = wa.exec(t3)) ? new N(e[1] * 255 / 100, e[2] * 255 / 100, e[3] * 255 / 100, 1) : (e = xa.exec(t3)) ? Ft(e[1], e[2], e[3], e[4]) : (e = ba.exec(t3)) ? Ft(e[1] * 255 / 100, e[2] * 255 / 100, e[3] * 255 / 100, e[4]) : (e = Aa.exec(t3)) ? Bn(e[1], e[2] / 100, e[3] / 100, 1) : (e = Ca.exec(t3)) ? Bn(e[1], e[2] / 100, e[3] / 100, e[4]) : zn.hasOwnProperty(t3) ? In(zn[t3]) : t3 === "transparent" ? new N(NaN, NaN, NaN, 0) : null;
}
function In(t3) {
...
Je(P, je, Nr(Ot, { brighter(t3) {
  ...
  return new P(Dn(this.h), Lt(this.s), Lt(this.l), se(this.opacity));
}, displayable() {
  return (0 <= this.s && this.s <= 1 || isNaN(this.s)) && 0 <= this.l && this.l <= 1 && 0 <= this.opacity && this.opacity <= 1;
}, formatHsl() {
  const t3 = se(this.opacity);
  return `${t3 === 1 ? "hsl(" : "hsla("}${Dn(this.h)}, ${Lt(this.s) * 100}%, ${Lt(this.l) * 100}%${t3 === 1 ? ")" : `, ${t3})`}`;
} }));
function Dn(t3) {
...
ue.prototype = Br.prototype = { constructor: ue, restart: function(t3, e, n) {
...
function Me(t3) {
  if (!ht) {
    ...
    var e = t3 - nt;
    e > 24 ? (t3 < 1 / 0 && (mt = setTimeout(Wn, t3 - $t.now() - ve)), vt && (vt = clearInterval(vt))) : (vt || (ce = $t.now(), vt = setInterval(Ha, Fr)), ht = 1, Lr(Wn));
  }
}
function Un(t3, e, n) {
  var r = new ue();
...
var Wa = Ir("start", "end", "cancel", "interrupt"), Ua = [], Dr = 0, qn = 1, Pe = 2, qt = 3, Xn = 4, Ie = 5, Xt = 6;
function ge(t3, e, n, r, i, s) {
  var o = t3.__transition;
  if (!o) t3.__transition = {};
  else if (n in o) return;
  qa(t3, n, { name: e, index: r, group: i, on: Wa, tween: Ua, time: s.time, delay: s.delay, duration: s.duration, ease: s.ease, timer: null, state: Dr });
}
function en(t3, e) {
  var n = I(t3, e);
...
function qa(t3, e, n) {
  ...
  function o(u) {
    ...
    if (Un(function() {
      n.state === qt && (n.state = Xn, n.timer.restart(a, n.delay, n.time), a(u));
    }), n.state = Pe, n.on.call("start", t3, t3.__data__, n.index, n.group), n.state === Pe) {
      for (n.state = qt, i = new Array(h = n.tween.length), l = 0, f = -1; l < h; ++l) (d = n.tween[l].value.call(t3, t3.__data__, n.index, n.group)) && (i[++f] = d);
      i.length = f + 1;
    }
  }
  function a(u) {
...
function Hr(t3, e) {
  ...
  if (n) {
    ...
    for (o in n) {
      ...
      i = r.state > Pe && r.state < Ie, r.state = Xt, r.timer.stop(), r.on.call(i ? "interrupt" : "cancel", t3, t3.__data__, r.index, r.group), delete n[o];
    }
...
function Wr(t3, e) {
  ...
  for (t3 = t3 + "", e = e + ""; (r = Fe.exec(t3)) && (i = Te.exec(e)); ) (s = i.index) > n && (s = e.slice(n, s), a[o] ? a[o] += s : a[++o] = s), (r = r[0]) === (i = i[0]) ? a[o] ? a[o] += i : a[++o] = i : (a[++o] = null, c.push({ i: o, x: B(r, i) })), n = Te.lastIndex;
...
function Ur(t3, e) {
  var n = typeof e, r;
  return e == null || n === "boolean" ? nn(e) : (n === "number" ? B : n === "string" ? (r = et(e)) ? (e = r, le) : Wr : e instanceof et ? le : e instanceof Date ? ja : Qa(e) ? Ka : Array.isArray(e) ? Ja : typeof e.valueOf != "function" && typeof e.toString != "function" || isNaN(e) ? tc : B)(t3, e);
}
var Gn = 180 / Math.PI, Le = { translateX: 0, translateY: 0, rotate: 0, skewX: 0, scaleX: 1, scaleY: 1 };
function qr(t3, e, n, r, i, s) {
  var o, a, c;
...
function rc(t3) {
  ...
  return e.isIdentity ? Le : qr(e.a, e.b, e.c, e.d, e.e, e.f);
}
function ic(t3) {
  return t3 == null || (Bt || (Bt = document.createElementNS("http://www.w3.org/2000/svg", "g")), Bt.setAttribute("transform", t3), !(t3 = Bt.transform.baseVal.consolidate())) ? Le : (t3 = t3.matrix, qr(t3.a, t3.b, t3.c, t3.d, t3.e, t3.f));
}
function Xr(t3, e, n, r) {
  function i(u) {
...
var sc = Xr(rc, "px, ", "px)", "deg)"), oc = Xr(ic, ", ", ")", ")");
function ac(t3, e) {
  var n, r;
  return function() {
...
function Gr(t3, e) {
  var n;
  return (typeof e == "number" ? B : e instanceof et ? le : (n = et(e)) ? (e = n, le) : Wr)(t3, e);
}
function lc(t3) {
  return function() {
    this.removeAttribute(t3);
...
var Hc = kt.prototype.constructor;
function Vc() {
...
function Gc(t3, e, n) {
  ...
  return e == null ? this.styleTween(t3, Wc(t3, r)).on("end.style." + t3, Yr(t3)) : typeof e == "function" ? this.styleTween(t3, qc(t3, r, rn(this, "style." + t3, e))).each(Xc(this._id, t3)) : this.styleTween(t3, Uc(t3, r, e), n).on("end.style." + t3, null);
}
function Yc(t3, e, n) {
  return function(r) {
...
function ru() {
  ...
  return new X(r, this._parents, t3, n);
}
function iu() {
...
var U = kt.prototype;
X.prototype = { constructor: X, select: Bc, selectAll: Dc, selectChild: U.selectChild, selectChildren: U.selectChildren, filter: Oc, merge: zc, selection: Vc, transition: ru, call: U.call, nodes: U.nodes, node: U.node, size: U.size, empty: U.empty, each: U.each, on: Ic, attr: gc, attrTween: xc, style: Gc, styleTween: Kc, text: jc, textTween: nu, remove: Lc, tween: uc, delay: Cc, duration: Ec, ease: kc, easeVarying: Nc, end: iu, [Symbol.iterator]: U[Symbol.iterator] };
function ou(t3) {
...
`, Jr = Nt`
  ...
  pointer-events: none;
  user-select: none;
`, pu = Object.freeze(Object.defineProperty({ __proto__: null, hidden: De, nonInteractive: Jr, positionFixed: Qr, root: me, show: Be, tooltip: hu, variables: du }, Symbol.toStringTag, { value: "Module" }));
class jr {
  constructor(e = {}) {
  ...
  hide() {
    this.div.classed(Be, false).on("transitionend", () => {
      this.div.classed(De, !this._isShown);
    }), this._isShown = false;
  }
  display() {
    this.div.classed(De, false).classed(Be, true), this._isShown = true;
  }
  place(e) {
...
jr.selectors = pu;
var He = Math.PI, Ve = 2 * He, K = 1e-6, vu = Ve - K;
function We() {
...
We.prototype = gu.prototype = { constructor: We, moveTo: function(t3, e) {
  ...
  if (this._x1 === null) this._ += "M" + (this._x1 = t3) + "," + (this._y1 = e);
    ...
    var h = n - s, d = r - o, v = a * a + c * c, p = h * h + d * d, g = Math.sqrt(v), y = Math.sqrt(f), m = i * Math.tan((He - Math.acos((v + f - p) / (2 * g * y))) / 2), _ = m / y, T = m / g;
  ...
  this._x1 === null ? this._ += "M" + c + "," + u : (Math.abs(this._x1 - c) > K || Math.abs(this._y1 - u) > K) && (this._ += "L" + c + "," + u), n && (f < 0 && (f = f % Ve + Ve), f > vu ? this._ += "A" + n + "," + n + ",0,1," + l + "," + (t3 - o) + "," + (e - a) + "A" + n + "," + n + ",0,1," + l + "," + (this._x1 = c) + "," + (this._y1 = u) : f > K && (this._ += "A" + n + "," + n + ",0," + +(f >= He) + "," + l + "," + (this._x1 = t3 + n * Math.cos(i)) + "," + (this._y1 = e + n * Math.sin(i))));
...
function ku(t3, e = void 0, n = void 0, r = true, i = Mr, s = false) {
  const o = Array.isArray(t3) ? t3.map((f) => lt(Hn, f)) : [lt(Hn, t3)], a = o.map((f) => $u(f, e, r, i, s)), c = o[0];
