import { u as se } from "./ViQ2U2w0.js";
import { j as O, B as _, O as le, X as ht, M as ce, N as ae, aZ as tt, u as M, a0 as fe, aX as ue, a_ as de, d as Ot, Q as Ct, a$ as Nt, b as me, o as jt, w as It, E as pe, b0 as he, U as Yt, c as ge, a as we, m as ye, h as ve } from "./gdLxT4Lf.js";
import { c as Xt, u as qt, P as Ut, h as xe, l as be, i as Ae } from "./BI3535uL.js";
const Oe = ["top", "right", "bottom", "left"], Z = Math.min, T = Math.max, at = Math.round, ct = Math.floor, V = (t) => ({ x: t, y: t }), Ce = { left: "right", right: "left", bottom: "top", top: "bottom" }, Pe = { start: "end", end: "start" };
function yt(t, e, n) {
  return T(t, Z(e, n));
}
function X(t, e) {
...
function Bt(t, e, n) {
  ...
  const s = Y(e), r = St(e), l = Rt(r), c = q(e), a = s === "y", f = o.x + o.width / 2 - i.width / 2, u = o.y + o.height / 2 - i.height / 2, p = o[l] / 2 - i[l] / 2;
  let d;
  switch (c) {
    case "top":
...
async function rt(t, e) {
  var n;
  e === void 0 && (e = {});
  const { x: o, y: i, platform: s, rects: r, elements: l, strategy: c } = t, { boundary: a = "clippingAncestors", rootBoundary: f = "viewport", elementContext: u = "floating", altBoundary: p = false, padding: d = 0 } = X(e, t), m = Gt(d), g = l[p ? u === "floating" ? "reference" : "floating" : u], w = ut(await s.getClippingRect({ element: (n = await (s.isElement == null ? void 0 : s.isElement(g))) == null || n ? g : g.contextElement || await (s.getDocumentElement == null ? void 0 : s.getDocumentElement(l.floating)), boundary: a, rootBoundary: f, strategy: c })), v = u === "floating" ? { x: o, y: i, width: r.floating.width, height: r.floating.height } : r.reference, y = await (s.getOffsetParent == null ? void 0 : s.getOffsetParent(l.floating)), x = await (s.isElement == null ? void 0 : s.isElement(y)) ? await (s.getScale == null ? void 0 : s.getScale(y)) || { x: 1, y: 1 } : { x: 1, y: 1 }, A = ut(s.convertOffsetParentRelativeRectToViewportRelativeRect ? await s.convertOffsetParentRelativeRectToViewportRelativeRect({ elements: l, rect: v, offsetParent: y, strategy: c }) : v);
...
const Te = (t) => ({ name: "arrow", options: t, async fn(e) {
  const { x: n, y: o, placement: i, rects: s, platform: r, elements: l, middlewareData: c } = e, { element: a, padding: f = 0 } = X(t, e) || {};
  if (a == null) return {};
  ...
  const C = x / 2 - A / 2, S = b / 2 - h[m] / 2 - 1, E = Z(u[w], S), R = Z(u[v], S), D = E, W = b - h[m] - R, $ = b / 2 - h[m] / 2 + C, k = yt(D, $, W), I = !c.arrow && it(i) != null && $ !== k && s.reference[m] / 2 - ($ < D ? E : R) - h[m] / 2 < 0, L = I ? $ < D ? $ - D : $ - W : 0;
  return { [d]: p[d] + L, data: { [d]: k, centerOffset: $ - k - L, ...I && { alignmentOffset: L } }, reset: I };
} }), Be = function(t) {
  return t === void 0 && (t = {}), { name: "flip", options: t, async fn(e) {
    var n, o;
    const { placement: i, middlewareData: s, rects: r, initialPlacement: l, platform: c, elements: a } = e, { mainAxis: f = true, crossAxis: u = true, fallbackPlacements: p, fallbackStrategy: d = "bestFit", fallbackAxisSideDirection: m = "none", flipAlignment: h = true, ...g } = X(t, e);
    if ((n = s.arrow) != null && n.alignmentOffset) return {};
    const w = q(i), v = Y(l), y = q(l) === l, x = await (c.isRTL == null ? void 0 : c.isRTL(a.floating)), A = p || (y || !h ? [ft(l)] : Se(l)), P = m !== "none";
    ...
    if (E = [...E, { placement: i, overflows: S }], !S.every((k) => k <= 0)) {
      var R, D;
      const k = (((R = s.flip) == null ? void 0 : R.index) || 0) + 1, I = b[k];
      if (I) {
        var W;
        const U = u === "alignment" ? v !== Y(I) : false, H = ((W = E[0]) == null ? void 0 : W.overflows[0]) > 0;
        if (!U || H) return { data: { index: k, overflows: E }, reset: { placement: I } };
      }
      let L = (D = E.filter((U) => U.overflows[0] <= 0).sort((U, H) => U.overflows[1] - H.overflows[1])[0]) == null ? void 0 : D.placement;
      if (!L) switch (d) {
        case "bestFit": {
          var $;
          const U = ($ = E.filter((H) => {
...
const $e = function(t) {
  return t === void 0 && (t = {}), { name: "hide", options: t, async fn(e) {
    const { rects: n } = e, { strategy: o = "referenceHidden", ...i } = X(t, e);
    switch (o) {
...
async function Me(t, e) {
  const { placement: n, platform: o, elements: i } = t, s = await (o.isRTL == null ? void 0 : o.isRTL(i.floating)), r = q(n), l = it(n), c = Y(n) === "y", a = ["left", "top"].includes(r) ? -1 : 1, f = s && c ? -1 : 1, u = X(e, t);
...
const Fe = function(t) {
  ...
  return t === void 0 && (t = {}), { name: "shift", options: t, async fn(e) {
    const { x: n, y: o, placement: i } = e, { mainAxis: s = true, crossAxis: r = false, limiter: l = { fn: (g) => {
      let { x: w, y: v } = g;
      return { x: w, y: v };
    } }, ...c } = X(t, e), a = { x: n, y: o }, f = await rt(e, c), u = Y(q(i)), p = Pt(u);
    let d = a[p], m = a[u];
    if (s) {
  ...
  return t === void 0 && (t = {}), { options: t, fn(e) {
    const { x: n, y: o, placement: i, rects: s, middlewareData: r } = e, { offset: l = 0, mainAxis: c = true, crossAxis: a = true } = X(t, e), f = { x: n, y: o }, u = Y(i), p = Pt(u);
    let d = f[p], m = f[u];
    const h = X(l, e), g = typeof h == "number" ? { mainAxis: h, crossAxis: 0 } : { mainAxis: 0, crossAxis: 0, ...h };
    if (c) {
    ...
    if (a) {
      var w, v;
      const y = p === "y" ? "width" : "height", x = ["top", "left"].includes(q(i)), A = s.reference[u] - s.floating[y] + (x && ((w = r.offset) == null ? void 0 : w[u]) || 0) + (x ? 0 : g.crossAxis), P = s.reference[u] + s.reference[y] + (x ? 0 : ((v = r.offset) == null ? void 0 : v[u]) || 0) - (x ? g.crossAxis : 0);
      m < A ? m = A : m > P && (m = P);
    }
    return { [p]: d, [u]: m };
  } };
  ...
  return t === void 0 && (t = {}), { name: "size", options: t, async fn(e) {
    ...
    }, ...a } = X(t, e), f = await rt(e, a), u = q(i), p = it(i), d = Y(i) === "y", { width: m, height: h } = s.floating;
    let g, w;
    u === "top" || u === "bottom" ? (g = u, w = p === (await (r.isRTL == null ? void 0 : r.isRTL(l.floating)) ? "start" : "end") ? "left" : "right") : (w = u, g = p === "end" ? "top" : "bottom");
    const v = h - f.top - f.bottom, y = m - f.left - f.right, x = Z(h - f[g], v), A = Z(m - f[w], y), P = !e.middlewareData.shift;
    let b = x, C = A;
    if ((n = e.middlewareData.shift) != null && n.enabled.x && (C = y), (o = e.middlewareData.shift) != null && o.enabled.y && (b = v), P && !p) {
      const E = T(f.left, 0), R = T(f.right, 0), D = T(f.top, 0), W = T(f.bottom, 0);
      d ? C = m - 2 * (E !== 0 || R !== 0 ? E + R : T(f.left, f.right)) : b = h - 2 * (D !== 0 || W !== 0 ? D + W : T(f.top, f.bottom));
    }
...
function Zt(t) {
  const e = K(t);
  return ot(e) ? t.ownerDocument ? t.ownerDocument.body : t.body : N(e) && lt(e) ? e : Zt(e);
}
function st(t, e, n) {
  var o;
  e === void 0 && (e = []), n === void 0 && (n = true);
  const i = Zt(t), s = i === ((o = t.ownerDocument) == null ? void 0 : o.body), r = B(i);
  if (s) {
    const l = xt(r);
...
function Q(t, e, n, o) {
  ...
  const l = je(s, n, o) ? Qt(s) : V(0);
  let c = (i.left + l.x) / r.x, a = (i.top + l.y) / r.y, f = i.width / r.x, u = i.height / r.y;
  if (s) {
    const p = B(s), d = o && F(o) ? B(o) : o;
    let m = p, h = xt(m);
    for (; h && o && d !== m; ) {
      const g = nt(h), w = h.getBoundingClientRect(), v = z(h), y = w.left + (h.clientLeft + parseFloat(v.paddingLeft)) * g.x, x = w.top + (h.clientTop + parseFloat(v.paddingTop)) * g.y;
...
function Jt(t, e, n) {
  n === void 0 && (n = false);
  const o = t.getBoundingClientRect(), i = o.left + e.scrollLeft - (n ? 0 : Tt(t, o)), s = o.top + e.scrollTop;
  return { x: i, y: s };
}
function Ie(t) {
  ...
  const f = V(0), u = N(o);
  if ((u || !u && !s) && ((J(o) !== "body" || lt(r)) && (c = pt(o)), N(o))) {
    const d = Q(o);
    a = nt(o), f.x = d.x + o.clientLeft, f.y = d.y + o.clientTop;
  }
  const p = r && !u && !s ? Jt(r, c, true) : V(0);
...
function Xe(t) {
  const e = j(t), n = pt(t), o = t.ownerDocument.body, i = T(e.scrollWidth, e.clientWidth, o.scrollWidth, o.clientWidth), s = T(e.scrollHeight, e.clientHeight, o.scrollHeight, o.clientHeight);
...
function Ue(t, e) {
  const n = Q(t, true, e === "fixed"), o = n.top + t.clientTop, i = n.left + t.clientLeft, s = N(t) ? nt(t) : V(1), r = t.clientWidth * s.x, l = t.clientHeight * s.y, c = i * s.x, a = o * s.y;
  return { width: r, height: l, x: c, y: a };
}
function zt(t, e, n) {
  let o;
  if (e === "viewport") o = qe(t, n);
  else if (e === "document") o = Xe(j(t));
...
function te(t, e) {
  const n = K(t);
  return n === e || !F(n) || ot(n) ? false : z(n).position === "fixed" || te(n, e);
}
function Ge(t, e) {
  const n = e.get(t);
  if (n) return n;
  ...
  for (; F(r) && !ot(r); ) {
    const l = z(r), c = Dt(r);
    !c && l.position === "fixed" && (i = null), (s ? !c && !i : !c && l.position === "static" && !!i && ["absolute", "fixed"].includes(i.position) || lt(r) && !c && te(t, r)) ? o = o.filter((f) => f !== r) : i = l, r = K(r);
  }
  return e.set(t, o), o;
}
function Ze(t) {
  ...
  const r = [...n === "clippingAncestors" ? mt(e) ? [] : Ge(e, this._c) : [].concat(n), o], l = r[0], c = r.reduce((a, f) => {
    const u = zt(e, f, i);
    return a.top = T(u.top, a.top), a.right = Z(u.right, a.right), a.bottom = Z(u.bottom, a.bottom), a.left = T(u.left, a.left), a;
  }, zt(e, l, i));
...
function Qe(t, e, n) {
  const o = N(e), i = j(e), s = n === "fixed", r = Q(t, true, s, e);
  let l = { scrollLeft: 0, scrollTop: 0 };
  const c = V(0);
  function a() {
    c.x = Tt(i);
  }
  if (o || !o && !s) if ((J(e) !== "body" || lt(i)) && (l = pt(e)), o) {
    const d = Q(e, true, s, e);
    c.x = d.x + e.clientLeft, c.y = d.y + e.clientTop;
  } else i && a();
  s && !o && i && a();
  const f = i && !o && !s ? Jt(i, l) : V(0), u = r.left + l.scrollLeft - c.x - f.x, p = r.top + l.scrollTop - c.y - f.y;
...
function Wt(t, e) {
  if (!N(t) || z(t).position === "fixed") return null;
  if (e) return e(t);
...
function ee(t, e) {
  ...
  let o = Wt(t, e);
  for (; o && _e(o) && gt(o); ) o = Wt(o, e);
  return o && ot(o) && gt(o) && !Dt(o) ? n : o || Ve(t) || n;
}
...
const en = { convertOffsetParentRelativeRectToViewportRelativeRect: Ie, getDocumentElement: j, getClippingRect: Ze, getOffsetParent: ee, getElementRects: Je, getClientRects: Ye, getDimensions: Ke, getScale: nt, isElement: F, isRTL: tn };
function ne(t, e) {
...
function nn(t, e) {
  ...
  function r(l, c) {
    ...
    if (l || e(), !p || !d) return;
    const m = ct(u), h = ct(i.clientWidth - (f + p)), g = ct(i.clientHeight - (u + d)), w = ct(f), y = { rootMargin: -m + "px " + -h + "px " + -g + "px " + -w + "px", threshold: T(0, Z(1, c)) || 1 };
    let x = true;
    function A(P) {
...
function on(t, e, n, o) {
  o === void 0 && (o = {});
  const { ancestorScroll: i = true, ancestorResize: s = true, elementResize: r = typeof ResizeObserver == "function", layoutShift: l = typeof IntersectionObserver == "function", animationFrame: c = false } = o, a = kt(t), f = i || s ? [...a ? st(a) : [], ...st(e)] : [];
  f.forEach((w) => {
...
const rn = Fe, sn = ze, Ht = Be, ln = He, cn = $e, an = Te, fn = We, un = (t, e, n) => {
...
function pn(t, e, n) {
  ...
  }), a = O(() => bt(t.value)), f = O(() => bt(e.value)), u = _(0), p = _(0), d = _(l.value), m = _(r.value), h = le({}), g = _(false), w = O(() => {
    const b = { position: d.value, left: "0", top: "0" };
    if (!f.value) return b;
    const C = _t(f.value, u.value), S = _t(f.value, p.value);
...
const [ie, gn] = Xt("PopperRoot"), Rn = Ot({ inheritAttrs: false, __name: "PopperRoot", setup(t) {
  const e = _();
  ...
  const e = t, { forwardRef: n, currentElement: o } = qt(), i = ie();
  return Nt(() => {
    i.onAnchorChange(e.reference ?? o.value);
  }), (s, r) => (jt(), me(M(Ut), { ref: M(n), as: s.as, "as-child": s.asChild }, { default: It(() => [Ct(s.$slots, "default")]), _: 3 }, 8, ["as", "as-child"]));
} });
function wn(t) {
  return t !== null;
}
...
const xn = { side: "bottom", sideOffset: 0, align: "center", alignOffset: 0, arrowPadding: 0, avoidCollisions: true, collisionBoundary: () => [], collisionPadding: 0, sticky: "partial", hideWhenDetached: false, positionStrategy: "fixed", updatePositionStrategy: "optimized", prioritizePosition: false }, [En, bn] = Xt("PopperContent"), Dn = Ot({ inheritAttrs: false, __name: "PopperContent", props: he({ side: {}, sideOffset: {}, align: {}, alignOffset: {}, avoidCollisions: { type: Boolean }, collisionBoundary: {}, collisionPadding: {}, arrowPadding: {}, sticky: {}, hideWhenDetached: { type: Boolean }, positionStrategy: {}, updatePositionStrategy: {}, disableUpdateOnLayoutShift: { type: Boolean }, prioritizePosition: { type: Boolean }, reference: {}, asChild: { type: Boolean }, as: {} }, { ...xn }), emits: ["placed"], setup(t, { emit: e }) {
  const n = t, o = e, i = ie(), { forwardRef: s, currentElement: r } = qt(), l = _(), c = _(), { width: a, height: f } = vn(c), u = O(() => n.side + (n.align !== "center" ? `-${n.align}` : "")), p = O(() => typeof n.collisionPadding == "number" ? n.collisionPadding : { top: 0, right: 0, bottom: 0, left: 0, ...n.collisionPadding }), d = O(() => Array.isArray(n.collisionBoundary) ? n.collisionBoundary : [n.collisionBoundary]), m = O(() => ({ padding: p.value, boundary: d.value.filter(wn), altBoundary: d.value.length > 0 })), h = be(() => [rn({ mainAxis: n.sideOffset + f.value, alignmentAxis: n.alignOffset }), n.prioritizePosition && n.avoidCollisions && Ht({ ...m.value }), n.avoidCollisions && sn({ mainAxis: true, crossAxis: !!n.prioritizePosition, limiter: n.sticky === "partial" ? fn() : void 0, ...m.value }), !n.prioritizePosition && n.avoidCollisions && Ht({ ...m.value }), ln({ ...m.value, apply: ({ elements: R, rects: D, availableWidth: W, availableHeight: $ }) => {
    const { width: k, height: I } = D.reference, L = R.floating.style;
    L.setProperty("--reka-popper-available-width", `${W}px`), L.setProperty("--reka-popper-available-height", `${$}px`), L.setProperty("--reka-popper-anchor-width", `${k}px`), L.setProperty("--reka-popper-anchor-height", `${I}px`);
