import { u as w } from "./BhpWC2zv.js";
import { d as y, i as D, c as T, o as S, e as r, T as $, t as g, u as p } from "./C95QRNzc.js";
import { g as l, c as j, h as A } from "./CCkBGt8y.js";
const B = { flex: "~ items-center gap-x-16 wrap", text: "12 neutral", "nq-label": "" }, v = ["datetime"], E = { flex: "~ gap-1ch", "not-italic": "" }, I = { "text-blue": "" }, L = y({ __name: "ArticleMetadata", props: { date: {}, authors: {} }, setup(t) {
  ...
  return (i, o) => (S(), T("div", B, [r("time", { datetime: p(a) }, g(p(a)), 9, v), r("address", E, [o[0] || (o[0] = r("span", { "text-neutral-800": "" }, "by", -1)), r("span", I, g(i.authors), 1)]), $(i.$slots, "after")]));
} }), C = Object.assign(L, { __name: "ArticleMetadata" });
function N({ data: t, uid: s }) {
  ...
  const _ = `/blog/${s}`, b = new Date(t.publish_date), c = t.image || t.meta_image, M = j(c);
