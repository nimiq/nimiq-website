import { u as T } from "./ZiJUCFG6.js";
import { d, B as c, j as f, E as g, X as h, c as v, o as w, t as b, u as V, af as x, ag as $, aj as I, b5 as A, m as D, al as N } from "./gdLxT4Lf.js";
class m {
...
const B = m, M = { "data-allow-mismatch": "", "tabular-nums": "" }, C = d({ __name: "TweenedNumber", props: { value: { default: 0 }, decimals: { default: 0 }, duration: { default: 1e3 } }, setup(a) {
...
} }), y = Object.assign(C, { __name: "AnimatedTweenedNumber" }), U = d({ __name: "AmountInput", props: x({ decimals: { default: 0 }, min: { default: 0 } }, { modelValue: {}, modelModifiers: {} }), emits: ["update:modelValue"], setup(a) {
  ...
  return g(r), (t, o) => I((w(), v("input", D({ "onUpdate:modelValue": o[0] || (o[0] = (s) => N(u) ? u.value = s : null), type: "text", style: { "field-sizing": "content" }, "focus-visible:outline": "1 solid blue", "font-semibold": "", "lh-none": "", "px-12": "", "rounded-2": "", "bg-transparent": "", "nq-input-box": "", inputmode: "decimal" }, t.$attrs, { onBlur: r }), null, 16)), [[A, V(u)]]);
} }), F = Object.assign(U, { __name: "AmountInput" });
export {
  y as _,
  F as a
};
