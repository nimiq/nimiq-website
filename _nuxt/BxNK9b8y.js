import { bn as O, a as v, W as N, d as y, X as S, S as w, $ as D, e as C, o as A, f as g, Q as _, h as o, R, a2 as q, a0 as M, v as k, x as K, B as P, bk as j, g as z, s as L, l as U, a6 as X, K as Q } from "./BdODHn_3.js";
import { i as W } from "./CHIgUVhi.js";
import { u as G } from "./DPSHcICq.js";
function J(t, n) {
  return W(t) ? false : Array.isArray(t) ? t.some((a) => O(a, n)) : O(t, n);
}
...
function te(t, n) {
  const a = v(() => Z(t)), e = N(t, "modelValue", n, { defaultValue: ee(t), passive: t.modelValue === void 0, deep: true });
  function l(d) {
...
const [E, ae] = D("AccordionRoot"), ve = y({ __name: "AccordionRoot", props: { collapsible: { type: Boolean, default: false }, disabled: { type: Boolean, default: false }, dir: {}, orientation: { default: "vertical" }, unmountOnHide: { type: Boolean, default: true }, asChild: { type: Boolean }, as: {}, type: {}, modelValue: {}, defaultValue: {} }, emits: ["update:modelValue"], setup(t, { emit: n }) {
  const a = t, e = n, { dir: l, disabled: i, unmountOnHide: d } = S(a), s = G(l), { modelValue: u, changeModelValue: p, isSingle: m } = te(a, e), { forwardRef: c, currentElement: f } = w();
  return ae({ disabled: i, direction: s, orientation: a.orientation, parentElement: f, isSingle: m, collapsible: a.collapsible, modelValue: u, changeModelValue: p, unmountOnHide: d }), (h, r) => (A(), C(o(R), { ref: o(c), "as-child": h.asChild, as: h.as }, { default: g(() => [_(h.$slots, "default", { modelValue: o(u) })]), _: 3 }, 8, ["as-child", "as"]));
...
function ie(t, n, a, e = {}) {
  ...
  const { arrowKeyOptions: l = "both", attributeName: i = "[data-reka-collection-item]", itemsArray: d = [], loop: s = true, dir: u = "ltr", preventScroll: p = true, focus: m = false } = e, [c, f, h, r, b, x] = [t.key === "ArrowRight", t.key === "ArrowLeft", t.key === "ArrowUp", t.key === "ArrowDown", t.key === "Home", t.key === "End"], B = h || r, $ = c || f;
...
const [H, se] = D("AccordionItem"), me = y({ __name: "AccordionItem", props: { disabled: { type: Boolean }, value: {}, unmountOnHide: { type: Boolean }, asChild: { type: Boolean }, as: {} }, setup(t, { expose: n }) {
  const a = t, e = E(), l = v(() => e.isSingle.value ? a.value === e.modelValue.value : Array.isArray(e.modelValue.value) && e.modelValue.value.includes(a.value)), i = v(() => e.disabled.value || a.disabled), d = v(() => i.value ? "" : void 0), s = v(() => l.value ? "open" : "closed");
  n({ open: l, dataDisabled: d });
  const { currentRef: u, currentElement: p } = w();
  se({ open: l, dataState: s, disabled: i, dataDisabled: d, triggerId: "", currentRef: u, currentElement: p, value: v(() => a.value) });
  function m(c) {
    var _a;
    const f = c.target;
