import { a as N, u as w, c as D, P as R, b as S, s as P, f as q } from "./BI3535uL.js";
import { ar as O, j as m, d as y, T, b as C, o as A, w as g, Q as _, u as o, V as j, B as k, X as K, E as z, a as L, m as U, f as X, a1 as Q } from "./gdLxT4Lf.js";
import { i as G } from "./CHIgUVhi.js";
import { u as J } from "./BgZlBkZ2.js";
function W(t, n) {
  return G(t) ? false : Array.isArray(t) ? t.some((a) => O(a, n)) : O(t, n);
}
...
const [E, ae] = D("AccordionRoot"), ve = y({ __name: "AccordionRoot", props: { collapsible: { type: Boolean, default: false }, disabled: { type: Boolean, default: false }, dir: {}, orientation: { default: "vertical" }, unmountOnHide: { type: Boolean, default: true }, asChild: { type: Boolean }, as: {}, type: {}, modelValue: {}, defaultValue: {} }, emits: ["update:modelValue"], setup(t, { emit: n }) {
  const a = t, e = n, { dir: l, disabled: i, unmountOnHide: r } = T(a), s = J(l), { modelValue: u, changeModelValue: p, isSingle: v } = te(a, e), { forwardRef: c, currentElement: f } = w();
...
} }), [M, oe] = D("CollapsibleRoot"), ne = y({ __name: "CollapsibleRoot", props: { defaultOpen: { type: Boolean, default: false }, open: { type: Boolean, default: void 0 }, disabled: { type: Boolean }, unmountOnHide: { type: Boolean, default: true }, asChild: { type: Boolean }, as: {} }, emits: ["update:open"], setup(t, { expose: n, emit: a }) {
  const e = t, i = N(e, "open", a, { defaultValue: e.defaultOpen, passive: e.open === void 0 }), { disabled: r, unmountOnHide: s } = T(e);
