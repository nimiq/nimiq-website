import { d as C, a as h, j as i, o as r, k as m, h as n, q as F, t as g, g as L, p as G, n as M, v as N, B as X, l as $, e as I, av as W, aw as U, A as D, x as P, F as O, r as E, Z as J, ah as Z, f as Y, ax as Q } from "./BSLliBk6.js";
import { S as T, P as ee } from "./D0DW2WUk.js";
import { _ as R } from "./DlAUqK2U.js";
import { u as te } from "./DSIwmKJ7.js";
import { f as oe, g as ne, h as se } from "./FOZmO4jG.js";
import { c as re, u as ie } from "./CMlG4309.js";
const le = { relative: "" }, ae = ["width", "height"], ce = ["stroke", "cx", "cy", "r"], ue = ["stroke", "stroke-width", "stroke-dasharray", "cx", "cy", "r"], de = { "text-16": "", "font-bold": "", flex: "", "size-full": "", "items-center": "", "left-0": "", "top-0": "", "justify-center": "", absolute: "" }, be = { key: 0 }, me = { key: 1, "text-24": "", "i-nimiq:check-thin": "" }, he = C({ __name: "RadialProgress", props: { progress: {}, radius: {}, strokeWidth: {}, innerStrokeWidth: {}, innerStroke: {}, stroke: {} }, setup(t) {
...
} }), ke = Object.assign(he, { __name: "AlbatrossLiveviewRadialProgress" }), _e = { "text-24": "", "font-bold": "", "lh-none": "" }, pe = { "text-24": "", "mb-16": "" }, fe = C({ __name: "MacroBlock.client", props: { block: {} }, setup(t) {
...
const q = (t) => ge[ye(t)], we = 320, xe = 240, Be = C({ __name: "TransactionCanvas", props: { hashes: {} }, setup(t) {
  const e = t, u = 2 * Math.PI, c = N();
  return X(() => {
    if (!c.value) return;
    ...
    let _ = p, s = f;
    for (const k of e.hashes) l.beginPath(), l.arc(_, s, a, 0, u), l.fillStyle = q({ hash: k }), l.fill(), s -= b, s < a && (s = f, _ -= b);
  }), (l, o) => (r(), i("canvas", { ref_key: "canvas", ref: c, width: "320", height: "240" }, null, 512));
} }), Ne = Object.assign(Be, { __name: "AlbatrossLiveviewTransactionCanvas" }), Ce = { title: "Micro Block" }, Ae = { key: 0, text: "12 white center", "mt--22": "", "py-4": "", "rounded-t-8": "", "w-160": "", "bg-gradient-orange": "", "nq-label": "" }, $e = { flex: "~ items-center justify-between", "text-15": "", "px-16": "", "pb-10": "", "pt-14": "" }, Me = { key: 0, "text-13": "", "font-semibold": "", "lh-none": "" }, Se = { key: 0, text: "neutral-700 13 center", "font-semibold": "", "mt-80": "", "grow-1": "" }, Fe = { key: 1, "grow-1": "" }, Le = { flex: "~ items-center justify-between gap-6", "pt-2": "", "w-full": "", text: "neutral-800 12" }, Oe = { "whitespace-nowrap": "" }, Ee = { key: 0, "whitespace-nowrap": "" }, je = 1102, Ie = C({ __name: "MicroBlock", props: { block: {} }, setup(t) {
...
const V = 20, Te = W(ve), We = { flex: "~ justify-end items-center" }, De = { key: 2, grid: "~ place-content-center", "i-custom:curly": "", "h-120pt": "", "min-w-120pt": "", text: "30pt neutral-700/85" }, Re = C({ __name: "Block", props: { block: {} }, setup(t) {
  return (e, u) => {
    const c = Te, l = Pe;
...
} }), qe = Object.assign(Re, { __name: "AlbatrossLiveviewBlock" });
function Ve() {
  ...
  P(a, (s) => {
    ...
    s.startsWith("[") && s.endsWith("]") ? t.value = JSON.parse(s) : t.value.length >= V && o(JSON.parse(s));
  });
  const d = h(() => {
    var _a;
...
const z = re(Ve), ze = { flex: "~ col wrap", h: "56 md:44" }, x = 60, Ke = C({ __name: "Batch.client", props: { batchNumber: {}, blockNumber: {} }, setup(t) {
  const e = t, u = ee, { microblocks: c } = z();
  function l(k) {
    const y = u + (e.batchNumber - 1) * x + k, w = c.value.find((v) => v.number === y);
    return (w == null ? void 0 : w.producer.publicKey) ? q({ publicKey: w.producer.publicKey }) : "rgb(var(--nq-neutral) / 1)";
  }
  const o = N(false), a = ie(o), b = h(() => {
  ...
  return (k, y) => (r(), i("div", { "max-w": "[calc(100vw-12px)] md:full", flex: "~ justify-between items-start", "px-16": "", "w-388": "", onClick: y[0] || (y[0] = () => n(a)()) }, [m("div", ze, [(r(true), i(O, null, E(n(d), (w) => (r(), i("div", { key: `micro-block-${w}`, "m-4": "", "rounded-2": "", "size-6": "", "inline-block": "", "transition-colors": "", style: F({ backgroundColor: n(o) ? l(w) : "rgb(var(--nq-neutral-800) / 1)" }) }, null, 4))), 128)), (r(true), i(O, null, E(n(b), (w) => (r(), i("div", { key: `micro-block-${n(d) + w}`, "m-4": "", "rounded-2": "", "bg-neutral-500": "", "size-6": "", "inline-block": "" }))), 128))]), m("div", { text: "14 neutral-900 center", flex: "~ justify-center col items-center", "font-bold": "", "ml-4": "", "rounded-8": "", "bg-neutral-600": "", "op-60": "", "shrink-0": "", "size-44": "", "transition-all": "", relative: "", class: M(n(_)) }, [y[1] || (y[1] = m("span", null, "M", -1)), m("span", { class: M(n(s)) }, g(k.batchNumber), 3)], 2)]));
} }), He = Object.assign(Ke, { __name: "AlbatrossLiveviewBatch" }), Ge = W(He), Xe = { flex: "~ justify-end items-center", "px-24": "", "min-h-208": "", "of-hidden": "" }, Ue = { key: 0, flex: "~ justify-center items-center", "font-bold": "", "min-h-224": "", "inset-0": "", absolute: "" }, Je = { key: 0, text: "f-lg white" }, Ze = { key: 1, text: "18 white", "px-32": "", "py-24": "", "rounded-4": "", "bg-red": "", shadow: "", ring: "1.5 red/3" }, Ye = { key: 1, flex: "~ justify-center", "px-32": "", "w-full": "", "of-hidden": "", "f-mt-lg": "" }, Qe = { flex: "~ justify-center" }, j = 208, et = 0.55, tt = C({ __name: "Blockchain", setup(t) {
  const { blocks: e, batchNumber: u, blockNumber: c, status: l } = z();
  let o = 0, a = e.value.length * j, b = null;
  const d = N(), p = N(), f = se(d), _ = N(false), s = N(false);
  function k() {
    if (b || !_.value) return;
    function v() {
  ...
  J(() => {
    const v = l.value === "OPEN" && e.value.length >= V && f.value;
  ...
  return (v, ot) => {
    const K = qe, H = Ge;
    return r(), i("div", { ref_key: "target", ref: d, relative: "", "of-x-clip": "" }, [m("div", Xe, [m("div", { ref_key: "chainElement", ref: p, flex: "~ justify-end items-center", style: { "will-change": "transform" } }, [L(Q, { tag: "div", flex: "~ justify-end items-center", "enter-from-class": "op-0", "enter-active-class": "transition-opacity duration-400 ease-in" }, { default: Y(() => [(r(true), i(O, null, E(n(e), (A) => (r(), I(K, { key: `block-${A.number}`, block: A, style: F({ width: j }) }, null, 8, ["block", "style"]))), 128))]), _: 1 })], 512)]), n(l) !== "OPEN" || n(e).length === 0 ? (r(), i("div", Ue, [n(l) === "CONNECTING" || n(e).length === 0 ? (r(), i("div", Je, " Loading... ")) : n(l) === "CLOSED" ? (r(), i("div", Ze, " We couldn't connect to the " + g(n(w)), 1)) : $("", true)])) : (r(), i("div", Ye, [m("div", Qe, [(r(), i(O, null, E(7, (A) => L(H, { key: `batch-${n(u) - 2 + A - 1}`, "batch-number": n(u) - 3 + A - 1, "block-number": n(c), class: "animate-batch-unshift" }, null, 8, ["batch-number", "block-number"])), 64))])]))], 512);
  };
