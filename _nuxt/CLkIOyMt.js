import { Z as hr, $ as pr, a0 as mr, a1 as _n, a2 as vr, d as K, e as O, o as A, f as _, l as dt, J as Dt, h, P as At, s as _t, a3 as us, a4 as gr, a5 as ee, j as yr, r as R, t as cs, a6 as ds, a as F, a7 as Gt, k as Hn, m as fs, a8 as br, g as M, z as wr, a9 as xr, aa as Tr, ab as Sr, y as Kn, ac as Ei, ad as hs, ae as Xe, x as j, n as oe, B as L, H as at, af as Pr, Q as Pt, T as Ye, C as k, E as z, ag as Pe, G as lt, w as $t, I as ht, D as Mt, ah as _r, ai as Ar, A as Mr, v as Ze, aj as Cr, ak as ps, q as ms, al as vs, p as gs, am as kr, an as Er, F as an, u as Dr, ao as Vr, ap as Rr, aq as Lr, ar as Or, as as $r, at as Br, au as Ir, av as Fr, aw as jr, ax as Nr, ay as Ur, az as zr } from "./B8biU-UE.js";
import { a as ys, b as bs } from "./DRbUa3ZN.js";
import { u as Wn, S as I } from "./C01oBEpG.js";
import { _ as Hr, a as Kr, b as Wr } from "./CxNn5mIg.js";
import { u as ws, _ as Gr, a as qr, b as Xr, c as Yr } from "./Do5eQmpX.js";
import { _ as Zr } from "./DnvL1dhk.js";
import { _ as Gn } from "./DlAUqK2U.js";
import { _ as Jr } from "./CDGVCZAD.js";
import { r as Qr } from "./B5vKjtsS.js";
import { u as _e } from "./DPuYpcc3.js";
import { u as tl } from "./DIegsOBI.js";
import { _ as el } from "./CfRIQ3dD.js";
import { b as nl, d as il, e as ol, f as sl, a as al } from "./DOgGst0G.js";
import { u as rl } from "./C_osuW3n.js";
import { _ as ll } from "./CmnqzRqC.js";
import { g as xs } from "./BzRmGp1f.js";
import { _ as ul } from "./DiY6giUn.js";
import "./CoPlYyca.js";
import "./CHIgUVhi.js";
import "./Fc1-Bd8L.js";
import "./D-k9HlQ8.js";
...
const [qt, vl] = Hn(["NavigationMenuRoot", "NavigationMenuSub"], "NavigationMenuContext"), gl = K({ __name: "NavigationMenuRoot", props: { modelValue: { default: void 0 }, defaultValue: {}, dir: {}, orientation: { default: "horizontal" }, delayDuration: { default: 200 }, skipDelayDuration: { default: 300 }, disableClickTrigger: { type: Boolean, default: false }, disableHoverTrigger: { type: Boolean, default: false }, disablePointerLeaveClose: { type: Boolean }, unmountOnHide: { type: Boolean, default: true }, asChild: { type: Boolean }, as: { default: "nav" } }, emits: ["update:modelValue"], setup(t, { emit: e }) {
  const n = t, o = yr(n, "modelValue", e, { defaultValue: n.defaultValue ?? "", passive: n.modelValue === void 0 }), a = R(""), { forwardRef: s, currentElement: r } = _t(), l = R(), c = R(), u = R(), { getItems: d, CollectionSlot: f } = _e({ key: "NavigationMenu", isProvider: true }), { delayDuration: p, skipDelayDuration: m, dir: g, disableClickTrigger: w, disableHoverTrigger: T, unmountOnHide: y } = cs(n), v = tl(g), x = ds(false, m), b = F(() => o.value !== "" || x.value ? 150 : p.value), P = br((S) => {
...
const [Du, Vu] = Me("Motion"), [Ru, $m] = Me("LayoutGroup");
function Li(t) {
...
const ti = /* @__PURE__ */ new WeakMap(), [Nu, Bm] = Me("AnimatePresenceContext");
function Uu(t) {
...
const kp = [eh, uh, dh, ph, vh, sp, Cp, Ap, Mp], Ep = { reducedMotion: "never", transition: void 0, nonce: void 0 }, [Dp, Fm] = Me("MotionConfig");
function Vp() {
  return Dp(F(() => Ep));
}
function sn(t) {
...
const [Rp, jm] = Me("LazyMotionContext");
function Lp(t) {
...
} }), dm = Object.assign(Gn(cm, [["__scopeId", "data-v-eb703c99"]]), { __name: "NavigationFooter" }), fm = zr(Cl), hm = { "bottom-20": "", "right-20": "", fixed: "", "z-102": "" }, Nm = K({ __name: "default", props: { darkHeader: { type: Boolean, default: false }, footerBgColor: { default: "grey" }, draft: { type: Boolean }, showSocialsHexagonBg: { type: Boolean } }, async setup(t) {
  let e, n;
  const { data: i } = ([e, n] = $t(() => Ae()), e = await e, n(), e);
  return (o, a) => {
