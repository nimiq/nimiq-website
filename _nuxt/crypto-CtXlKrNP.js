...
(function() {
  ...
  (async () => {
    ...
    var re = "" + new URL("index_bg-DMJKx344.wasm", _documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === "SCRIPT" && _documentCurrentScript.src || new URL("_nuxt/crypto-CtXlKrNP.js", document.baseURI).href).href, oe = async (e = {}, t) => {
      let n;
