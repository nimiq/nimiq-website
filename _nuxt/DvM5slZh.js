import { d as E, r as x, n as V, p as G, T as g, e as J, o as Y, f as j, g as X, _ as Q, h as $ } from "./B8biU-UE.js";
import { g as W } from "./CqkleIqs.js";
import { c as K } from "./ClMfwJO2.js";
const A = (s, e = 16) => {
  let t = 0, i = null;
  return function(...r) {
...
class we extends fe {
  ...
  async ready() {
    ...
    this._ready = false;
    const e = this.createRequestMessage(b.Ready, void 0), t = await this.postRequest(e, (i) => {
...
var ye = Object.defineProperty, be = (s, e, t) => e in s ? ye(s, e, { enumerable: true, configurable: true, writable: true, value: t }) : s[e] = t, D = (s, e, t) => (be(s, typeof e != "symbol" ? e + "" : e, t), t), F, L;
...
const m = "slice-simulator", I = "slice-simulator--root", Me = () => document.querySelector(`.${m}`), De = () => document.querySelector(`.${I}`), Z = (s) => {
  ...
  const r = t[i + 1];
  return r || null;
}, T = () => ({ zIndex: 100, background: "#ffffff" }), U = () => [], Ee = () => "";
...
class Ne extends $e {
  constructor(e) {
    ...
    }), u(this, "setActiveSlice", A(this._setActiveSlice, 16)), this._slices = (e == null ? void 0 : e.slices) || U(), this._activeSlice = null, this._message = "", this._mouse = { x: 0, y: 0 };
  }
  set slices(e) {
...
var Ze = Object.defineProperty, Ue = (s, e, t) => e in s ? Ze(s, e, { enumerable: true, configurable: true, writable: true, value: t }) : s[e] = t, w = (s, e, t) => (Ue(s, typeof e != "symbol" ? e + "" : e, t), t);
class He {
  constructor(e) {
...
}, d = new He(), Ge = E({ name: "SliceSimulator", props: { zIndex: { type: Number, default: T().zIndex, required: false }, background: { type: String, default: T().background, required: false } }, setup(s, { slots: e }) {
  const t = x(U()), i = x(Ee());
  return V(() => {
    ...
    const r = [];
    return i.value ? r.push(g("article", { innerHTML: i.value })) : t.value.length && e.default && r.push(g("div", { id: "root", class: I, onClickCapture: Ve, onSubmitCapture: Be }, [e.default({ slices: t.value })])), g("div", { class: m, style: { zIndex: s.zIndex, position: "fixed", top: 0, left: 0, width: "100%", height: "100vh", overflow: "auto", background: s.background } }, r);
  };
} }), Je = Ge, Qe = E({ __name: "slice-simulator", setup(s) {
  return (e, t) => {
    const i = Q;
    return Y(), J($(Je), null, { default: j(({ slices: r }) => [X(i, { slices: r, components: $(K) }, null, 8, ["slices", "components"])]), _: 1 });
  };
} });
export {
  Qe as default
