...
import { b3 as U, j as z, aA as l, ar as M, b4 as E, z as F, b5 as R } from "./g1xKa6TI.js";
...
class S {
  ...
  _doProcessBlock(e, s) {
    ...
    for (let n = 0; n < 64; n++) {
      ...
      const D = c & y ^ ~c & g, A = o & a ^ o & i ^ a & i, j = (o << 30 | o >>> 2) ^ (o << 19 | o >>> 13) ^ (o << 10 | o >>> 22), O = (c << 26 | c >>> 6) ^ (c << 21 | c >>> 11) ^ (c << 7 | c >>> 25), m = _ + O + D + x[n] + d[n], b = j + A;
...
function I(r, e, s) {
  ...
  const { server: h, lazy: c, default: y, transform: g, pick: _, watch: n, immediate: D, getCachedData: A, deep: j, dedupe: O, ...m } = t, b = M({ ...E, ...m, cache: typeof t.cache == "boolean" ? void 0 : t.cache }), f = { server: h, lazy: c, default: y, transform: g, pick: _, immediate: D, getCachedData: A, deep: j, dedupe: O, watch: n === false ? [] : [...n || [], b] };
  let u;
