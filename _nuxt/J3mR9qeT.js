...
import { a0 as ii, j as si, aS as on, d as oi, ao as ai, B as ci, c as ui, E as li, a1 as fi, G as hi, L as di, o as pi } from "./ClGJWWej.js";
...
function Ti(t3) {
  return this.select(t3 == null ? Ci : Si(typeof t3 == "function" ? t3 : nr(t3)));
}
...
function js(t3, e, n) {
  ...
  function p() {
    ...
    !a && u && !l && w(), d(), u === void 0 && T > t3 ? a ? (h = Date.now(), s || (l = setTimeout(u ? C : w, t3))) : w() : s !== true && (l = setTimeout(u ? C : w, u === void 0 ? t3 - T : t3));
  }
  return p.cancel = v, p;
}
...
var j = function(t3) {
  ...
  return t3.connect = function(e, n) {
    ...
    xn(i.observationTargets, n) < 0 && (s && J.push(i), i.observationTargets.push(new So(n, r && r.box)), wn(1), Ee.schedule());
...
function Xo(t3) {
  return Cr(Vt("", null, null, null, [""], t3 = Sr(t3), 0, [0], t3));
}
function Vt(t3, e, n, r, i, s, o, a, c) {
  for (var u = 0, l = 0, f = o, h = 0, d = 0, v = 0, p = 1, g = 1, y = 1, m = 0, _ = "", T = i, w = s, C = r, x = _; g; ) switch (v = m, m = z()) {
    case 40:
      if (v != 108 && k(x, f - 1) == 58) {
    ...
    case 0:
      switch (m) {
        ...
        case 59:
          x += ";";
        default:
          if (Pt(C = bn(x, e, n, u, l, i, a, _, T = [], w = [], f), s), m === 123) if (l === 0) Vt(x, e, C, C, T, s, f, a, w);
          else switch (h === 99 && k(x, 3) === 110 ? 100 : h) {
            case 100:
            case 108:
            case 109:
            case 115:
              Vt(t3, C, C, r && Pt(bn(t3, C, C, 0, 0, i, a, _, i, T = [], f), w), i, w, f, a, r ? T : w);
              break;
            default:
              Vt(x, C, C, C, [""], w, 0, a, w);
          }
...
function ua(t3, e, n) {
  ...
  if (Array.isArray(n)) for (var i = 0; i < n.length; i++) r += ne(t3, e, n[i]) + ";";
    ...
    if (typeof o != "object") {
      var a = o;
      e != null && e[a] !== void 0 ? r += s + "{" + e[a] + "}" : Cn(a) && (r += we(s) + ":" + Tn(s, a) + ";");
    } else if (Array.isArray(o) && typeof o[0] == "string" && (e == null || e[o[0]] === void 0)) for (var c = 0; c < o.length; c++) Cn(o[c]) && (r += we(s) + ":" + Tn(s, o[c]) + ";");
    else {
      var u = ne(t3, e, o);
      switch (s) {
        case "animation":
...
var Ct = 0.7, re = 1 / Ct, ot = "\\s*([+-]?\\d+)\\s*", Tt = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*", H = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*", _a = /^#([0-9a-f]{3,8})$/, ya = new RegExp(`^rgb\\(${ot},${ot},${ot}\\)$`), wa = new RegExp(`^rgb\\(${H},${H},${H}\\)$`), xa = new RegExp(`^rgba\\(${ot},${ot},${ot},${Tt}\\)$`), ba = new RegExp(`^rgba\\(${H},${H},${H},${Tt}\\)$`), Aa = new RegExp(`^hsl\\(${Tt},${H},${H}\\)$`), Sa = new RegExp(`^hsla\\(${Tt},${H},${H},${Tt}\\)$`), On = { aliceblue: 15792383, antiquewhite: 16444375, aqua: 65535, aquamarine: 8388564, azure: 15794175, beige: 16119260, bisque: 16770244, black: 0, blanchedalmond: 16772045, blue: 255, blueviolet: 9055202, brown: 10824234, burlywood: 14596231, cadetblue: 6266528, chartreuse: 8388352, chocolate: 13789470, coral: 16744272, cornflowerblue: 6591981, cornsilk: 16775388, crimson: 14423100, cyan: 65535, darkblue: 139, darkcyan: 35723, darkgoldenrod: 12092939, darkgray: 11119017, darkgreen: 25600, darkgrey: 11119017, darkkhaki: 12433259, darkmagenta: 9109643, darkolivegreen: 5597999, darkorange: 16747520, darkorchid: 10040012, darkred: 9109504, darksalmon: 15308410, darkseagreen: 9419919, darkslateblue: 4734347, darkslategray: 3100495, darkslategrey: 3100495, darkturquoise: 52945, darkviolet: 9699539, deeppink: 16716947, deepskyblue: 49151, dimgray: 6908265, dimgrey: 6908265, dodgerblue: 2003199, firebrick: 11674146, floralwhite: 16775920, forestgreen: 2263842, fuchsia: 16711935, gainsboro: 14474460, ghostwhite: 16316671, gold: 16766720, goldenrod: 14329120, gray: 8421504, green: 32768, greenyellow: 11403055, grey: 8421504, honeydew: 15794160, hotpink: 16738740, indianred: 13458524, indigo: 4915330, ivory: 16777200, khaki: 15787660, lavender: 15132410, lavenderblush: 16773365, lawngreen: 8190976, lemonchiffon: 16775885, lightblue: 11393254, lightcoral: 15761536, lightcyan: 14745599, lightgoldenrodyellow: 16448210, lightgray: 13882323, lightgreen: 9498256, lightgrey: 13882323, lightpink: 16758465, lightsalmon: 16752762, lightseagreen: 2142890, lightskyblue: 8900346, lightslategray: 7833753, lightslategrey: 7833753, lightsteelblue: 11584734, lightyellow: 16777184, lime: 65280, limegreen: 3329330, linen: 16445670, magenta: 16711935, maroon: 8388608, mediumaquamarine: 6737322, mediumblue: 205, mediumorchid: 12211667, mediumpurple: 9662683, mediumseagreen: 3978097, mediumslateblue: 8087790, mediumspringgreen: 64154, mediumturquoise: 4772300, mediumvioletred: 13047173, midnightblue: 1644912, mintcream: 16121850, mistyrose: 16770273, moccasin: 16770229, navajowhite: 16768685, navy: 128, oldlace: 16643558, olive: 8421376, olivedrab: 7048739, orange: 16753920, orangered: 16729344, orchid: 14315734, palegoldenrod: 15657130, palegreen: 10025880, paleturquoise: 11529966, palevioletred: 14381203, papayawhip: 16773077, peachpuff: 16767673, peru: 13468991, pink: 16761035, plum: 14524637, powderblue: 11591910, purple: 8388736, rebeccapurple: 6697881, red: 16711680, rosybrown: 12357519, royalblue: 4286945, saddlebrown: 9127187, salmon: 16416882, sandybrown: 16032864, seagreen: 3050327, seashell: 16774638, sienna: 10506797, silver: 12632256, skyblue: 8900331, slateblue: 6970061, slategray: 7372944, slategrey: 7372944, snow: 16775930, springgreen: 65407, steelblue: 4620980, tan: 13808780, teal: 32896, thistle: 14204888, tomato: 16737095, turquoise: 4251856, violet: 15631086, wheat: 16113331, white: 16777215, whitesmoke: 16119285, yellow: 16776960, yellowgreen: 10145074 };
Qe(Nt, et, { copy(t3) {
  return Object.assign(new this.constructor(), this, t3);
}, displayable() {
  return this.rgb().displayable();
}, hex: zn, formatHex: zn, formatHex8: Ca, formatHsl: Ta, formatRgb: Mn, toString: Mn });
function zn() {
...
function et(t3) {
  var e, n;
  return t3 = (t3 + "").trim().toLowerCase(), (e = _a.exec(t3)) ? (n = e[1].length, e = parseInt(e[1], 16), n === 6 ? Pn(e) : n === 3 ? new N(e >> 8 & 15 | e >> 4 & 240, e >> 4 & 15 | e & 240, (e & 15) << 4 | e & 15, 1) : n === 8 ? It(e >> 24 & 255, e >> 16 & 255, e >> 8 & 255, (e & 255) / 255) : n === 4 ? It(e >> 12 & 15 | e >> 8 & 240, e >> 8 & 15 | e >> 4 & 240, e >> 4 & 15 | e & 240, ((e & 15) << 4 | e & 15) / 255) : null) : (e = ya.exec(t3)) ? new N(e[1], e[2], e[3], 1) : (e = wa.exec(t3)) ? new N(e[1] * 255 / 100, e[2] * 255 / 100, e[3] * 255 / 100, 1) : (e = xa.exec(t3)) ? It(e[1], e[2], e[3], e[4]) : (e = ba.exec(t3)) ? It(e[1] * 255 / 100, e[2] * 255 / 100, e[3] * 255 / 100, e[4]) : (e = Aa.exec(t3)) ? Ln(e[1], e[2] / 100, e[3] / 100, 1) : (e = Sa.exec(t3)) ? Ln(e[1], e[2] / 100, e[3] / 100, e[4]) : On.hasOwnProperty(t3) ? Pn(On[t3]) : t3 === "transparent" ? new N(NaN, NaN, NaN, 0) : null;
}
function Pn(t3) {
...
Qe(N, Re, Nr(Nt, { brighter(t3) {
  ...
  return t3 = t3 == null ? Ct : Math.pow(Ct, t3), new N(this.r * t3, this.g * t3, this.b * t3, this.opacity);
}, rgb() {
  return this;
}, clamp() {
...
Qe(P, Je, Nr(Nt, { brighter(t3) {
  ...
  return t3 = t3 == null ? Ct : Math.pow(Ct, t3), new P(this.h, this.s, this.l * t3, this.opacity);
}, rgb() {
...
var Ie = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g, Ce = new RegExp(Ie.source, "g");
function ec(t3) {
  return function() {
    return t3;
  };
...
function Wr(t3, e) {
  var n = Ie.lastIndex = Ce.lastIndex = 0, r, i, s, o = -1, a = [], c = [];
  for (t3 = t3 + "", e = e + ""; (r = Ie.exec(t3)) && (i = Ce.exec(e)); ) (s = i.index) > n && (s = e.slice(n, s), a[o] ? a[o] += s : a[++o] = s), (r = r[0]) === (i = i[0]) ? a[o] ? a[o] += i : a[++o] = i : (a[++o] = null, c.push({ i: o, x: B(r, i) })), n = Ce.lastIndex;
...
function Ec(t3) {
  var e = this._id;
  return arguments.length ? this.each((typeof t3 == "function" ? Cc : Tc)(e, t3)) : I(this.node(), e).duration;
}
function $c(t3, e) {
  if (typeof e != "function") throw new Error();
  return function() {
...
var U = $t.prototype;
q.prototype = { constructor: q, select: Bc, selectAll: Dc, selectChild: U.selectChild, selectChildren: U.selectChildren, filter: Oc, merge: zc, selection: Vc, transition: ru, call: U.call, nodes: U.nodes, node: U.node, size: U.size, empty: U.empty, each: U.each, on: Ic, attr: gc, attrTween: xc, style: Gc, styleTween: Kc, text: jc, textTween: nu, remove: Lc, tween: uc, delay: Sc, duration: Ec, ease: kc, easeVarying: Nc, end: iu, [Symbol.iterator]: U[Symbol.iterator] };
function ou(t3) {
...
const fu = { components: [], container: void 0, followCursor: true, allowHover: true, horizontalPlacement: S.Auto, horizontalShift: 0, verticalPlacement: S.Top, verticalShift: 0, attributes: {}, triggers: {}, className: void 0 }, ge = Rt`
  label: tooltip;
...
class jr {
  ...
  placeByElement(e) {
    ...
    const h = n.verticalPlacement === S.Auto ? l !== S.Center ? S.Center : u[1] - s < 0 ? S.Bottom : S.Top : n.verticalPlacement;
    let d = -s;
    switch (h) {
      case S.Center:
        d += (s + c.height) / 2;
  ...
  return Jn || (Jn = 1, function(t3) {
    (function(e) {
      ...
      function f(v, p) {
        ...
        let g = p.allowable_tags, y = p.tag_replacement, m = p.state, _ = p.tag_buffer, T = p.depth, w = p.in_quote_char, C = "";
...
`:
        ...
        return p.state = m, p.tag_buffer = _, p.depth = T, p.in_quote_char = w, C;
      }
      function h(v) {
...
function Eu(t3, e = 15, n = at.Middle) {
  if (!t3) return "";
  let r = Tu(t3, e);
  return n === at.Start ? r = Su(t3, e) : n === at.Middle && (r = Cu(t3, e)), r;
}
function ti(t3, e = [" "]) {
  let n = [t3];
...
function ku(t3, e = void 0, n = void 0, r = true, i = Mr, s = false) {
  ...
  return o.forEach((f, h) => {
    ...
    for (let w = 0; w < v.length; w += 1) {
      let C = v[w];
      u += _;
      const x = `${C} \u2026`, W = r ? Gt(x, f.fontSize, f.fontWidthToHeightRatio) : Yt(x, f.fontFamily, f.fontSize);
      if (T = Math.max(W, T), n && u + _ > n && w !== v.length - 1) {
        C.charAt(C.length - 1) === Pr && (C = C.substr(0, v[w].length - 1)), W < e ? v[w] = x : v[w] = `${v[w].substr(0, v[w].length - 2)}\u2026`, v = v.slice(0, w + 1);
        break;
      }
    }
