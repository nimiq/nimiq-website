import { d as nt, X as Gt, b6 as Ht, v as wt, j, Z as It, x as pt, C as kt, o as G, Q as jt, bw as dt, an as gt, am as Pt, a as lt, B as Vt, K as Yt, ac as Ut, g as V, f as St, e as Xt, l as ht, h as W, bG as qt, D as Qt, au as Zt, k as tt, av as Ct, t as st, q as Kt } from "./BdODHn_3.js";
import { C as Jt, d as te, $ as ft, A as ct, a0 as _t, a1 as Y, a2 as B, q as C, a3 as yt, r as ee, s as L, a4 as rt, a5 as et, a6 as mt, a7 as xt, a8 as k, a9 as At, aa as ne, ab as ae, l as oe, w as Dt, i as ie, f as at, t as se, m as re, S as le, v as Rt, u as ce, h as ue, ac as de, Q as Lt, R as Tt, X as ge, Y as fe, Z as me, _ as pe } from "./B-Y4bdgU.js";
import { _ as he } from "./DlAUqK2U.js";
import { _ as Ot } from "./CiDt83jx.js";
import { h as ve } from "./5qd8EHar.js";
import { u as be } from "./CZEBxxT2.js";
import { u as Et } from "./Bo9A3gK3.js";
import { u as _e } from "./DvOX9PRL.js";
import { g as ye } from "./CpsPJSKh.js";
import "./CqkleIqs.js";
import "./BTeZegdw.js";
import "./D0DW2WUk.js";
const xe = Object.assign(Object.assign({}, Jt), { tooltip: void 0, annotations: void 0 });
class Ae extends te {
  constructor(e, n, o) {
    var l;
...
function it(c, e, n, o, l, u, s) {
  var t = c - n, i = e - o, a = (s ? u : -u) / et(t * t + i * i), h = a * i, g = -a * t, d = c + h, v = e + g, b = n + h, R = o + g, r = (d + b) / 2, D = (v + R) / 2, y = b - d, x = R - v, _ = y * y + x * x, w = l - u, A = d * R - b * v, F = (x < 0 ? -1 : 1) * et(ne(0, w * w * _ - A * A)), N = (A * x - y * F) / _, S = (-A * y - x * F) / _, T = (A * x + y * F) / _, O = (-A * y + x * F) / _, f = N - r, p = S - D, z = T - r, $ = O - D;
...
function Le() {
  ...
  function i() {
    ...
    if (t || (t = a = ee()), d < g && (h = d, d = g, g = h), !(d > L)) t.moveTo(0, 0);
      ...
      if (N > L) {
        var z = At(N / g * B(F)), $ = At(N / d * B(F));
        (w -= z * 2) > L ? (z *= r ? 1 : -1, x += z, _ -= z) : (w = 0, x = _ = (v + b) / 2), (A -= $ * 2) > L ? ($ *= r ? 1 : -1, D += $, y -= $) : (A = 0, D = y = (v + b) / 2);
      }
      var H = d * Y(D), I = d * B(D), ot = g * Y(_), U = g * B(_);
      if (S > L) {
        var P = d * Y(y), X = d * B(y), q = g * Y(x), Q = g * B(x), M;
        if (R < _t && (M = De(H, I, q, Q, P, X, ot, U))) {
          var Z = H - M[0], K = I - M[1], m = P - M[0], E = X - M[1], J = 1 / B(ae((Z * m + K * E) / (et(Z * Z + K * K) * et(m * m + E * E))) / 2), bt = et(M[0] * M[0] + M[1] * M[1]);
          T = mt(S, (g - bt) / (J - 1)), O = mt(S, (d - bt) / (J + 1));
        }
      }
...
`, We = Object.freeze(Object.defineProperty({ __proto__: null, background: zt, centralLabel: Mt, centralSubLabel: Wt, root: Nt, segment: vt, segmentExit: $t, variables: Me }, Symbol.toStringTag, { value: "Module" }));
class ut extends re {
  constructor(e) {
  ...
  _render(e) {
    ...
    const U = Ee().startAngle((o = (n = r.angleRange) === null || n === void 0 ? void 0 : n[0]) !== null && o !== void 0 ? o : 0).endAngle((u = (l = r.angleRange) === null || l === void 0 ? void 0 : l[1]) !== null && u !== void 0 ? u : 2 * Math.PI).padAngle(r.padAngle).value((m) => Rt(m.datum, r.value, m.index) || 0).sort((m, E) => {
      var J;
      return (J = r.sortFunction) === null || J === void 0 ? void 0 : J.call(r, m.datum, E.datum);
    })(x).map((m) => {
      const E = Object.assign(Object.assign({}, m), { data: m.data.datum, index: m.data.index, innerRadius: z, outerRadius: p });
    ...
    q.call(ze, r, this.arcGen, _), q.sort((m, E) => E.value - m.value), P.exit().attr("class", $t).call($e, _);
    const Q = A ? "start" : N ? "end" : "middle";
    this.centralLabel.attr("dy", r.centralSubLabel ? "-0.55em" : null).style("text-anchor", Q).text((s = r.centralLabel) !== null && s !== void 0 ? s : null), this.centralSubLabel.attr("dy", r.centralLabel ? "0.55em" : null).style("text-anchor", Q).text((t = r.centralSubLabel) !== null && t !== void 0 ? t : null), r.centralSubLabelWrap && de(this.centralSubLabel, z * 1.9);
...
const He = nt({ __name: "index", props: { id: { type: Function }, value: {}, angleRange: {}, padAngle: {}, sortFunction: { type: Function }, cornerRadius: {}, color: {}, radius: {}, arcWidth: {}, centralLabel: {}, centralSubLabel: {}, centralSubLabelWrap: { type: Boolean }, showEmptySegments: { type: Boolean }, emptySegmentAngle: {}, showBackground: { type: Boolean }, backgroundAngleRange: {}, centralLabelOffsetX: {}, centralLabelOffsetY: {}, duration: {}, events: {}, attributes: {}, data: {} }, setup(c, { expose: e }) {
...
} }), Ue = Object.assign(Ye, { __name: "StakingDistribution" }), Xe = Ct(Bt), qe = { flex: "~ col items-center" }, Qe = ["src"], Ze = { flex: "~ gap-2 col", "font-semibold": "", "lh-none": "" }, Ke = { "f-text-lg": "" }, Je = { flex: "~ justify-between items-baseline gap-12", "mt-4": "" }, tn = { text: "f-sm neutral-800", "lh-none": "" }, en = { key: 0, text: "green f-xs", "font-bold": "", "lh-none": "" }, nn = nt({ __name: "Distribution", props: { info: {} }, setup(c) {
  ...
  return (s, t) => {
    const i = Xe, a = Ot;
    return G(), j("div", qe, [V(i, { data: W(u) }, { default: St(({ color: h, value: g, name: d, logo: v, balance: b }) => [(G(), j("div", { key: d, style: Kt({ "--c": h }), ring: "1.5 $c", flex: "~ items-center gap-16", "data-tooltip-container": "", "text-neutral": "", "font-semibold": "", "p-16": "", "rounded-8": "", "bg-neutral-0": "", "w-max": "", shadow: "" }, [v ? (G(), j("img", { key: 0, src: v, "size-40": "", loading: "lazy" }, null, 8, Qe)) : ht("", true), tt("div", Ze, [tt("h3", Ke, st(d), 1), tt("div", Je, [tt("span", tn, st(W(n).format(g)), 1), b > 0 ? (G(), j("p", en, st(W(o).format(b / 1e5)) + " NIM ", 1)) : ht("", true)])])], 4))]), _: 1 }, 8, ["data"]), V(a, { wrapper: "div", field: s.info, "text-center": "", "max-w-42ch": "", "f-m-lg": "" }, null, 8, ["field"])]);
  };
