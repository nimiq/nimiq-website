import { u as se } from "./BIPleKtX.js";
import { j as O, C as V, P as le, Y as ht, N as ce, O as ae, aV as tt, u as M, a1 as fe, aT as ue, aW as de, d as Ot, R as Ct, aX as Nt, b as me, o as jt, w as It, G as pe, aY as he, V as Yt, c as ge, a as we, m as ye, h as ve } from "./BguRs3jF.js";
import { c as Xt, u as qt, P as Gt, h as xe, l as be, i as Ae } from "./CMmzeBWC.js";
...
async function rt(t, e) {
  var n;
  e === void 0 && (e = {});
  const { x: o, y: i, platform: s, rects: r, elements: l, strategy: c } = t, { boundary: a = "clippingAncestors", rootBoundary: f = "viewport", elementContext: u = "floating", altBoundary: p = false, padding: d = 0 } = X(e, t), m = Ut(d), g = l[p ? u === "floating" ? "reference" : "floating" : u], w = ut(await s.getClippingRect({ element: (n = await (s.isElement == null ? void 0 : s.isElement(g))) == null || n ? g : g.contextElement || await (s.getDocumentElement == null ? void 0 : s.getDocumentElement(l.floating)), boundary: a, rootBoundary: f, strategy: c })), v = u === "floating" ? { x: o, y: i, width: r.floating.width, height: r.floating.height } : r.reference, y = await (s.getOffsetParent == null ? void 0 : s.getOffsetParent(l.floating)), x = await (s.isElement == null ? void 0 : s.isElement(y)) ? await (s.getScale == null ? void 0 : s.getScale(y)) || { x: 1, y: 1 } : { x: 1, y: 1 }, A = ut(s.convertOffsetParentRelativeRectToViewportRelativeRect ? await s.convertOffsetParentRelativeRectToViewportRelativeRect({ elements: l, rect: v, offsetParent: y, strategy: c }) : v);
...
const ke = (t) => ({ name: "arrow", options: t, async fn(e) {
  ...
  if (a == null) return {};
  const u = Ut(f), p = { x: n, y: o }, d = St(i), m = Rt(d), h = await r.getDimensions(a), g = d === "y", w = g ? "top" : "left", v = g ? "bottom" : "right", y = g ? "clientHeight" : "clientWidth", x = s.reference[m] + s.reference[d] - p[d] - s.floating[m], A = p[d] - s.reference[d], P = await (r.getOffsetParent == null ? void 0 : r.getOffsetParent(a));
  let b = P ? P[y] : 0;
  ...
  return t === void 0 && (t = {}), { name: "flip", options: t, async fn(e) {
    ...
    if (E = [...E, { placement: i, overflows: S }], !S.every((T) => T <= 0)) {
      ...
      if (I) {
        var z;
        const G = u === "alignment" ? v !== Y(I) : false, H = ((z = E[0]) == null ? void 0 : z.overflows[0]) > 0;
        if (!G || H) return { data: { index: T, overflows: E }, reset: { placement: I } };
      }
      let L = (D = E.filter((G) => G.overflows[0] <= 0).sort((G, H) => G.overflows[1] - H.overflows[1])[0]) == null ? void 0 : D.placement;
      if (!L) switch (d) {
        case "bestFit": {
          var $;
          const G = ($ = E.filter((H) => {
            if (P) {
              const U = Y(H.placement);
              return U === v || U === "y";
            }
            return true;
          }).map((H) => [H.placement, H.overflows.filter((U) => U > 0).reduce((U, re) => U + re, 0)]).sort((H, U) => H[1] - U[1])[0]) == null ? void 0 : $[0];
          G && (L = G);
          break;
        }
...
function Ke(t) {
  ...
  const r = [...n === "clippingAncestors" ? mt(e) ? [] : Ue(e, this._c) : [].concat(n), o], l = r[0], c = r.reduce((a, f) => {
    const u = Wt(e, f, i);
...
const [ie, gn] = Xt("PopperRoot"), Rn = Ot({ inheritAttrs: false, __name: "PopperRoot", setup(t) {
  ...
  }), (s, r) => (jt(), me(M(Gt), { ref: M(n), as: s.as, "as-child": s.asChild }, { default: It(() => [Ct(s.$slots, "default")]), _: 3 }, 8, ["as", "as-child"]));
} });
function wn(t) {
  return t !== null;
}
