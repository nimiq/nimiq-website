import { c as At } from "./CVtsTRWS.js";
import { M as Ft, N as qt, O as Ht, P as at, Q as zt, d as H, b as O, o as b, w as y, R as Z, m as de, u as e, S as st, T as jt, B as N, U as ut, j as F, V as he, a as x, W as Vt, X as dt, f as B, E as ke, c as D, F as X, L as le, H as nt, e as $, t as I, Y as xe, g as W, s as ue, r as Q, n as ne, Z as Wt, h as _e, $ as Kt, a0 as Gt, a1 as ct, a2 as Ut, G as Xt, q as Yt, y as Zt, _ as Pe, i as Fe, l as Jt, a3 as Qt, D as ea } from "./ClGJWWej.js";
import { h as ta, g as ft } from "./SvaN8giD.js";
import { u as qe, S as R } from "./CNR68Ipz.js";
import { P as re, u as oe, a as aa, r as pt, c as He, b as mt, d as na, e as oa, f as ze, i as ot, g as Oe, h as ia } from "./DvG5VWlW.js";
import { _ as la, a as ra, b as sa, c as ua, d as da } from "./BlGBlRxG.js";
import { u as vt, _ as ca, a as fa, b as pa, c as ma } from "./Bu3WqqYb.js";
import { _ as va } from "./Pl2CaGPD.js";
import { _ as ga } from "./DBd8fsAv.js";
import { u as $e, _ as ha } from "./Bygj8hOA.js";
import { u as wa } from "./ZsnPzy3h.js";
import { g as ge, _ as ya } from "./DsoEoSLB.js";
import { u as ba } from "./ZXfttXAr.js";
import { b as _a, d as ka, e as xa, f as $a } from "./CEBR9iVI.js";
import { u as Sa } from "./TWV2KN6z.js";
import { _ as Ma } from "./D2oR6gL8.js";
import { g as gt } from "./Dxc61GTl.js";
import { _ as Ca } from "./B5soDbN4.js";
import "./FVrYAlZa.js";
import "./CHIgUVhi.js";
import "./YKo2rOHu.js";
import "./BVy4Ey-L.js";
function Ta(n = {}) {
  var _a2;
  const a = at(""), i = at(n.politeness || "polite"), o = zt();
...
function Na(n = {}) {
  const a = Ft(), i = a._routeAnnouncer || (a._routeAnnouncer = Ta(n));
  return n.politeness !== i.politeness.value && (i.politeness.value = n.politeness || "polite"), qt() && (a._routeAnnouncerDeps || (a._routeAnnouncerDeps = 0), a._routeAnnouncerDeps++, Ht(() => {
    a._routeAnnouncerDeps--, a._routeAnnouncerDeps === 0 && (i._cleanup(), delete a._routeAnnouncer);
  })), i;
}
const Da = H({ __name: "MenuSeparator", props: { asChild: { type: Boolean }, as: {} }, setup(n) {
  const a = n;
  return (i, o) => (b(), O(e(re), de(a, { role: "separator", "aria-orientation": "horizontal" }), { default: y(() => [Z(i.$slots, "default")]), _: 3 }, 16));
} }), Ea = H({ __name: "DropdownMenuSeparator", props: { asChild: { type: Boolean }, as: {} }, setup(n) {
  const a = n;
  return oe(), (i, o) => (b(), O(e(Da), st(jt(a)), { default: y(() => [Z(i.$slots, "default")]), _: 3 }, 16));
} }), [pe, La] = He(["NavigationMenuRoot", "NavigationMenuSub"], "NavigationMenuContext"), Oa = H({ __name: "NavigationMenuRoot", props: { modelValue: { default: void 0 }, defaultValue: {}, dir: {}, orientation: { default: "horizontal" }, delayDuration: { default: 200 }, skipDelayDuration: { default: 300 }, disableClickTrigger: { type: Boolean, default: false }, disableHoverTrigger: { type: Boolean, default: false }, disablePointerLeaveClose: { type: Boolean }, unmountOnHide: { type: Boolean, default: true }, asChild: { type: Boolean }, as: { default: "nav" } }, emits: ["update:modelValue"], setup(n, { emit: a }) {
  ...
  }), La({ isRootMenu: true, modelValue: t, previousValue: u, baseId: mt(void 0, "reka-navigation-menu"), disableClickTrigger: M, disableHoverTrigger: L, dir: c, unmountOnHide: f, orientation: i.orientation, rootNavigationMenu: d, indicatorTrack: h, activeTrigger: _, onIndicatorTrackChange: (v) => {
    h.value = v;
...
const Pa = "navigationMenu.linkSelect", Le = "navigationMenu.rootContentDismiss";
function Ae(n) {
...
const [Ve, Ia] = He("NavigationMenuItem"), Ba = H({ __name: "NavigationMenuItem", props: { value: {}, asChild: { type: Boolean }, as: { default: "li" } }, setup(n) {
  const a = n;
  oe();
  ...
  return (m, r) => (b(), O(e(re), { "as-child": m.asChild, as: m.as, "data-menu-item": "", onKeydown: Vt(w, ["up", "down", "left", "right", "home", "end", "space"]) }, { default: y(() => [Z(m.$slots, "default")]), _: 3 }, 8, ["as-child", "as"]));
} }), Aa = H({ __name: "NavigationMenuContentImpl", props: { disableOutsidePointerEvents: { type: Boolean }, asChild: { type: Boolean }, as: {} }, emits: ["escapeKeyDown", "pointerDownOutside", "focusOutside", "interactOutside"], setup(n, { emit: a }) {
...
} }), Fa = H({ inheritAttrs: false, __name: "NavigationMenuContent", props: { forceMount: { type: Boolean }, disableOutsidePointerEvents: { type: Boolean }, asChild: { type: Boolean }, as: {} }, emits: ["escapeKeyDown", "pointerDownOutside", "focusOutside", "interactOutside"], setup(n, { emit: a }) {
...
} }), qa = H({ inheritAttrs: false, __name: "NavigationMenuIndicator", props: { forceMount: { type: Boolean }, asChild: { type: Boolean }, as: {} }, setup(n) {
...
} }), Ha = H({ __name: "NavigationMenuLink", props: { active: { type: Boolean }, asChild: { type: Boolean }, as: { default: "a" } }, emits: ["select"], setup(n, { emit: a }) {
  const i = n, o = a, { CollectionItem: t } = $e({ key: "NavigationMenu" });
  oe();
  async function u(l) {
    var _a2;
    const d = new CustomEvent(Pa, { bubbles: true, cancelable: true, detail: { originalEvent: l } });
...
} }), za = H({ inheritAttrs: false, __name: "NavigationMenuList", props: { asChild: { type: Boolean }, as: { default: "ul" } }, setup(n) {
...
} }), ja = ["aria-owns"], Va = H({ inheritAttrs: false, __name: "NavigationMenuTrigger", props: { disabled: { type: Boolean }, asChild: { type: Boolean }, as: { default: "button" } }, setup(n) {
...
} }), Wa = H({ inheritAttrs: false, __name: "NavigationMenuViewport", props: { forceMount: { type: Boolean }, align: { default: "center" }, asChild: { type: Boolean }, as: {} }, setup(n) {
  var _a2;
...
} }), Ka = H({ name: "NuxtRouteAnnouncer", props: { atomic: { type: Boolean, default: false }, politeness: { type: String, default: "polite" } }, setup(n, { slots: a, expose: i }) {
...
} }), Ya = Object.assign(Xa, { __name: "NavigationAnnouncementBanner" }), Za = { key: 0, role: "list", flex: "~ items-center gap-2 wrap", "text-neutral-700": "" }, Ja = H({ __name: "SocialMediaLogosList", props: { items: {} }, async setup(n) {
  let a, i;
  const { data: o } = ([a, i] = ue(() => qe()), a = await a, i(), a), t = F(() => n.items.map((l) => o.value[l]).filter(Boolean)), u = (l) => l.charAt(0).toUpperCase() + l.slice(1);
  return (l, d) => {
    var _a2;
    const h = xe;
...
function it(n, a, i, o = {}) {
  var t, u, l;
  const { clone: d = false, passive: h = false, eventName: s, deep: _ = false, defaultValue: p, shouldEmit: g } = o, w = Gt(), m = i || (w == null ? void 0 : w.emit) || ((t = w == null ? void 0 : w.$emit) == null ? void 0 : t.bind(w)) || ((l = (u = w == null ? void 0 : w.proxy) == null ? void 0 : u.$emit) == null ? void 0 : l.bind(w == null ? void 0 : w.proxy));
  let r = s;
...
const [Ke, an] = He("DrawerRoot"), bt = /* @__PURE__ */ new WeakMap();
...
const q = { DURATION: 0.5, EASE: [0.32, 0.72, 0, 1] }, _t = 0.4, rn = 0.25, sn = 100, kt = 8, Ee = 16, xt = 26, lt = "vaul-dragging";
function un({ activeSnapPoint: n, snapPoints: a, drawerRef: i, overlayRef: o, fadeFromIndex: t, onSnapPointChange: u, direction: l }) {
  ...
  const s = F(() => (a.value && n.value === a.value[a.value.length - 1]) ?? null), _ = F(() => a.value && a.value.length > 0 && ((t == null ? void 0 : t.value) || (t == null ? void 0 : t.value) === 0) && !Number.isNaN(t == null ? void 0 : t.value) && a.value[(t == null ? void 0 : t.value) ?? -1] === n.value || !a.value), p = F(() => {
    ...
    ct(() => {
      var E;
      u(v, g.value), K((E = i.value) == null ? void 0 : E.$el, { transition: `transform ${q.DURATION}s cubic-bezier(${q.EASE.join(",")})`, transform: j(l.value) ? `translate3d(0, ${f}px, 0)` : `translate3d(${f}px, 0, 0)` });
    }), g.value && v !== g.value.length - 1 && v !== (t == null ? void 0 : t.value) ? K((S = o.value) == null ? void 0 : S.$el, { transition: `opacity ${q.DURATION}s cubic-bezier(${q.EASE.join(",")})`, opacity: "0" }) : K((k = o.value) == null ? void 0 : k.$el, { transition: `opacity ${q.DURATION}s cubic-bezier(${q.EASE.join(",")})`, opacity: "1" }), n.value = v !== null ? ((C = a.value) == null ? void 0 : C[v]) ?? null : null;
  };
  le([n, g, a], () => {
    var f;
    if (n.value) {
  ...
  function r({ draggedDistance: f, closeDrawer: c, velocity: S, dismissible: k }) {
    ...
    if (ie && K((C = o.value) == null ? void 0 : C.$el, { transition: `opacity ${q.DURATION}s cubic-bezier(${q.EASE.join(",")})` }), S > 2 && !se) {
      k ? c() : m(g.value[0]);
      return;
    }
    if (S > 2 && se && g && a.value) {
...
function dn(n) {
  ...
  return ke(() => {
    ...
    p(), window.addEventListener("scroll", p), Xt(() => {
...
function fn(n) {
  ...
  function Pt(T) {
    ...
    we.value && window.clearTimeout(we.value), K((z = P.value) == null ? void 0 : z.$el, { transition: `transform ${q.DURATION}s cubic-bezier(${q.EASE.join(",")})`, transform: `scale(${A}) translate3d(0, ${U}px, 0)` }), !T && (V = P.value) != null && V.$el && (we.value = window.setTimeout(() => {
      var Y, ee;
  ...
  function It(T) {
    ...
    T && K((z = P.value) == null ? void 0 : z.$el, { transition: `transform ${q.DURATION}s cubic-bezier(${q.EASE.join(",")})`, transform: j(r.value) ? `scale(${A}) translate3d(0, ${U}px, 0)` : `scale(${A}) translate3d(${U}px, 0, 0)` });
  }
...
} }), mn = H({ __name: "DrawerOverlay", setup(n) {
...
function gn() {
  ...
  he((h) => {
    if (a.value && i.value) {
      ...
      if (!s) return;
      ln(o.value && !t.value ? Be(document.body, { background: "black" }) : vn, Be(s, { transformOrigin: j(n.value) ? "top" : "left", transitionProperty: "transform, border-radius", transitionDuration: `${q.DURATION}s`, transitionTimingFunction: `cubic-bezier(${q.EASE.join(",")})` }));
...
const hn = H({ __name: "DrawerContent", setup(n) {
  ...
  }), (k, C) => (b(), O(e(sa), { ref_key: "drawerRef", ref: u, "data-vaul-drawer": "", "data-vaul-drawer-direction": e(m), "data-vaul-delayed-snap-points": M.value ? "true" : "false", "data-vaul-snap-points": e(i) && e(t) ? "true" : "false", style: _e({ "--snap-point-height": L.value }), onPointerdown: c, onPointermove: S, onPointerup: e(h), onPointerDownOutside: f, onOpenAutoFocus: C[0] || (C[0] = Kt(() => {
...
function Se() {
  const { client: n } = Yt();
  return Zt("$prismic_navigation", async () => {
...
} }), go = Object.assign(Fe(vo, [["__scopeId", "data-v-8da03509"]]), { __name: "NavigationFooter" }), ho = At(Ka), wo = { fixed: "", "bottom-20": "", "right-20": "", "z-102": "" }, Ho = H({ __name: "default", props: { darkHeader: { type: Boolean, default: false }, footerBgColor: { default: "grey" }, draft: { type: Boolean }, showSocialsHexagonBg: { type: Boolean } }, async setup(n) {
  let a, i;
  const { data: o } = ([a, i] = ue(() => Se()), a = await a, i(), a);
  return (t, u) => {
