import { _ as O } from "./B7p6i3HK.js";
import { d as C, b as h, o as s, w as n, R as _, m as D, u as e, a7 as I, Z as z, a8 as V, p as j, a9 as E, L as U, G, a as p, a3 as R, $ as Z, e as o, c as m, f as H, i as F, s as J, v as K, y as Q, F as B, r as M, n as W, t as X } from "./7tyaNgEA.js";
import { i as N, _ as Y, c as ee, d as te, a as oe, b as ne } from "./Ce-DOn_-.js";
import { u as S, P as A } from "./BqwFAzj-.js";
import { g as ae } from "./CpsPJSKh.js";
import { u as se } from "./BmIFlatj.js";
import "./-SGvg42Q.js";
import "./8Lad1M9Y.js";
import "./6j_b9UX3.js";
import "./BmXLCl62.js";
...
} }), re = C({ __name: "DialogDescription", props: { asChild: { type: Boolean }, as: { default: "p" } }, setup(l) {
  const r = l;
  S();
  const d = N();
  return (u, c) => (s(), h(e(A), D(r, { id: e(d).descriptionId }), { default: n(() => [_(u.$slots, "default")]), _: 3 }, 16, ["id"]));
} }), ie = C({ __name: "DialogTitle", props: { asChild: { type: Boolean }, as: { default: "h2" } }, setup(l) {
  const r = l, d = N();
...
const ce = C({ __name: "Modal", props: I({ name: {} }, { open: { type: Boolean }, openModifiers: {} }), emits: I(["close"], ["update:open"]), setup(l, { emit: r }) {
  ...
  return f.value = b.query[v] === d.name, U(f, (i) => {
    ...
    const y = ee, q = oe, T = ie, P = re, k = le, t = ne, $ = te, a = Y;
    return s(), h(a, { open: f.value, "onUpdate:open": g[1] || (g[1] = (x) => f.value = x) }, { default: n(() => [p(y, D(i.$attrs, { "bg-transparent": "" }), { default: n(() => [_(i.$slots, "trigger", {}, void 0, true)]), _: 3 }, 16), p($, null, { default: n(() => [p(R, { name: "backdrop" }, { default: n(() => [p(q, { fixed: "", "inset-0": "", "z-200": "", "bg-darkblue": "", "op-60": "" })]), _: 1 }), p(R, { name: "modal" }, { default: n(() => [(s(), h(t, { key: i.name, lg: "top-1/2 left-1/2 translate--1/2", rounded: "t-8 lg:8", "data-modal": "", fixed: "", "bottom-0": "", "z-200": "", "h-max": "", "max-h-85dvh": "", "w-full": "", transform: "", "of-y-auto": "", "shadow-lg": "", "outline-none": "", "lg:max-w-500": "", onOpenAutoFocus: g[0] || (g[0] = Z(() => {
  ...
  return (k, t) => {
    ...
    return s(), m("section", _e, [o("div", fe, [p($, { field: k.slice.primary.subline }, null, 8, ["field"])]), k.slice.primary.asModal ? (s(), h(me, { key: 0, name: e(L).TechnicalDetails, outline: "~ 1.5 neutral-500", "text-18": "", "nq-pill-lg": "", "nq-pill-tertiary": "", "f-mt-sm": "" }, { trigger: n(() => [t[2] || (t[2] = o("div", { "i-custom:cli-docs": "", "mr-8": "" }, null, -1)), o("span", null, X(e(f)), 1), t[3] || (t[3] = o("div", { "ml-8": "", "text-11": "", "op-60": "", "i-nimiq:info": "" }, null, -1))]), top: n(() => {
      var _a;
      return [o("ul", be, [(s(true), m(B, null, M((_a = e(b)) == null ? void 0 : _a.length, (a) => (s(), m("li", { key: a, "flex-1": "" }, [o("button", { class: W(e(y) === a - 1 ? "bg-green" : "bg-neutral-500"), "h-4": "", "w-full": "", "rounded-full": "", "transition-colors": "", role: "tab", "aria-selected": e(y) === a - 1, tabindex: e(y) === a - 1 ? 0 : -1, onClick: (x) => e(q)(a - 1) }, null, 10, ge)]))), 128))])];
