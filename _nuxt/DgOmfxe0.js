import { ai as r, aj as e } from "./BSLliBk6.js";
...
function u() {
  return r("$socialMedias", async () => {
    const { client: a } = e(), n = await a.getByType("socialMedia").then((o) => o.results);
    if (!(n == null ? void 0 : n.length)) throw new Error("Social media data not found");
    return Object.fromEntries(Object.entries(s).map(([o, c]) => {
      const i = n.find((t) => t.data.platform === o);
      if (!i) throw new Error(`Platform data not found for ${o}`);
      return [o, { ...i.data, id: i.id, ...c }];
    }));
  });
}
export {
