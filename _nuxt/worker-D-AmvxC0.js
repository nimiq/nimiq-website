...
(function() {
  ...
  (async () => {
    ...
    var fe = "" + new URL("index_bg-qZr735g8.wasm", _documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === "SCRIPT" && _documentCurrentScript.src || new URL("_nuxt/worker-D-AmvxC0.js", document.baseURI).href).href, ue = async (e = {}, t) => {
      let n;
...
${e.stack}` : r;
    ...
    function __(e, t) {
      ...
      p().setBigInt64(e + 8, d(r) ? BigInt(0) : r, true), p().setInt32(e + 0, !d(r), true);
    }
    function r_(e) {
      const t = e;
