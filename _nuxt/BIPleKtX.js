import { a1 as J, a_ as Q, aW as Z, C as w, V as S, a2 as P, d as _, j as g, ar as U, b as I, o as M, w as H, R as W, u as O, h as ee, Y as $, H as te, aC as ne, f as se, X as oe } from "./BguRs3jF.js";
import { i as T, u as z, o as re, P as q, m as ae, h as ie, n as ue, t as le, p as ce, q as N, s as de, v as fe } from "./CMmzeBWC.js";
function Be(e) {
...
function ye(e, n) {
  ...
  return S((i) => {
    if (!T) return;
    const l = async (c) => {
      if (!(n == null ? void 0 : n.value)) return;
      await P(), await P();
      const v = c.target;
      !n.value || !v || Y(n.value, v) || c.target && !s.value && V(pe, e, { originalEvent: c });
    };
    t.addEventListener("focusin", l), i(() => t.removeEventListener("focusin", l));
  }), { onFocusCapture: () => s.value = true, onBlurCapture: () => s.value = false };
}
const h = U({ layersRoot: /* @__PURE__ */ new Set(), layersWithOutsidePointerEventsDisabled: /* @__PURE__ */ new Set(), branches: /* @__PURE__ */ new Set() }), _e = _({ __name: "DismissableLayer", props: { disableOutsidePointerEvents: { type: Boolean, default: false }, asChild: { type: Boolean }, as: {} }, emits: ["escapeKeyDown", "pointerDownOutside", "focusOutside", "interactOutside", "dismiss"], setup(e, { emit: n }) {
  const t = e, s = n, { forwardRef: i, currentElement: l } = z(), c = g(() => {
    var _a;
    return ((_a = l.value) == null ? void 0 : _a.ownerDocument) ?? globalThis.document;
  }), v = g(() => h.layersRoot), d = g(() => l.value ? Array.from(v.value).indexOf(l.value) : -1), y = g(() => h.layersWithOutsidePointerEventsDisabled.size > 0), a = g(() => {
    ...
    !a.value || f || (s("pointerDownOutside", r), s("interactOutside", r), await P(), r.defaultPrevented || s("dismiss"));
  }, l), u = ye((r) => {
  ...
  }), (r, f) => (M(), I(O(q), { ref: O(i), "as-child": r.asChild, as: r.as, "data-dismissable-layer": "", style: ee({ pointerEvents: y.value ? a.value ? "auto" : "none" : void 0 }), onFocusCapture: O(u).onFocusCapture, onBlurCapture: O(u).onBlurCapture, onPointerdownCapture: O(o).onPointerDownCapture }, { default: H(() => [W(r.$slots, "default")]), _: 3 }, 8, ["as-child", "as", "style", "onFocusCapture", "onBlurCapture", "onPointerdownCapture"]));
} });
function C() {
...
function be() {
  ...
  return { add(n) {
    const t = e.value[0];
    n !== t && (t == null ? void 0 : t.pause()), e.value = R(e.value, n), e.value.unshift(n);
  }, remove(n) {
    var _a;
    e.value = R(e.value, n), (_a = e.value[0]) == null ? void 0 : _a.resume();
  } };
}
function R(e, n) {
...
const k = "focusScope.autoFocusOnMount", A = "focusScope.autoFocusOnUnmount", x = { bubbles: false, cancelable: true };
function we(e, { select: n = false } = {}) {
  const t = C();
  for (const s of e) if (E(s, { select: n }), C() !== t) return true;
}
function ge(e) {
  const n = j(e), t = K(n, e), s = K(n.reverse(), e);
  return [t, s];
}
function j(e) {
...
function K(e, n) {
  for (const t of e) if (!Oe(t, { upTo: n })) return t;
}
function Oe(e, { upTo: n }) {
...
function E(e, { select: n = false } = {}) {
  if (e && e.focus) {
    const t = C();
    e.focus({ preventScroll: true }), e !== t && De(e) && n && e.select();
  }
}
const Ie = _({ __name: "FocusScope", props: { loop: { type: Boolean, default: false }, trapped: { type: Boolean, default: false }, asChild: { type: Boolean }, as: {} }, emits: ["mountAutoFocus", "unmountAutoFocus"], setup(e, { emit: n }) {
  const t = e, s = n, { currentRef: i, currentElement: l } = z(), c = w(null), v = be(), d = U({ paused: false, pause() {
    this.paused = true;
  }, resume() {
    this.paused = false;
  } });
  S((a) => {
    ...
    const u = C();
    if (!o.contains(u)) {
      const r = new CustomEvent(k, x);
      o.addEventListener(k, (f) => s("mountAutoFocus", f)), o.dispatchEvent(r), r.defaultPrevented || (we(Ee(j(o)), { select: true }), C() === u && E(o));
    }
    a(() => {
      o.removeEventListener(k, (p) => s("mountAutoFocus", p));
      const r = new CustomEvent(A, x), f = (p) => {
        s("unmountAutoFocus", p);
      };
      o.addEventListener(A, f), o.dispatchEvent(r), setTimeout(() => {
        r.defaultPrevented || E(u ?? document.body, { select: true }), o.removeEventListener(A, f), v.remove(d);
      }, 0);
    });
  });
  function y(a) {
    if (!t.loop && !t.trapped || d.paused) return;
    const o = a.key === "Tab" && !a.altKey && !a.ctrlKey && !a.metaKey, u = C();
    if (o && u) {
      const m = a.currentTarget, [r, f] = ge(m);
  ...
  return (a, o) => (M(), I(O(q), { ref_key: "currentRef", ref: i, tabindex: "-1", "as-child": a.asChild, as: a.as, onKeydown: y }, { default: H(() => [W(a.$slots, "default")]), _: 3 }, 8, ["as-child", "as"]));
} });
var Ce = function(e) {
  if (typeof document > "u") return null;
  var n = Array.isArray(e) ? e[0] : e;
  return n.ownerDocument.body;
}, D = /* @__PURE__ */ new WeakMap(), L = /* @__PURE__ */ new WeakMap(), F = {}, B = 0, X = function(e) {
  ...
  var i = Se(n, Array.isArray(e) ? e : [e]);
  ...
  var a = function(o) {
    !o || d.has(o) || Array.prototype.forEach.call(o.children, function(u) {
      if (v.has(u)) a(u);
        ...
        D.set(u, f), l.set(u, p), c.push(u), f === 1 && r && L.set(u, true), p === 1 && u.setAttribute(t, "true"), r || u.setAttribute(s, "true");
      } catch (b) {
        console.error("aria-hidden: cannot operate on ", u, b);
      }
    });
  };
  return a(n), v.clear(), B++, function() {
    c.forEach(function(o) {
      var u = D.get(o) - 1, m = l.get(o) - 1;
      D.set(o, u), l.set(o, m), u || (L.has(o) || o.removeAttribute(s), L.delete(o)), m || o.removeAttribute(t);
    }), B--, B || (D = /* @__PURE__ */ new WeakMap(), D = /* @__PURE__ */ new WeakMap(), L = /* @__PURE__ */ new WeakMap(), F = {});
  };
}, Le = function(e, n, t) {
  t === void 0 && (t = "data-aria-hidden");
  var s = Array.from(Array.isArray(e) ? e : [e]), i = Ce(e);
  return i ? (s.push.apply(s, Array.from(i.querySelectorAll("[aria-live], script"))), Pe(s, i, t, "aria-hidden")) : function() {
    return null;
  };
};
function Me(e) {
...
const Fe = ue(() => {
  const e = w(/* @__PURE__ */ new Map()), n = w(), t = g(() => {
    for (const c of e.value.values()) if (c) return true;
    return false;
  }), s = ce({ scrollBody: w(true) });
  let i = null;
  const l = () => {
    document.body.style.paddingRight = "", document.body.style.marginRight = "", document.body.style.pointerEvents = "", document.body.style.removeProperty("--scrollbar-width"), document.body.style.overflow = n.value ?? "", N && (i == null ? void 0 : i()), n.value = void 0;
  };
  return $(t, (c, v) => {
    var _a;
    if (!T) return;
    ...
    const d = window.innerWidth - document.documentElement.clientWidth, y = { padding: d, margin: 0 }, a = ((_a = s.scrollBody) == null ? void 0 : _a.value) ? typeof s.scrollBody.value == "object" ? ne({ padding: s.scrollBody.value.padding === true ? d : s.scrollBody.value.padding, margin: s.scrollBody.value.margin === true ? d : s.scrollBody.value.margin }, y) : y : { padding: 0, margin: 0 };
    d > 0 && (document.body.style.paddingRight = typeof a.padding == "number" ? `${a.padding}px` : String(a.padding), document.body.style.marginRight = typeof a.margin == "number" ? `${a.margin}px` : String(a.margin), document.body.style.setProperty("--scrollbar-width", `${d}px`), document.body.style.overflow = "hidden"), N && (i = de(document, "touchmove", (o) => Te(o), { passive: false })), P(() => {
...
function We(e) {
  ...
  const s = g({ get: () => t.value.get(n) ?? false, set: (i) => t.value.set(n, i) });
  return le(() => {
    t.value.delete(n);
  }), s;
}
...
const Ne = _({ __name: "Teleport", props: { to: { default: "body" }, disabled: { type: Boolean }, defer: { type: Boolean }, forceMount: { type: Boolean } }, setup(e) {
  const n = fe();
  return (t, s) => O(n) || t.forceMount ? (M(), I(oe, { key: 0, to: t.to, disabled: t.disabled, defer: t.defer }, [W(t.$slots, "default")], 8, ["to", "disabled", "defer"])) : se("", true);
} });
export {
  _e as _,
  Ie as a,
