import { a as O, r as _, a1 as se, Q as pt, $ as le, a0 as ce, b2 as tt, h as M, d as Ct, k as Nt, l as Ot, s as It, bg as jt, e as ae, o as Yt, f as qt, P as Xt, n as fe, af as ue, bh as de, bi as me, a7 as Ut, B as he, g as pe, J as ge, v as we, ac as ye } from "./B8biU-UE.js";
const xe = ["top", "right", "bottom", "left"], J = Math.min, k = Math.max, at = Math.round, ct = Math.floor, V = (t) => ({ x: t, y: t }), ve = { left: "right", right: "left", bottom: "top", top: "bottom" }, be = { start: "end", end: "start" };
function yt(t, e, n) {
  return k(t, J(e, n));
}
function q(t, e) {
...
const Ee = (t) => ({ name: "arrow", options: t, async fn(e) {
  ...
  const C = v / 2 - A / 2, S = b / 2 - p[m] / 2 - 1, E = J(u[w], S), R = J(u[x], S), D = E, z = b - p[m] - R, $ = b / 2 - p[m] / 2 + C, T = yt(D, $, z), j = !c.arrow && it(i) != null && $ !== T && s.reference[m] / 2 - ($ < D ? E : R) - p[m] / 2 < 0, L = j ? $ < D ? $ - D : $ - z : 0;
  ...
  return t === void 0 && (t = {}), { name: "flip", options: t, async fn(e) {
    ...
    const w = X(i), x = Y(l), y = X(l) === l, v = await (c.isRTL == null ? void 0 : c.isRTL(a.floating)), A = h || (y || !p ? [ft(l)] : Ce(l)), P = m !== "none";
...
const ke = function(t) {
  ...
  return t === void 0 && (t = {}), { name: "size", options: t, async fn(e) {
    ...
    const x = p - f.top - f.bottom, y = m - f.left - f.right, v = J(p - f[g], x), A = J(m - f[w], y), P = !e.middlewareData.shift;
    let b = v, C = A;
...
function Jt(t) {
  const e = K(t);
  return ot(e) ? t.ownerDocument ? t.ownerDocument.body : t.body : N(e) && lt(e) ? e : Jt(e);
}
function st(t, e, n) {
  var o;
  e === void 0 && (e = []), n === void 0 && (n = true);
  const i = Jt(t), s = i === ((o = t.ownerDocument) == null ? void 0 : o.body), r = B(i);
  if (s) {
    const l = vt(r);
...
function _e(t) {
  ...
  const f = V(0), u = N(o);
  if ((u || !u && !s) && ((Z(o) !== "body" || lt(r)) && (c = ht(o)), N(o))) {
    const d = Q(o);
    a = nt(o), f.x = d.x + o.clientLeft, f.y = d.y + o.clientTop;
  }
  const h = r && !u && !s ? Zt(r, c, true) : V(0);
...
function Ye(t, e) {
  const n = e.get(t);
  if (n) return n;
  let o = st(t, [], false).filter((l) => F(l) && Z(l) !== "body"), i = null;
...
function qe(t) {
  ...
  const r = [...n === "clippingAncestors" ? mt(e) ? [] : Ye(e, this._c) : [].concat(n), o], l = r[0], c = r.reduce((a, f) => {
    const u = Wt(e, f, i);
    return a.top = k(u.top, a.top), a.right = J(u.right, a.right), a.bottom = J(u.bottom, a.bottom), a.left = k(u.left, a.left), a;
  }, Wt(e, l, i));
...
function Ue(t, e, n) {
  ...
  if (o || !o && !s) if ((Z(e) !== "body" || lt(i)) && (l = ht(e)), o) {
    const d = Q(e, true, s, e);
    c.x = d.x + e.clientLeft, c.y = d.y + e.clientTop;
  } else i && a();
  s && !o && i && a();
  const f = i && !o && !s ? Zt(i, l) : V(0), u = r.left + l.scrollLeft - c.x - f.x, h = r.top + l.scrollTop - c.y - f.y;
...
const Ke = { convertOffsetParentRelativeRectToViewportRelativeRect: _e, getDocumentElement: I, getClippingRect: qe, getOffsetParent: ee, getElementRects: Ge, getClientRects: Ve, getDimensions: Xe, getScale: nt, isElement: F, isRTL: Je };
function ne(t, e) {
...
function Qe(t, e) {
  ...
  function r(l, c) {
    ...
    if (l || e(), !h || !d) return;
    const m = ct(u), p = ct(i.clientWidth - (f + h)), g = ct(i.clientHeight - (u + d)), w = ct(f), y = { rootMargin: -m + "px " + -p + "px " + -g + "px " + -w + "px", threshold: k(0, J(1, c)) || 1 };
    let v = true;
    function A(P) {
...
function bt(t) {
  if (cn(t)) {
    const e = t.$el;
    return Et(e) && Z(e) === "#comment" ? null : e;
  }
  return t;
}
function et(t) {
...
const [ie, un] = Nt("PopperRoot"), yn = Ct({ inheritAttrs: false, __name: "PopperRoot", setup(t) {
  ...
  }), (s, r) => (Yt(), ae(M(Xt), { ref: M(n), as: s.as, "as-child": s.asChild }, { default: qt(() => [Ot(s.$slots, "default")]), _: 3 }, 8, ["as", "as-child"]));
} });
function dn(t) {
  return t !== null;
}
