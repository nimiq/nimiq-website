import { x as w, h as q, r as I, p as N } from "./BqwFAzj-.js";
import { j as f, B as v, d as T, c as h, o as _, a as b, e as D, R as M, a0 as V, M as A, a2 as C, t as B, m as E } from "./7tyaNgEA.js";
import { g as F } from "./6j_b9UX3.js";
import { _ as L } from "./CMf5N-6F.js";
function Z(t) {
  return f(() => {
    var _a;
...
const k = { flex: "~ justify-start", "max-w-780px": "", "w-full": "", "px-32": "", "f-mt-xs": "" }, H = T({ __name: "LeftAligned", props: { headline: {}, subline: {} }, setup(t) {
  return (e, a) => {
    const l = L;
    return _(), h("section", null, [b(l, { headline: e.headline, subline: e.subline, "left-align": "", "max-w-780px": "", "w-full": "", "px-32": "" }, null, 8, ["headline", "subline"]), D("div", k, [M(e.$slots, "bottom")])]);
  };
  ...
  var _a;
  const e = t, a = (_a = V()) == null ? void 0 : _a.vnode.el, l = a == null ? void 0 : a.getAttribute("datetime"), u = a == null ? void 0 : a.getAttribute("data-locale"), m = A(), i = f(() => {
    const n = e.datetime;
