import { aw as $, ax as F, ay as k, az as S, aA as T, aB as I, aC as A, aD as W, aE as H, aF as _, M as C, q as U, j as b, d as G, aG as V, B as q, E as X, c as Y, R as Q, o as J, m as z, u as v, S as Z } from "./7tyaNgEA.js";
  ...
  if (Object.keys(n).length >= 1) {
    for (const u in n) {
      ...
      if (f !== void 0) {
        ...
        for (const p of a) l.push({ width: f._cWidth * p, src: M(e, t, r, f, p) });
      }
    }
    le(c);
  } else for (const u of a) {
    const f = Object.keys(n)[0];
    let p = f ? j(f, String(n[f]), o, s, e) : void 0;
    p === void 0 && (p = { size: "", screenMaxWidth: 0, _cWidth: (_d = r.modifiers) == null ? void 0 : _d.width, _cHeight: (_e2 = r.modifiers) == null ? void 0 : _e2.height }), l.push({ width: u, src: M(e, t, r, p, u) });
  }
  ce(l);
...
}, fe = Object.freeze(Object.defineProperty({ __proto__: null, getImage: me, prismicCDN: E }, Symbol.toStringTag, { value: "Module" })), ge = R({ keyMap: { format: "f", fit: "fit", width: "w", height: "h", resize: "s", quality: "q", background: "b" }, joinWith: "&", formatter: (e, t) => _(e) + "_" + _(t) }), he = (e, { modifiers: t = {}, baseURL: r } = {}, i) => {
...
}, pe = true, be = true, we = Object.freeze(Object.defineProperty({ __proto__: null, getImage: he, supportsAlias: be, validateDomains: pe }, Symbol.toStringTag, { value: "Module" })), L = { screens: { xs: 320, sm: 640, md: 768, lg: 1024, xl: 1280, xxl: 1536, "2xl": 1536 }, presets: {}, provider: "ipxStatic", domains: [], alias: {}, densities: [1, 2], format: ["webp"] };
...
const ye = { src: { type: String, required: false }, format: { type: String, required: false }, quality: { type: [Number, String], required: false }, background: { type: String, required: false }, fit: { type: String, required: false }, modifiers: { type: Object, required: false }, preset: { type: String, required: false }, provider: { type: String, required: false }, sizes: { type: [Object, String], required: false }, densities: { type: String, required: false }, preload: { type: [Boolean, Object], required: false }, width: { type: [String, Number], required: false }, height: { type: [String, Number], required: false }, alt: { type: String, required: false }, referrerpolicy: { type: String, required: false }, usemap: { type: String, required: false }, longdesc: { type: String, required: false }, ismap: { type: Boolean, required: false }, loading: { type: String, required: false, validator: (e) => ["lazy", "eager"].includes(e) }, crossorigin: { type: [Boolean, String], required: false, validator: (e) => ["anonymous", "use-credentials", "", true, false].includes(e) }, decoding: { type: String, required: false, validator: (e) => ["async", "auto", "sync"].includes(e) }, nonce: { type: [String], required: false } }, ve = (e) => {
  ...
  const r = e, i = V(), o = t, n = false, a = D(), s = ve(r), c = q(false), l = q(), m = b(() => a.getSizes(r.src, { ...s.options.value, sizes: r.sizes, densities: r.densities, modifiers: { ...s.modifiers.value, width: g(r.width), height: g(r.height) } })), x = b(() => {
    ...
    const h = Array.isArray(d) ? d : typeof d == "number" ? [d, d] : [10, 10];
    return a(r.src, { ...s.modifiers.value, width: h[0], height: h[1], quality: h[2] || 50, blur: h[3] || 3 }, s.options.value);
  }), y = b(() => r.sizes ? m.value.src : a(r.src, s.modifiers.value, s.options.value)), u = b(() => w.value ? w.value : y.value), p = C().isHydrating;
  return X(() => {
    if (w.value || r.custom) {
      const d = new Image();
      y.value && (d.src = y.value), r.sizes && (d.sizes = m.value.sizes || "", d.srcset = m.value.srcset), d.onload = (h) => {
        c.value = true, o("load", h);
      }, d.onerror = (h) => {
        o("error", h);
      }, xe("nuxt-image");
      return;
    }
    l.value && (l.value.complete && p && (l.value.getAttribute("data-error") ? o("error", new Event("error")) : o("load", new Event("load"))), l.value.onload = (d) => {
      o("load", d);
    }, l.value.onerror = (d) => {
      o("error", d);
    });
  }), (d, h) => d.custom ? Q(d.$slots, "default", Z(z({ key: 1 }, { ...v(n) ? { onerror: "this.setAttribute('data-error', 1)" } : {}, imgAttrs: { ...x.value, ...v(i) }, isLoaded: c.value, src: u.value }))) : (J(), Y("img", z({ key: 0, ref_key: "imgEl", ref: l, class: w.value && !c.value ? d.placeholderClass : void 0 }, { ...v(n) ? { onerror: "this.setAttribute('data-error', 1)" } : {}, ...x.value, ...v(i) }, { src: u.value }), null, 16, ke));
