import { d as nt, U as Bt, aj as Gt, B as wt, c as j, V as It, L as pt, G as kt, o as B, R as jt, ao as dt, ap as gt, aq as Pt, j as lt, E as Vt, a1 as Ut, Z as Yt, a as V, w as St, b as qt, f as ht, u as M, b9 as Xt, H as Zt, i as Qt, e as tt, a4 as Ct, t as st, h as Jt } from "./7tyaNgEA.js";
import { C as Kt, d as te, $ as ft, A as ct, a0 as _t, a1 as U, a2 as W, q as C, a3 as yt, r as ee, s as L, a4 as rt, a5 as et, a6 as mt, a7 as xt, a8 as k, a9 as At, aa as ne, ab as ae, l as oe, w as Dt, i as ie, f as at, t as se, m as re, S as le, v as Rt, u as ce, h as ue, ac as de, Q as Lt, R as Ot, X as ge, Y as fe, Z as me, _ as pe } from "./n9Zfb6Is.js";
import { _ as Tt } from "./B7p6i3HK.js";
import { u as he } from "./B3mO7cbA.js";
import { u as Et } from "./DSYs-LpM.js";
import { u as ve } from "./C-1Ou19O.js";
...
function it(c, e, a, o, l, u, s) {
  var t = c - a, i = e - o, n = (s ? u : -u) / et(t * t + i * i), h = n * i, f = -n * t, d = c + h, v = e + f, b = a + h, R = o + f, r = (d + b) / 2, D = (v + R) / 2, y = b - d, x = R - v, _ = y * y + x * x, w = l - u, A = d * R - b * v, F = (x < 0 ? -1 : 1) * et(ne(0, w * w * _ - A * A)), N = (A * x - y * F) / _, S = (-A * y - x * F) / _, O = (A * x + y * F) / _, T = (-A * y + x * F) / _, g = N - r, p = S - D, $ = O - r, z = T - D;
  return g * g + p * p > $ * $ + z * z && (N = O, S = T), { cx: N, cy: S, x01: -h, y01: -f, x11: N * (l / w - 1), y11: S * (l / w - 1) };
}
function Ce() {
  ...
  function i() {
    ...
    if (t || (t = n = ee()), d < f && (h = d, d = f, f = h), !(d > L)) t.moveTo(0, 0);
      ...
      var D = v, y = b, x = v, _ = b, w = R, A = R, F = s.apply(this, arguments) / 2, N = F > L && (o ? +o.apply(this, arguments) : et(f * f + d * d)), S = mt(xt(d - f) / 2, +a.apply(this, arguments)), O = S, T = S, g, p;
      if (N > L) {
...
class ut extends re {
  ...
  _render(e) {
    ...
    }), P = this.arcGroup.selectAll(`.${vt}`).data(Y, (m) => r.id(m.data, m.index)), q = P.enter().append("path").attr("class", vt).call(Ee, r), X = P.merge(q);
    X.call(Fe, r, this.arcGen, _), X.sort((m, E) => E.value - m.value), P.exit().attr("class", zt).call(Ne, _);
...
const He = nt({ __name: "index", props: { component: {}, tooltip: {}, annotations: {}, duration: {}, margin: {}, padding: {}, sizing: {}, width: {}, height: {}, svgDefs: {}, ariaLabel: {}, data: {} }, setup(c, { expose: e }) {
  ...
  }), kt(() => u == null ? void 0 : u.destroy()), gt(Ot, { data: o, update: (n) => s.component = n, destroy: () => s.component = void 0 }), gt(ge, { data: o, update: (n) => s.tooltip = n, destroy: () => {
    s.tooltip = void 0;
...
const We = nt({ __name: "index", props: { id: { type: Function }, value: {}, angleRange: {}, padAngle: {}, sortFunction: { type: Function }, cornerRadius: {}, color: {}, radius: {}, arcWidth: {}, centralLabel: {}, centralSubLabel: {}, centralSubLabelWrap: { type: Boolean }, showEmptySegments: { type: Boolean }, emptySegmentAngle: {}, showBackground: { type: Boolean }, backgroundAngleRange: {}, centralLabelOffsetX: {}, centralLabelOffsetY: {}, duration: {}, events: {}, attributes: {}, data: {} }, setup(c, { expose: e }) {
  ...
  function t(i) {
    ...
    return Xt(Zt(e.default, i.data), n), n.innerHTML;
  }
  return (i, n) => (B(), j("div", Be, [V(M(He), { data: i.data, height: 280, width: 280, relative: "", "size-280": "", "max-w-280": "" }, { default: St(() => [V(M(We), { color: s, value: u, "angle-range": l, "corner-radius": 8, "arc-width": 64, "pad-angle": 0.045, "show-background": false }), e.default ? (B(), qt(M(pe), { key: 0, triggers: { [M(ut).selectors.segment]: t } }, null, 8, ["triggers"])) : ht("", true)]), _: 1 }, 8, ["data"])]));
} }), Wt = Object.assign(Qt(Ge, [["__scopeId", "data-v-917916cc"]]), { __name: "ChartDonut" }), Ie = Ct(Wt), je = { relative: "", flex: "~ col items-center" }, Pe = { ring: "1.5 green", absolute: "", "right-8": "", "top-196": "", "rounded-full": "", "bg-neutral-0": "", "px-12": "", "py-6": "", "text-neutral": "", "font-semibold": "" }, Ve = nt({ __name: "Distribution", props: { info: {} }, setup(c) {
  ...
  return (s, t) => {
    const i = Ye, n = Tt;
    return B(), j("div", qe, [V(i, { data: M(u) }, { default: St(({ color: h, value: f, name: d, logo: v, balance: b }) => [(B(), j("div", { key: d, style: Jt({ "--c": h }), ring: "1.5 $c", flex: "~ items-center gap-16", "data-tooltip-container": "", "w-max": "", "rounded-8": "", "bg-neutral-0": "", "p-16": "", "text-neutral": "", "font-semibold": "", shadow: "" }, [v ? (B(), j("img", { key: 0, src: v, "size-40": "", loading: "lazy" }, null, 8, Xe)) : ht("", true), tt("div", Ze, [tt("h3", Qe, st(d), 1), tt("div", Je, [tt("span", Ke, st(M(a).format(f)), 1), b > 0 ? (B(), j("p", tn, st(M(o).format(b / 1e5)) + " NIM ", 1)) : ht("", true)])])], 4))]), _: 1 }, 8, ["data"]), V(n, { wrapper: "div", field: s.info, "max-w-42ch": "", "text-center": "", "f-m-lg": "" }, null, 8, ["field"])]);
  };
