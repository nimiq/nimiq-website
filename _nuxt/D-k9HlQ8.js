import { i as T, _ as z, u as K, a as U, b as x } from "./DBRxGtFx.js";
import { d as m, s as w, e as g, o as f, f as p, l as v, B as C, J as y, h as e, P as k, a as V, g as _, v as Y, t as j, j as N, r as O, k as W, a3 as E, a4 as R, aJ as X, bc as q, ab as H, a9 as J, bd as G, aa as $, be as Q, A, m as S, y as Z, n as ee, bf as oe, a1 as D, x as te, C as B, D as F } from "./B8biU-UE.js";
import { u as ae } from "./CoPlYyca.js";
...
const ne = { key: 0, d: "M0 0L6 6L12 0" }, ie = { key: 1, d: "M0 0L4.58579 4.58579C5.36683 5.36683 6.63316 5.36684 7.41421 4.58579L12 0" }, re = m({ __name: "Arrow", props: { width: { default: 10 }, height: { default: 5 }, rounded: { type: Boolean }, asChild: { type: Boolean }, as: { default: "svg" } }, setup(u) {
  ...
  const i = u;
  return (o, a) => (f(), g(e(X), E(R(i)), { default: p(() => [v(o.$slots, "default")]), _: 3 }, 16));
  ...
  return Q(n), (l, d) => (f(), g(I, y(e(r), { ref: e(c), "trap-focus": e(s).open.value, "disable-outside-pointer-events": "", onCloseAutoFocus: d[0] || (d[0] = A((h) => {
    ...
    const b = h.detail.originalEvent, M = b.button === 0 && b.ctrlKey === true, L = b.button === 2 || M;
    t.value = L;
  ...
  }), (t, r) => (f(), g(oe(e(o).hasCustomAnchor.value ? e(k) : e(x)), { "as-child": "" }, { default: p(() => [_(e(k), { id: e(o).triggerId, ref: e(a), type: t.as === "button" ? "button" : void 0, "aria-haspopup": "dialog", "aria-expanded": e(o).open.value, "aria-controls": e(o).contentId, "data-state": e(o).open.value ? "open" : "closed", as: t.as, "as-child": i.asChild, onClick: e(o).onOpenToggle }, { default: p(() => [v(t.$slots, "default")]), _: 3 }, 8, ["id", "type", "aria-expanded", "aria-controls", "data-state", "as", "as-child", "onClick"])]), _: 3 }));
  ...
  return (t, r) => {
    ...
    return f(), g(h, { open: e(o), "onUpdate:open": s }, { default: p(() => [_(c, y(t.$attrs, { "bg-transparent": "", "h-max": "", block: "", onMouseenter: a, onFocus: a }), { default: p(() => [v(t.$slots, "trigger", {}, () => [r[0] || (r[0] = B("div", { "text-12": "", "text-neutral-700": "", "i-nimiq:info": "" }, null, -1))], true)]), _: 3 }, 16), e(i) ? (f(), g(d, { key: 0 }, { default: p(() => [_(l, { "as-child": "", class: "tooltip-animation", "side-offset": t.sideOffset, "collision-padding": t.collisionPadding, side: t.side, flex: "~ col", "max-w-360": "" }, { default: p(() => [B("div", { class: F(t.dark ? "bg-white" : "bg-gradient-neutral shadow dark scheme-dark"), "p-16": "", "rounded-8": "", text: "neutral dark:white" }, [v(t.$slots, "default", {}, void 0, true)], 2), _(n, { "as-child": "" }, { default: p(() => [B("div", { "rotate-180": "", class: F({ dark: t.dark }) }, r[1] || (r[1] = [B("div", { "aria-hidden": "", "mt--1": "", "h-8": "", "w-16": "", "i-nimiq:tooltip-triangle": "", class: "tooltip-animation", text: "darkblue dark:white" }, null, -1)]), 2)]), _: 1 })]), _: 3 }, 8, ["side-offset", "collision-padding", "side"])]), _: 3 })) : te("", true)]), _: 3 }, 8, ["open"]);
  };
