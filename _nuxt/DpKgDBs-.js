import { _ as oe } from "./D2oR6gL8.js";
import { d as C, U as ne, j as v, b as _, o as i, w as d, R as I, u as l, g as $, m as q, S as le, T as ie, t as E, p as re, l as ue, a8 as pe, B as T, L as A, q as de, V as ce, ac as ge, a4 as fe, c as y, f as D, a as b, F as V, r as F, n as S, e as f, D as me, C as ve, h as _e, _ as xe, ab as he, i as be } from "./ClGJWWej.js";
import { g as Pe } from "./CpsPJSKh.js";
import { g as ye, A as Ce } from "./aGufb5sz.js";
import { c as we, u as k, a as Re, P as B } from "./DvG5VWlW.js";
import "./BVy4Ey-L.js";
import "./ZXfttXAr.js";
import "./DsoEoSLB.js";
import "./xLWJwwMd.js";
import "./SvaN8giD.js";
const [z, $e] = we("PaginationRoot"), Ie = C({ __name: "PaginationRoot", props: { page: {}, defaultPage: { default: 1 }, itemsPerPage: {}, total: { default: 0 }, siblingCount: { default: 2 }, disabled: { type: Boolean }, showEdges: { type: Boolean, default: false }, asChild: { type: Boolean }, as: { default: "nav" } }, emits: ["update:page"], setup(o, { emit: a }) {
  ...
  return $e({ page: c, onPageChange(p) {
    c.value = p;
...
} }), ke = C({ __name: "PaginationEllipsis", props: { asChild: { type: Boolean }, as: {} }, setup(o) {
  const a = o;
...
const Ne = C({ __name: "PaginationList", props: { asChild: { type: Boolean }, as: {} }, setup(o) {
  ...
  return (t, r) => (i(), _(l(B), q(a, { "data-type": "page", "aria-label": `Page ${t.value}`, "aria-current": n.value ? "page" : void 0, "data-selected": n.value ? "true" : void 0, disabled: s.value, type: t.as === "button" ? "button" : void 0, onClick: r[0] || (r[0] = (c) => !s.value && l(e).onPageChange(t.value)) }), { default: d(() => [I(t.$slots, "default", {}, () => [$(E(t.value), 1)])]), _: 3 }, 16, ["aria-label", "aria-current", "data-selected", "disabled", "type"]));
