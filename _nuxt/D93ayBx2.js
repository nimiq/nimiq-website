...
const Z = Object.assign(h(F, [["render", U], ["__scopeId", "data-v-f8955561"]]), { __name: "AnimatedStakingRipple" }), G = { flex: "~ col md:items-center", group: "" }, H = { bg: "green/15 data-inverted:white/30", text: "green data-inverted:white", "data-percentage": "", "px-10": "", "py-3": "", "rounded-4": "", "inline-flex": "~" }, M = { key: 2, flex: "~ gap-16 lg:gap-20 wrap" }, J = C({ __name: "Staking", props: { headline: {}, subline: {}, links: { default: () => [] }, showStakingIcon: { type: Boolean, default: false }, primaryPill: { type: Boolean } }, async setup(c) {
  var _a, _b;
  let n, m;
  const { annualRewardPercentage: y } = E(), { client: k } = S(), { data: u } = ([n, m] = T(() => B("staking_values", () => k.getSingle("stakingValues").then((t) => t.data))), n = await n, m(), n);
  if (!u) throw new Error("No staking values found");
  const w = ((_b = (_a = c.headline) == null ? void 0 : _a.at(0)) == null ? void 0 : _b.type.replace("heading", "h")) || "h2", g = O(c.headline).split("{{ interestPerAnnum }}"), _ = `terms-note-${P()}`;
  return (t, f) => {
    var _a2;
    const x = Z, v = D, b = z;
    return a(), i("div", G, [t.showStakingIcon ? (a(), d(x, { key: 0, "size-120": "" })) : p("", true), (a(), d(I(s(w)), { "f-mt-md": "", text: "data-inverted:white wrap md:balance" }, { default: A(() => [l(o(s(g)[0]) + " ", 1), e("span", H, [l(" ~" + o(s(y)), 1), e("div", { "text-14": "", "translate-y-8": "", "i-nimiq:asterisk": "", "aria-labelledby": _ })]), l(" " + o(s(g)[1]), 1)]), _: 1 })), ("hasText" in t ? t.hasText : s(R))(t.subline) ? (a(), d(v, { key: 1, wrapper: "p", field: t.subline, "data-inverted:text": "white/80" }, null, 8, ["field"])) : p("", true), t.links.length > 0 ? (a(), i("ul", M, [(a(true), i(N, null, V(t.links, (r, q) => (a(), i("li", { key: q }, [j(b, { field: r, "f-mt-lg": "", "nq-arrow": "", "nq-pill-lg": "", "md:mx-auto": "", class: $({ "nq-pill-blue": r.variant === "nq-pill-blue", "nq-pill-secondary": r.variant === "nq-pill-secondary", "nq-pill-tertiary bg-white text-neutral": r.variant === "nq-pill-tertiary" }) }, null, 8, ["field", "class"])]))), 128))])) : p("", true), e("small", { id: _, text: "green-1100 data-inverted:white/80 sm:center", "data-note": "", "transition-colors": "", "duration-400": "", "f-mt-md": "", "sm:max-w-32ch": "" }, [f[0] || (f[0] = e("div", { "aria-hidden": "", "size-0.4em": "", "i-nimiq:asterisk": "", "un-translate": "x--8 sm:x-4 y-4 sm:y-8" }, null, -1)), l(" " + o((_a2 = s(u)) == null ? void 0 : _a2.stakingNote), 1)])]);
  };
