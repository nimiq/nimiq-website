...
import { a1 as ii, j as si, aW as an, d as oi, a5 as ai, C as ci, c as ui, G as li, a2 as fi, H as hi, Y as di, o as pi } from "./BguRs3jF.js";
var Ee = "http://www.w3.org/1999/xhtml";
const cn = { svg: "http://www.w3.org/2000/svg", xhtml: Ee, xlink: "http://www.w3.org/1999/xlink", xml: "http://www.w3.org/XML/1998/namespace", xmlns: "http://www.w3.org/2000/xmlns/" };
function fe(t3) {
  var e = t3 += "", n = e.indexOf(":");
  return n >= 0 && (e = t3.slice(0, n)) !== "xmlns" && (t3 = t3.slice(n + 1)), cn.hasOwnProperty(e) ? { space: cn[e], local: t3 } : t3;
}
function vi(t3) {
  return function() {
    var e = this.ownerDocument, n = this.namespaceURI;
    return n === Ee && e.documentElement.namespaceURI === Ee ? e.createElement(t3) : e.createElementNS(n, t3);
  };
}
function gi(t3) {
  return function() {
...
function bi(t3) {
  typeof t3 == "function" ? t3 = xi(t3) : t3 = er(t3);
...
function Ti(t3) {
  return this.select(t3 == null ? Si : Ci(typeof t3 == "function" ? t3 : rr(t3)));
}
...
function Ri(t3) {
  return this.selectAll(t3 == null ? $i : ki(typeof t3 == "function" ? t3 : rr(t3)));
}
function Ni(t3) {
  typeof t3 != "function" && (t3 = nr(t3));
...
function Mi(t3, e, n, r, i, s) {
  for (var o = 0, a, c = e.length, u = s.length; o < u; ++o) (a = e[o]) ? (a.__data__ = s[o], r[o] = a) : n[o] = new Kt(t3, s[o]);
...
function Pi(t3, e, n, r, i, s, o) {
  ...
  for (a = 0; a < f; ++a) d = o.call(t3, s[a], a, s) + "", (c = u.get(d)) ? (r[a] = c, c.__data__ = s[a], u.delete(d)) : n[a] = new Kt(t3, s[a]);
...
function Di() {
  return new M(this._exit || this._groups.map(ir), this._parents);
}
function Hi(t3, e, n) {
...
function ct(t3, e) {
  return t3.style.getPropertyValue(e) || sr(t3).getComputedStyle(t3, null).getPropertyValue(e);
}
function cs(t3) {
  return function() {
    delete this[t3];
...
function Xe(t3) {
  return t3.classList || new ar(t3);
}
function ar(t3) {
  this._node = t3, this._names = or(t3.getAttribute("class") || "");
}
ar.prototype = { add: function(t3) {
...
function cr(t3, e) {
  for (var n = Xe(t3), r = -1, i = e.length; ++r < i; ) n.add(e[r]);
}
function ur(t3, e) {
  for (var n = Xe(t3), r = -1, i = e.length; ++r < i; ) n.remove(e[r]);
}
function hs(t3) {
  return function() {
    cr(this, t3);
...
function ps(t3, e) {
  return function() {
    (e.apply(this, arguments) ? cr : ur)(this, t3);
  };
}
function vs(t3, e) {
  var n = or(t3 + "");
  if (arguments.length < 2) {
    for (var r = Xe(this.node()), i = -1, s = n.length; ++i < s; ) if (!r.contains(n[i])) return false;
    return true;
  }
...
function $s(t3) {
  var e = typeof t3 == "function" ? t3 : tr(t3);
...
function Rs(t3, e) {
  var n = typeof t3 == "function" ? t3 : tr(t3), r = e == null ? ks : typeof e == "function" ? e : Ue(e);
  return this.select(function() {
...
function Bs(t3, e, n) {
  ...
  for (a = e ? Hs : Ds, i = 0; i < s; ++i) this.each(a(r[i], e, n));
  return this;
}
function lr(t3, e, n) {
  var r = sr(t3), i = r.CustomEvent;
...
function Ws(t3, e) {
  return function() {
    return lr(this, t3, e.apply(this, arguments));
  };
}
function Us(t3, e) {
...
function kt() {
  return new M([[document.documentElement]], fr);
}
function qs() {
  return this;
}
M.prototype = kt.prototype = { constructor: M, select: _i, selectAll: bi, selectChild: Ti, selectChildren: Ri, filter: Ni, data: Fi, enter: Oi, exit: Di, join: Hi, merge: Bi, selection: qs, order: Vi, sort: Wi, call: Xi, nodes: qi, node: Gi, size: Yi, empty: Zi, each: Ki, attr: rs, style: as, property: fs, classed: vs, text: ys, html: As, raise: Ss, lower: Es, append: $s, insert: Rs, remove: Os, clone: Ps, datum: Is, on: Bs, dispatch: Us, [Symbol.iterator]: Xs };
function rt(t3) {
  return typeof t3 == "string" ? new M([[document.querySelector(t3)]], [document.documentElement]) : new M([[t3]], fr);
}
function Gs(t3) {
  let e;
...
function Zs(t3) {
  let e, n, r;
  t3.length !== 2 ? (e = _e, n = (a, c) => _e(t3(a), c), r = (a, c) => t3(a) - c) : (e = t3 === _e || t3 === Ys ? t3 : Ks, n = t3, r = t3);
...
const qe = (t3) => typeof t3 == "number", hr = (t3) => typeof t3 == "function", Ge = (t3) => Array.isArray(t3), to = (t3) => t3 instanceof Object, Qt = (t3) => t3.constructor.name !== "Function" && t3.constructor.name !== "Object", hn = (t3) => to(t3) && !Ge(t3) && !hr(t3) && !Qt(t3), Jt = (t3, e, n = [], r = /* @__PURE__ */ new Set()) => {
  if (Array.isArray(t3)) {
    if (!Array.isArray(e) || t3.length !== e.length) return false;
    if (r.has(t3)) return true;
    r.add(t3);
    for (let i = 0; i < t3.length; i++) if (!Jt(t3[i], e[i], n, r)) return false;
    return true;
  }
  ...
  if (typeof t3 == "object" && t3 !== null && e !== null) {
    ...
    if (r.has(t3)) return true;
    r.add(t3);
    for (const o of i) if (!Jt(t3[o], e[o], n, r)) return false;
    return true;
  }
  return t3 === e;
  ...
  const r = Qt(t3) ? t3 : jt(t3);
  return n.has(e) ? n.get(e) : (n.set(e, r), Object.keys(e).forEach((i) => {
    i === "__proto__" || i === "constructor" || (hn(t3[i]) && hn(e[i]) ? r[i] = lt(t3[i], e[i], n) : Qt(e) ? r[i] = e : r[i] = jt(e[i]));
  }), r);
}, te = (t3, e, n) => js(e, t3);
function dr(t3, e, n) {
  return hr(e) ? e(t3, n) : e;
}
function no(t3, e, n) {
  return dr(t3, e, n);
}
...
function ro(t3, ...e) {
  return t3 ? fn(t3, (r, i) => fn(e, (s) => X(r, s, i))) : void 0;
}
function io(t3, ...e) {
...
}, pn = "ResizeObserver loop completed with undelivered notifications.", ao = function() {
  var t3;
  typeof ErrorEvent == "function" ? t3 = new ErrorEvent("error", { message: pn }) : (t3 = document.createEvent("Event"), t3.initEvent("error", false, false), t3.message = pn), window.dispatchEvent(t3);
}, At;
(function(t3) {
...
var j = function(t3) {
  ...
  return false;
}, wt = typeof window < "u" ? window : {}, zt = /* @__PURE__ */ new WeakMap(), gn = /auto|scroll/, lo = /^tb|vertical/, fo = /msie|trident/i.test(wt.navigator && wt.navigator.userAgent), F = function(t3) {
  return parseFloat(t3 || "0");
}, it = function(t3, e, n) {
  return t3 === void 0 && (t3 = 0), e === void 0 && (e = 0), n === void 0 && (n = false), new co((n ? e : t3) || 0, (n ? t3 : e) || 0);
}, mn = j({ devicePixelContentBoxSize: it(), borderBoxSize: it(), contentBoxSize: it(), contentRect: new pr(0, 0, 0, 0) }), gr = function(t3, e) {
  if (e === void 0 && (e = false), zt.has(t3) && !e) return zt.get(t3);
  if (vr(t3)) return zt.set(t3, mn), mn;
  var n = getComputedStyle(t3), r = Ye(t3) && t3.ownerSVGElement && t3.getBBox(), i = !fo && n.boxSizing === "border-box", s = lo.test(n.writingMode || ""), o = !r && gn.test(n.overflowY || ""), a = !r && gn.test(n.overflowX || ""), c = r ? 0 : F(n.paddingTop), u = r ? 0 : F(n.paddingRight), l = r ? 0 : F(n.paddingBottom), f = r ? 0 : F(n.paddingLeft), h = r ? 0 : F(n.borderTopWidth), d = r ? 0 : F(n.borderRightWidth), v = r ? 0 : F(n.borderBottomWidth), p = r ? 0 : F(n.borderLeftWidth), g = f + u, y = c + l, m = p + d, _ = h + v, T = a ? t3.offsetHeight - _ - t3.clientHeight : 0, w = o ? t3.offsetWidth - m - t3.clientWidth : 0, S = i ? g + m : 0, x = i ? y + _ : 0, W = r ? r.width : F(n.width) - S - w, $ = r ? r.height : F(n.height) - x - T, ei = W + g + w + m, ni = $ + y + T + _, on = j({ devicePixelContentBoxSize: it(Math.round(W * devicePixelRatio), Math.round($ * devicePixelRatio), s), borderBoxSize: it(ei, ni, s), contentBoxSize: it(W, $, s), contentRect: new pr(f, c, W, $) });
  return zt.set(t3, on), on;
}, mr = function(t3, e, n) {
  var r = gr(t3, n), i = r.borderBoxSize, s = r.contentBoxSize, o = r.devicePixelContentBoxSize;
  switch (e) {
    case At.DEVICE_PIXEL_CONTENT_BOX:
      return o;
    case At.BORDER_BOX:
      return i;
    default:
  ...
  return !!Ht;
}, wo = 250, xo = { attributes: true, characterData: true, childList: true, subtree: true }, yn = ["resize", "load", "transitionend", "animationend", "animationstart", "animationiteration", "keyup", "keydown", "mouseup", "mousedown", "mouseover", "mouseout", "blur", "focus"], wn = function(t3) {
  return t3 === void 0 && (t3 = 0), Date.now() + t3;
}, we = false, bo = function() {
  function t3() {
    var e = this;
  ...
  return t3.prototype.run = function(e) {
    ...
    document.body ? n() : wt.addEventListener("DOMContentLoaded", n);
  }, t3.prototype.start = function() {
    var e = this;
    this.stopped && (this.stopped = false, this.observer = new MutationObserver(this.listener), this.observe(), yn.forEach(function(n) {
      return wt.addEventListener(n, e.listener, true);
    }));
  }, t3.prototype.stop = function() {
    var e = this;
    this.stopped || (this.observer && this.observer.disconnect(), yn.forEach(function(n) {
      return wt.removeEventListener(n, e.listener, true);
    }), this.stopped = true);
  }, t3;
}(), $e = new bo(), xn = function(t3) {
  !Ht && t3 > 0 && $e.start(), Ht += t3, !Ht && $e.stop();
}, Ao = function(t3) {
  return !Ye(t3) && !uo(t3) && getComputedStyle(t3).display === "inline";
}, Co = function() {
  function t3(e, n) {
    this.target = e, this.observedBox = n || At.CONTENT_BOX, this.lastReportedSize = { inlineSize: 0, blockSize: 0 };
  }
  ...
  return t3;
}(), Mt = /* @__PURE__ */ new WeakMap(), bn = function(t3, e) {
  ...
  return t3.connect = function(e, n) {
    ...
    var i = Mt.get(e), s = i.observationTargets.length === 0;
    bn(i.observationTargets, n) < 0 && (s && J.push(i), i.observationTargets.push(new Co(n, r && r.box)), xn(1), $e.schedule());
  }, t3.unobserve = function(e, n) {
    var r = Mt.get(e), i = bn(r.observationTargets, n), s = r.observationTargets.length === 1;
    i >= 0 && (s && J.splice(J.indexOf(r), 1), r.observationTargets.splice(i, 1), xn(-1));
  }, t3.disconnect = function(e) {
    var n = this, r = Mt.get(e);
  ...
  return t3.prototype.observe = function(e, n) {
    ...
    if (!vn(e)) throw new TypeError("Failed to execute 'observe' on 'ResizeObserver': parameter 1 is not of type 'Element");
    Pt.observe(this, e, n);
    ...
    if (!vn(e)) throw new TypeError("Failed to execute 'unobserve' on 'ResizeObserver': parameter 1 is not of type 'Element");
    Pt.unobserve(this, e);
...
class ee {
  constructor(e) {
    ...
    n.attr("role", "figure"), this.svg = n.append("svg").style("display", "block").attr("xmlns", "http://www.w3.org/2000/svg").attr("height", ee.DEFAULT_CONTAINER_HEIGHT).attr("aria-hidden", true), this._svgDefs = this.svg.append("defs"), this._svgDefsExternal = this.svg.append("defs"), this.element = this.svg.node();
  }
  updateContainer(e) {
    var n;
  ...
  get containerHeight() {
    return this.config.height ? this.element.clientHeight : this._container.clientHeight || this._container.getBoundingClientRect().height || ee.DEFAULT_CONTAINER_HEIGHT;
  }
  get width() {
    return dn(this.containerWidth - this.config.margin.left - this.config.margin.right, 0, Number.POSITIVE_INFINITY);
  }
  get height() {
    return dn(this.containerHeight - this.config.margin.top - this.config.margin.bottom, 0, Number.POSITIVE_INFINITY);
  }
  _removeAllChildren() {
...
ee.DEFAULT_CONTAINER_HEIGHT = 300;
function ko(t3) {
...
}(), R = "-ms-", ne = "-moz-", b = "-webkit-", wr = "comm", Ze = "rule", Ke = "decl", Oo = "@import", xr = "@keyframes", zo = "@layer", Mo = Math.abs, he = String.fromCharCode, Po = Object.assign;
function Io(t3, e) {
...
var de = 1, ft = 1, Ar = 0, O = 0, E = 0, dt = "";
function pe(t3, e, n, r, i, s, o) {
  return { value: t3, root: e, parent: n, type: r, props: i, children: s, line: de, column: ft, length: o, return: "" };
}
function pt(t3, e) {
  return Po(pe("", null, null, "", null, null, 0), t3, { length: -t3.length }, e);
}
function Do() {
  return E;
}
function Ho() {
  return E = O > 0 ? k(dt, --O) : 0, ft--, E === 10 && (ft = 1, de--), E;
}
function z() {
  return E = O < Ar ? k(dt, O++) : 0, ft++, E === 10 && (ft = 1, de++), E;
}
function H() {
  return k(dt, O);
}
...
function Cr(t3) {
  return de = ft = 1, Ar = L(dt = t3), O = 0, [];
}
function Sr(t3) {
  return dt = "", t3;
}
function Vt(t3) {
  return br(Rt(O - 1, Re(t3 === 91 ? t3 + 2 : t3 === 40 ? t3 + 1 : t3)));
}
function Bo(t3) {
  for (; (E = H()) && E < 33; ) z();
  return St(t3) > 2 || St(E) > 3 ? "" : " ";
}
function Vo(t3, e) {
  for (; --e && z() && !(E < 48 || E > 102 || E > 57 && E < 65 || E > 70 && E < 97); ) ;
  return Rt(t3, Bt() + (e < 6 && H() == 32 && z() == 32));
}
function Re(t3) {
  for (; z(); ) switch (E) {
    case t3:
...
function Wo(t3, e) {
  for (; z() && t3 + E !== 57; ) if (t3 + E === 84 && H() === 47) break;
  return "/*" + Rt(e, O - 1) + "*" + he(t3 === 47 ? t3 : z());
}
function Uo(t3) {
  for (; !St(H()); ) z();
  return Rt(t3, O);
...
function Xo(t3) {
  return Sr(Wt("", null, null, null, [""], t3 = Cr(t3), 0, [0], t3));
}
function Wt(t3, e, n, r, i, s, o, a, c) {
  for (var u = 0, l = 0, f = o, h = 0, d = 0, v = 0, p = 1, g = 1, y = 1, m = 0, _ = "", T = i, w = s, S = r, x = _; g; ) switch (v = m, m = z()) {
    case 40:
      if (v != 108 && k(x, f - 1) == 58) {
        ke(x += A(Vt(m), "&", "&\f"), "&\f") != -1 && (y = -1);
        break;
      }
    case 34:
    case 39:
    ...
    case 0:
      switch (m) {
        ...
        case 125:
          g = 0;
        case 59 + l:
          y == -1 && (x = A(x, /\f/g, "")), d > 0 && L(x) - f && It(d > 32 ? Cn(x + ";", r, n, f - 1) : Cn(A(x, " ", "") + ";", r, n, f - 2), c);
          break;
        case 59:
          x += ";";
        default:
          if (It(S = An(x, e, n, u, l, i, a, _, T = [], w = [], f), s), m === 123) if (l === 0) Wt(x, e, S, S, T, s, f, a, w);
          else switch (h === 99 && k(x, 3) === 110 ? 100 : h) {
            case 100:
            case 108:
            case 109:
            case 115:
              Wt(t3, S, S, r && It(An(t3, S, S, 0, 0, i, a, _, i, T = [], f), w), i, w, f, a, r ? T : w);
              break;
            default:
              Wt(x, S, S, S, [""], w, 0, a, w);
          }
    ...
    default:
      if (p < 1) {
        if (m == 123) --p;
        else if (m == 125 && p++ == 0 && Ho() == 125) continue;
      }
      switch (x += he(m), m * p) {
        case 38:
          y = l > 0 ? 1 : (x += "\f", -1);
        ...
        case 44:
          ...
          break;
        case 64:
          H() === 45 && (x += Vt(z())), h = H(), l = f = L(_ = x += Uo(Bt())), m++;
          break;
        case 45:
          v === 45 && L(x) == 2 && (p = 0);
      }
...
function An(t3, e, n, r, i, s, o, a, c, u, l) {
  for (var f = i - 1, h = i === 0 ? s : [""], d = Qe(h), v = 0, p = 0, g = 0; v < r; ++v) for (var y = 0, m = Ct(t3, f + 1, f = Mo(p = o[v])), _ = t3; y < d; ++y) (_ = br(p > 0 ? h[y] + " " + m : A(m, /&\f/g, h[y]))) && (c[g++] = _);
  return pe(t3, e, n, i === 0 ? Ze : a, c, u, l);
}
function qo(t3, e, n) {
  return pe(t3, e, n, wr, he(Do()), Ct(t3, 2, -2), 0);
}
function Cn(t3, e, n, r) {
  return pe(t3, e, n, Ke, Ct(t3, 0, r), Ct(t3, r + 1, -1), r);
}
function st(t3, e) {
  for (var n = "", r = Qe(t3), i = 0; i < r; i++) n += e(t3[i], i, t3, e) || "";
  return n;
}
...
var Qo = function(e, n, r) {
  for (var i = 0, s = 0; i = s, s = H(), i === 38 && s === 12 && (n[r] = 1), !St(s); ) z();
  return Rt(e, O);
}, Jo = function(e, n) {
  var r = -1, i = 44;
  do
    switch (St(i)) {
      case 0:
        i === 38 && H() === 12 && (n[r] = 1), e[r] += Qo(O - 1, n, r);
        break;
      case 2:
        e[r] += Vt(i);
        break;
  ...
  switch (Io(t3, e)) {
    ...
    case 4765:
      if (L(t3) - 1 - e > 6) switch (k(t3, e + 1)) {
        ...
        case 102:
          return A(t3, /(.+:)(.+)-([^]+)/, "$1" + b + "$2-$3$1" + ne + (k(t3, e + 3) == 108 ? "$3" : "$2-$3")) + t3;
        case 115:
          return ~ke(t3, "stretch") ? Tr(A(t3, "stretch", "fill-available"), e) + t3 : t3;
      }
      break;
    case 4949:
      if (k(t3, e + 1) !== 115) break;
    case 6444:
      switch (k(t3, L(t3) - 3 - (~ke(t3, "!important") && 10))) {
        case 107:
          return A(t3, ":", ":" + b) + t3;
        case 101:
    ...
    case Ze:
      if (e.length) return Lo(e.props, function(s) {
        switch (Fo(s, /(::plac\w+|:read-\w+)/)) {
          case ":read-only":
          case ":read-write":
            return st([pt(e, { props: [A(s, /:(read-\w+)/, ":" + ne + "$1")] })], i);
          case "::placeholder":
            return st([pt(e, { props: [A(s, /:(plac\w+)/, ":" + b + "input-$1")] }), pt(e, { props: [A(s, /:(plac\w+)/, ":" + ne + "$1")] }), pt(e, { props: [A(s, /:(plac\w+)/, R + "input-$1")] })], i);
        }
        return "";
      });
  }
...
function ua(t3, e, n) {
  var r = "";
  if (Array.isArray(n)) for (var i = 0; i < n.length; i++) r += re(t3, e, n[i]) + ";";
  else for (var s in n) {
    var o = n[s];
    if (typeof o != "object") {
      var a = o;
      e != null && e[a] !== void 0 ? r += s + "{" + e[a] + "}" : Tn(a) && (r += xe(s) + ":" + En(s, a) + ";");
    } else if (Array.isArray(o) && typeof o[0] == "string" && (e == null || e[o[0]] === void 0)) for (var c = 0; c < o.length; c++) Tn(o[c]) && (r += xe(s) + ":" + En(s, o[c]) + ";");
    else {
      var u = re(t3, e, o);
      switch (s) {
        case "animation":
...
var $n = /label:\s*([^\s;{]+)\s*(;|$)/g, Z;
function be(t3, e, n) {
  if (t3.length === 1 && typeof t3[0] == "object" && t3[0] !== null && t3[0].styles !== void 0) return t3[0];
  var r = true, i = "";
  Z = void 0;
  var s = t3[0];
  if (s == null || s.raw === void 0) r = false, i += re(n, e, s);
  else {
    var o = s;
    i += o[0];
  }
  for (var a = 1; a < t3.length; a++) if (i += re(n, e, t3[a]), r) {
    var c = s;
    i += c[a];
  }
  $n.lastIndex = 0;
  for (var u = "", l; (l = $n.exec(i)) !== null; ) u += "-" + l[1];
  var f = sa(i) + u;
...
var ha = function(e) {
  ...
  var r = function() {
    ...
    var f = be(u, n.registered, void 0);
    return fa(n, f), n.key + "-" + f.name;
  }, i = function() {
    for (var c = arguments.length, u = new Array(c), l = 0; l < c; l++) u[l] = arguments[l];
    var f = be(u, n.registered), h = "animation-" + f.name;
    return kn(n, { name: f.name, styles: "@keyframes " + h + "{" + f.styles + "}" }), h;
  }, s = function() {
    for (var c = arguments.length, u = new Array(c), l = 0; l < c; l++) u[l] = arguments[l];
    var f = be(u, n.registered);
    kn(n, f);
  }, o = function() {
    for (var c = arguments.length, u = new Array(c), l = 0; l < c; l++) u[l] = arguments[l];
    return Rn(n.registered, r, da(u));
  };
  ...
  }, sheet: n.sheet, cache: n, getRegisteredStyles: $r.bind(null, n.registered), merge: Rn.bind(null, n.registered, r) };
}, da = function t(e) {
  ...
  return n;
}, kr = ha({ key: "css" }), Rr = kr.injectGlobal, Nt = kr.css, Ae, Nn;
function pa() {
  return Nn || (Nn = 1, Ae = function(e, n) {
    n || (n = [0, ""]), e = String(e);
...
function et(t3) {
  var e, n;
  return t3 = (t3 + "").trim().toLowerCase(), (e = _a.exec(t3)) ? (n = e[1].length, e = parseInt(e[1], 16), n === 6 ? In(e) : n === 3 ? new N(e >> 8 & 15 | e >> 4 & 240, e >> 4 & 15 | e & 240, (e & 15) << 4 | e & 15, 1) : n === 8 ? Ft(e >> 24 & 255, e >> 16 & 255, e >> 8 & 255, (e & 255) / 255) : n === 4 ? Ft(e >> 12 & 15 | e >> 8 & 240, e >> 8 & 15 | e >> 4 & 240, e >> 4 & 15 | e & 240, ((e & 15) << 4 | e & 15) / 255) : null) : (e = ya.exec(t3)) ? new N(e[1], e[2], e[3], 1) : (e = wa.exec(t3)) ? new N(e[1] * 255 / 100, e[2] * 255 / 100, e[3] * 255 / 100, 1) : (e = xa.exec(t3)) ? Ft(e[1], e[2], e[3], e[4]) : (e = ba.exec(t3)) ? Ft(e[1] * 255 / 100, e[2] * 255 / 100, e[3] * 255 / 100, e[4]) : (e = Aa.exec(t3)) ? Dn(e[1], e[2] / 100, e[3] / 100, 1) : (e = Ca.exec(t3)) ? Dn(e[1], e[2] / 100, e[3] / 100, e[4]) : zn.hasOwnProperty(t3) ? In(zn[t3]) : t3 === "transparent" ? new N(NaN, NaN, NaN, 0) : null;
}
function In(t3) {
  return new N(t3 >> 16 & 255, t3 >> 8 & 255, t3 & 255, 1);
}
function Ft(t3, e, n, r) {
  return r <= 0 && (t3 = e = n = NaN), new N(t3, e, n, r);
}
function Ea(t3) {
  return t3 instanceof Ot || (t3 = et(t3)), t3 ? (t3 = t3.rgb(), new N(t3.r, t3.g, t3.b, t3.opacity)) : new N();
}
function Ne(t3, e, n, r) {
  return arguments.length === 1 ? Ea(t3) : new N(t3, e, n, r ?? 1);
}
function N(t3, e, n, r) {
  this.r = +t3, this.g = +e, this.b = +n, this.opacity = +r;
}
Je(N, Ne, Nr(Ot, { brighter(t3) {
  return t3 = t3 == null ? ie : Math.pow(ie, t3), new N(this.r * t3, this.g * t3, this.b * t3, this.opacity);
}, darker(t3) {
  return t3 = t3 == null ? Tt : Math.pow(Tt, t3), new N(this.r * t3, this.g * t3, this.b * t3, this.opacity);
}, rgb() {
  return this;
}, clamp() {
  return new N(tt(this.r), tt(this.g), tt(this.b), se(this.opacity));
}, displayable() {
  return -0.5 <= this.r && this.r < 255.5 && -0.5 <= this.g && this.g < 255.5 && -0.5 <= this.b && this.b < 255.5 && 0 <= this.opacity && this.opacity <= 1;
}, hex: Fn, formatHex: Fn, formatHex8: $a, formatRgb: Ln, toString: Ln }));
function Fn() {
...
function Or(t3) {
  ...
  if (t3 instanceof Ot || (t3 = et(t3)), !t3) return new P();
...
Je(P, je, Nr(Ot, { brighter(t3) {
  return t3 = t3 == null ? ie : Math.pow(ie, t3), new P(this.h, this.s, this.l * t3, this.opacity);
}, darker(t3) {
  return t3 = t3 == null ? Tt : Math.pow(Tt, t3), new P(this.h, this.s, this.l * t3, this.opacity);
}, rgb() {
  var t3 = this.h % 360 + (this.h < 0) * 360, e = isNaN(t3) || isNaN(this.s) ? 0 : this.s, n = this.l, r = n + (n < 0.5 ? n : 1 - n) * e, i = 2 * n - r;
  return new N(Se(t3 >= 240 ? t3 - 240 : t3 + 120, i, r), Se(t3, i, r), Se(t3 < 120 ? t3 + 240 : t3 - 120, i, r), this.opacity);
}, clamp() {
  return new P(Hn(this.h), Lt(this.s), Lt(this.l), se(this.opacity));
}, displayable() {
  return (0 <= this.s && this.s <= 1 || isNaN(this.s)) && 0 <= this.l && this.l <= 1 && 0 <= this.opacity && this.opacity <= 1;
}, formatHsl() {
  const t3 = se(this.opacity);
  return `${t3 === 1 ? "hsl(" : "hsla("}${Hn(this.h)}, ${Lt(this.s) * 100}%, ${Lt(this.l) * 100}%${t3 === 1 ? ")" : `, ${t3})`}`;
} }));
function Hn(t3) {
...
const gt = (globalThis == null ? void 0 : globalThis.UNOVIS_COLORS) || ["#4D8CFD", "#FF6B7E", "#F4B83E", "#A6CC74", "#00C19A", "#6859BE"], ka = (globalThis == null ? void 0 : globalThis.UNOVIS_COLORS_DARK) || ["#4D8CFD", "#FF6B7E", "#FFC16D", "#A6CC74", "#00C19A", "#7887E0"], G = (t3) => `--vis-${qe(t3) ? `color${t3 % gt.length}` : t3}`;
...
function Ma() {
  const t3 = Oe.map(Oa).concat(ze.map(za)).join(""), e = document.createElementNS("http://www.w3.org/2000/svg", "svg");
...
Rr`
  ...
  return `
    ...
    body.theme-patterns {
      ${Oe.map((t3, e) => `path[style*="fill: var(${G(e)})"]  {
...
Ut.prototype = Ir.prototype = { constructor: Ut, on: function(t3, e) {
  ...
  for (; ++s < o; ) if (i = (t3 = r[s]).type) n[i] = Vn(n[i], t3.name, e);
  else if (e == null) for (i in n) n[i] = Vn(n[i], t3.name, null);
  return this;
}, copy: function() {
  var t3 = {}, e = this._;
...
var ht = 0, mt = 0, vt = 0, Fr = 1e3, ae, _t, ce = 0, nt = 0, ve = 0, $t = typeof performance == "object" && performance.now ? performance : Date, Lr = typeof window == "object" && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function(t3) {
  setTimeout(t3, 17);
};
function tn() {
  return nt || (Lr(Da), nt = $t.now() + ve);
}
function Da() {
  nt = 0;
}
...
ue.prototype = Dr.prototype = { constructor: ue, restart: function(t3, e, n) {
  if (typeof t3 != "function") throw new TypeError("callback is not a function");
  n = (n == null ? tn() : +n) + (e == null ? 0 : +e), !this._next && _t !== this && (_t ? _t._next = this : ae = this, _t = this), this._call = t3, this._time = n, Me();
}, stop: function() {
...
function Ha() {
  tn(), ++ht;
  for (var t3 = ae, e; t3; ) (e = nt - t3._time) >= 0 && t3._call.call(void 0, e), t3 = t3._next;
  --ht;
}
function Wn() {
  nt = (ce = $t.now()) + ve, ht = mt = 0;
  try {
    Ha();
  } finally {
    ht = 0, Va(), nt = 0;
...
function Ba() {
  var t3 = $t.now(), e = t3 - ce;
  e > Fr && (ve -= e, ce = t3);
}
function Va() {
  for (var t3, e = ae, n, r = 1 / 0; e; ) e._call ? (r > e._time && (r = e._time), t3 = e, e = e._next) : (n = e._next, e._next = null, e = t3 ? t3._next = n : ae = n);
  _t = t3, Me(r);
}
function Me(t3) {
  if (!ht) {
    ...
    var e = t3 - nt;
    e > 24 ? (t3 < 1 / 0 && (mt = setTimeout(Wn, t3 - $t.now() - ve)), vt && (vt = clearInterval(vt))) : (vt || (ce = $t.now(), vt = setInterval(Ba, Fr)), ht = 1, Lr(Wn));
  }
}
function Un(t3, e, n) {
  var r = new ue();
...
var Wa = Ir("start", "end", "cancel", "interrupt"), Ua = [], Hr = 0, Xn = 1, Pe = 2, Xt = 3, qn = 4, Ie = 5, qt = 6;
function ge(t3, e, n, r, i, s) {
  var o = t3.__transition;
  if (!o) t3.__transition = {};
  else if (n in o) return;
  Xa(t3, n, { name: e, index: r, group: i, on: Wa, tween: Ua, time: s.time, delay: s.delay, duration: s.duration, ease: s.ease, timer: null, state: Hr });
}
function en(t3, e) {
  var n = I(t3, e);
...
function V(t3, e) {
  var n = I(t3, e);
  if (n.state > Xt) throw new Error("too late; already running");
  return n;
}
function I(t3, e) {
...
function Xa(t3, e, n) {
  ...
  r[e] = n, n.timer = Dr(s, 0, n.time);
  function s(u) {
    n.state = Xn, n.timer.restart(o, n.delay, n.time), n.delay <= u && o(u - n.delay);
  }
  function o(u) {
    var l, f, h, d;
    if (n.state !== Xn) return c();
    for (l in r) if (d = r[l], d.name === n.name) {
      if (d.state === Xt) return Un(o);
      d.state === qn ? (d.state = qt, d.timer.stop(), d.on.call("interrupt", t3, t3.__data__, d.index, d.group), delete r[l]) : +l < e && (d.state = qt, d.timer.stop(), d.on.call("cancel", t3, t3.__data__, d.index, d.group), delete r[l]);
    }
    if (Un(function() {
      n.state === Xt && (n.state = qn, n.timer.restart(a, n.delay, n.time), a(u));
    }), n.state = Pe, n.on.call("start", t3, t3.__data__, n.index, n.group), n.state === Pe) {
      for (n.state = Xt, i = new Array(h = n.tween.length), l = 0, f = -1; l < h; ++l) (d = n.tween[l].value.call(t3, t3.__data__, n.index, n.group)) && (i[++f] = d);
      i.length = f + 1;
    }
  }
  function a(u) {
    for (var l = u < n.duration ? n.ease.call(null, u / n.duration) : (n.timer.restart(c), n.state = Ie, 1), f = -1, h = i.length; ++f < h; ) i[f].call(t3, l);
    n.state === Ie && (n.on.call("end", t3, t3.__data__, n.index, n.group), c());
  }
  function c() {
...
function Br(t3, e) {
  ...
  if (n) {
    ...
    for (o in n) {
      ...
      i = r.state > Pe && r.state < Ie, r.state = qt, r.timer.stop(), r.on.call(i ? "interrupt" : "cancel", t3, t3.__data__, r.index, r.group), delete n[o];
    }
...
function Za(t3) {
  return (t3 = +t3) == 1 ? Vr : function(e, n) {
    return n - e ? Ya(e, n, t3) : nn(isNaN(e) ? n : e);
  };
}
function Vr(t3, e) {
  var n = e - t3;
  return n ? Ga(t3, n) : nn(isNaN(t3) ? e : t3);
}
const le = function t2(e) {
  var n = Za(e);
  function r(i, s) {
    var o = n((i = Ne(i)).r, (s = Ne(s)).r), a = n(i.g, s.g), c = n(i.b, s.b), u = Vr(i.opacity, s.opacity);
    return function(l) {
...
var Fe = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g, Te = new RegExp(Fe.source, "g");
function ec(t3) {
  return function() {
    return t3;
  };
...
function Wr(t3, e) {
  var n = Fe.lastIndex = Te.lastIndex = 0, r, i, s, o = -1, a = [], c = [];
  for (t3 = t3 + "", e = e + ""; (r = Fe.exec(t3)) && (i = Te.exec(e)); ) (s = i.index) > n && (s = e.slice(n, s), a[o] ? a[o] += s : a[++o] = s), (r = r[0]) === (i = i[0]) ? a[o] ? a[o] += i : a[++o] = i : (a[++o] = null, c.push({ i: o, x: D(r, i) })), n = Te.lastIndex;
...
function Ur(t3, e) {
  var n = typeof e, r;
  return e == null || n === "boolean" ? nn(e) : (n === "number" ? D : n === "string" ? (r = et(e)) ? (e = r, le) : Wr : e instanceof et ? le : e instanceof Date ? ja : Qa(e) ? Ka : Array.isArray(e) ? Ja : typeof e.valueOf != "function" && typeof e.toString != "function" || isNaN(e) ? tc : D)(t3, e);
}
var Gn = 180 / Math.PI, Le = { translateX: 0, translateY: 0, rotate: 0, skewX: 0, scaleX: 1, scaleY: 1 };
function Xr(t3, e, n, r, i, s) {
  var o, a, c;
  return (o = Math.sqrt(t3 * t3 + e * e)) && (t3 /= o, e /= o), (c = t3 * n + e * r) && (n -= t3 * c, r -= e * c), (a = Math.sqrt(n * n + r * r)) && (n /= a, r /= a, c /= a), t3 * r < e * n && (t3 = -t3, e = -e, c = -c, o = -o), { translateX: i, translateY: s, rotate: Math.atan2(e, t3) * Gn, skewX: Math.atan(c) * Gn, scaleX: o, scaleY: a };
}
var Dt;
function rc(t3) {
  const e = new (typeof DOMMatrix == "function" ? DOMMatrix : WebKitCSSMatrix)(t3 + "");
  return e.isIdentity ? Le : Xr(e.a, e.b, e.c, e.d, e.e, e.f);
}
function ic(t3) {
  return t3 == null || (Dt || (Dt = document.createElementNS("http://www.w3.org/2000/svg", "g")), Dt.setAttribute("transform", t3), !(t3 = Dt.transform.baseVal.consolidate())) ? Le : (t3 = t3.matrix, Xr(t3.a, t3.b, t3.c, t3.d, t3.e, t3.f));
}
function qr(t3, e, n, r) {
  ...
  function s(u, l, f, h, d, v) {
    if (u !== f || l !== h) {
      ...
      v.push({ i: p - 4, x: D(u, f) }, { i: p - 2, x: D(l, h) });
...
function Gr(t3, e) {
  var n;
  return (typeof e == "number" ? D : e instanceof et ? le : (n = et(e)) ? (e = n, le) : Wr)(t3, e);
}
function lc(t3) {
  return function() {
    this.removeAttribute(t3);
...
function gc(t3, e) {
  var n = fe(t3), r = n === "transform" ? oc : Gr;
  return this.attrTween(t3, typeof e == "function" ? (n.local ? vc : pc)(n, r, rn(this, "attr." + t3, e)) : e == null ? (n.local ? fc : lc)(n) : (n.local ? dc : hc)(n, r, e));
}
function mc(t3, e) {
  return function(n) {
...
function bc(t3, e) {
  return function() {
    en(this, t3).delay = +e.apply(this, arguments);
  };
}
function Ac(t3, e) {
  return e = +e, function() {
...
function Dc(t3) {
  ...
  typeof t3 != "function" && (t3 = Ue(t3));
  for (var r = this._groups, i = r.length, s = new Array(i), o = 0; o < i; ++o) for (var a = r[o], c = a.length, u = s[o] = new Array(c), l, f, h = 0; h < c; ++h) (l = a[h]) && (f = t3.call(l, l.__data__, h, a)) && ("__data__" in l && (f.__data__ = l.__data__), u[h] = f, ge(u[h], e, n, h, u, I(l, n)));
...
function Hc(t3) {
  ...
  for (var r = this._groups, i = r.length, s = [], o = [], a = 0; a < i; ++a) for (var c = r[a], u = c.length, l, f = 0; f < u; ++f) if (l = c[f]) {
    for (var h = t3.call(l, l.__data__, f, c), d, v = I(l, n), p = 0, g = h.length; p < g; ++p) (d = h[p]) && ge(d, e, n, p, h, v);
    s.push(h), o.push(l);
  }
  return new q(s, o, e, n);
}
var Bc = kt.prototype.constructor;
function Vc() {
...
function Gc(t3, e, n) {
  ...
  return e == null ? this.styleTween(t3, Wc(t3, r)).on("end.style." + t3, Yr(t3)) : typeof e == "function" ? this.styleTween(t3, Xc(t3, r, rn(this, "style." + t3, e))).each(qc(this._id, t3)) : this.styleTween(t3, Uc(t3, r, e), n).on("end.style." + t3, null);
}
function Yc(t3, e, n) {
  return function(r) {
...
function jc(t3) {
  return this.tween("text", typeof t3 == "function" ? Jc(rn(this, "text", t3)) : Qc(t3 == null ? "" : t3 + ""));
}
function tu(t3) {
  return function(e) {
...
function ru() {
  for (var t3 = this._name, e = this._id, n = Zr(), r = this._groups, i = r.length, s = 0; s < i; ++s) for (var o = r[s], a = o.length, c, u = 0; u < a; ++u) if (c = o[u]) {
    var l = I(c, e);
    ge(c, t3, n, u, o, { time: l.time + l.delay + l.duration, delay: 0, duration: l.duration, ease: l.ease });
  }
...
var U = kt.prototype;
q.prototype = { constructor: q, select: Dc, selectAll: Hc, selectChild: U.selectChild, selectChildren: U.selectChildren, filter: Oc, merge: zc, selection: Vc, transition: ru, call: U.call, nodes: U.nodes, node: U.node, size: U.size, empty: U.empty, each: U.each, on: Ic, attr: gc, attrTween: xc, style: Gc, styleTween: Kc, text: jc, textTween: nu, remove: Lc, tween: uc, delay: Cc, duration: Ec, ease: kc, easeVarying: Nc, end: iu, [Symbol.iterator]: U[Symbol.iterator] };
function ou(t3) {
...
function uu(t3) {
  var e, n;
  t3 instanceof q ? (e = t3._id, t3 = t3._name) : (e = Zr(), (n = au).time = tn(), t3 = t3 == null ? null : t3 + "");
  for (var r = this._groups, i = r.length, s = 0; s < i; ++s) for (var o = r[s], a = o.length, c, u = 0; u < a; ++u) (c = o[u]) && ge(c, t3, e, u, o, n || cu(c, e));
  return new q(r, this._parents, t3, e);
}
kt.prototype.interrupt = qa;
kt.prototype.transition = uu;
function Gu(t3, e, n) {
  if (t3.nodes().forEach((r) => Br(r)), e) {
...
const fu = { components: [], container: void 0, followCursor: true, allowHover: true, horizontalPlacement: C.Auto, horizontalShift: 0, verticalPlacement: C.Top, verticalShift: 0, attributes: {}, triggers: {}, className: void 0 }, me = Nt`
  label: tooltip;
...
`, Jr = Nt`
  ...
  pointer-events: none;
  user-select: none;
`, pu = Object.freeze(Object.defineProperty({ __proto__: null, hidden: He, nonInteractive: Jr, positionFixed: Qr, root: me, show: De, tooltip: hu, variables: du }, Symbol.toStringTag, { value: "Module" }));
class jr {
  constructor(e = {}) {
    this._defaultConfig = fu, this.config = this._defaultConfig, this._setUpEventsThrottled = te(this._setUpEvents, 500), this._setContainerPositionThrottled = te(this._setContainerPosition, 500), this._isShown = false, this.element = document.createElement("div"), this.div = rt(this.element).attr("class", me), this.setConfig(e), this.components = this.config.components, this._mutationObserver = new MutationObserver(() => {
  ...
  hide() {
    this.div.classed(De, false).on("transitionend", () => {
      this.div.classed(He, !this._isShown);
    }), this._isShown = false;
  }
  display() {
    this.div.classed(He, false).classed(De, true), this._isShown = true;
  }
  place(e) {
        ...
        for (const o of Object.keys(e.triggers)) {
          ...
          for (const u of s) {
            ...
            if (u.classList.contains(o)) {
              const l = c.indexOf(u), f = rt(u).datum(), h = a(f, l, c), [d, v] = this.isContainerBody() ? [i.clientX, i.clientY] : un(i, this._container);
...
jr.selectors = pu;
var Be = Math.PI, Ve = 2 * Be, K = 1e-6, vu = Ve - K;
function We() {
...
We.prototype = gu.prototype = { constructor: We, moveTo: function(t3, e) {
  ...
  if (this._x1 === null) this._ += "M" + (this._x1 = t3) + "," + (this._y1 = e);
    ...
    var h = n - s, d = r - o, v = a * a + c * c, p = h * h + d * d, g = Math.sqrt(v), y = Math.sqrt(f), m = i * Math.tan((Be - Math.acos((v + f - p) / (2 * g * y))) / 2), _ = m / y, T = m / g;
  ...
  this._x1 === null ? this._ += "M" + c + "," + u : (Math.abs(this._x1 - c) > K || Math.abs(this._y1 - u) > K) && (this._ += "L" + c + "," + u), n && (f < 0 && (f = f % Ve + Ve), f > vu ? this._ += "A" + n + "," + n + ",0,1," + l + "," + (t3 - o) + "," + (e - a) + "A" + n + "," + n + ",0,1," + l + "," + (this._x1 = c) + "," + (this._y1 = u) : f > K && (this._ += "A" + n + "," + n + ",0," + +(f >= Be) + "," + l + "," + (this._x1 = t3 + n * Math.cos(i)) + "," + (this._y1 = e + n * Math.sin(i))));
...
var Qu = Math.abs, Ju = Math.atan2, ju = Math.cos, tl = Math.max, el = Math.min, nl = Math.sin, rl = Math.sqrt, il = 1e-12, sn = Math.PI, Qn = sn / 2, sl = 2 * sn;
function ol(t3) {
  return t3 > 1 ? 0 : t3 < -1 ? sn : Math.acos(t3);
}
function al(t3) {
  return t3 >= 1 ? Qn : t3 <= -1 ? -Qn : Math.asin(t3);
}
function cl(t3, e, n, r) {
  return Array.isArray(e) && isFinite(n) ? e[n % e.length] : no(t3, e, n) || (qe(n) ? `var(${G(n)})` : null);
}
var at;
(function(t3) {
...
var Gt = { exports: {} }, mu = Gt.exports, jn;
function _u() {
...
function ul(t3, e, n = [" ", "-", ".", ","]) {
  const r = t3.text();
  if (!r) return;
  const i = Ge(n) ? n : [n], s = ti(r, i), o = parseFloat(t3.attr("x")) || 0;
  t3.text("");
...
`).map((c) => {
    ...
    for (let h = 0; h < l.length; h += 1) {
      (n ? Yt(f + l[h], t3.fontSize, t3.fontWidthToHeightRatio) : Zt(f + l[h], t3.fontFamily, t3.fontSize)) < e || h === 0 ? f += l[h] : (u.push(f.trim()), f = l[h]);
      const v = 2;
      if (i) for (; f.trim().length > v && (n ? Yt(f, t3.fontSize, t3.fontWidthToHeightRatio) : Zt(f, t3.fontFamily, t3.fontSize)) > e; ) {
        let g = f.trim().length - v;
        for (; g > 0; ) {
          const y = `${f.substring(0, g)}${Pr}`;
          if ((n ? Yt(y, t3.fontSize, t3.fontWidthToHeightRatio) : Zt(y, t3.fontFamily, t3.fontSize)) <= e || g === 1) {
...
function ku(t3, e = void 0, n = void 0, r = true, i = Mr, s = false) {
  const o = Array.isArray(t3) ? t3.map((f) => lt(Bn, f)) : [lt(Bn, t3)], a = o.map((f) => $u(f, e, r, i, s)), c = o[0];
  ...
  return o.forEach((f, h) => {
    ...
    for (let w = 0; w < v.length; w += 1) {
      let S = v[w];
      u += _;
      const x = `${S} \u2026`, W = r ? Yt(x, f.fontSize, f.fontWidthToHeightRatio) : Zt(x, f.fontFamily, f.fontSize);
...
function fl(t3, e, n, r) {
  ...
  let l = c ?? 0;
  if (n.textAlign && t3.setAttribute("text-anchor", xu(n.textAlign)), n.verticalAlign && n.verticalAlign !== xt.Top) {
    const f = Nu(o), h = n.verticalAlign === xt.Middle ? -f / 2 : n.verticalAlign === xt.Bottom ? -f : 0;
    l += h;
  }
