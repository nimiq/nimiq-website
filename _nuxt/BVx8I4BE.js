import { d as w, c as a, o as n, F as $, r as S, n as m, a as C, w as L, f as q, e as l, t as b, D as B, Y as U, b as v, g as V, u as c, _ as j, v as z, j as I, aj as A, ak as k, al as N, $ as O, h, m as P, i as H, R as T } from "./gdLxT4Lf.js";
import { _ as D } from "./BqBogM76.js";
import { _ as F } from "./BpR0sf--.js";
import { u as M } from "./BAKQThLi.js";
import { a as W } from "./Dcb2Q0rD.js";
import { g as E } from "./CpsPJSKh.js";
import "./DYDUvkDP.js";
function G(f) {
  return new URL(window.location.href);
}
const Q = { grid: "~ cols-1 lg:cols-2 gap-20 md:gap-22" }, Y = w({ __name: "Nimiq", props: { items: {} }, setup(f) {
  return (o, i) => {
    const r = B, u = U;
  ...
  let o, i;
  const { data: r } = ([o, i] = z(() => M({ labelTeamNimiq: f.labelTeamNimiq })), o = await o, i(), o), { filteredApps: u, getSpotlightAppsPosition: g, madeBy: e } = p(r.value);
  function p({ apps: x, spotLightApps: t }) {
    const d = W("made-by", "anyone");
    function y({ name: _, isHighlighted: R }) {
      return R ? { gridRow: `${(t.indexOf(_) + 1) * 3 - 2}`, class: "spotlight-app spotlight-span-2" } : void 0;
    }
    return { filteredApps: I(() => d.value === "anyone" ? x : d.value === "official" ? x.filter((_) => _.developer === "@nimiq") : d.value === "community" ? x.filter((_) => _.developer !== "@nimiq") : []), madeBy: d, getSpotlightAppsPosition: y };
  }
  return (x, t) => {
    const d = D, y = le;
    return n(), a($, null, [l("form", { "rounded-full": "", "bg-neutral-300": "", onSubmit: t[3] || (t[3] = O(() => {
...
} }), re = Object.assign(H(ie, [["__scopeId", "data-v-eeee24d0"]]), { __name: "AppsShowcaseAll" }), me = { "bg-neutral-100": "" }, ye = w({ __name: "index", props: E(), setup(f) {
  return (o, i) => {
    const r = J, u = re;
