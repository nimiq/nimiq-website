import { _ as O } from "./H0qEFha8.js";
import { d as $, b as h, o as s, w as n, R as _, m as D, u as e, ag as I, $ as L, ah as V, p as j, ai as E, Y as U, H, a as p, a4 as R, a0 as Y, e as o, c as m, f as G, i as F, s as J, v as K, z as Q, F as B, r as M, n as W, t as X } from "./g1xKa6TI.js";
import { i as N, _ as Z, c as ee, d as te, a as oe, b as ne } from "./D6ZTM1qK.js";
import { u as S, P as A } from "./DRAR02aM.js";
import { g as ae } from "./CpsPJSKh.js";
import { u as se } from "./Dq5jw32s.js";
import "./k4OXxJR1.js";
import "./Qjh2__OP.js";
import "./DUznQD6O.js";
import "./BDLNfpkA.js";
...
const ce = $({ __name: "Modal", props: I({ name: {} }, { open: { type: Boolean }, openModifiers: {} }), emits: I(["close"], ["update:open"]), setup(l, { emit: r }) {
  ...
  }), H(() => w.replace({ query: { ...b.query, [v]: void 0 } })), (i, g) => {
    const y = ee, q = oe, T = ie, P = re, k = le, t = ne, C = te, a = Z;
    return s(), h(a, { open: f.value, "onUpdate:open": g[1] || (g[1] = (x) => f.value = x) }, { default: n(() => [p(y, D(i.$attrs, { "bg-transparent": "" }), { default: n(() => [_(i.$slots, "trigger", {}, void 0, true)]), _: 3 }, 16), p(C, null, { default: n(() => [p(R, { name: "backdrop" }, { default: n(() => [p(q, { "bg-darkblue": "", "op-60": "", "inset-0": "", fixed: "", "z-200": "" })]), _: 1 }), p(R, { name: "modal" }, { default: n(() => [(s(), h(t, { key: i.name, lg: "top-1/2 left-1/2 translate--1/2", rounded: "t-8 lg:8", "outline-none": "", "data-modal": "", "h-max": "", "max-h-85dvh": "", "w-full": "", "shadow-lg": "", transform: "", "bottom-0": "", fixed: "", "z-200": "", "of-y-auto": "", "lg:max-w-500": "", onOpenAutoFocus: g[0] || (g[0] = Y(() => {
    }, ["prevent"])) }, { default: n(() => [o("div", de, [c.top ? (s(), m("div", ue, [_(i.$slots, "top", {}, void 0, true)])) : G("", true), p(T, { text: "24 center neutral lh-24", "font-bold": "", "lh-none": "", "mb-12": "", "px-24": "", "lg:px-40": "", as: "h2" }, { default: n(() => [_(i.$slots, "title", {}, void 0, true)]), _: 3 }), p(P, { text: "center neutral", "px-24": "", block: "", "lg:px-40": "" }, { default: n(() => [_(i.$slots, "description", {}, void 0, true)]), _: 3 }), o("div", pe, [_(i.$slots, "content", {}, void 0, true)]), p(k, { "aria-label": "Close", "close-btn": "", "text-28": "", "right-16": "", "top-16": "", absolute: "" })])]), _: 3 }))]), _: 3 })]), _: 3 })]), _: 3 }, 8, ["open"]);
  };
} }), me = Object.assign(F(ce, [["__scopeId", "data-v-824c1785"]]), { __name: "Modal" }), _e = { class: "dark", "text-neutral": "", "pt-0": "", "bg-darkerblue": "", "scheme-dark": "" }, fe = { "nq-prose-compact": "", "text-neutral-800": "", "f-mt-xs": "" }, be = { flex: "~ gap-8", "lh-none": "", "mb-32": "", "mt--8": "", "px-8": "", "h-12": "", "w-full": "" }, ge = ["aria-selected", "tabindex", "onClick"], xe = { mx: "-24 lg:-40", w: "[calc(100%+48px)] lg:[calc(100%+80px)]", "rounded-b-8": "", relative: "" }, he = ["aria-hidden"], ve = { flex: "~", border: "t neutral-500", w: "[calc(100%+48px)] lg:[calc(100%+80px)]", mx: "-24 lg:-40", "mb--32": "", "bottom-0": "", sticky: "", "of-hidden": "", "lg:rounded-b-8": "" }, ye = ["disabled"], ke = ["disabled"], Ce = { key: 1, "gap-x-64": "", "max-w-80ch": "", "break-inside-avoid": "", "f-pt-lg": "", "md:columns-2": "" }, $e = $({ __name: "index", props: ae(), async setup(l) {
  let r, d;
  const { client: u } = J(), { data: c } = ([r, d] = K(() => Q("technical_details", () => u.getSingle("albatrossSingleType").then((k) => k.data))), r = await r, d(), r), { buttonLabel: f, slides: b } = c.value, w = se({ initialIndex: 0 }), { slidePrev: v, scroller: i, slideNext: g, activeIndex: y, slideTo: q, canSlideNext: T, canSlidePrev: P } = w;
  return (k, t) => {
    const C = O;
    return s(), m("section", _e, [o("div", fe, [p(C, { field: k.slice.primary.subline }, null, 8, ["field"])]), k.slice.primary.asModal ? (s(), h(me, { key: 0, name: e(z).TechnicalDetails, outline: "~ 1.5 neutral-500", "text-18": "", "f-mt-sm": "", "nq-pill-lg": "", "nq-pill-tertiary": "" }, { trigger: n(() => [t[2] || (t[2] = o("div", { "i-custom:cli-docs": "", "mr-8": "" }, null, -1)), o("span", null, X(e(f)), 1), t[3] || (t[3] = o("div", { "text-11": "", "ml-8": "", "op-60": "", "i-nimiq:info": "" }, null, -1))]), top: n(() => {
      var _a;
      return [o("ul", be, [(s(true), m(B, null, M((_a = e(b)) == null ? void 0 : _a.length, (a) => (s(), m("li", { key: a, "flex-1": "" }, [o("button", { class: W(e(y) === a - 1 ? "bg-green" : "bg-neutral-500"), "rounded-full": "", "h-4": "", "w-full": "", "transition-colors": "", role: "tab", "aria-selected": e(y) === a - 1, tabindex: e(y) === a - 1 ? 0 : -1, onClick: (x) => e(q)(a - 1) }, null, 10, ge)]))), 128))])];
...
} }), Ie = F($e, [["__scopeId", "data-v-1f9bd190"]]);
export {
  Ie as default
};
