import { d as E, C as x, G, H as V, I as g, b as J, w as Y, u as $, o as j, a as X, A as Q } from "./g1xKa6TI.js";
import { g as W } from "./CqkleIqs.js";
import { c as K } from "./CeHn5qUl.js";
const A = (s, e = 16) => {
  let t = 0, i = null;
  return function(...r) {
...
const m = "slice-simulator", I = "slice-simulator--root", Me = () => document.querySelector(`.${m}`), De = () => document.querySelector(`.${I}`), Z = (s) => {
  ...
  const r = t[i + 1];
  return r || null;
}, T = () => ({ zIndex: 100, background: "#ffffff" }), H = () => [], Ee = () => "";
...
}, d = new Ue(), Ve = E({ name: "SliceSimulator", props: { zIndex: { type: Number, default: T().zIndex, required: false }, background: { type: String, default: T().background, required: false } }, setup(s, { slots: e }) {
  const t = x(H()), i = x(Ee());
  return G(() => {
...
} }), Je = Ve, Qe = E({ __name: "slice-simulator", setup(s) {
  return (e, t) => {
    const i = Q;
