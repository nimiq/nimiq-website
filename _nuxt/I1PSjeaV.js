import { a as Fe, c as ye, u as Se, b as Ne, d as Ke, _ as We } from "./CnMfizxz.js";
import { _ as qe } from "./skKO6Fnq.js";
import { _ as ze, m as Ue } from "./L9u5Uk1y.js";
import { i as je } from "./DRbUa3ZN.js";
import { bp as Ye, d as V, r as E, Q as Te, e as R, o as T, f as b, C as L, J as W, l as $, h as t, t as fe, j as be, a as O, k as se, x as te, B as N, H as me, I as Ee, s as G, n as j, q as J, ae as Ge, g as C, P as K, v as Je, bc as Pe, be as Qe, a7 as Xe, bd as Ze, A as Q, a9 as et, bf as tt, af as ot, bH as _e, aa as nt, a3 as oe, a4 as ne, y as at, ad as lt, m as Be, bt as st, a5 as it, al as rt, aJ as ut, G as ae, E as Ie, ay as dt, M as ct, L as we, bz as xe } from "./B8biU-UE.js";
import { c as pt, a as ft } from "./DOgGst0G.js";
import { g as mt } from "./CpsPJSKh.js";
import { a as vt } from "./CQkxAz7J.js";
import { _ as gt, a as ht, u as yt, b as bt } from "./DBRxGtFx.js";
import { _ as _t } from "./CfRIQ3dD.js";
import { u as X } from "./DPuYpcc3.js";
import { u as wt } from "./DIegsOBI.js";
import { i as Ce } from "./CHIgUVhi.js";
import { u as xt } from "./CoPlYyca.js";
import "./RJkaeARB.js";
import "./BzRmGp1f.js";
import "./B5vKjtsS.js";
...
const Et = V({ __name: "BubbleSelect", props: { autocomplete: {}, autofocus: { type: Boolean }, disabled: { type: Boolean }, form: {}, multiple: { type: Boolean }, name: {}, required: { type: Boolean }, size: {}, value: {} }, setup(n) {
  ...
  const e = n, f = s, { getItems: o } = X(), l = Y(), v = ie(), r = E(false), d = E(true), c = E(), { forwardRef: m, currentElement: g } = G(), { viewport: _, selectedItem: h, selectedItemText: u, focusSelectedItem: P } = v;
  function B() {
    if (l.triggerElement.value && l.valueElement.value && c.value && g.value && (_ == null ? void 0 : _.value) && (h == null ? void 0 : h.value) && (u == null ? void 0 : u.value)) {
      ...
      if (l.dir.value !== "rtl") {
        const M = p.left - a.left, F = w.left - M, z = i.left - F, U = i.width + z, ue = Math.max(U, a.width), de = window.innerWidth - A, ce = ye(F, A, Math.max(A, de - ue));
        c.value.style.minWidth = `${U}px`, c.value.style.left = `${ce}px`;
      } else {
        const M = a.right - p.right, F = window.innerWidth - w.right - M, z = window.innerWidth - i.right - F, U = i.width + z, ue = Math.max(U, a.width), de = window.innerWidth - A, ce = ye(F, A, Math.max(A, de - ue));
        c.value.style.minWidth = `${U}px`, c.value.style.right = `${ce}px`;
      }
      const y = o().map((M) => M.ref), x = window.innerHeight - A * 2, I = _.value.scrollHeight, S = window.getComputedStyle(g.value), q = Number.parseInt(S.borderTopWidth, 10), H = Number.parseInt(S.paddingTop, 10), ve = Number.parseInt(S.borderBottomWidth, 10), Re = Number.parseInt(S.paddingBottom, 10), ge = q + H + I + Re + ve, De = Math.min(h.value.offsetHeight * 5, ge), he = window.getComputedStyle(_.value), Ae = Number.parseInt(he.paddingTop, 10), Oe = Number.parseInt(he.paddingBottom, 10), Z = i.top + i.height / 2 - A, Me = x - Z, re = h.value.offsetHeight / 2, Le = h.value.offsetTop + re, ee = q + H + Le, He = ge - ee;
      if (ee <= Z) {
        const M = h.value === y[y.length - 1];
        c.value.style.bottom = "0px";
        const F = g.value.clientHeight - _.value.offsetTop - _.value.offsetHeight, z = Math.max(Me, re + (M ? Oe : 0) + F + ve), U = ee + z;
        c.value.style.height = `${U}px`;
      } else {
        const M = h.value === y[0];
        c.value.style.top = "0px";
        const z = Math.max(Z, q + _.value.offsetTop + (M ? Ae : 0) + re) + He;
        c.value.style.height = `${z}px`, _.value.scrollTop = ee - Z + _.value.offsetTop;
      }
  ...
  const D = E("");
  j(async () => {
    await J(), B(), g.value && (D.value = window.getComputedStyle(g.value).zIndex);
  });
  function k(i) {
    i && d.value === true && (B(), P == null ? void 0 : P(), d.value = false);
  }
  return Ge(l.triggerElement, () => {
    B();
  }), kt({ contentWrapper: c, shouldExpandOnScrollRef: r, onScrollButtonChange: k }), (i, a) => (T(), N("div", { ref_key: "contentWrapperElement", ref: c, style: Je({ display: "flex", flexDirection: "column", position: "fixed", zIndex: D.value }) }, [C(t(K), W({ ref: t(m), style: { boxSizing: "border-box", maxHeight: "100%" } }, { ...i.$attrs, ...e }), { default: b(() => [$(i.$slots, "default")]), _: 3 }, 16)], 4));
  ...
  const e = n, f = s, o = Y();
  yt(), xt(e.bodyLock);
  const { CollectionSlot: l, getItems: v } = X(), r = E();
  Qe(r);
  ...
  }, focusSelectedItem: B, position: e.position, isPositioned: h, searchRef: d }), (p, y) => (T(), R(t(l), null, { default: b(() => [C(t(Ze), { "as-child": "", onMountAutoFocus: y[6] || (y[6] = Q(() => {
  ...
  }) }, { default: b(() => [C(t(et), { "as-child": "", "disable-outside-pointer-events": "", onFocusOutside: y[2] || (y[2] = Q(() => {
  ...
  const e = n, f = s, { disabled: o } = fe(e), l = Y(), v = ie(), { forwardRef: r, currentElement: d } = G(), { CollectionItem: c } = X(), m = O(() => {
    var _a;
  ...
  async function B(a) {
    await J(), f("select", a), !a.defaultPrevented && (o.value || (l.onValueChange(e.value), l.multiple.value || l.onOpenChange(false)));
  }
  async function D(a) {
    var _a, _b;
    await J(), !a.defaultPrevented && (o.value ? (_a = v.onItemLeave) == null ? void 0 : _a.call(v) : (_b = a.currentTarget) == null ? void 0 : _b.focus({ preventScroll: true }));
  }
  async function k(a) {
    var _a;
    await J(), !a.defaultPrevented && a.currentTarget === it() && ((_a = v.onItemLeave) == null ? void 0 : _a.call(v));
  }
  async function i(a) {
    var _a;
    await J(), !(a.defaultPrevented || ((_a = v.searchRef) == null ? void 0 : _a.value) !== "" && a.key === " ") && (St.includes(a.key) && P(a), a.key === " " && a.preventDefault());
  }
  ...
  const { getItems: v } = X(), { search: r, handleTypeaheadSearch: d, resetTypeahead: c } = Se();
  function m() {
...
} }), zt = V({ __name: "SelectViewport", props: { nonce: {}, asChild: { type: Boolean }, as: {} }, setup(n) {
...
} }), Ut = { flex: "~ gap-x-32 gap-y-20 wrap items-baseline" }, jt = { "nq-label": "", text: "f-xs neutral-700" }, Yt = { "bg-neutral-100": "" }, mo = V({ __name: "index", props: mt(), setup(n) {
