...
defineProps(getSliceComponentProps<Content.SimpleHeadlineSlice>())
</script>

<template>
  <section v-if="slice.variation === 'default'" :class="useSectionColor(slice.primary.bgColor)" relative z-1>
