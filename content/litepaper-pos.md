...
Please find a high level roadmap below. For more details and the goals ahead, please visit [the official Nimiq Roadmap](/roadmap).
...
- [HackerOne Bug Bounty Program](https://medium.com/nimiq-network/public-bug-bounty-program-now-live-1eb09eee47ea) started (since moved to [Nimiq Bug Bounty Program](/bug-bounty))
...
- [Staking calculator](/staking) for the upcoming Nimiq 2.0 with PoS
...
For more details and the **roadmap ahead** see [the official Nimiq Roadmap](/roadmap).
