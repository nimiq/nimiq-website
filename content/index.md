---
seo:
  title: Nimiq | Universal money for independent Individuals
  description: It's a centralized world. Nimiq gives it back to the individual.
hero:
  title: Universal Money for Independent Individuals
...
appsLink:
  item: The Apps
  label: Enduser tech
  icon: nimiq:arrows-to-sides
apps:
  headline:
    headline: Powerful and independent apps made to put you back in control
    subline: Nimiq apps are accessible to everyone and will always be.
  items:
    - highlight: false
      title: Pay App
...
banner:
  ...
  items:
    - headline: View all apps
      subline: Explore all apps created by Nimiq's team and community
      link: /apps
techLink:
  item: The Tech
  label: Infra Tech
  icon: nimiq:bolt
techGrid:
  headline: "An instant, zero-fee and green alternative to FIAT money: The Nimiq Blockchain"
