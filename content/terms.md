...
The Nimiq Crowdsale Smart Contract ("Smart Contract System") code is adapted by the Company and deployed on the Ethereum protocol with the address provided at nimiq.com and is incorporated by reference herein ([Contract Link](https://github.com/nimiq-network/nimiq-exchange-token/tree/master/contracts)).
...
We may make changes to these Terms from time to time as reasonably required to comply with applicable law or regulation. If we make changes, we will post the amended Terms at [https://nimiq.com](https://nimiq.com/) and update the "Last Updated" date above. We may also attempt to notify you through the NET website at [https://nimiq.com](https://nimiq.com). The amended Terms will be effective immediately.
...
### Description of Company Nimiq Network Ltd and the Nimiq Network
...
- up to 1,050,000 NIM from exchange of NET from Token Sale Contributors with immediate vesting after the launch of Mainnet.
- 525,000 NIM for a Nimiq long-term endowment foundation vesting ratably over 10 years in 6 month increments at the end of each increment after the launch of Mainnet.
- 420,000 NIM for a Nimiq non-profit organization funding good cause partnerships and sponsorships vesting ratably over 10 years in 6 month increments at the end of each increment after the launch of Mainnet.
- 315,000 NIM for early contributors vested 50% in 3 months and the remainder in 6 month after the launch of Mainnet.
- 210,000 NIM for the Nimiq founders with ratable vesting over 3 years in 6 month increments after the launch of Mainnet.
- All remaining NIM would be created through mining over a period of up to 100 years. We might switch from Proof-of-Work to Proof-of-Stake. In such case the total supply cap of 21 Million NIM could be reduced. This would not reduce the amount of NIM held by Token Sale Contributors, so that it would be beneficial to Token Sale Contributors.
...
Further details regarding the Nimiq Mainnet are described in a whitepaper, available at: [https://medium.com/nimiq-network/nimiq-a-peer-to-peer-payment-protocol-native-to-the-web-ffd324bb084](https://medium.com/nimiq-network/nimiq-a-peer-to-peer-payment-protocol-native-to-the-web-ffd324bb084). The information contained in the whitepaper and on the Nimiq website are of descriptive nature only, and do not form part of the Terms.
...
- Technical Development and Staff (estimated 55% of proceeds) - This budget item will support the team of engineers that are developing the Nimiq Mainnet and Ecosystem. More specifically the intention is to focus on completing the Mini-Blockchain scheme, researching memory hard consensus algorithms, completing lightning network primitives, creating Genesis Block and launching Mainnet, and building ecosystem apps. In parallel we will harden the protocol with a peer review process and a well-funded bug bounty program.

- Community Development (estimated 12% of proceeds) - This budget item supports a team of experts building a transparent long-term relationship with the community and a strong culture through documentation, responsive support on GitHub/Slack/Reddit, hosting conferences, hackathons, coding challenges and Vlogs.

- Marketing and Business Development (estimated 12% of proceeds) - This budget item will be used for marketing to expand awareness and adoption, developing partnerships, third-party engineering, promotional work, growth hacking, public relations, and affiliate program partnerships.

- Operations (estimated 12% of proceeds) - This budget item will entail accounting, communication, travel and transportation costs; physical infrastructure and security costs; and other associated administration costs.

- Legal (estimated 5% of proceeds) - This budget item will entail legal and related professional services fees to support the setup, expansion and operation of Nimiq Network.

- Contingency (estimated 4% of proceeds) - This budget item is intended as a reserve to address unforeseen costs.
...
[NIM Activation Terms, NET Replacement, and Explanatory Note](/activation-terms)
