...
media:
  ...
  poster: /assets/images/prismic/Z2o2TpbqstJ98zcq_poster.jpg
dive:
  headline:
    label: Take a deep dive
    subline: "Truly decentralized payments accessible to all, or in short: Crypto for humans."
  items:
    - icon: nimiq:duotone-document
      headline: Whitepaper
      link: /litepaper
      color: orange
    - icon: nimiq:duotone-document-text
      headline: Onepager
      link: /onepager
      color: purple
...
team:
  headline:
    headline: Meet the people behind the tech.
  items:
    - shape: Hexagons
      headline: Team Nimiq
      subline: Meet the people behind Nimiq and join the team.
      icon: nimiq:duotone-three-hands-hexagon
      link: /team
      color: blue
roadmap:
  headline: Roadmap
  subline: Nimiq's past and future milestones in one interactive place.
  actions:
    - href: /roadmap
      label: See Roadmap
feedback:
  headline: Feedback
  subline: Nimiq is all about transparency. A great way to find answers is asking the community. Try Telegram for general questions and Discord for tech-related inquiries.
  actions:
