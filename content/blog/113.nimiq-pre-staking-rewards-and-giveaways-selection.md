...
authors:
  - Team Nimiq
image: /assets/images/media/Z5mKMJbqstJ99-G_BlogpostNimiqPrestakinggiveaway.png
---
...
2. It will then utilize the election macro block hash from each day of the selection rounds (details provided below) as a randomness generator to pick a random participant as the winner for each prize.
3. Once a participant wins, they are removed from the pool to ensure no duplicates.
4. The process repeats for each prize, with new block hashes providing fresh randomness for every round.
