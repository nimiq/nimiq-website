...
authors:
  - TEAM NIMIQ
image: /assets/images/media/d45231be-53f8-4f18-96dc-a0818d132d92_blog_nimiq-20-supply-curve-voting_1.jpg
---
...
[**UPDATE 1**: First vote concluded May 18, 2020 with** "YES"** on making an adjustment to the NIM supply curve.  [See results here](/vote/#change-curve).]
...
- **Voting first whether or not the emission rate should change:** It cannot be assumed that the entire community wants the supply curve to change. After all, there are a good number of long time stakeholders that have supported the project with the current supply curve. [**UPDATE**: First vote concluded May 18, 2020 with** "YES"** on making an adjustment to the NIM supply curve.  [See results here](/vote/#change-curve).]
...
- **Ranked votings:** Instead of voting for a single hard choice this complex topic benefits from users rating the selections from favorite to least favorite which the voting tool will support for the second round. [**UPDATE**: Vote concluded on June 8, 2020 and the NIM supply curve for Nimiq 2.0 has been determined as the "**BLUE**" curve (community suggestion).  [See results here](/vote/#rank-curves).]
...
![Supply curve voting options](/assets/images/media/eb201545-0ea1-4e0b-8f0d-e8dff4a431c6_blog_nimiq-20-supply-curve-voting_2.png)
...
![Supply curve option A chart](/assets/images/media/7a99f3ea-f5cb-4488-9bb6-39becf655e83_blog_nimiq-20-supply-curve-voting_3.png)
...
![Supply curve option B chart](/assets/images/media/fa768d07-5b7b-41ee-8f04-e2aaf2551a18_blog_nimiq-20-supply-curve-voting_4.png)
...
![Supply curve option C chart](/assets/images/media/7141c2ef-63cd-4f95-b208-3539aca860c6_blog_nimiq-20-supply-curve-voting_5.png)
...
![Supply curve comparison overlay](/assets/images/media/7504adbf-a9a5-4a4c-b829-523abc286170_blog_nimiq-20-supply-curve-voting_6.png)
...
![Voting process instructions](/assets/images/media/413df6b5-5934-4ba5-83f0-c2ce78f652f9_blog_nimiq-20-supply-curve-voting_7.png)
