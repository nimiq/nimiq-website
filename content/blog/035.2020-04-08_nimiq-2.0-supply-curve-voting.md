...
path: /blog/nimiq-2.0-supply-curve-voting
...
- **Voting first whether or not the emission rate should change:** It cannot be assumed that the entire community wants the supply curve to change. After all, there are a good number of long time stakeholders that have supported the project with the current supply curve. [**UPDATE**: First vote concluded May 18, 2020 with**"YES"** on making an adjustment to the NIM supply curve. [See results here](/blog/supply-curve-for-nimiq-20-finalized).]
...
- **Ranked votings:** Instead of voting for a single hard choice this complex topic benefits from users rating the selections from favorite to least favorite which the voting tool will support for the second round. [**UPDATE**: Vote concluded on June 8, 2020 and the NIM supply curve for Nimiq 2.0 has been determined as the "**BLUE**" curve (community suggestion). [See results here](/blog/supply-curve-for-nimiq-20-finalized).]
