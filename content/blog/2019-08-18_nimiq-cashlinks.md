---
title: Nimiq Cashlinks
description: Sending Crypto to a new user has never been easier
slug: nimiq-cashlinks
...
- **Without the need to already have an account address**
- While receiving some NIM directly from someone they know
- With the **least amount of friction** possible
- Connecting directly to the payment network from their browser
- With the **most user-friendly**, best-looking interface!

## I want to invite my friends now! How do I do it?

To send a Cashlink to a friend who’s new to crypto, simply visit [wallet.nimiq.com](https://wallet.nimiq.com) and click the “Send” button. You will find the Cashlink option at the bottom of the screen.

All you then need to do is create (fund) the Cashlink and share it with your friend via Messenger, SMS or Email.

### What will your friend see on their end?
...
## Exciting isn’t it? [Try it out](https://safe.nimiq.com/) and invite some friends!
...
![](/assets/images/prismic/74cbf6cc-a878-46ef-b04b-9458a3d88a7e_blog_nimiq-cashlinks_2.jpg)

To kick-start the usage of Cashlinks, Team Nimiq will be handing out some brand new engaging Cashlink business cards at the [Web3Summit](https://web3summit.com/) and [CCC](https://events.ccc.de/camp/2019/) events in Berlin as well as the [BDLT](https://bdlt.school/) event in Vienna, where [Nimiq Developers will be giving a talk and a workshop](https://medium.com/nimiq-network/nimiq-is-speaking-in-vienna-d6d0faf3457d).
