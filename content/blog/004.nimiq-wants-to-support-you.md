...
authors:
  - TEAM NIMIQ
image: /assets/images/media/4833c262-c193-4ce2-9288-575c2a31e488_blog_nimiq-wants-to-support-you_1.png
---
...
2. **Public announcement**: The highest voted projects will be announced at least one week before the board meeting so that the community can voice their thoughts and opinions.
3. **Board meeting**: Guided by the community votes and feedback, the board will decide which projects proposals to accept or reject, or if changes need to be made. All final decisions will come with feedback.

_**PLEASE NOTE**: Team Nimiq is currently working on finalizing the details. If you think you already have a strong reason to apply for funding before we deploy the whole process we are happy to hear your feedback on Discord or directly via  [sven@nimiq.com](/mailto:sven@nimiq.com)._
