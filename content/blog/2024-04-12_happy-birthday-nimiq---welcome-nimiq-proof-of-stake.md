---
title: Happy Birthday Nimiq - Welcome Nimiq Proof-of-Stake!
description: As we gear up to celebrate the anniversary of the Nimiq Blockchain, we are also excited to prepare for the migration to Proof-of-Stake. This blog post details the latest security audits, and how users can participate in the complete test of the migration to Proof-of-Stake.
slug: happy-birthday-nimiq---welcome-nimiq-proof-of-stake
...
![](/assets/images/prismic/Zho2DDjCgu4jzzC2_Capturadeecra_2024-04-13_a_s08.31.03.png)
...
- **Access the** **[Testnet Wallet](https://wallet.nimiq-testnet.com/)**.
...
- **Review the Documentation: **Detailed instructions and requirements for registering as a Validator are available in our **[Migration Guide](https://www.nimiq.com/developers/build/migration-guide)**. Make sure to go through the guide thoroughly to understand the Validator registration process and responsibilities.
