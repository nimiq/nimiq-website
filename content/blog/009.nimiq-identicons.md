...
authors:
  - TEAM NIMIQ
image: /assets/images/media/9a91eed6-d535-4686-aabd-209593e5fffd_blog_nimiq-identicons_6.png
---
...
2. By replacing a BTC or ETH wallet address copied to a clipboard with one being controlled by the hacker.

![MetaMask browser extension interface](/assets/images/media/ab17721d-4afc-4ae3-9333-00e8d7cf3a7c_blog_nimiq-identicons_3.png)
...
![Ethereum address identicons](/assets/images/media/fe899cf8-86b8-40eb-8183-9adc21180d73_blog_nimiq-identicons_2.png)
...
![Nimiq address identicons](/assets/images/media/8af37106-f487-4fe5-a8f3-a5f4725965d5_blog_nimiq-identicons_5.jpeg)
...
![Identicon clipboard hijacking detection](/assets/images/media/29167f0f-5a77-4703-84c7-946cc9e0ee6a_blog_nimiq-identicons_4.png)
...
There is also an ongoing effort to improve the usability in the *check-at-a-glance _user interaction, by adding a suggested name to each identicon. Many thanks and credit to community developer  [Terorie](https://github.com/terorie) for contributing the _naming scheme*.
...
![Nimiq identicon element variations](/assets/images/media/f3a4ea5c-f8ff-4731-82fd-59c7548639f1_blog_nimiq-identicons_1.png)
