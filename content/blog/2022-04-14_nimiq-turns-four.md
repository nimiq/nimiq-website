---
title: Happy 4th Birthday Nimiq!
description: Nimiq turns four! Let's celebrate together with some juicy leaks.
slug: nimiq-turns-four
...
Four years ago, the first block was mined on the Nimiq Blockchain. ‘Love’ in as many languages as possible will forever be its message, see [https://nimiq.watch/#1](https://nimiq.watch/#1)
...
The overall structure was updated to properly represent Nimiq’s past and future developments. Most noticeably, there is more focus on our Apps. [SuperSimpleSwap.com](https://www.supersimpleswap.com/), [Cryptopayment.link](http://Cryptopayment.link) and of course the Nimiq Wallet are now more accessible and embedded in proper product pages that allow for professional (SEO) marketing.
...
![](/assets/images/prismic/0d69fdec-1ef8-4d20-8e5b-3f2ee1a091b2_Website_Teaser.png)
...
![](/assets/images/prismic/9726add2-7b5e-499f-88ae-4f7fe53b0aea_Dev_Center_Teaser.png)

## TEN31 KYC

Another longstanding request is about to be answered: Together with our partner [TEN31](https://www.ten31.com/), we are about to launch a KYC option. Once KYC’d with TEN31, you will be able to profit from higher limits for crypto-fiat swaps in the wallet, on [SuperSimpleSwap.com](http://supersimpleswap.com/) and on all upcoming products of TEN31 and Nimiq, including the upcoming ‘Nimiq for Bluecode’ app.
...
![](/assets/images/prismic/235045c7-9a53-4b71-8cca-537669ff056e_KYC_Teaser.png)

## Cryptopayment.link V2

Nimiq’s Cryptopayment.link started as a bit of an experiment. We wanted to create a super simple way for people to accept crypto. The underlying idea was that there are many people in the world for whom investing in anything, let alone crypto, is simply impossible. These people shouldn’t be excluded from the financial revolution.

Cryptopayment.link, or CPL for short, gives those people a tool to sell their services or goods for crypto, even if it’s just every once in a while.
...
While we continue to see overwhelming feedback and interest from potential third-party integrators when presenting it e.g. at the [Blockchance](https://www.blockchance.eu/) conference, our basic idea for marketing is a grassroots approach.
...
![](/assets/images/prismic/b73d3d6e-8983-49b9-90de-57593d4a82df_SuperSimple_Refferals_Teaser.png)
...
![](/assets/images/prismic/28337d17-d4a4-4c5b-86d5-df2583b3f0a7_Youtube_Tutorial_Placeholder_Image_1_-_General_Usage_23_.png)
...
![](/assets/images/prismic/68e5e659-f6b8-4233-af2c-81b5357d33ef_Frame_96_3_.png)
