...
authors:
  - Team Nimiq
image: /assets/images/media/ZwL5ebVsGrYSwa2C_NimiqPoSmigrationStarts_-1-.png
---
...
- **Phase 1: Validator Registration Starts**: September 12**Ends**: October 6
- **Phase 2: Pre-StakingStarts**: October 7**Ends**: November 10
- **Phase 3: ActivationStarts**: November 19, ~7 AM UTC**Ends**: When 80% of the pre-staked NIM signals readiness. After 24 hours from the start, the activation resets for a new candidate transition block and activation attempt.

![PoS migration phases timeline](/assets/images/media/ZuHlfhoQrfVKl_QJ_MigrationPhaseswDates.png)
