...
[**UPDATE 2**: The follow-up ranking vote concluded on June 8, 2020 and the NIM supply curve for Nimiq 2.0 has been determined as the "**BLUE**" curve (community suggestion). [See results here](/blog/supply-curve-for-nimiq-20-finalized).]

[**UPDATE 1**: First vote concluded May 18, 2020 with**"YES"** on making an adjustment to the NIM supply curve. [See results here](/blog/supply-curve-for-nimiq-20-finalized).]
...
**First Vote** (Vote App): **Should Nimiq adjust the current supply curve?** Stakeholders can vote “Yes” or “No” for 10 days: starting on Friday May 8, 2020 at approximately 12:00 noon UTC and ending on Monday May 18 at approximately 12:00 noon UTC (the more exact time will be determined by a specific blockheight target published at the beginning of the vote). [**UPDATE**: Vote concluded May 18, 2020 with**"YES"** on making an adjustment to the NIM supply curve. [See results here](/blog/supply-curve-for-nimiq-20-finalized).]

**Second Vote** (Vote App): Given that the first decision resulted in favor of a supply curve adjustment, stakeholders can vote **by ranking four options: “Green Curve”, “Red Curve”, “Blue Curve” or “None of these”** (1st choice = 1pt, 2nd = 1/2pt, 3rd = 1/4pt, 4th = 1/8pt). This vote will be open for 10 days, starting on **Friday May 29,** 2020 at approximately 12:00 noon UTC and ending on **Monday June 8** at approximately 12:00 noon UTC (the more exact time would be determined by a specific blockheight target published at the beginning of the vote). [**UPDATE**: Vote concluded on June 8, 2020 and the NIM supply curve for Nimiq 2.0 has been determined as the "**BLUE**" curve (community suggestion). [See results here](/blog/supply-curve-for-nimiq-20-finalized).]
...
The first vote has been concluded. The second vote will be on the Mainnet Vote App. The voting app is available on the Testnet at [nimiq-testnet.com/vote](https://nimiq-testnet.com/vote) for you to try out. [Click here](https://getsome.nimiq-testnet.com/) for free Testnet NIM. Reminder: **DO NOT USE your Mainnet account(s) on the Testnet**.
