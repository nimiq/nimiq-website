---
title: Community Funding Board 8th Meeting
description: New community reward schemes & ways to support the Nimiq ecosystem
slug: community-funding-board-8th-meeting
...
![](/assets/images/prismic/6bd52839-7c13-47f9-b7f2-5f5c06f331d3_blog_community-funding-board-8th-meeting_2.png)
...
![](/assets/images/prismic/7f8d6993-7124-4f11-8863-6866ab22abc2_blog_community-funding-board-8th-meeting_3.png)

Source: [Medium](https://towardsdatascience.com/visualize-programming-language-popularity-using-tiobeindexpy-f82c5a96400d)
...
Python was assigned a low difficulty rating because the [Python RPC library has already been started](https://github.com/jgraef/nimiq-api-python). Both Go and Ruby were deemed low priority for the Community Funding Board. However, it was acknowledged that quite a lot of people use Ruby for web apps and this made it a more interesting programming language than others in the ‘low’ category.

### Bounty criteria

![](/assets/images/prismic/4ecefcbe-877e-4469-86e0-62cd59110fd2_blog_community-funding-board-8th-meeting_4.png)
...
- **Thomkha** - for his documentation on [how to run the Nimiq Rust node on Android](https://telegra.ph/How-to-run-the-Nimiq-Rust-node-on-Android-12-03).
- **Smittop** - for his cool [pixel auction](https://pixel.auction/) solution powered by NIM.
- **Mario** - Nimiq widget.
...
The Board also discussed an old proposal for a [NIM/ETH cross-chain atomic swap tool](https://github.com/hector-nimiq/nimeth-atomicswap) and debated if this old project would be fitting for another community bounty. The outcome was that Nimiq Core should be consulted to see if OASIS would make the project obsolete.

## Finally…

The Community Funding Board is still accepting proposals for funding and mentoring. If you have a great idea and need a little help to get it off the ground, please do follow our [proposal submission guide](https://forum.nimiq.community/t/project-proposal-template/59) and email your idea to proposals [at] nimiq [dot] com.
