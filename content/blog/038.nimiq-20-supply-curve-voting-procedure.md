...
authors:
  - TEAM NIMIQ
image: /assets/images/media/7b8333e7-2e54-4a5c-9126-ab0edd370fa3_blog_nimiq-20-supply-curve-voting-procedure_1.jpg
---
...
![Voting procedure overview](/assets/images/media/417f1f4d-648c-41d7-8290-336d307dbdb7_blog_nimiq-20-supply-curve-voting-procedure_2.png)
...
The first vote has been concluded. The second vote will be on the Mainnet at /vote#rank-curves. The voting app is available on the Testnet at https://nimiq-testnet.com/vote for you to try out.  [Click here](https://getsome.nimiq-testnet.com/) for free Testnet NIM. Reminder: **DO NOT USE your Mainnet account(s) on the Testnet**.

### Guide for first vote [YES/NO, May 8 - 18]

### Step 1: Read the instructions carefully

![Supply curve candidate A](/assets/images/media/5234b8e7-e3b1-46b0-8940-5d346cbe9b53_blog_nimiq-20-supply-curve-voting-procedure_3.png)
...
![Supply curve candidate B](/assets/images/media/59eac8cc-4283-40ee-99c6-d3b0146d6a4f_blog_nimiq-20-supply-curve-voting-procedure_4.png)
...
![Supply curve candidate C](/assets/images/media/beb69e3c-d652-4c04-ab75-9bf8d6a79055_blog_nimiq-20-supply-curve-voting-procedure_5.png)
...
![Supply curve candidate D](/assets/images/media/34c3fa66-ef0f-4ef5-9fda-927e29ac1f24_blog_nimiq-20-supply-curve-voting-procedure_6.png)
...
![Supply curve candidate E](/assets/images/media/fedee627-6603-414d-be86-a548384b8a94_blog_nimiq-20-supply-curve-voting-procedure_7.png)
...
![Voting weight calculation](/assets/images/media/dc6f4be9-c6c1-459e-808c-75dc1104343f_blog_nimiq-20-supply-curve-voting-procedure_8.png)
...
![Vote submission instructions](/assets/images/media/477bfb6d-9355-4b79-8f61-df0c5b1848ac_blog_nimiq-20-supply-curve-voting-procedure_9.png)
...
Try out our Testnet Vote which will run until Wednesday May 6. The important first vote on Mainnet will begin on Friday May 8 approximately at 12:00 noon UTC. UPDATE: The important first vote on Mainnet has been concluded and resulted with 78.4% in favor of making an adjustment to the NIM supply curve. The second vote on ranking NIM supply curve options will begin on **Friday May 29** at approximately 12:00 noon UTC ([/vote#rank-curves](https://www.nimiq.com/vote#rank-curves)). Try the  [Testnet Ranking Vote](https://nimiq-testnet.com/vote/) from Saturday May 23 to Tuesday May 26. Nimiq will share all official information and results on its  [Twitter account](https://twitter.com/nimiq) so make sure to stay tuned.
