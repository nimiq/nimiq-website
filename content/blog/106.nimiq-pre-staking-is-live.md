...
authors:
  - Team Nimiq
image: /assets/images/media/ZwLGFrVsGrYSwavQ_StartsPre-StakingphaseBLOG-1-.png
---
...
2. 100 million NIM in additional Bonus Giveaways: your chances increase as you accumulate points for staking a certain way (timing, choice of pool, etc):
...
The more you optimize your pre-staking strategy, the better your chances! [**Learn more details on the Pre-staking page!**](https://prestaking.nimiq.com/)
...
![Pre-staking wallet interface](/assets/images/media/Zv6t-LVsGrYSwV4a_MainV1.png)

After logging into your account, you will find important information about the campaign.

**2. Find the Pre-Stake Button**

![Pre-staking amount selection](/assets/images/media/Zv6vSLVsGrYSwV5X_prestake1.png)

Look for the button with a golden plant-like icon to begin the pre-staking process.

**3. Select a Validator**

![Validator picker interface](/assets/images/media/Zv6vhLVsGrYSwV5f_pickvalidator.png)
...
![Pre-staking confirmation screen](/assets/images/media/Zv7CiLVsGrYSwWEn_MainV1-1-.png)

Decide how much NIM you want to pre-stake. And confirm stake.

**5. Claim your points**

![Staking points claim interface](/assets/images/media/ZwLKnbVsGrYSwavk_ClaimPoints.png)
...
Stay tuned through our official channels, be cautious of impersonators, and gear up for Proof of Stake!Pura VidaTeam Nimiq
