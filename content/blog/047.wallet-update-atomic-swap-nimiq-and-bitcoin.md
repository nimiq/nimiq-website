...
authors:
  - TEAM NIMIQ
image: /assets/images/media/33cee702-2282-41bc-b3ad-224421a714b1_blog_wallet-update-atomic-swap-nimiq-and-bitcoin_1.png
---
...
![Atomic swap wallet interface](/assets/images/media/0501967e-359e-459f-8729-2c2332a6e9c2_blog_wallet-update-atomic-swap-nimiq-and-bitcoin_2.png)
...
2. Click on the Bitcoin section down here to see your BTC transaction history.
3. You can generate new Bitcoin addresses to receive BTC with the "Receive" button and send BTC to any address with the "Send" button.
4. This is your BTC transaction history for this account.
...
![NIM-BTC swap flow diagram](/assets/images/media/35845d92-a0cc-423c-ad9d-cafb0382bb35_blog_wallet-update-atomic-swap-nimiq-and-bitcoin_3.png)
