---
title: Community Funding Board 19th Report
description: In this report, we'll update you on the first meeting of the new board elected by the Nimiq community, as well as the funding decisions made during the meeting.
slug: in-this-report-well-update-you-on-the-first-meeting
...
1. We start with a budget of 200 USD in NIM per month and would require analytics data of the Twitch stream to decide in the next Community Funding Board meeting about the amount of the funding.
1. The stream would have to run 24/7
...
UAH Motorsport is a racing team started by a group of future engineers from Universidad de Alcalá in Spain. Their goal is to build the perfect electric race car that can perform well on any type of track, and represent them in the international university Formula Student (SAE) competition.
...
1. Community Developer Brantje (Sander) for creating the Albatross Dev-Net blockchain explorer albatross.nimiq.tools - 100k $NIM reward
1. Community Moderator Yeppa for taking care of requests of any kind over many Nimiq Telegram groups - 30k $NIM reward
1. FonsL and Albermonte for building the Nimiq Treasury game - 50k $NIM reward each
