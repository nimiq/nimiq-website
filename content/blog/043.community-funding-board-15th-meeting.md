---
title: Community Funding Board 15th Meeting
description: NimiqX, NimiqChina and Community Hackathon Organization
slug: community-funding-board-15th-meeting
...
![](/assets/images/prismic/e7cf1e1b-665d-46c2-9d35-fe82a9153dae_blog_community-funding-board-15th-meeting_2.png)
...
[This proposal](https://forum.nimiq.community/t/nimiqx-project-proposal/864/3) has been approved, and will receive funding of 393 USD in NIM.

![](/assets/images/prismic/72df6f15-bfed-413e-8469-d999bfcddb8d_blog_community-funding-board-15th-meeting_3.png)
...
[This proposal](https://forum.nimiq.community/t/nimiqchina-project-proposal/863) has been approved with funding of 298 USD in NIM.
...
![](/assets/images/prismic/8464b8bc-8869-48b2-a549-ebeeb559dc37_blog_community-funding-board-15th-meeting_4.png)

### Nimiq DJ Hektor Palme

You can find him playing some tunes at his [Theta channel](https://www.theta.tv/hektorpalme0815). He runs frequent giveaways and supports adoption of Nimiq one beat at a time. The board agreed to reward him with 10’000 NIM for his support.

![](/assets/images/prismic/96e4e1da-bc14-4d20-91db-3ba10802d850_blog_community-funding-board-15th-meeting_12.png)

### [Noviopay](https://nimiq.noviopay.com/) by Kaspar_NL

Dutch developer Kaspar_NL surprised us with [this nice app](https://nimiq.noviopay.com/) to request donations. It is simple, yet useful and perfectly showcases how to use Nimiq in a project. We will reward Kaspar with 10’000 NIM for his work. Thanks and BUIDL on!

![](/assets/images/prismic/8d1b6b7e-7dec-4063-a452-7e1b2d62d00b_blog_community-funding-board-15th-meeting_5.png)

### [Albatross Staking Calculator](https://albacore.mopsus.com/calculator) by Ken_Blazer

Team Nimiq released information about how staking could look like in Nimiq 2.0 and immediately Ken_Blazer got to work. He created a useful staking calculator to calculate potential rewards on Nimiq 2.0 as well as different variables of the rewards system. Check it out [here](https://albacore.mopsus.com/calculator). We want to reward Ken_Blazer with 25’000 NIM for his work.

![](/assets/images/prismic/812d8fe7-ec11-4136-aa14-af90dfa0b3a0_blog_community-funding-board-15th-meeting_6.png)
...
![](/assets/images/prismic/c19ebff4-0490-44de-b1d6-41080fb9044f_blog_community-funding-board-15th-meeting_7.png)
...
![](/assets/images/prismic/885089a3-c99d-425a-991c-5c61a4cf803e_blog_community-funding-board-15th-meeting_8.png)
...
![](/assets/images/prismic/5e058256-6b7a-4cf7-98c0-dd576357cd78_blog_community-funding-board-15th-meeting_9.jpeg)

### FonsL and his awesome Nimiq OASIS Infographic

FonsL has been supporting the community for a while with cool designs and this time he created a clear and nice infographic about Nimiq OASIS. Even though we have a running [competition for Nimiq OASIS infographics designers](https://twitter.com/nimiq/status/1291040529501880321), we would like to reward FonsL with 5’000 NIM for creating this one out of pure love before the contest was even announced.

![](/assets/images/prismic/6ab7ae4f-36cc-4644-b1c8-751fd0a1587a_blog_community-funding-board-15th-meeting_10.png)
...
- [Nimiq payments module for Catarse](https://forum.nimiq.community/t/nimiq-payments-module-for-catarse-crowdfunding-platform/374): [Catarse](http://catarse.me/) is an [open source ](https://github.com/catarse/catarse)crowdfunding platform. It has a modular system that allows for adding alternative payment systems and NIM could be a good option.
- [Vanity address generator](https://forum.nimiq.community/t/vanity-nimiq-address-generator/252): A suggestion on creating an address generator based on existing tools like the [nimiq vanity wallet](https://github.com/valentinvieriu/nimiq-vanity-wallet) and the [Nimiq Identicon Builder](https://nimiq.github.io/identicons/builder.html) to allow users to customize their address to a higher degree.

If you have more ideas remember you can share them in the [Project Ideas section of the Forum](https://forum.nimiq.community/c/discussion/project-ideas/20).

A lot have been going on and we had many things to share this month. Now we are excited about next month’s meeting. Remember you can [send a proposal by following these instructions](https://forum.nimiq.community/t/how-to-apply-for-project-funding/60).
...
![](/assets/images/prismic/df730841-e55b-482e-b522-ad9b1778c18d_blog_community-funding-board-15th-meeting_11.png)
