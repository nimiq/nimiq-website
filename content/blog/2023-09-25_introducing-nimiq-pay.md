---
title: Introducing Nimiq Pay
description: We are ready to talk about and introduce to you the all new native mobile app named "Nimiq Pay". It is entering late stage development and we want to provide insights into our vision and its features.
slug: introducing-nimiq-pay
...
### Integration with [Nimiq Crypto Map](https://map.nimiq.com/)

Locating places that accept NIM should be as easy as finding a coffee shop nearby. We're in the process of fine-tuning the [Nimiq Crypto Map](https://map.nimiq.com/) for mobile users, ensuring that they can swiftly identify establishments and services that welcome NIM. It’s not just a tool for our users, it's an opportunity for businesses to tap into the thriving world of cryptocurrency.
