...
Based on the detailed insights shared in the [previous blog post](https://www.nimiq.com/blog/nimiq-proof-of-stake-supply-curve-update/) regarding the transition of Nimiq to Proof-of-Stake (PoS) and the thoughtful dialogue that followed within the community, a comprehensive understanding has been achieved.

![](/assets/images/prismic/ZgSBnMt2UUcvBPRv_curves.png)
...
![](/assets/images/prismic/ZgTI4st2UUcvBPdp_SupplyCurveDecisionProcess-GreenCurve-PoWOriginal--5-.png)
...
![](/assets/images/prismic/ZgTI28t2UUcvBPdk_SupplyCurveDecisionProcess-RedCurve-6-.png)
...
![](/assets/images/prismic/ZgTI6st2UUcvBPdq_SupplyCurveDecisionProcess-GrayCurve-3-.png)
...
1. **Your vote will be automatically submitted through the Nimiq Voting app **by sending 1 Luna (= 0.00001 NIM) to the preset burn address (an address that will be derived by the voting app based on the hash of the voting setup. This makes it verifiable that the setup is not changed during or after voting). The transaction contains the vote in the form of a public message recorded on the blockchain.
1. **What counts is the balance (1 NIM = 1 Vote) on your voting address AT THE CLOSING OF THE VOTE WHEN A SNAPSHOT OF THE BLOCKCHAIN IS TAKEN AT THE FINAL BLOCK. **For example: if you submit a vote and then move the funds away from that address before the end of the voting period, the balance on that address will be zero, equivalent to no votes. Note that of course, you can vote again with your new address that now has the balance. This prevents anyone from using their balance(s) more than once.
...
### Step 1: Visit the [Vote App](https://www.nimiq.com/vote/)

![](/assets/images/prismic/ZgSB-8t2UUcvBPSP_Screenshot2024-03-22at09.52.42.png)

### Step 2: Rank the choices

The curve choices are randomized in their position when you enter the voting app. Drag them into the order of your preference before submitting your vote. You can read more [about the curves in the latest Blog post](https://www.nimiq.com/blog/nimiq-proof-of-stake-supply-curve-update/) as well as [this forum discussion](https://forum.nimiq.community/t/supply-curve-update-discussion/1995/27).
...
![](/assets/images/prismic/Zf3Pw8cYqOFdyCaJ_image-12-.png)
...
![](/assets/images/prismic/Zf3PzMcYqOFdyCaK_image-13-.png)
...
All official information and results will be shared through [**Nimiq’s Twitter account**](http://x.com/nimiq), ensuring the community remains informed. Make sure to stay tuned for updates.
