...
content: |
  Quick Access: [Policy](https://www.nimiq.com/bug-bounty/#disclosure-policy), [Rewards](https://www.nimiq.com/bug-bounty/#rewards), [Rules](https://www.nimiq.com/bug-bounty/#program-rules), [In Scope](https://www.nimiq.com/bug-bounty/#in-scope), [Out of Scope](https://www.nimiq.com/bug-bounty/#out-of-scope).
  ...
  is a simple, secure and censorship-resistant payment protocol, native to the web. We look forward to working with the community to find security vulnerabilities in order to keep our protocol and official implementations as safe as possible. You can find our developer reference [here](https://www.nimiq.dev/).

  ## SLA

  will make a best effort to meet the following SLAs for hackers participating in our program:
  ...
  To find these vulnerabilities, you can use both the source code directly, as well as our testnet (the instructions to access both of them are in the "[In Scope](https://www.nimiq.com/bug-bounty/#in-scope)" section below).
  ...
  - Any issues that are outside what is defined in the "[In Scope](https://www.nimiq.com/bug-bounty/#in-scope)" section below.
  ...
  To get you started, you can download the [Burp Suite Project Configuration file](https://www.nimiq.com/bug-bounty/#in-scope). To learn more about Nimiq, [create your account](https://wallet.nimiq.com/?onboarding=signup), [join the community](https://t.me/Nimiq) and find out more on [nimiq.com](/).
