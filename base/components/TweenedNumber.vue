...
const { decimals = 0, value = 0, animationDuration = 1000, min = 0, max = 100, locale = 'en-US', digitsCount } = props
...
<template>
  <span style="font-variant-numeric: tabular">{{ formattedValue }}</span>
</template>
